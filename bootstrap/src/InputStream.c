...
typedef void (*$fn71)(panda$io$InputStream$LineIterator*);
typedef void (*$fn73)(panda$io$InputStream$LineIterator*);
typedef panda$core$String* (*$fn74)(panda$io$InputStream*);
...
panda$core$String* panda$io$InputStream$LineIterator$next$R$panda$core$String(panda$io$InputStream$LineIterator* self) {
    ...
    result72 = self->_next;
    (($fn73) self->$class->vtable[4])(self);
    return result72;
}
void panda$io$InputStream$LineIterator$readNext(panda$io$InputStream$LineIterator* self) {
    panda$core$String* $tmp75 = (($fn74) self->input->$class->vtable[11])(self->input);
    self->_next = $tmp75;
}
