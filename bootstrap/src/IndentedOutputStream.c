...
void panda$io$IndentedOutputStream$write$panda$unsafe$Pointer$LTpanda$core$UInt8$GT$panda$core$Int64$panda$core$Int64(panda$io$IndentedOutputStream* self, panda$core$UInt8* p_ptr, panda$core$Int64 p_offset, panda$core$Int64 p_count) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp3, ((panda$core$Object*) wrap_panda$core$Int64(p_offset)), ((panda$core$Object*) wrap_panda$core$Int64($tmp4)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp6 = ((panda$core$Int64$wrapper*) $tmp3.start)->value.value;
    panda$core$Int64 i5 = { $tmp6 };
    int64_t $tmp8 = ((panda$core$Int64$wrapper*) $tmp3.end)->value.value;
