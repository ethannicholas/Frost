...
void panda$io$Console$print$panda$core$String(panda$core$String* p_s) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp1, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Object*) wrap_panda$core$Int64(p_s->_length)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp3 = ((panda$core$Int64$wrapper*) $tmp1.start)->value.value;
    panda$core$Int64 i2 = { $tmp3 };
    int64_t $tmp5 = ((panda$core$Int64$wrapper*) $tmp1.end)->value.value;
