...
__attribute__((weak)) frost$core$Object* frost$unsafe$NewPointer$$IDX$frost$core$Int$R$frost$unsafe$NewPointer$T$shim(frost$core$Object* p0, frost$core$Int p1, int64_t pointerSize) {
    frost$core$Object* result = frost$unsafe$NewPointer$$IDX$frost$core$Int$R$frost$unsafe$NewPointer$T(((frost$unsafe$NewPointer$wrapper*) p0)->value, p1, pointerSize);

    return result;
}
__attribute__((weak)) void frost$unsafe$NewPointer$$IDXEQ$frost$core$Int$frost$unsafe$NewPointer$T$shim(frost$core$Object* p0, frost$core$Int p1, frost$core$Object* p2, int64_t pointerSize) {
    frost$unsafe$NewPointer$$IDXEQ$frost$core$Int$frost$unsafe$NewPointer$T(((frost$unsafe$NewPointer$wrapper*) p0)->value, p1, p2, pointerSize);

}
__attribute__((weak)) frost$unsafe$NewPointer frost$unsafe$NewPointer$realloc$frost$core$Int$frost$core$Int$R$frost$unsafe$NewPointer$LTfrost$unsafe$NewPointer$T$GT$shim(frost$core$Object* p0, frost$core$Int p1, frost$core$Int p2, int64_t pointerSize) {
    frost$unsafe$NewPointer result = frost$unsafe$NewPointer$realloc$frost$core$Int$frost$core$Int$R$frost$unsafe$NewPointer$LTfrost$unsafe$NewPointer$T$GT(((frost$unsafe$NewPointer$wrapper*) p0)->value, p1, p2, pointerSize);

    return result;
}
__attribute__((weak)) frost$unsafe$NewPointer frost$unsafe$NewPointer$$ADD$frost$core$Int$R$frost$unsafe$NewPointer$LTfrost$unsafe$NewPointer$T$GT$shim(frost$core$Object* p0, frost$core$Int p1, int64_t pointerSize) {
    frost$unsafe$NewPointer result = frost$unsafe$NewPointer$$ADD$frost$core$Int$R$frost$unsafe$NewPointer$LTfrost$unsafe$NewPointer$T$GT(((frost$unsafe$NewPointer$wrapper*) p0)->value, p1, pointerSize);
...
frost$unsafe$NewPointer frost$unsafe$NewPointer$alloc$frost$core$Int$R$frost$unsafe$NewPointer$LTfrost$unsafe$NewPointer$T$GT(frost$core$Int param0, int64_t param1) {
...
frost$core$Object* frost$unsafe$NewPointer$$IDX$frost$core$Int$R$frost$unsafe$NewPointer$T(frost$unsafe$NewPointer param0, frost$core$Int param1, int64_t param2) {
...
void frost$unsafe$NewPointer$$IDXEQ$frost$core$Int$frost$unsafe$NewPointer$T(frost$unsafe$NewPointer param0, frost$core$Int param1, frost$core$Object* param2, int64_t param3) {
...
frost$unsafe$NewPointer frost$unsafe$NewPointer$realloc$frost$core$Int$frost$core$Int$R$frost$unsafe$NewPointer$LTfrost$unsafe$NewPointer$T$GT(frost$unsafe$NewPointer param0, frost$core$Int param1, frost$core$Int param2, int64_t param3) {
...
frost$unsafe$NewPointer frost$unsafe$NewPointer$$ADD$frost$core$Int$R$frost$unsafe$NewPointer$LTfrost$unsafe$NewPointer$T$GT(frost$unsafe$NewPointer param0, frost$core$Int param1, int64_t param2) {
...
frost$core$Int _1;
// /Users/ethannicholas/Dropbox/Frost/src/frost/unsafe/NewPointer.frost:134
_1 = (frost$core$Int) {134u};
...
frost$core$Int _1;
// /Users/ethannicholas/Dropbox/Frost/src/frost/unsafe/NewPointer.frost:159
_1 = (frost$core$Int) {159u};
