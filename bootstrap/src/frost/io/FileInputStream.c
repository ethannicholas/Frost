...
block1:;
// line 22
frost$io$FileInputStream$close(param0);
goto block2;
block2:;
// line 20
...
// line 32
frost$core$UInt8$nullable $tmp5;
frost$io$FileInputStream$readImpl$R$frost$core$UInt8$Q(&$tmp5, param0);
return $tmp5;
...
// line 41
frost$core$Int64 $tmp6;
frost$io$FileInputStream$readImpl$frost$unsafe$Pointer$LTfrost$core$UInt8$GT$frost$core$Int64$R$frost$core$Int64(&$tmp6, param0, param1, param2);
return $tmp6;
