...
frost$threads$ScopedLock$class_type frost$threads$ScopedLock$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Immutable$class, NULL, { frost$core$Object$convert$R$frost$core$String, frost$threads$ScopedLock$cleanup$shim} };
