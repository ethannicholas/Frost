...
__attribute__((weak)) frost$core$String* frost$core$Real64$convert$R$frost$core$String$shim(frost$core$Object* p0) {
    frost$core$String* result = frost$core$Real64$convert$R$frost$core$String(((frost$core$Real64$wrapper*) p0)->value);
...
frost$core$Real64$wrapperclass_type frost$core$Real64$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, &$s2, (frost$core$Class*) &frost$core$Value$class, (ITable*) &frost$core$Real64$wrapper_frost$core$Equatable, { frost$core$Real64$convert$R$frost$core$String$shim, frost$core$Value$cleanup$shim} };
