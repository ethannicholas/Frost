...
__attribute__((weak)) frost$core$String* frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT$get_asString$R$frost$core$String$shim(frost$core$Object* p0) {
    frost$core$String* result = frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT$get_asString$R$frost$core$String(((frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT$wrapper*) p0)->value);

    return result;
}
__attribute__((weak)) void frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT$cleanup$shim(frost$core$Object* p0) {
    frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT$cleanup(((frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT$wrapper*) p0)->value);

}

static frost$core$String $s1;
frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT$class_type frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT$class = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s1, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT$get_asString$R$frost$core$String$shim, frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT$cleanup$shim} };

static frost$core$String $s2;
frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT$wrapperclass_type frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s2, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT$get_asString$R$frost$core$String$shim, frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT$cleanup$shim} };typedef frost$core$String* (*$fn17)(frost$core$Object*);
typedef frost$core$String* (*$fn32)(frost$core$Object*);
typedef frost$core$String* (*$fn40)(frost$core$Object*);

static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x53\x74\x65\x70\x70\x65\x64\x52\x61\x6e\x67\x65\x3c\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x49\x6e\x74\x33\x32\x2c\x20\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x49\x6e\x74\x33\x32\x3e", 59, 3615797001978239834, NULL };
...
frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT$init$frost$core$Int32$frost$core$Int32$frost$core$Int32$frost$core$Bit(frost$core$Int32 param0, frost$core$Int32 param1, frost$core$Int32 param2, frost$core$Bit param3) {

frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT local0;
// /Users/ethannicholas/Dropbox/Frost/src/frost/core/SteppedRange.frost:43
frost$core$Int32* $tmp3 = &(&local0)->start;
*$tmp3 = param0;
// /Users/ethannicholas/Dropbox/Frost/src/frost/core/SteppedRange.frost:44
frost$core$Int32* $tmp4 = &(&local0)->end;
*$tmp4 = param1;
// /Users/ethannicholas/Dropbox/Frost/src/frost/core/SteppedRange.frost:45
frost$core$Int32* $tmp5 = &(&local0)->step;
*$tmp5 = param2;
// /Users/ethannicholas/Dropbox/Frost/src/frost/core/SteppedRange.frost:46
frost$core$Bit* $tmp6 = &(&local0)->inclusive;
*$tmp6 = param3;
frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT $tmp7 = *(&local0);
return $tmp7;

}
frost$core$String* frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT$get_asString$R$frost$core$String(frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT param0) {
...
frost$core$Int32 $tmp10 = param0.start;
...
frost$core$Int32 $tmp14 = param0.start;
frost$core$Int32$wrapper* $tmp15;
$tmp15 = (frost$core$Int32$wrapper*) frostObjectAlloc(20, (frost$core$Class*) &frost$core$Int32$wrapperclass);
$tmp15->value = $tmp14;
...
frost$core$Int32 $tmp25 = param0.end;
...
frost$core$Int32 $tmp29 = param0.end;
frost$core$Int32$wrapper* $tmp30;
$tmp30 = (frost$core$Int32$wrapper*) frostObjectAlloc(20, (frost$core$Class*) &frost$core$Int32$wrapperclass);
$tmp30->value = $tmp29;
...
frost$core$Int32$wrapper* $tmp38;
$tmp38 = (frost$core$Int32$wrapper*) frostObjectAlloc(20, (frost$core$Class*) &frost$core$Int32$wrapperclass);
$tmp38->value = $tmp37;
...
void frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT$cleanup(frost$core$SteppedRange$LTfrost$core$Int32$Cfrost$core$Int32$GT param0) {
