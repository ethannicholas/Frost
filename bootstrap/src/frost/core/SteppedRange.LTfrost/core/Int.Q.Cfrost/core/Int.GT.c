...
$tmp15->value = ((frost$core$Int) $tmp14.value);
...
frost$core$Int$nullable $tmp25 = param0.end;
...
frost$core$Int$nullable $tmp29 = param0.end;
...
$tmp30->value = ((frost$core$Int) $tmp29.value);
