...
__attribute__((weak)) void frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int64$GT$cleanup$shim(frost$core$Object* p0) {
    frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int64$GT$cleanup(((frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int64$GT$wrapper*) p0)->value);

}

static frost$core$String $s1;
frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int64$GT$class_type frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int64$GT$class = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s1, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int64$GT$get_asString$R$frost$core$String$shim, frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int64$GT$cleanup$shim} };

static frost$core$String $s2;
frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int64$GT$wrapperclass_type frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int64$GT$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s2, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int64$GT$get_asString$R$frost$core$String$shim, frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int64$GT$cleanup$shim} };typedef frost$core$String* (*$fn18)(frost$core$Object*);
typedef frost$core$String* (*$fn34)(frost$core$Object*);
typedef frost$core$String* (*$fn42)(frost$core$Object*);

static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "", 67, -3358117431072420309, NULL };
...
frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int64$GT frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int64$GT$init$frost$core$String$Index$Q$frost$core$String$Index$Q$frost$core$Int64$frost$core$Bit(frost$core$String$Index$nullable param0, frost$core$String$Index$nullable param1, frost$core$Int64 param2, frost$core$Bit param3) {

frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int64$GT local0;
...
*$tmp6 = param3;
frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int64$GT $tmp7 = *(&local0);
return $tmp7;
...
frost$core$Int64 $tmp39 = param0.step;
frost$core$Int64$wrapper* $tmp40;
$tmp40 = (frost$core$Int64$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &frost$core$Int64$wrapperclass);
$tmp40->value = $tmp39;
...
void frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int64$GT$cleanup(frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int64$GT param0) {
