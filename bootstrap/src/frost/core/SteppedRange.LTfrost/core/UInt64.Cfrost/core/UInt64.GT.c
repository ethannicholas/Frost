...
__attribute__((weak)) frost$core$String* frost$core$SteppedRange$LTfrost$core$UInt64$Cfrost$core$UInt64$GT$get_asString$R$frost$core$String$shim(frost$core$Object* p0) {
    frost$core$String* result = frost$core$SteppedRange$LTfrost$core$UInt64$Cfrost$core$UInt64$GT$get_asString$R$frost$core$String(((frost$core$SteppedRange$LTfrost$core$UInt64$Cfrost$core$UInt64$GT$wrapper*) p0)->value);
...
frost$core$SteppedRange$LTfrost$core$UInt64$Cfrost$core$UInt64$GT$class_type frost$core$SteppedRange$LTfrost$core$UInt64$Cfrost$core$UInt64$GT$class = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s1, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$SteppedRange$LTfrost$core$UInt64$Cfrost$core$UInt64$GT$get_asString$R$frost$core$String$shim, frost$core$SteppedRange$LTfrost$core$UInt64$Cfrost$core$UInt64$GT$cleanup$shim} };

static frost$core$String $s2;
frost$core$SteppedRange$LTfrost$core$UInt64$Cfrost$core$UInt64$GT$wrapperclass_type frost$core$SteppedRange$LTfrost$core$UInt64$Cfrost$core$UInt64$GT$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s2, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$SteppedRange$LTfrost$core$UInt64$Cfrost$core$UInt64$GT$get_asString$R$frost$core$String$shim, frost$core$SteppedRange$LTfrost$core$UInt64$Cfrost$core$UInt64$GT$cleanup$shim} };typedef frost$core$String* (*$fn3)(frost$core$Object*);
...
frost$core$Bit* _10;
frost$core$SteppedRange$LTfrost$core$UInt64$Cfrost$core$UInt64$GT _12;
...
frost$core$String* frost$core$SteppedRange$LTfrost$core$UInt64$Cfrost$core$UInt64$GT$get_asString$R$frost$core$String(frost$core$SteppedRange$LTfrost$core$UInt64$Cfrost$core$UInt64$GT param0) {
...
_18 = *(&local0);
_19 = param0.start;
frost$core$UInt64$wrapper* $tmp6;
$tmp6 = (frost$core$UInt64$wrapper*) frostObjectAlloc(sizeof(frost$core$UInt64$wrapper), (frost$core$Class*) &frost$core$UInt64$wrapperclass);
$tmp6->value = _19;
...
_51 = *(&local0);
_52 = param0.end;
frost$core$UInt64$wrapper* $tmp10;
$tmp10 = (frost$core$UInt64$wrapper*) frostObjectAlloc(sizeof(frost$core$UInt64$wrapper), (frost$core$Class*) &frost$core$UInt64$wrapperclass);
$tmp10->value = _52;
...
_69 = *(&local0);
_70 = param0.step;
frost$core$UInt64$wrapper* $tmp13;
$tmp13 = (frost$core$UInt64$wrapper*) frostObjectAlloc(sizeof(frost$core$UInt64$wrapper), (frost$core$Class*) &frost$core$UInt64$wrapperclass);
$tmp13->value = _70;
