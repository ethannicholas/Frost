...
frost$core$UInt64 $tmp25 = param0.end;
...
frost$core$UInt64 $tmp29 = param0.end;
frost$core$UInt64$wrapper* $tmp30;
$tmp30 = (frost$core$UInt64$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &frost$core$UInt64$wrapperclass);
$tmp30->value = $tmp29;
...
frost$core$UInt64$wrapper* $tmp38;
$tmp38 = (frost$core$UInt64$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &frost$core$UInt64$wrapperclass);
$tmp38->value = $tmp37;
