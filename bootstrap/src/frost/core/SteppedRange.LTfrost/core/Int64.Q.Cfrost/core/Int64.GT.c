...
frost$core$Int64$nullable $tmp26 = param0.end;
...
frost$core$Int64$nullable $tmp30 = param0.end;
...
if ($tmp30.nonnull) {
    ...
    $tmp32->value = ((frost$core$Int64) $tmp30.value);
