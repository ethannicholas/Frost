...
__attribute__((weak)) frost$core$String* frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT$get_asString$R$frost$core$String$shim(frost$core$Object* p0) {
    frost$core$String* result = frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT$get_asString$R$frost$core$String(((frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT$wrapper*) p0)->value);

    return result;
}
__attribute__((weak)) void frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT$cleanup$shim(frost$core$Object* p0) {
    frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT$cleanup(((frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT$wrapper*) p0)->value);

}

static frost$core$String $s1;
frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT$class_type frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT$class = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s1, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT$get_asString$R$frost$core$String$shim, frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT$cleanup$shim} };

static frost$core$String $s2;
frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT$wrapperclass_type frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s2, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT$get_asString$R$frost$core$String$shim, frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT$cleanup$shim} };typedef frost$core$String* (*$fn3)(frost$core$Object*);
...
frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT$init$frost$core$UInt$frost$core$UInt$frost$core$UInt$frost$core$Bit(frost$core$UInt param0, frost$core$UInt param1, frost$core$UInt param2, frost$core$Bit param3) {

frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT local0;
frost$core$UInt* _1;
frost$core$UInt* _4;
frost$core$UInt* _7;
frost$core$Bit* _10;
frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT _12;
...
frost$core$String* frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT$get_asString$R$frost$core$String(frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT param0) {
...
_18 = *(&local0);
_19 = param0.start;
frost$core$UInt$wrapper* $tmp6;
$tmp6 = (frost$core$UInt$wrapper*) frostObjectAlloc(sizeof(frost$core$UInt$wrapper), (frost$core$Class*) &frost$core$UInt$wrapperclass);
$tmp6->value = _19;
...
_51 = *(&local0);
_52 = param0.end;
frost$core$UInt$wrapper* $tmp10;
$tmp10 = (frost$core$UInt$wrapper*) frostObjectAlloc(sizeof(frost$core$UInt$wrapper), (frost$core$Class*) &frost$core$UInt$wrapperclass);
$tmp10->value = _52;
...
_69 = *(&local0);
_70 = param0.step;
frost$core$UInt$wrapper* $tmp13;
$tmp13 = (frost$core$UInt$wrapper*) frostObjectAlloc(sizeof(frost$core$UInt$wrapper), (frost$core$Class*) &frost$core$UInt$wrapperclass);
$tmp13->value = _70;
...
void frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT$cleanup(frost$core$SteppedRange$LTfrost$core$UInt$Cfrost$core$UInt$GT param0) {
