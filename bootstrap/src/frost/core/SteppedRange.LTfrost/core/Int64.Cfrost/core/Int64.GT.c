...
__attribute__((weak)) frost$core$String* frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT$get_asString$R$frost$core$String$shim(frost$core$Object* p0) {
    frost$core$String* result = frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT$get_asString$R$frost$core$String(((frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT$wrapper*) p0)->value);

    return result;
}
__attribute__((weak)) void frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT$cleanup$shim(frost$core$Object* p0) {
    frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT$cleanup(((frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT$wrapper*) p0)->value);

}

static frost$core$String $s1;
frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT$class_type frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT$class = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s1, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT$get_asString$R$frost$core$String$shim, frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT$cleanup$shim} };

static frost$core$String $s2;
frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT$wrapperclass_type frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s2, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT$get_asString$R$frost$core$String$shim, frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT$cleanup$shim} };typedef frost$core$String* (*$fn3)(frost$core$Object*);
...
frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT$init$frost$core$Int64$frost$core$Int64$frost$core$Int64$frost$core$Bit(frost$core$Int64 param0, frost$core$Int64 param1, frost$core$Int64 param2, frost$core$Bit param3) {

frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT local0;
frost$core$Int64* _1;
frost$core$Int64* _4;
frost$core$Int64* _7;
frost$core$Bit* _10;
frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT _12;
...
frost$core$String* frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT$get_asString$R$frost$core$String(frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT param0) {
...
_18 = *(&local0);
_19 = param0.start;
frost$core$Int64$wrapper* $tmp6;
$tmp6 = (frost$core$Int64$wrapper*) frostObjectAlloc(sizeof(frost$core$Int64$wrapper), (frost$core$Class*) &frost$core$Int64$wrapperclass);
$tmp6->value = _19;
...
$tmp10 = (frost$core$Int64$wrapper*) frostObjectAlloc(sizeof(frost$core$Int64$wrapper), (frost$core$Class*) &frost$core$Int64$wrapperclass);
$tmp10->value = _52;
...
void frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT$cleanup(frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT param0) {
