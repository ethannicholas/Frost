...
*$tmp6 = param3;
frost$core$SteppedRange$LTfrost$core$Int64$Cfrost$core$Int64$GT $tmp7 = *(&local0);
return $tmp7;
...
frost$core$Int64 $tmp14 = param0.start;
...
frost$core$Int64 $tmp25 = param0.end;
...
frost$core$Int64 $tmp29 = param0.end;
frost$core$Int64$wrapper* $tmp30;
$tmp30 = (frost$core$Int64$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &frost$core$Int64$wrapperclass);
$tmp30->value = $tmp29;
