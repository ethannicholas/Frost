...
frost$core$Int8 $tmp25 = param0.end;
...
frost$core$Int8 $tmp29 = param0.end;
frost$core$Int8$wrapper* $tmp30;
$tmp30 = (frost$core$Int8$wrapper*) frostObjectAlloc(17, (frost$core$Class*) &frost$core$Int8$wrapperclass);
$tmp30->value = $tmp29;
...
frost$core$Int8 $tmp37 = param0.step;
frost$core$Int8$wrapper* $tmp38;
$tmp38 = (frost$core$Int8$wrapper*) frostObjectAlloc(17, (frost$core$Class*) &frost$core$Int8$wrapperclass);
$tmp38->value = $tmp37;
