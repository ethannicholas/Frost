...
__attribute__((weak)) frost$core$String* frost$core$SteppedRange$LTfrost$core$Int8$Cfrost$core$Int8$GT$convert$R$frost$core$String$shim(frost$core$Object* p0) {
    frost$core$String* result = frost$core$SteppedRange$LTfrost$core$Int8$Cfrost$core$Int8$GT$convert$R$frost$core$String(((frost$core$SteppedRange$LTfrost$core$Int8$Cfrost$core$Int8$GT$wrapper*) p0)->value);
...
frost$core$SteppedRange$LTfrost$core$Int8$Cfrost$core$Int8$GT$class_type frost$core$SteppedRange$LTfrost$core$Int8$Cfrost$core$Int8$GT$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$SteppedRange$LTfrost$core$Int8$Cfrost$core$Int8$GT$convert$R$frost$core$String$shim, frost$core$SteppedRange$LTfrost$core$Int8$Cfrost$core$Int8$GT$cleanup$shim} };

static frost$core$String $s2;
frost$core$SteppedRange$LTfrost$core$Int8$Cfrost$core$Int8$GT$wrapperclass_type frost$core$SteppedRange$LTfrost$core$Int8$Cfrost$core$Int8$GT$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, &$s2, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$SteppedRange$LTfrost$core$Int8$Cfrost$core$Int8$GT$convert$R$frost$core$String$shim, frost$core$SteppedRange$LTfrost$core$Int8$Cfrost$core$Int8$GT$cleanup$shim} };
...
frost$core$String* frost$core$SteppedRange$LTfrost$core$Int8$Cfrost$core$Int8$GT$convert$R$frost$core$String(frost$core$SteppedRange$LTfrost$core$Int8$Cfrost$core$Int8$GT param0) {
