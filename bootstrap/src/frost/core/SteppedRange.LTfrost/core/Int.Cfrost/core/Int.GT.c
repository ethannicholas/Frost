...
*$tmp6 = param3;
frost$core$SteppedRange$LTfrost$core$Int$Cfrost$core$Int$GT $tmp7 = *(&local0);
return $tmp7;
...
frost$core$Int $tmp10 = param0.start;
...
frost$core$Int $tmp14 = param0.start;
...
frost$core$Int $tmp25 = param0.end;
...
frost$core$Int $tmp29 = param0.end;
