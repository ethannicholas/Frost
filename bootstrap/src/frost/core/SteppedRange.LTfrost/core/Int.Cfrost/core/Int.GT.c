...
__attribute__((weak)) frost$core$String* frost$core$SteppedRange$LTfrost$core$Int$Cfrost$core$Int$GT$get_asString$R$frost$core$String$shim(frost$core$Object* p0) {
    frost$core$String* result = frost$core$SteppedRange$LTfrost$core$Int$Cfrost$core$Int$GT$get_asString$R$frost$core$String(((frost$core$SteppedRange$LTfrost$core$Int$Cfrost$core$Int$GT$wrapper*) p0)->value);

    return result;
}
__attribute__((weak)) void frost$core$SteppedRange$LTfrost$core$Int$Cfrost$core$Int$GT$cleanup$shim(frost$core$Object* p0) {
    frost$core$SteppedRange$LTfrost$core$Int$Cfrost$core$Int$GT$cleanup(((frost$core$SteppedRange$LTfrost$core$Int$Cfrost$core$Int$GT$wrapper*) p0)->value);
...
frost$core$SteppedRange$LTfrost$core$Int$Cfrost$core$Int$GT frost$core$SteppedRange$LTfrost$core$Int$Cfrost$core$Int$GT$init$frost$core$Int$frost$core$Int$frost$core$Int$frost$core$Bit(frost$core$Int param0, frost$core$Int param1, frost$core$Int param2, frost$core$Bit param3) {

frost$core$SteppedRange$LTfrost$core$Int$Cfrost$core$Int$GT local0;
frost$core$Int* _1;
frost$core$Int* _4;
frost$core$Int* _7;
frost$core$Bit* _10;
...
frost$core$String* frost$core$SteppedRange$LTfrost$core$Int$Cfrost$core$Int$GT$get_asString$R$frost$core$String(frost$core$SteppedRange$LTfrost$core$Int$Cfrost$core$Int$GT param0) {
...
void frost$core$SteppedRange$LTfrost$core$Int$Cfrost$core$Int$GT$cleanup(frost$core$SteppedRange$LTfrost$core$Int$Cfrost$core$Int$GT param0) {
