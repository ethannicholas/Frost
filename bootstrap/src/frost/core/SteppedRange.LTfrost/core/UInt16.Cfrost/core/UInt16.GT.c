...
__attribute__((weak)) frost$core$String* frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$get_asString$R$frost$core$String$shim(frost$core$Object* p0) {
    frost$core$String* result = frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$get_asString$R$frost$core$String(((frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$wrapper*) p0)->value);

    return result;
}
__attribute__((weak)) void frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$cleanup$shim(frost$core$Object* p0) {
    frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$cleanup(((frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$wrapper*) p0)->value);

}

static frost$core$String $s1;
frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$class_type frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$class = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s1, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$get_asString$R$frost$core$String$shim, frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$cleanup$shim} };

static frost$core$String $s2;
frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$wrapperclass_type frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s2, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$get_asString$R$frost$core$String$shim, frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$cleanup$shim} };typedef frost$core$String* (*$fn17)(frost$core$Object*);
typedef frost$core$String* (*$fn32)(frost$core$Object*);
typedef frost$core$String* (*$fn40)(frost$core$Object*);

static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x53\x74\x65\x70\x70\x65\x64\x52\x61\x6e\x67\x65\x3c\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x55\x49\x6e\x74\x31\x36\x2c\x20\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x55\x49\x6e\x74\x31\x36\x3e", 61, 774876423370998480, NULL };
static frost$core$String $s2 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x53\x74\x65\x70\x70\x65\x64\x52\x61\x6e\x67\x65\x3c\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x55\x49\x6e\x74\x31\x36\x2c\x20\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x55\x49\x6e\x74\x31\x36\x3e", 61, 774876423370998480, NULL };
static frost$core$String $s22 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x2e\x2e\x2e", 3, 1504239, NULL };
static frost$core$String $s24 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x2e\x2e", 2, 14893, NULL };
static frost$core$String $s35 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x20\x62\x79\x20", 4, 138041984, NULL };

frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$init$frost$core$UInt16$frost$core$UInt16$frost$core$UInt16$frost$core$Bit(frost$core$UInt16 param0, frost$core$UInt16 param1, frost$core$UInt16 param2, frost$core$Bit param3) {

frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT local0;
// /Users/ethannicholas/Dropbox/Frost/src/frost/core/SteppedRange.frost:43
frost$core$UInt16* $tmp3 = &(&local0)->start;
*$tmp3 = param0;
// /Users/ethannicholas/Dropbox/Frost/src/frost/core/SteppedRange.frost:44
frost$core$UInt16* $tmp4 = &(&local0)->end;
*$tmp4 = param1;
// /Users/ethannicholas/Dropbox/Frost/src/frost/core/SteppedRange.frost:45
frost$core$UInt16* $tmp5 = &(&local0)->step;
*$tmp5 = param2;
// /Users/ethannicholas/Dropbox/Frost/src/frost/core/SteppedRange.frost:46
frost$core$Bit* $tmp6 = &(&local0)->inclusive;
*$tmp6 = param3;
frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT $tmp7 = *(&local0);
return $tmp7;

}
frost$core$String* frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$get_asString$R$frost$core$String(frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT param0) {
...
frost$core$UInt16 $tmp10 = param0.start;
...
frost$core$UInt16 $tmp14 = param0.start;
frost$core$UInt16$wrapper* $tmp15;
$tmp15 = (frost$core$UInt16$wrapper*) frostObjectAlloc(18, (frost$core$Class*) &frost$core$UInt16$wrapperclass);
$tmp15->value = $tmp14;
...
frost$core$UInt16 $tmp25 = param0.end;
...
frost$core$UInt16 $tmp29 = param0.end;
frost$core$UInt16$wrapper* $tmp30;
$tmp30 = (frost$core$UInt16$wrapper*) frostObjectAlloc(18, (frost$core$Class*) &frost$core$UInt16$wrapperclass);
$tmp30->value = $tmp29;
...
frost$core$UInt16 $tmp37 = param0.step;
frost$core$UInt16$wrapper* $tmp38;
$tmp38 = (frost$core$UInt16$wrapper*) frostObjectAlloc(18, (frost$core$Class*) &frost$core$UInt16$wrapperclass);
$tmp38->value = $tmp37;
...
void frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$cleanup(frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT param0) {
