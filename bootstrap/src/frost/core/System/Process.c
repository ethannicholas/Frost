...
frost$core$System$Process$class_type frost$core$System$Process$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Immutable$class, NULL, { frost$core$Object$get_asString$R$frost$core$String, frost$core$System$Process$cleanup$shim, frost$core$System$Process$openStandardInput$R$frost$core$Maybe$LTfrost$io$OutputStream$GT, frost$core$System$Process$openStandardOutput$R$frost$core$Maybe$LTfrost$io$InputStream$GT, frost$core$System$Process$openStandardError$R$frost$core$Maybe$LTfrost$io$InputStream$GT, frost$core$System$Process$exitCode$R$frost$core$Int64$Q, frost$core$System$Process$waitFor$R$frost$core$Int64, frost$core$System$Process$_cleanup} };
