...
struct { frost$core$Class* cl; ITable* next; void* methods[1]; } frost$core$MutableString$Index$_frost$collections$Key = { (frost$core$Class*) &frost$collections$Key$class, (ITable*) &frost$core$MutableString$Index$_frost$core$Equatable, { frost$core$MutableString$Index$get_hash$R$frost$core$Int$shim} };
...
struct { frost$core$Class* cl; ITable* itable; void* methods[1]; } frost$core$MutableString$Index$wrapper_frost$collections$Key = { (frost$core$Class*) &frost$collections$Key$class, (ITable*) &frost$core$MutableString$Index$wrapper_frost$core$Equatable, { frost$core$MutableString$Index$get_hash$R$frost$core$Int$shim} };
