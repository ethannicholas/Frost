...
struct { frost$core$Class* cl; ITable* next; void* methods[1]; } frost$core$MutableString$Index$_frost$collections$Key = { (frost$core$Class*) &frost$collections$Key$class, (ITable*) &frost$core$MutableString$Index$_frost$core$Equatable, { frost$core$MutableString$Index$get_hash$R$frost$core$Int64$shim} };

static frost$core$String $s1;
frost$core$MutableString$Index$class_type frost$core$MutableString$Index$class = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s1, (frost$core$Class*) &frost$core$Value$class, (ITable*) &frost$core$MutableString$Index$_frost$collections$Key, { frost$core$Object$get_asString$R$frost$core$String, frost$core$Value$cleanup$shim, frost$core$MutableString$Index$$EQ$frost$core$MutableString$Index$R$frost$core$Bit$shim, frost$core$MutableString$Index$$GT$frost$core$MutableString$Index$R$frost$core$Bit$shim, frost$core$MutableString$Index$get_hash$R$frost$core$Int64$shim, frost$core$MutableString$Index$cleanup$shim} };
...
struct { frost$core$Class* cl; ITable* itable; void* methods[1]; } frost$core$MutableString$Index$wrapper_frost$collections$Key = { (frost$core$Class*) &frost$collections$Key$class, (ITable*) &frost$core$MutableString$Index$wrapper_frost$core$Equatable, { frost$core$MutableString$Index$get_hash$R$frost$core$Int64$shim} };

static frost$core$String $s2;
frost$core$MutableString$Index$wrapperclass_type frost$core$MutableString$Index$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s2, (frost$core$Class*) &frost$core$Value$class, (ITable*) &frost$core$MutableString$Index$wrapper_frost$collections$Key, { frost$core$Object$get_asString$R$frost$core$String, frost$core$Value$cleanup$shim} };
