...
__attribute__((weak)) frost$core$String* frost$core$Range$LTfrost$core$Int$GT$get_asString$R$frost$core$String$shim(frost$core$Object* p0) {
    frost$core$String* result = frost$core$Range$LTfrost$core$Int$GT$get_asString$R$frost$core$String(((frost$core$Range$LTfrost$core$Int$GT$wrapper*) p0)->value);

    return result;
}
__attribute__((weak)) void frost$core$Range$LTfrost$core$Int$GT$cleanup$shim(frost$core$Object* p0) {
    frost$core$Range$LTfrost$core$Int$GT$cleanup(((frost$core$Range$LTfrost$core$Int$GT$wrapper*) p0)->value);

}

static frost$core$String $s1;
frost$core$Range$LTfrost$core$Int$GT$class_type frost$core$Range$LTfrost$core$Int$GT$class = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s1, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$Range$LTfrost$core$Int$GT$get_asString$R$frost$core$String$shim, frost$core$Range$LTfrost$core$Int$GT$cleanup$shim} };

static frost$core$String $s2;
frost$core$Range$LTfrost$core$Int$GT$wrapperclass_type frost$core$Range$LTfrost$core$Int$GT$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s2, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$Range$LTfrost$core$Int$GT$get_asString$R$frost$core$String$shim, frost$core$Range$LTfrost$core$Int$GT$cleanup$shim} };typedef frost$core$String* (*$fn3)(frost$core$Object*);
...
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x52\x61\x6e\x67\x65\x3c\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x49\x6e\x74\x3e", 32, 5960423919534101283, NULL };
static frost$core$String $s2 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x52\x61\x6e\x67\x65\x3c\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x49\x6e\x74\x3e", 32, 5960423919534101283, NULL };
...
frost$core$Range$LTfrost$core$Int$GT frost$core$Range$LTfrost$core$Int$GT$init$frost$core$Int$frost$core$Int$frost$core$Bit(frost$core$Int param0, frost$core$Int param1, frost$core$Bit param2) {

frost$core$Range$LTfrost$core$Int$GT local0;
frost$core$Int* _1;
frost$core$Int* _4;
frost$core$Bit* _7;
...
frost$core$String* frost$core$Range$LTfrost$core$Int$GT$get_asString$R$frost$core$String(frost$core$Range$LTfrost$core$Int$GT param0) {
...
void frost$core$Range$LTfrost$core$Int$GT$cleanup(frost$core$Range$LTfrost$core$Int$GT param0) {
