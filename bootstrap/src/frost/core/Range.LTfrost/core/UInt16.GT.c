...
__attribute__((weak)) frost$core$String* frost$core$Range$LTfrost$core$UInt16$GT$convert$R$frost$core$String$shim(frost$core$Object* p0) {
    frost$core$String* result = frost$core$Range$LTfrost$core$UInt16$GT$convert$R$frost$core$String(((frost$core$Range$LTfrost$core$UInt16$GT$wrapper*) p0)->value);
...
frost$core$Range$LTfrost$core$UInt16$GT$class_type frost$core$Range$LTfrost$core$UInt16$GT$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$Range$LTfrost$core$UInt16$GT$convert$R$frost$core$String$shim, frost$core$Range$LTfrost$core$UInt16$GT$cleanup$shim} };

static frost$core$String $s2;
frost$core$Range$LTfrost$core$UInt16$GT$wrapperclass_type frost$core$Range$LTfrost$core$UInt16$GT$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, &$s2, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$Range$LTfrost$core$UInt16$GT$convert$R$frost$core$String$shim, frost$core$Range$LTfrost$core$UInt16$GT$cleanup$shim} };
...
// line 30
frost$core$UInt16* $tmp3 = &(&local0)->min;
*$tmp3 = param0;
// line 31
frost$core$UInt16* $tmp4 = &(&local0)->max;
*$tmp4 = param1;
// line 32
frost$core$Bit* $tmp5 = &(&local0)->inclusive;
*$tmp5 = param2;
frost$core$Range$LTfrost$core$UInt16$GT $tmp6 = *(&local0);
return $tmp6;

}
frost$core$String* frost$core$Range$LTfrost$core$UInt16$GT$convert$R$frost$core$String(frost$core$Range$LTfrost$core$UInt16$GT param0) {
...
frost$core$UInt16 $tmp13 = param0.min;
frost$core$UInt16$wrapper* $tmp14;
$tmp14 = (frost$core$UInt16$wrapper*) frostObjectAlloc(14, (frost$core$Class*) &frost$core$UInt16$wrapperclass);
$tmp14->value = $tmp13;
...
block4:;
// line 47
frost$core$UInt16 $tmp21 = param0.max;
...
frost$core$UInt16 $tmp25 = param0.max;
frost$core$UInt16$wrapper* $tmp26;
$tmp26 = (frost$core$UInt16$wrapper*) frostObjectAlloc(14, (frost$core$Class*) &frost$core$UInt16$wrapperclass);
$tmp26->value = $tmp25;
