...
__attribute__((weak)) frost$core$String* frost$core$Range$LTfrost$core$UInt16$GT$get_asString$R$frost$core$String$shim(frost$core$Object* p0) {
    frost$core$String* result = frost$core$Range$LTfrost$core$UInt16$GT$get_asString$R$frost$core$String(((frost$core$Range$LTfrost$core$UInt16$GT$wrapper*) p0)->value);

    return result;
}
__attribute__((weak)) void frost$core$Range$LTfrost$core$UInt16$GT$cleanup$shim(frost$core$Object* p0) {
    frost$core$Range$LTfrost$core$UInt16$GT$cleanup(((frost$core$Range$LTfrost$core$UInt16$GT$wrapper*) p0)->value);
...
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x52\x61\x6e\x67\x65\x3c\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x55\x49\x6e\x74\x31\x36\x3e", 35, 2021333864975650393, NULL };
static frost$core$String $s2 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x52\x61\x6e\x67\x65\x3c\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x55\x49\x6e\x74\x31\x36\x3e", 35, 2021333864975650393, NULL };
...
frost$core$Range$LTfrost$core$UInt16$GT local0;
frost$core$UInt16* _1;
frost$core$UInt16* _4;
frost$core$Bit* _7;
frost$core$Range$LTfrost$core$UInt16$GT _9;
...
frost$core$String* frost$core$Range$LTfrost$core$UInt16$GT$get_asString$R$frost$core$String(frost$core$Range$LTfrost$core$UInt16$GT param0) {
...
_51 = *(&local0);
_52 = param0.max;
frost$core$UInt16$wrapper* $tmp9;
$tmp9 = (frost$core$UInt16$wrapper*) frostObjectAlloc(sizeof(frost$core$UInt16$wrapper), (frost$core$Class*) &frost$core$UInt16$wrapperclass);
$tmp9->value = _52;
...
void frost$core$Range$LTfrost$core$UInt16$GT$cleanup(frost$core$Range$LTfrost$core$UInt16$GT param0) {
