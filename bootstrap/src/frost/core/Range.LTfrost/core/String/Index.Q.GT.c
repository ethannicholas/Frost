...
if ($tmp13.nonnull) {
    ...
    $tmp20 = (frost$core$String$Index$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &frost$core$String$Index$wrapperclass);
    $tmp20->value = ((frost$core$String$Index) $tmp13.value);
...
block6:;
// line 47
frost$core$String$Index$nullable $tmp27 = param0.max;
...
frost$core$String$Index$nullable $tmp31 = param0.max;
...
if ($tmp31.nonnull) {
    ...
    $tmp38->value = ((frost$core$String$Index) $tmp31.value);
