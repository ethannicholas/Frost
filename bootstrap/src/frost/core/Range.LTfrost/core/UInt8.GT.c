...
frost$core$UInt8 $tmp24 = param0.max;
...
frost$core$UInt8 $tmp28 = param0.max;
frost$core$UInt8$wrapper* $tmp29;
$tmp29 = (frost$core$UInt8$wrapper*) frostObjectAlloc(17, (frost$core$Class*) &frost$core$UInt8$wrapperclass);
$tmp29->value = $tmp28;
