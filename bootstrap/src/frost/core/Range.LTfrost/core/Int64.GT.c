...
frost$core$Range$LTfrost$core$Int64$GT$class_type frost$core$Range$LTfrost$core$Int64$GT$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$Range$LTfrost$core$Int64$GT$get_asString$R$frost$core$String$shim, frost$core$Range$LTfrost$core$Int64$GT$cleanup$shim} };

static frost$core$String $s2;
frost$core$Range$LTfrost$core$Int64$GT$wrapperclass_type frost$core$Range$LTfrost$core$Int64$GT$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, &$s2, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$Range$LTfrost$core$Int64$GT$get_asString$R$frost$core$String$shim, frost$core$Range$LTfrost$core$Int64$GT$cleanup$shim} };
