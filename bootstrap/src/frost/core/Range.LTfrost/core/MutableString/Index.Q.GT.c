...
$tmp14->value = ((frost$core$MutableString$Index) $tmp13.value);
...
frost$core$MutableString$Index$nullable $tmp24 = param0.max;
...
frost$core$MutableString$Index$nullable $tmp28 = param0.max;
...
$tmp29->value = ((frost$core$MutableString$Index) $tmp28.value);
