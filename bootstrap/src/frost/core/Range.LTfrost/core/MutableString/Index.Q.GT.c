...
abort(); // unreachable
block3:;
frost$core$MutableString$Index$wrapper* $tmp19;
$tmp19 = (frost$core$MutableString$Index$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &frost$core$MutableString$Index$wrapperclass);
$tmp19->value = ((frost$core$MutableString$Index) $tmp13.value);
...
frost$core$MutableString$Index$nullable $tmp33 = param0.max;
...
abort(); // unreachable
block11:;
frost$core$MutableString$Index$wrapper* $tmp39;
$tmp39 = (frost$core$MutableString$Index$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &frost$core$MutableString$Index$wrapperclass);
$tmp39->value = ((frost$core$MutableString$Index) $tmp33.value);
