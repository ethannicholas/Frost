...
block4:;
// line 47
frost$core$MutableString$Index$nullable $tmp22 = param0.max;
...
frost$core$MutableString$Index$nullable $tmp26 = param0.max;
frost$core$Object* $tmp27;
if ($tmp26.nonnull) {
    frost$core$MutableString$Index$wrapper* $tmp28;
    $tmp28 = (frost$core$MutableString$Index$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &frost$core$MutableString$Index$wrapperclass);
    $tmp28->value = ((frost$core$MutableString$Index) $tmp26.value);
