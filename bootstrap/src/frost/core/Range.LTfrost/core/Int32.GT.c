...
__attribute__((weak)) frost$core$String* frost$core$Range$LTfrost$core$Int32$GT$get_asString$R$frost$core$String$shim(frost$core$Object* p0) {
    frost$core$String* result = frost$core$Range$LTfrost$core$Int32$GT$get_asString$R$frost$core$String(((frost$core$Range$LTfrost$core$Int32$GT$wrapper*) p0)->value);

    return result;
}
__attribute__((weak)) void frost$core$Range$LTfrost$core$Int32$GT$cleanup$shim(frost$core$Object* p0) {
    frost$core$Range$LTfrost$core$Int32$GT$cleanup(((frost$core$Range$LTfrost$core$Int32$GT$wrapper*) p0)->value);

}

static frost$core$String $s1;
frost$core$Range$LTfrost$core$Int32$GT$class_type frost$core$Range$LTfrost$core$Int32$GT$class = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s1, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$Range$LTfrost$core$Int32$GT$get_asString$R$frost$core$String$shim, frost$core$Range$LTfrost$core$Int32$GT$cleanup$shim} };

static frost$core$String $s2;
frost$core$Range$LTfrost$core$Int32$GT$wrapperclass_type frost$core$Range$LTfrost$core$Int32$GT$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s2, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$Range$LTfrost$core$Int32$GT$get_asString$R$frost$core$String$shim, frost$core$Range$LTfrost$core$Int32$GT$cleanup$shim} };typedef frost$core$String* (*$fn16)(frost$core$Object*);
typedef frost$core$String* (*$fn31)(frost$core$Object*);

static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x52\x61\x6e\x67\x65\x3c\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x49\x6e\x74\x33\x32\x3e", 34, 2355662188789198852, NULL };
static frost$core$String $s2 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x52\x61\x6e\x67\x65\x3c\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x49\x6e\x74\x33\x32\x3e", 34, 2355662188789198852, NULL };
...
frost$core$Range$LTfrost$core$Int32$GT frost$core$Range$LTfrost$core$Int32$GT$init$frost$core$Int32$frost$core$Int32$frost$core$Bit(frost$core$Int32 param0, frost$core$Int32 param1, frost$core$Bit param2) {

frost$core$Range$LTfrost$core$Int32$GT local0;
// /Users/ethannicholas/Dropbox/Frost/src/frost/core/Range.frost:30
frost$core$Int32* $tmp3 = &(&local0)->min;
*$tmp3 = param0;
// /Users/ethannicholas/Dropbox/Frost/src/frost/core/Range.frost:31
frost$core$Int32* $tmp4 = &(&local0)->max;
*$tmp4 = param1;
// /Users/ethannicholas/Dropbox/Frost/src/frost/core/Range.frost:32
frost$core$Bit* $tmp5 = &(&local0)->inclusive;
*$tmp5 = param2;
frost$core$Range$LTfrost$core$Int32$GT $tmp6 = *(&local0);
return $tmp6;

}
frost$core$String* frost$core$Range$LTfrost$core$Int32$GT$get_asString$R$frost$core$String(frost$core$Range$LTfrost$core$Int32$GT param0) {
...
frost$core$Int32 $tmp9 = param0.min;
...
frost$core$Int32 $tmp13 = param0.min;
frost$core$Int32$wrapper* $tmp14;
$tmp14 = (frost$core$Int32$wrapper*) frostObjectAlloc(20, (frost$core$Class*) &frost$core$Int32$wrapperclass);
$tmp14->value = $tmp13;
...
frost$core$Int32 $tmp24 = param0.max;
...
frost$core$Int32 $tmp28 = param0.max;
frost$core$Int32$wrapper* $tmp29;
$tmp29 = (frost$core$Int32$wrapper*) frostObjectAlloc(20, (frost$core$Class*) &frost$core$Int32$wrapperclass);
$tmp29->value = $tmp28;
...
void frost$core$Range$LTfrost$core$Int32$GT$cleanup(frost$core$Range$LTfrost$core$Int32$GT param0) {
