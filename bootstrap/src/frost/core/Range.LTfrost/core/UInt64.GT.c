...
__attribute__((weak)) frost$core$String* frost$core$Range$LTfrost$core$UInt64$GT$convert$R$frost$core$String$shim(frost$core$Object* p0) {
    frost$core$String* result = frost$core$Range$LTfrost$core$UInt64$GT$convert$R$frost$core$String(((frost$core$Range$LTfrost$core$UInt64$GT$wrapper*) p0)->value);
...
frost$core$Range$LTfrost$core$UInt64$GT$class_type frost$core$Range$LTfrost$core$UInt64$GT$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$Range$LTfrost$core$UInt64$GT$convert$R$frost$core$String$shim, frost$core$Range$LTfrost$core$UInt64$GT$cleanup$shim} };

static frost$core$String $s2;
frost$core$Range$LTfrost$core$UInt64$GT$wrapperclass_type frost$core$Range$LTfrost$core$UInt64$GT$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, &$s2, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$Range$LTfrost$core$UInt64$GT$convert$R$frost$core$String$shim, frost$core$Range$LTfrost$core$UInt64$GT$cleanup$shim} };
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x52\x61\x6e\x67\x65\x3c\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x55\x49\x6e\x74\x36\x34\x3e", 35, 6209072884589362240, NULL };
static frost$core$String $s2 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x52\x61\x6e\x67\x65\x3c\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x55\x49\x6e\x74\x36\x34\x3e", 35, 6209072884589362240, NULL };
...
// line 30
frost$core$UInt64* $tmp3 = &(&local0)->min;
*$tmp3 = param0;
// line 31
frost$core$UInt64* $tmp4 = &(&local0)->max;
*$tmp4 = param1;
// line 32
frost$core$Bit* $tmp5 = &(&local0)->inclusive;
*$tmp5 = param2;
frost$core$Range$LTfrost$core$UInt64$GT $tmp6 = *(&local0);
return $tmp6;

}
frost$core$String* frost$core$Range$LTfrost$core$UInt64$GT$convert$R$frost$core$String(frost$core$Range$LTfrost$core$UInt64$GT param0) {
...
// line 38
frost$core$UInt64 $tmp9 = param0.min;
...
frost$core$UInt64 $tmp13 = param0.min;
frost$core$UInt64$wrapper* $tmp14;
$tmp14 = (frost$core$UInt64$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &frost$core$UInt64$wrapperclass);
$tmp14->value = $tmp13;
...
block4:;
// line 47
frost$core$UInt64 $tmp21 = param0.max;
...
frost$core$UInt64 $tmp25 = param0.max;
frost$core$UInt64$wrapper* $tmp26;
$tmp26 = (frost$core$UInt64$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &frost$core$UInt64$wrapperclass);
$tmp26->value = $tmp25;
