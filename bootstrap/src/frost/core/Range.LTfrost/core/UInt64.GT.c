...
frost$core$Range$LTfrost$core$UInt64$GT$wrapperclass_type frost$core$Range$LTfrost$core$UInt64$GT$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s2, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$Range$LTfrost$core$UInt64$GT$get_asString$R$frost$core$String$shim, frost$core$Range$LTfrost$core$UInt64$GT$cleanup$shim} };typedef frost$core$String* (*$fn16)(frost$core$Object*);
typedef frost$core$String* (*$fn31)(frost$core$Object*);

static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x52\x61\x6e\x67\x65\x3c\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x55\x49\x6e\x74\x36\x34\x3e", 35, 6209072884589362240, NULL };
static frost$core$String $s2 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x52\x61\x6e\x67\x65\x3c\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x55\x49\x6e\x74\x36\x34\x3e", 35, 6209072884589362240, NULL };
...
frost$core$UInt64 $tmp24 = param0.max;
...
frost$core$UInt64 $tmp28 = param0.max;
frost$core$UInt64$wrapper* $tmp29;
$tmp29 = (frost$core$UInt64$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &frost$core$UInt64$wrapperclass);
$tmp29->value = $tmp28;
