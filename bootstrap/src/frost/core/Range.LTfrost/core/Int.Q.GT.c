...
$tmp14->value = ((frost$core$Int) $tmp13.value);
...
frost$core$Int$nullable $tmp24 = param0.max;
...
frost$core$Int$nullable $tmp28 = param0.max;
...
$tmp29->value = ((frost$core$Int) $tmp28.value);
