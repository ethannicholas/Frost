...
frost$core$Int$nullable $tmp9 = param0.min;
...
frost$core$Int$nullable $tmp13 = param0.min;
...
if ($tmp13.nonnull) {
    ...
    $tmp15->value = ((frost$core$Int) $tmp13.value);
...
frost$core$Int$nullable $tmp25 = param0.max;
...
frost$core$Int$nullable $tmp29 = param0.max;
...
if ($tmp29.nonnull) {
    ...
    $tmp31->value = ((frost$core$Int) $tmp29.value);
