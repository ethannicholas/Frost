...
frost$core$Range$LTfrost$core$UInt32$GT$wrapperclass_type frost$core$Range$LTfrost$core$UInt32$GT$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s2, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$Range$LTfrost$core$UInt32$GT$get_asString$R$frost$core$String$shim, frost$core$Range$LTfrost$core$UInt32$GT$cleanup$shim} };typedef frost$core$String* (*$fn16)(frost$core$Object*);
typedef frost$core$String* (*$fn31)(frost$core$Object*);

static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x52\x61\x6e\x67\x65\x3c\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x55\x49\x6e\x74\x33\x32\x3e", 35, 6209072884589331435, NULL };
static frost$core$String $s2 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x52\x61\x6e\x67\x65\x3c\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x55\x49\x6e\x74\x33\x32\x3e", 35, 6209072884589331435, NULL };
...
frost$core$UInt32 $tmp24 = param0.max;
...
frost$core$UInt32 $tmp28 = param0.max;
frost$core$UInt32$wrapper* $tmp29;
$tmp29 = (frost$core$UInt32$wrapper*) frostObjectAlloc(20, (frost$core$Class*) &frost$core$UInt32$wrapperclass);
$tmp29->value = $tmp28;
