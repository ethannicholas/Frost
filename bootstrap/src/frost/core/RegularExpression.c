...
frost$core$RegularExpression$class_type frost$core$RegularExpression$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Immutable$class, NULL, { frost$core$Object$convert$R$frost$core$String, frost$core$RegularExpression$cleanup$shim, frost$core$RegularExpression$matcher$frost$core$String$R$frost$core$Matcher, frost$core$RegularExpression$compile$frost$core$String$frost$core$Int64, frost$core$RegularExpression$destroy} };
