...
static frost$core$String $s686 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x55\x49\x6e\x74\x33\x32\x2e\x66\x72\x6f\x73\x74", 12, 7225265477699224004, NULL };
...
frost$core$UInt32 $tmp689 = (frost$core$UInt32) {((uint32_t) $tmp688)};
return ((frost$core$UInt32$nullable) { $tmp689, true });
...
uint32_t $tmp700 = param0.value;
frost$core$UInt $tmp701 = (frost$core$UInt) {((uint64_t) $tmp700)};
return $tmp701;
...
frost$core$Int $tmp712 = (frost$core$Int) {10u};
*(&local0) = $tmp712;
...
frost$core$UInt32 $tmp723 = *(&local3);
frost$core$UInt32 $tmp724 = (frost$core$UInt32) {0u};
uint32_t $tmp725 = $tmp723.value;
uint32_t $tmp726 = $tmp724.value;
...
frost$core$UInt32 $tmp733 = *(&local3);
frost$core$UInt32 $tmp734 = (frost$core$UInt32) {10u};
...
frost$core$UInt32 $tmp739 = (frost$core$UInt32) {48u};
uint32_t $tmp740 = $tmp738.value;
uint32_t $tmp741 = $tmp739.value;
uint32_t $tmp742 = $tmp740 + $tmp741;
frost$core$UInt32 $tmp743 = (frost$core$UInt32) {$tmp742};
// begin inline call to function frost.core.UInt32.get_asUInt8():frost.core.UInt8 from UInt32.frost:1002:56
// /Users/ethannicholas/Dropbox/Frost/src/frost/core/UInt32.frost:966
uint32_t $tmp744 = $tmp743.value;
...
frost$core$UInt32 $tmp748 = *(&local3);
frost$core$UInt32 $tmp749 = (frost$core$UInt32) {10u};
uint32_t $tmp750 = $tmp748.value;
uint32_t $tmp751 = $tmp749.value;
uint32_t $tmp752 = $tmp750 / $tmp751;
frost$core$UInt32 $tmp753 = (frost$core$UInt32) {$tmp752};
*(&local3) = $tmp753;
...
*(&local2) = $tmp759;
frost$core$UInt32 $tmp760 = *(&local3);
frost$core$UInt32 $tmp761 = (frost$core$UInt32) {0u};
...
frost$core$UInt32 $tmp776 = (frost$core$UInt32) {48u};
frost$core$UInt32 $tmp777 = *(&local3);
frost$core$UInt32 $tmp778 = (frost$core$UInt32) {10u};
...
uint32_t $tmp780 = $tmp778.value;
uint32_t $tmp781 = $tmp779 % $tmp780;
frost$core$UInt32 $tmp782 = (frost$core$UInt32) {$tmp781};
uint32_t $tmp783 = $tmp776.value;
uint32_t $tmp784 = $tmp782.value;
uint32_t $tmp785 = $tmp783 - $tmp784;
frost$core$UInt32 $tmp786 = (frost$core$UInt32) {$tmp785};
// begin inline call to function frost.core.UInt32.get_asUInt8():frost.core.UInt8 from UInt32.frost:1011:56
// /Users/ethannicholas/Dropbox/Frost/src/frost/core/UInt32.frost:966
uint32_t $tmp787 = $tmp786.value;
...
frost$core$UInt32 $tmp791 = *(&local3);
frost$core$UInt32 $tmp792 = (frost$core$UInt32) {10u};
uint32_t $tmp793 = $tmp791.value;
uint32_t $tmp794 = $tmp792.value;
uint32_t $tmp795 = $tmp793 / $tmp794;
frost$core$UInt32 $tmp796 = (frost$core$UInt32) {$tmp795};
*(&local3) = $tmp796;
...
*(&local2) = $tmp802;
frost$core$UInt32 $tmp803 = *(&local3);
frost$core$UInt32 $tmp804 = (frost$core$UInt32) {0u};
