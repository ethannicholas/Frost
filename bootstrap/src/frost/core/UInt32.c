...
frost$core$UInt8 $tmp605 = frost$core$UInt32$get_asUInt8$R$frost$core$UInt8($tmp604);
...
frost$core$UInt8 $tmp643 = frost$core$UInt32$get_asUInt8$R$frost$core$UInt8($tmp642);
...
frost$core$UInt64 $tmp732 = frost$core$UInt32$get_asUInt64$R$frost$core$UInt64(param0);
