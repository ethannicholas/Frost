...
static frost$core$String $s528 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x55\x49\x6e\x74\x33\x32\x2e\x66\x72\x6f\x73\x74", 12, 8497875689263501798, NULL };
...
frost$core$Int64 $tmp502 = frost$core$Int64$init$builtin_int64($tmp501);
...
frost$core$Int64 $tmp508 = (frost$core$Int64) {32};
return $tmp508;
...
frost$core$UInt64 $tmp512 = (frost$core$UInt64) {2147483648};
...
frost$core$Int64 $tmp515 = (frost$core$Int64) {2};
...
block3:;
frost$core$Int64 $tmp521 = (frost$core$Int64) {36};
...
block2:;
frost$core$Int64 $tmp527 = (frost$core$Int64) {715};
...
frost$core$Bit $tmp532 = frost$core$Bit$init$builtin_bit(!$tmp531.nonnull);
...
frost$core$Int64 $tmp555 = (frost$core$Int64) {10};
*(&local0) = $tmp555;
...
frost$core$UInt32 $tmp566 = (frost$core$UInt32) {0};
...
frost$core$UInt32 $tmp575 = (frost$core$UInt32) {10};
...
frost$core$UInt32 $tmp579 = frost$core$UInt32$init$builtin_uint32($tmp578);
frost$core$UInt32 $tmp580 = (frost$core$UInt32) {48};
...
frost$core$UInt32 $tmp590 = (frost$core$UInt32) {10};
...
frost$core$UInt32 $tmp602 = (frost$core$UInt32) {0};
...
frost$core$UInt32 $tmp616 = (frost$core$UInt32) {48};
frost$core$UInt32 $tmp617 = *(&local3);
frost$core$UInt32 $tmp618 = (frost$core$UInt32) {10};
...
frost$core$UInt32 $tmp622 = frost$core$UInt32$init$builtin_uint32($tmp621);
...
frost$core$UInt32 $tmp644 = (frost$core$UInt32) {0};
...
frost$core$UInt8 $tmp652 = (frost$core$UInt8) {45};
...
frost$core$Bit $tmp663 = frost$core$Bit$init$builtin_bit(false);
...
frost$core$UInt64 $tmp721 = (frost$core$UInt64) {4294967295};
