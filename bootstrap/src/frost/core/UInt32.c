...
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x55\x49\x6e\x74\x33\x32", 17, -3969265259549713363, NULL };
static frost$core$String $s3 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x55\x49\x6e\x74\x33\x32", 17, -3969265259549713363, NULL };
static frost$core$String $s7 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x55\x49\x6e\x74\x33\x32\x2e\x66\x72\x6f\x73\x74", 12, 7225265477699224004, NULL };
...
static frost$core$String $s9 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x55\x49\x6e\x74\x33\x32\x2e\x66\x72\x6f\x73\x74", 12, 7225265477699224004, NULL };
...
static frost$core$String $s11 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x55\x49\x6e\x74\x33\x32\x2e\x66\x72\x6f\x73\x74", 12, 7225265477699224004, NULL };
...
_1 = (org$frostlang$frost$UInt32List*) frostObjectAlloc(sizeof(org$frostlang$frost$UInt32List), (frost$core$Class*) &org$frostlang$frost$UInt32List$class);
_2 = param0.min;
_3 = param0.max;
...
$tmp5 = (frost$core$UInt32$wrapper*) frostObjectAlloc(sizeof(frost$core$UInt32$wrapper), (frost$core$Class*) &frost$core$UInt32$wrapperclass);
$tmp5->value = param0;
...
int64_t _25;
frost$core$Int _26;
frost$core$UInt32 _31;
frost$core$UInt32 _32;
uint32_t _33;
uint32_t _34;
bool _35;
frost$core$Bit _36;
...
int64_t _82;
frost$core$Int _83;
frost$core$UInt32 _86;
frost$core$UInt32 _87;
uint32_t _88;
uint32_t _89;
bool _90;
frost$core$Bit _91;
...
frost$core$UInt32 _112;
frost$core$UInt32 _113;
uint32_t _116;
uint32_t _117;
uint32_t _118;
...
frost$core$UInt32 _136;
uint32_t _137;
uint32_t _138;
uint32_t _139;
frost$core$UInt32 _140;
frost$core$Int _143;
frost$core$Int _144;
int64_t _145;
int64_t _146;
...
_4 = *(&local0);
// begin inline call to method frost.unsafe.Pointer.alloc(count:frost.core.Int):frost.unsafe.Pointer<frost.unsafe.Pointer.T> from UInt32.frost:997:42
...
_70 = *(&local5);
_71 = (frost$core$UInt32) {10u};
_72 = _70.value;
_73 = _71.value;
_74 = _72 / _73;
_75 = (frost$core$UInt32) {_74};
*(&local5) = _75;
...
_135 = *(&local5);
_136 = (frost$core$UInt32) {10u};
_137 = _135.value;
_138 = _136.value;
_139 = _137 / _138;
_140 = (frost$core$UInt32) {_139};
*(&local5) = _140;
