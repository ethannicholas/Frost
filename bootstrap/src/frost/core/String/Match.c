...
frost$core$UInt64 $tmp36 = frost$core$Int64$convert$R$frost$core$UInt64($tmp35);
...
// unreffing REF($87:frost.collections.ImmutableArray<frost.collections.ImmutableArray.T>)
