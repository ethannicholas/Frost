...
frost$collections$Array* frost$core$String$parse$frost$core$RegularExpression$R$frost$collections$Array$LTfrost$core$String$Q$GT$Q(frost$core$String* param0, frost$core$RegularExpression* param1) {
