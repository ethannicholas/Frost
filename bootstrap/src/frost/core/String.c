...
typedef frost$core$Object* (*$fn90)(frost$core$String*);
typedef frost$core$Object* (*$fn91)(frost$core$Object*, frost$core$String*);
typedef frost$core$String* (*$fn92)(frost$core$Object*);
typedef frost$core$String* (*$fn93)(frost$core$Object*);
typedef frost$core$Object* (*$fn96)(frost$core$String*);
typedef frost$core$Object* (*$fn97)(frost$core$Object*, frost$core$String*);
...
typedef frost$collections$Iterator* (*$fn110)(frost$collections$Iterable*);
typedef frost$core$Int (*$fn111)(frost$collections$Iterator*);
typedef frost$collections$Iterator* (*$fn112)(frost$collections$Iterable*);
typedef frost$core$Int (*$fn113)(frost$collections$Iterator*);
typedef frost$collections$Iterator* (*$fn118)(frost$collections$Iterable*);
typedef frost$core$Int (*$fn119)(frost$collections$Iterator*);
...
typedef frost$core$Int (*$fn127)(frost$collections$Iterator*);
typedef frost$collections$Iterator* (*$fn128)(frost$collections$Iterable*);
typedef frost$core$Int (*$fn129)(frost$collections$Iterator*);
...
static frost$core$String $s86 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x53\x74\x72\x69\x6e\x67\x2e\x66\x72\x6f\x73\x74", 12, 7542466198510074048, NULL };
...
static frost$core$String $s88 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x53\x74\x72\x69\x6e\x67\x2e\x66\x72\x6f\x73\x74", 12, 7542466198510074048, NULL };
...
static frost$core$String $s94 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x53\x74\x72\x69\x6e\x67\x2e\x66\x72\x6f\x73\x74", 12, 7542466198510074048, NULL };
...
static frost$core$String $s108 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x53\x74\x72\x69\x6e\x67\x2e\x66\x72\x6f\x73\x74", 12, 7542466198510074048, NULL };
static frost$core$String $s109 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x53\x74\x72\x69\x6e\x67\x2e\x66\x72\x6f\x73\x74", 12, 7542466198510074048, NULL };
static frost$core$String $s136 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x53\x74\x72\x69\x6e\x67\x2e\x66\x72\x6f\x73\x74", 12, 7542466198510074048, NULL };
...
static frost$core$String $s138 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x53\x74\x72\x69\x6e\x67\x2e\x66\x72\x6f\x73\x74", 12, 7542466198510074048, NULL };
...
static frost$core$String $s141 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x53\x74\x72\x69\x6e\x67\x2e\x66\x72\x6f\x73\x74", 12, 7542466198510074048, NULL };
...
static frost$core$String $s144 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x53\x74\x72\x69\x6e\x67\x2e\x66\x72\x6f\x73\x74", 12, 7542466198510074048, NULL };
...
void frost$core$String$init$frost$unsafe$NewPointer$LTfrost$core$Char8$GT$frost$core$Int(void* rawSelf, frost$unsafe$NewPointer param1, frost$core$Int param2) {
...
void frost$core$String$init$frost$unsafe$NewPointer$LTfrost$core$Char8$GT$frost$core$Int$frost$core$String(void* rawSelf, frost$unsafe$NewPointer param1, frost$core$Int param2, frost$core$String* param3) {
frost$core$String* param0 = (frost$core$String*) rawSelf;
...
_11 = &param0->_length;
_12 = *_11;
// begin inline call to method frost.unsafe.NewPointer.alloc(count:frost.core.Int):frost.unsafe.NewPointer<frost.unsafe.NewPointer.T> from String.frost:365:40
...
frost$unsafe$NewPointer* _91;
frost$unsafe$NewPointer _92;
int64_t _93;
frost$core$Int _94;
...
_40 = &_39->_length;
_41 = *_40;
// begin inline call to method frost.unsafe.NewPointer.alloc(count:frost.core.Int):frost.unsafe.NewPointer<frost.unsafe.NewPointer.T> from String.frost:377:45
// /Users/ethannicholas/Dropbox/Frost/src/frost/unsafe/NewPointer.frost:49
_44 = _41.value;
_45 = _44 * 1u;
...
_8 = &param0->data;
_9 = *_8;
// begin inline call to method frost.unsafe.NewPointer.destroy() from String.frost:450:25
...
frost$core$Bit _121;
bool _122;
frost$unsafe$NewPointer* _124;
frost$unsafe$NewPointer _125;
int64_t _126;
frost$core$Int _127;
...
// begin inline call to method frost.unsafe.NewPointer.alloc(count:frost.core.Int):frost.unsafe.NewPointer<frost.unsafe.NewPointer.T> from String.frost:545:46
// /Users/ethannicholas/Dropbox/Frost/src/frost/unsafe/NewPointer.frost:49
_11 = _8.value;
_12 = _11 * 1u;
...
frost$core$String$init$frost$unsafe$NewPointer$LTfrost$core$Char8$GT$frost$core$Int(_159, _160, _168);
...
frost$unsafe$NewPointer* _176;
frost$unsafe$NewPointer _177;
int64_t _178;
frost$core$Int _179;
...
frost$unsafe$NewPointer* _365;
frost$unsafe$NewPointer _366;
int64_t _367;
frost$core$Int _368;
...
_27 = param1.min;
_28 = _27.value;
// begin inline call to function frost.unsafe.NewPointer.+(count:frost.core.Int):frost.unsafe.NewPointer<frost.unsafe.NewPointer.T> from String.frost:692:28
...
_48 = *(&local3);
_50 = *(&local0);
// begin inline call to frost.core.String.init(data:frost.unsafe.NewPointer<frost.core.Char8>, length:frost.core.Int, owner:frost.core.String) from String.frost:692:22
// /Users/ethannicholas/Dropbox/Frost/src/frost/core/String.frost:328
...
frost$unsafe$NewPointer* _250;
frost$unsafe$NewPointer _251;
int64_t _252;
frost$core$Int _253;
...
frost$unsafe$NewPointer* _450;
frost$unsafe$NewPointer _451;
int64_t _452;
frost$core$Int _453;
...
frost$unsafe$NewPointer* _516;
frost$unsafe$NewPointer _517;
int64_t _518;
frost$core$Int _519;
...
frost$unsafe$NewPointer* _780;
frost$unsafe$NewPointer _781;
int64_t _782;
frost$core$Int _783;
...
frost$unsafe$NewPointer* _813;
frost$unsafe$NewPointer _814;
int64_t _815;
frost$core$Int _816;
...
frost$unsafe$NewPointer* _846;
frost$unsafe$NewPointer _847;
int64_t _848;
frost$core$Int _849;
...
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int$frost$core$String(&$s94, _39, &$s95);
abort(); // unreachable
block4:;
_42 = _34;
_43 = param2;
...
block14:;
_120 = *(&local4);
_121 = ($fn106) _120->$class->vtable[0];
_122 = _121(_120);
...
_154 = ($fn107) _153->$class->vtable[0];
_155 = _154(_153);
_156 = ((frost$core$Object*) _155);
...
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int(&$s108, _10);
abort(); // unreachable
block1:;
...
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int(&$s109, _9);
abort(); // unreachable
block1:;
...
// /Users/ethannicholas/Dropbox/Frost/src/frost/core/String.frost:485
_24 = ((frost$collections$Iterable*) param0);
ITable* $tmp132 = _24->$class->itable;
while ($tmp132->$class != (frost$core$Class*) &frost$collections$Iterable$class) {
    $tmp132 = $tmp132->next;
}
_25 = $tmp132->methods[0];
_26 = _25(_24);
ITable* $tmp133 = _26->$class->itable;
while ($tmp133->$class != (frost$core$Class*) &frost$collections$Iterator$class) {
    $tmp133 = $tmp133->next;
}
_27 = $tmp133->methods[2];
_28 = _27(_26);
_29 = ((frost$core$Object*) _26);
frost$core$Frost$unref$frost$core$Object$Q(_29);
_32 = param1.value;
...
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int$frost$core$String(&$s136, _99, &$s137);
abort(); // unreachable
block13:;
...
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int$frost$core$String(&$s138, _116, &$s139);
abort(); // unreachable
block15:;
...
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int$frost$core$String(&$s141, _7, &$s142);
abort(); // unreachable
block1:;
...
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int$frost$core$String(&$s144, _15, &$s145);
abort(); // unreachable
block3:;
