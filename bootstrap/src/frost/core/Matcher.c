...
static frost$core$String $s132 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x24", 1, 137, NULL };
...
if ($tmp125) goto block12; else goto block15;
block15:;
...
if ($tmp129) goto block12; else goto block14;
block12:;
// line 149
frost$core$Int64$nullable $tmp130 = *(&local3);
frost$core$String* $tmp131 = frost$core$Matcher$group$frost$core$Int64$R$frost$core$String$Q(param0, ((frost$core$Int64) $tmp130.value));
frost$core$MutableString$append$frost$core$String(param1, $tmp131);
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp131));
goto block13;
block14:;
// line 1
// line 152
frost$core$MutableString$append$frost$core$String(param1, &$s132);
goto block13;
block13:;
goto block6;
block8:;
// line 155
frost$core$String$Index $tmp133 = *(&local1);
frost$core$Bit $tmp134 = frost$core$Bit$init$builtin_bit(false);
frost$core$Range$LTfrost$core$String$Index$Q$GT $tmp135 = frost$core$Range$LTfrost$core$String$Index$Q$GT$init$frost$core$String$Index$Q$frost$core$String$Index$Q$frost$core$Bit(((frost$core$String$Index$nullable) { $tmp133, true }), ((frost$core$String$Index$nullable) { .nonnull = false }), $tmp134);
frost$core$String* $tmp136 = frost$core$String$$IDX$frost$core$Range$LTfrost$core$String$Index$Q$GT$R$frost$core$String(param2, $tmp135);
frost$core$MutableString$append$frost$core$String(param1, $tmp136);
...
frost$core$Matcher$get_end$R$frost$core$String$Index(&$tmp138, param0);
frost$core$String$Index* $tmp139 = &param0->replacementIndex;
*$tmp139 = $tmp138;
return;
...
// line 171
frost$core$String** $tmp140 = &param0->searchText;
frost$core$String* $tmp141 = *$tmp140;
frost$core$String$Index* $tmp142 = &param0->replacementIndex;
frost$core$String$Index $tmp143 = *$tmp142;
frost$core$Bit $tmp144 = frost$core$Bit$init$builtin_bit(false);
frost$core$Range$LTfrost$core$String$Index$Q$GT $tmp145 = frost$core$Range$LTfrost$core$String$Index$Q$GT$init$frost$core$String$Index$Q$frost$core$String$Index$Q$frost$core$Bit(((frost$core$String$Index$nullable) { $tmp143, true }), ((frost$core$String$Index$nullable) { .nonnull = false }), $tmp144);
frost$core$String* $tmp146 = frost$core$String$$IDX$frost$core$Range$LTfrost$core$String$Index$Q$GT$R$frost$core$String($tmp141, $tmp145);
...
frost$core$String** $tmp147 = &param0->searchText;
