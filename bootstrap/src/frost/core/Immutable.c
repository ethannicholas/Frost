...
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x66\x72\x6f\x73\x74\x2e\x63\x6f\x72\x65\x2e\x49\x6d\x6d\x75\x74\x61\x62\x6c\x65", 20, -2552342564646005864, NULL };

void frost$core$Immutable$init(void* rawSelf) {
frost$core$Immutable* param0 = (frost$core$Immutable*) rawSelf;

return;

}
void frost$core$Immutable$cleanup(void* rawSelf) {
frost$core$Immutable* param0 = (frost$core$Immutable*) rawSelf;
