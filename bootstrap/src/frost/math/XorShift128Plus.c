...
frost$core$Int64 $tmp21 = (frost$core$Int64) {123456789};
...
frost$core$Int64 $tmp37 = (frost$core$Int64) {23};
...
frost$core$Int64 $tmp45 = frost$core$Int64$init$builtin_int64($tmp44);
*(&local0) = $tmp45;
...
frost$core$Int64 $tmp53 = (frost$core$Int64) {17};
...
frost$core$Int64 $tmp61 = frost$core$Int64$init$builtin_int64($tmp60);
frost$core$Int64 $tmp62 = *(&local1);
frost$core$Int64 $tmp63 = (frost$core$Int64) {26};
