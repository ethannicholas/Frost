...
frost$collections$Key$class_type frost$collections$Key$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, (ITable*) &frost$collections$Key$_frost$collections$Key, { frost$core$Object$convert$R$frost$core$String, frost$core$Object$cleanup, NULL} };
