...
#include "frost/collections/SpecializedArrayIterator.LTorg/frostlanguage/frostc/parser/Token.GT.h"
#include "frost/core/MutableString.h"

__attribute__((weak)) void frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDXEQ$frost$core$Int64$org$frostlanguage$frostc$parser$Token$shim(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* p0, frost$core$Int64 p1, frost$core$Object* p2) {
    frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDXEQ$frost$core$Int64$org$frostlanguage$frostc$parser$Token(p0, p1, ((org$frostlanguage$frostc$parser$Token$wrapper*) p2)->value);

}
__attribute__((weak)) void frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$insert$frost$core$Int64$org$frostlanguage$frostc$parser$Token$shim(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* p0, frost$core$Int64 p1, frost$core$Object* p2) {
    frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$insert$frost$core$Int64$org$frostlanguage$frostc$parser$Token(p0, p1, ((org$frostlanguage$frostc$parser$Token$wrapper*) p2)->value);

}
__attribute__((weak)) frost$core$Object* frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$removeIndex$frost$core$Int64$R$org$frostlanguage$frostc$parser$Token$shim(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* p0, frost$core$Int64 p1) {
    org$frostlanguage$frostc$parser$Token result = frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$removeIndex$frost$core$Int64$R$org$frostlanguage$frostc$parser$Token(p0, p1);

    org$frostlanguage$frostc$parser$Token$wrapper* $tmp2;
    $tmp2 = (org$frostlanguage$frostc$parser$Token$wrapper*) frostObjectAlloc(64, (frost$core$Class*) &org$frostlanguage$frostc$parser$Token$wrapperclass);
    $tmp2->value = result;
    return ((frost$core$Object*) $tmp2);
}
__attribute__((weak)) frost$collections$Iterator* frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$get_iterator$R$frost$collections$Iterator$LTorg$frostlanguage$frostc$parser$Token$GT$shim(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* p0) {
    frost$collections$Iterator* result = frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$get_iterator$R$frost$collections$Iterator$LTorg$frostlanguage$frostc$parser$Token$GT(p0);

    return result;
}
__attribute__((weak)) frost$core$Object* frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$Int64$R$org$frostlanguage$frostc$parser$Token$shim(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* p0, frost$core$Int64 p1) {
    org$frostlanguage$frostc$parser$Token result = frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$Int64$R$org$frostlanguage$frostc$parser$Token(p0, p1);

    org$frostlanguage$frostc$parser$Token$wrapper* $tmp3;
    $tmp3 = (org$frostlanguage$frostc$parser$Token$wrapper*) frostObjectAlloc(64, (frost$core$Class*) &org$frostlanguage$frostc$parser$Token$wrapperclass);
    $tmp3->value = result;
...
__attribute__((weak)) void frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$add$org$frostlanguage$frostc$parser$Token$shim(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* p0, frost$core$Object* p1) {
    frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$add$org$frostlanguage$frostc$parser$Token(p0, ((org$frostlanguage$frostc$parser$Token$wrapper*) p1)->value);

}
__attribute__((weak)) void frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$addAll$frost$collections$CollectionView$LTorg$frostlanguage$frostc$parser$Token$GT$shim(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* p0, frost$collections$CollectionView* p1) {
    frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$addAll$frost$collections$CollectionView$LTorg$frostlanguage$frostc$parser$Token$GT(p0, p1);

}

struct { frost$core$Class* cl; ITable* next; void* methods[4]; } frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$_frost$collections$List = { (frost$core$Class*) &frost$collections$List$class, NULL, { frost$collections$List$$IDXEQ$frost$core$Range$LTfrost$core$Int64$GT$frost$collections$ListView$LTfrost$collections$List$T$GT, frost$collections$List$$IDXEQ$frost$core$Range$LTfrost$core$Int64$Q$GT$frost$collections$ListView$LTfrost$collections$List$T$GT, frost$collections$List$filterInPlace$$LPfrost$collections$List$T$RP$EQ$GT$LPfrost$core$Bit$RP, frost$collections$List$sortInPlace$$LPfrost$collections$List$T$Cfrost$collections$List$T$RP$EQ$GT$LPfrost$core$Bit$RP} };

struct { frost$core$Class* cl; ITable* next; void* methods[3]; } frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$_frost$collections$ListWriter = { (frost$core$Class*) &frost$collections$ListWriter$class, (ITable*) &frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$_frost$collections$List, { frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDXEQ$frost$core$Int64$org$frostlanguage$frostc$parser$Token$shim, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$insert$frost$core$Int64$org$frostlanguage$frostc$parser$Token$shim, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$removeIndex$frost$core$Int64$R$org$frostlanguage$frostc$parser$Token$shim} };

struct { frost$core$Class* cl; ITable* next; void* methods[1]; } frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$_frost$collections$Iterable = { (frost$core$Class*) &frost$collections$Iterable$class, (ITable*) &frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$_frost$collections$ListWriter, { frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$get_iterator$R$frost$collections$Iterator$LTorg$frostlanguage$frostc$parser$Token$GT$shim} };

struct { frost$core$Class* cl; ITable* next; void* methods[7]; } frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$_frost$collections$ListView = { (frost$core$Class*) &frost$collections$ListView$class, (ITable*) &frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$_frost$collections$Iterable, { frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$Int64$R$org$frostlanguage$frostc$parser$Token$shim, frost$collections$ListView$$IDX$frost$core$Range$LTfrost$core$Int64$GT$R$frost$collections$ListView$LTfrost$collections$ListView$T$GT, frost$collections$ListView$$IDX$frost$core$Range$LTfrost$core$Int64$Q$GT$R$frost$collections$ListView$LTfrost$collections$ListView$T$GT, frost$collections$ListView$$IDX$frost$core$SteppedRange$LTfrost$core$Int64$Q$Cfrost$core$Int64$GT$R$frost$collections$ListView$LTfrost$collections$ListView$T$GT, frost$collections$ListView$filter$$LPfrost$collections$ListView$T$RP$EQ$GT$LPfrost$core$Bit$RP$R$frost$collections$ListView$LTfrost$collections$ListView$T$GT, frost$collections$ListView$get_iterator$R$frost$collections$Iterator$LTfrost$collections$ListView$T$GT$shim, frost$collections$ListView$sort$$LPfrost$collections$ListView$T$Cfrost$collections$ListView$T$RP$EQ$GT$LPfrost$core$Bit$RP$R$frost$collections$ListView$LTfrost$collections$ListView$T$GT} };

struct { frost$core$Class* cl; ITable* next; void* methods[3]; } frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$_frost$collections$CollectionWriter = { (frost$core$Class*) &frost$collections$CollectionWriter$class, (ITable*) &frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$_frost$collections$ListView, { frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$add$org$frostlanguage$frostc$parser$Token$shim, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$addAll$frost$collections$CollectionView$LTorg$frostlanguage$frostc$parser$Token$GT$shim, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$clear} };

struct { frost$core$Class* cl; ITable* next; void* methods[7]; } frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$_frost$collections$CollectionView = { (frost$core$Class*) &frost$collections$CollectionView$class, (ITable*) &frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$_frost$collections$CollectionWriter, { frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$get_count$R$frost$core$Int64, frost$collections$CollectionView$join$R$frost$core$String, frost$collections$CollectionView$join$frost$core$String$R$frost$core$String, frost$collections$CollectionView$fold$$LPfrost$collections$CollectionView$T$Cfrost$collections$CollectionView$T$RP$EQ$GT$LPfrost$collections$CollectionView$T$RP$R$frost$collections$CollectionView$T, frost$collections$CollectionView$fold$$LPfrost$collections$CollectionView$T$Cfrost$collections$CollectionView$T$RP$EQ$GT$LPfrost$collections$CollectionView$T$RP$frost$collections$CollectionView$T$R$frost$collections$CollectionView$T, frost$collections$CollectionView$apply$$LPfrost$collections$CollectionView$T$RP$EQ$AM$GT$LP$RP, frost$collections$CollectionView$map$$LPfrost$collections$CollectionView$T$RP$EQ$GT$LPfrost$collections$CollectionView$map$U$RP$R$frost$collections$Array$LTfrost$collections$CollectionView$map$U$GT} };

struct { frost$core$Class* cl; ITable* next; void* methods[1]; } frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$_frost$collections$Collection = { (frost$core$Class*) &frost$collections$Collection$class, (ITable*) &frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$_frost$collections$CollectionView, { frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$clear} };

static frost$core$String $s1;
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$class_type frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, (ITable*) &frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$_frost$collections$Collection, { frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$convert$R$frost$core$String, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$cleanup, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$Int64$R$org$frostlanguage$frostc$parser$Token$shim, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDXEQ$frost$core$Int64$org$frostlanguage$frostc$parser$Token$shim, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$insert$frost$core$Int64$org$frostlanguage$frostc$parser$Token$shim, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$Range$LTfrost$core$Int64$GT$R$frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$Range$LTfrost$core$Int64$Q$GT$R$frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$SteppedRange$LTfrost$core$Int64$Q$Cfrost$core$Int64$GT$R$frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$add$org$frostlanguage$frostc$parser$Token$shim, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$addAll$frost$collections$CollectionView$LTorg$frostlanguage$frostc$parser$Token$GT$shim, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$ensureCapacity$frost$core$Int64, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$get_count$R$frost$core$Int64, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$get_iterator$R$frost$collections$Iterator$LTorg$frostlanguage$frostc$parser$Token$GT$shim, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$removeIndex$frost$core$Int64$R$org$frostlanguage$frostc$parser$Token$shim, frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$clear} };
...
void frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$init(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0) {

// line 45
frost$core$Int64 $tmp4 = (frost$core$Int64) {16};
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$init$frost$core$Int64(param0, $tmp4);
return;

}
void frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$init$frost$core$Int64(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0, frost$core$Int64 param1) {
...
org$frostlanguage$frostc$parser$Token$nullable* $tmp9 = ((org$frostlanguage$frostc$parser$Token$nullable*) frostZAlloc($tmp8 * 56));
org$frostlanguage$frostc$parser$Token$nullable** $tmp10 = &param0->data;
*$tmp10 = $tmp9;
return;

}
void frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$init$frost$collections$ListView$LTorg$frostlanguage$frostc$parser$Token$GT(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0, frost$collections$ListView* param1) {
...
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$init$frost$core$Int64(param0, $tmp16);
// line 55
...
*(&local0) = ((org$frostlanguage$frostc$parser$Token$wrapper*) $tmp29)->value;
// line 56
org$frostlanguage$frostc$parser$Token $tmp30 = *(&local0);
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$add$org$frostlanguage$frostc$parser$Token(param0, $tmp30);
...
*$tmp32 = $tmp31;
// line 62
org$frostlanguage$frostc$parser$Token$nullable** $tmp33 = &param0->data;
*$tmp33 = ((org$frostlanguage$frostc$parser$Token$nullable*) param1);
// line 63
...
void frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$cleanup(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0) {

// line 69
org$frostlanguage$frostc$parser$Token$nullable** $tmp36 = &param0->data;
org$frostlanguage$frostc$parser$Token$nullable* $tmp37 = *$tmp36;
frostFree($tmp37);
// line 68
...
org$frostlanguage$frostc$parser$Token frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$Int64$R$org$frostlanguage$frostc$parser$Token(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0, frost$core$Int64 param1) {
...
block9:;
// line 75
org$frostlanguage$frostc$parser$Token$nullable** $tmp88 = &param0->data;
org$frostlanguage$frostc$parser$Token$nullable* $tmp89 = *$tmp88;
int64_t $tmp90 = param1.value;
org$frostlanguage$frostc$parser$Token$nullable $tmp91 = $tmp89[$tmp90];
return ((org$frostlanguage$frostc$parser$Token) $tmp91.value);

}
void frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDXEQ$frost$core$Int64$org$frostlanguage$frostc$parser$Token(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0, frost$core$Int64 param1, org$frostlanguage$frostc$parser$Token param2) {
...
block9:;
// line 81
org$frostlanguage$frostc$parser$Token$nullable** $tmp142 = &param0->data;
org$frostlanguage$frostc$parser$Token$nullable* $tmp143 = *$tmp142;
int64_t $tmp144 = param1.value;
$tmp143[$tmp144] = ((org$frostlanguage$frostc$parser$Token$nullable) { param2, true });
return;

}
void frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$insert$frost$core$Int64$org$frostlanguage$frostc$parser$Token(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0, frost$core$Int64 param1, org$frostlanguage$frostc$parser$Token param2) {
...
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$ensureCapacity$frost$core$Int64(param0, $tmp153);
// line 87
...
org$frostlanguage$frostc$parser$Token $tmp202 = frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$Int64$R$org$frostlanguage$frostc$parser$Token(param0, $tmp201);
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDXEQ$frost$core$Int64$org$frostlanguage$frostc$parser$Token(param0, $tmp195, $tmp202);
goto block3;
block3:;
...
*$tmp245 = $tmp244;
// line 91
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDXEQ$frost$core$Int64$org$frostlanguage$frostc$parser$Token(param0, param1, param2);
return;

}
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$Range$LTfrost$core$Int64$GT$R$frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0, frost$core$Range$LTfrost$core$Int64$GT param1) {
...
org$frostlanguage$frostc$parser$Token* $tmp263 = ((org$frostlanguage$frostc$parser$Token*) frostZAlloc($tmp262 * 48));
*(&local2) = $tmp263;
// line 107
...
block3:;
// line 108
org$frostlanguage$frostc$parser$Token* $tmp284 = *(&local2);
...
org$frostlanguage$frostc$parser$Token $tmp292 = frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$Int64$R$org$frostlanguage$frostc$parser$Token(param0, $tmp291);
...
block4:;
// line 110
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* $tmp314 = (frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT*) frostObjectAlloc(40, (frost$core$Class*) &frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$class);
org$frostlanguage$frostc$parser$Token* $tmp315 = *(&local2);
frost$core$Int64 $tmp316 = *(&local1);
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$init$frost$unsafe$Pointer$LTorg$frostlanguage$frostc$parser$Token$GT$frost$core$Int64($tmp314, $tmp315, $tmp316);
...
// unreffing REF($93:frost.collections.SpecializedArray<org.frostlanguage.frostc.parser.Token>)
return $tmp314;

}
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$Range$LTfrost$core$Int64$Q$GT$R$frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0, frost$core$Range$LTfrost$core$Int64$Q$GT param1) {
...
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* $tmp340 = frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$Range$LTfrost$core$Int64$GT$R$frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT(param0, $tmp339);
frost$core$Frost$ref$frost$core$Object$Q(((frost$core$Object*) $tmp340));
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp340));
// unreffing REF($53:frost.collections.SpecializedArray<org.frostlanguage.frostc.parser.Token>)
return $tmp340;

}
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$SteppedRange$LTfrost$core$Int64$Q$Cfrost$core$Int64$GT$R$frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0, frost$core$SteppedRange$LTfrost$core$Int64$Q$Cfrost$core$Int64$GT param1) {

frost$core$Int64 local0;
frost$core$Int64 local1;
frost$core$Int64 local2;
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* local3 = NULL;
...
block8:;
// line 176
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* $tmp375 = (frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT*) frostObjectAlloc(40, (frost$core$Class*) &frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$class);
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$init($tmp375);
*(&local3) = ((frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT*) NULL);
frost$core$Frost$ref$frost$core$Object$Q(((frost$core$Object*) $tmp375));
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* $tmp376 = *(&local3);
...
// unreffing REF($73:frost.collections.SpecializedArray<org.frostlanguage.frostc.parser.Token>)
// line 177
...
block17:;
// line 179
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* $tmp391 = *(&local3);
frost$core$Int64 $tmp392 = *(&local1);
org$frostlanguage$frostc$parser$Token $tmp393 = frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$Int64$R$org$frostlanguage$frostc$parser$Token(param0, $tmp392);
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$add$org$frostlanguage$frostc$parser$Token($tmp391, $tmp393);
// line 180
...
block22:;
// line 186
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* $tmp416 = *(&local3);
frost$core$Int64 $tmp417 = *(&local1);
org$frostlanguage$frostc$parser$Token $tmp418 = frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$Int64$R$org$frostlanguage$frostc$parser$Token(param0, $tmp417);
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$add$org$frostlanguage$frostc$parser$Token($tmp416, $tmp418);
// line 187
...
block24:;
// line 191
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* $tmp445 = *(&local3);
frost$core$Int64 $tmp446 = *(&local1);
org$frostlanguage$frostc$parser$Token $tmp447 = frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$Int64$R$org$frostlanguage$frostc$parser$Token(param0, $tmp446);
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$add$org$frostlanguage$frostc$parser$Token($tmp445, $tmp447);
goto block25;
block25:;
// line 193
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* $tmp448 = *(&local3);
frost$core$Frost$ref$frost$core$Object$Q(((frost$core$Object*) $tmp448));
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* $tmp449 = *(&local3);
...
void frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$add$org$frostlanguage$frostc$parser$Token(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0, org$frostlanguage$frostc$parser$Token param1) {
...
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$ensureCapacity$frost$core$Int64(param0, $tmp456);
// line 199
org$frostlanguage$frostc$parser$Token$nullable** $tmp457 = &param0->data;
org$frostlanguage$frostc$parser$Token$nullable* $tmp458 = *$tmp457;
frost$core$Int64* $tmp459 = &param0->_count;
frost$core$Int64 $tmp460 = *$tmp459;
int64_t $tmp461 = $tmp460.value;
$tmp458[$tmp461] = ((org$frostlanguage$frostc$parser$Token$nullable) { param1, true });
// line 200
...
void frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$addAll$frost$collections$CollectionView$LTorg$frostlanguage$frostc$parser$Token$GT(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0, frost$collections$CollectionView* param1) {
...
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$ensureCapacity$frost$core$Int64(param0, $tmp479);
// line 206
...
*(&local0) = ((org$frostlanguage$frostc$parser$Token$wrapper*) $tmp492)->value;
// line 207
org$frostlanguage$frostc$parser$Token$nullable** $tmp493 = &param0->data;
org$frostlanguage$frostc$parser$Token$nullable* $tmp494 = *$tmp493;
frost$core$Int64* $tmp495 = &param0->_count;
frost$core$Int64 $tmp496 = *$tmp495;
org$frostlanguage$frostc$parser$Token $tmp497 = *(&local0);
int64_t $tmp498 = $tmp496.value;
$tmp494[$tmp498] = ((org$frostlanguage$frostc$parser$Token$nullable) { $tmp497, true });
// line 208
...
void frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$ensureCapacity$frost$core$Int64(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0, frost$core$Int64 param1) {
...
block7:;
// line 221
org$frostlanguage$frostc$parser$Token$nullable** $tmp541 = &param0->data;
org$frostlanguage$frostc$parser$Token$nullable* $tmp542 = *$tmp541;
...
org$frostlanguage$frostc$parser$Token$nullable* $tmp548 = (org$frostlanguage$frostc$parser$Token$nullable*) frostRealloc($tmp542, $tmp546 * 8, $tmp547 * 8);
org$frostlanguage$frostc$parser$Token$nullable** $tmp549 = &param0->data;
*$tmp549 = $tmp548;
return;

}
frost$core$Int64 frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$get_count$R$frost$core$Int64(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0) {
...
frost$collections$Iterator* frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$get_iterator$R$frost$collections$Iterator$LTorg$frostlanguage$frostc$parser$Token$GT(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0) {

// line 231
frost$collections$SpecializedArrayIterator$LTorg$frostlanguage$frostc$parser$Token$GT* $tmp552 = (frost$collections$SpecializedArrayIterator$LTorg$frostlanguage$frostc$parser$Token$GT*) frostObjectAlloc(32, (frost$core$Class*) &frost$collections$SpecializedArrayIterator$LTorg$frostlanguage$frostc$parser$Token$GT$class);
frost$collections$SpecializedArrayIterator$LTorg$frostlanguage$frostc$parser$Token$GT$init$frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT($tmp552, param0);
...
// unreffing REF($1:frost.collections.SpecializedArrayIterator<org.frostlanguage.frostc.parser.Token>)
return ((frost$collections$Iterator*) $tmp552);

}
org$frostlanguage$frostc$parser$Token frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$removeIndex$frost$core$Int64$R$org$frostlanguage$frostc$parser$Token(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0, frost$core$Int64 param1) {
...
block4:;
// line 236
org$frostlanguage$frostc$parser$Token $tmp572 = frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$Int64$R$org$frostlanguage$frostc$parser$Token(param0, param1);
*(&local1) = $tmp572;
// line 237
...
org$frostlanguage$frostc$parser$Token $tmp605 = frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDX$frost$core$Int64$R$org$frostlanguage$frostc$parser$Token(param0, $tmp604);
frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$$IDXEQ$frost$core$Int64$org$frostlanguage$frostc$parser$Token(param0, $tmp598, $tmp605);
goto block8;
block8:;
...
*$tmp633 = $tmp632;
// line 241
org$frostlanguage$frostc$parser$Token$nullable** $tmp634 = &param0->data;
org$frostlanguage$frostc$parser$Token$nullable* $tmp635 = *$tmp634;
frost$core$Int64* $tmp636 = &param0->_count;
frost$core$Int64 $tmp637 = *$tmp636;
int64_t $tmp638 = $tmp637.value;
$tmp635[$tmp638] = ((org$frostlanguage$frostc$parser$Token$nullable) { .nonnull = false });
// line 242
org$frostlanguage$frostc$parser$Token $tmp639 = *(&local1);
return $tmp639;

}
void frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$clear(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0) {
...
block1:;
// line 249
org$frostlanguage$frostc$parser$Token$nullable** $tmp663 = &param0->data;
org$frostlanguage$frostc$parser$Token$nullable* $tmp664 = *$tmp663;
frost$core$Int64 $tmp665 = *(&local0);
int64_t $tmp666 = $tmp665.value;
$tmp664[$tmp666] = ((org$frostlanguage$frostc$parser$Token$nullable) { .nonnull = false });
goto block3;
block3:;
...
frost$core$String* frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT$convert$R$frost$core$String(frost$collections$SpecializedArray$LTorg$frostlanguage$frostc$parser$Token$GT* param0) {
...
*(&local2) = ((org$frostlanguage$frostc$parser$Token$wrapper*) $tmp706)->value;
// line 259
...
*(&local1) = &$s711;
// line 261
org$frostlanguage$frostc$parser$Token $tmp712 = *(&local2);
...
org$frostlanguage$frostc$parser$Token $tmp716 = *(&local2);
org$frostlanguage$frostc$parser$Token$wrapper* $tmp717;
$tmp717 = (org$frostlanguage$frostc$parser$Token$wrapper*) frostObjectAlloc(64, (frost$core$Class*) &org$frostlanguage$frostc$parser$Token$wrapperclass);
$tmp717->value = $tmp716;
