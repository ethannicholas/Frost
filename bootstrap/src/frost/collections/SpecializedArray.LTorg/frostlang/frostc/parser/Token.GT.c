...
__attribute__((weak)) frost$core$Object* frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT$$IDX$frost$core$Int$R$org$frostlang$frostc$parser$Token$shim(frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT* p0, frost$core$Int p1) {
    ...
    $tmp2 = (org$frostlang$frostc$parser$Token$wrapper*) frostObjectAlloc(sizeof(org$frostlang$frostc$parser$Token$wrapper), (frost$core$Class*) &org$frostlang$frostc$parser$Token$wrapperclass);
    $tmp2->value = result;
...
__attribute__((weak)) frost$core$Object* frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT$removeIndex$frost$core$Int$R$org$frostlang$frostc$parser$Token$shim(frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT* p0, frost$core$Int p1) {
    ...
    $tmp3 = (org$frostlang$frostc$parser$Token$wrapper*) frostObjectAlloc(sizeof(org$frostlang$frostc$parser$Token$wrapper), (frost$core$Class*) &org$frostlang$frostc$parser$Token$wrapperclass);
    $tmp3->value = result;
...
frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT* param0 = (frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT*) rawSelf;
...
void frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT$init$frost$core$Int(void* rawSelf, frost$core$Int param1) {
frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT* param0 = (frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT*) rawSelf;
...
// begin inline call to method frost.unsafe.NewPointer.alloc(count:frost.core.Int):frost.unsafe.NewPointer<frost.unsafe.NewPointer.T> from SpecializedArray.frost:41:36
...
void frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT$init$frost$collections$ListView$LTorg$frostlang$frostc$parser$Token$GT(void* rawSelf, frost$collections$ListView* param1) {
frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT* param0 = (frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT*) rawSelf;
...
org$frostlang$frostc$parser$Token _36;
org$frostlang$frostc$parser$Token _39;
...
_34 = $tmp11->methods[1];
_35 = _34(_28);
_36 = ((org$frostlang$frostc$parser$Token$wrapper*) _35)->value;
*(&local1) = _36;
// /Users/ethannicholas/Dropbox/Frost/src/frost/collections/SpecializedArray.frost:50
_39 = *(&local1);
frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT$add$org$frostlang$frostc$parser$Token(param0, _39);
_41 = _35;
...
void frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT$init$frost$unsafe$NewPointer$LTorg$frostlang$frostc$parser$Token$GT$frost$core$Int(void* rawSelf, frost$unsafe$NewPointer param1, frost$core$Int param2) {
frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT* param0 = (frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT*) rawSelf;
...
_1 = &param0->data;
_2 = *_1;
// begin inline call to method frost.unsafe.NewPointer.destroy() from SpecializedArray.frost:63:21
...
org$frostlang$frostc$parser$Token frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT$$IDX$frost$core$Int$R$org$frostlang$frostc$parser$Token(void* rawSelf, frost$core$Int param1) {
frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT* param0 = (frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT*) rawSelf;
...
int64_t _24;
org$frostlang$frostc$parser$Token _25;
...
_24 = _23.value;
_25 = ((org$frostlang$frostc$parser$Token*)_22)[_24];
return _25;

}
void frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT$$IDXEQ$frost$core$Int$org$frostlang$frostc$parser$Token(void* rawSelf, frost$core$Int param1, org$frostlang$frostc$parser$Token param2) {
frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT* param0 = (frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT*) rawSelf;
...
_23 = frost$core$Int64$init$frost$core$Int(param1);
_24 = _23.value;
((org$frostlang$frostc$parser$Token*)_22)[_24] = param2;
return;

}
void frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT$insert$frost$core$Int$org$frostlang$frostc$parser$Token(void* rawSelf, frost$core$Int param1, org$frostlang$frostc$parser$Token param2) {
frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT* param0 = (frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT*) rawSelf;
...
int64_t _97;
org$frostlang$frostc$parser$Token _98;
int64_t _99;
frost$core$Int _102;
int64_t _104;
int64_t _105;
...
_97 = _96.value;
_98 = ((org$frostlang$frostc$parser$Token*)_89)[_97];
_99 = _86.value;
((org$frostlang$frostc$parser$Token*)_84)[_99] = _98;
_102 = *(&local0);
...
_159 = _158.value;
((org$frostlang$frostc$parser$Token*)_157)[_159] = param2;
return;

}
void frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT$add$org$frostlang$frostc$parser$Token(void* rawSelf, org$frostlang$frostc$parser$Token param1) {
frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT* param0 = (frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT*) rawSelf;
...
_16 = _15.value;
((org$frostlang$frostc$parser$Token*)_12)[_16] = param1;
...
void frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT$addAll$frost$collections$CollectionView$LTorg$frostlang$frostc$parser$Token$GT(void* rawSelf, frost$collections$CollectionView* param1) {
frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT* param0 = (frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT*) rawSelf;
...
frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT$ensureCapacity$frost$core$Int(param0, _8);
...
_19 = $tmp35->methods[1];
_20 = _19(_13);
_21 = ((org$frostlang$frostc$parser$Token$wrapper*) _20)->value;
*(&local0) = _21;
...
_30 = *(&local0);
_31 = _29.value;
((org$frostlang$frostc$parser$Token*)_26)[_31] = _30;
...
void frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT$ensureCapacity$frost$core$Int(void* rawSelf, frost$core$Int param1) {
frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT* param0 = (frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT*) rawSelf;
...
frost$core$Int _70;
frost$core$Int* _71;
frost$unsafe$NewPointer* _75;
frost$unsafe$NewPointer _76;
frost$core$Int _77;
frost$core$Int* _78;
frost$core$Int _79;
int64_t _82;
...
_78 = &param0->capacity;
_79 = *_78;
// begin inline call to method frost.unsafe.NewPointer.realloc(oldCount:frost.core.Int, newCount:frost.core.Int):frost.unsafe.NewPointer<frost.unsafe.NewPointer.T> from SpecializedArray.frost:112:29
...
org$frostlang$frostc$parser$Token frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT$removeIndex$frost$core$Int$R$org$frostlang$frostc$parser$Token(void* rawSelf, frost$core$Int param1) {
frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT* param0 = (frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT*) rawSelf;
...
int64_t _45;
org$frostlang$frostc$parser$Token _46;
frost$core$Int* _50;
frost$core$Int _51;
frost$core$Int _52;
int64_t _53;
...
int64_t _111;
org$frostlang$frostc$parser$Token _112;
frost$core$Int _115;
int64_t _116;
int64_t _117;
bool _118;
...
org$frostlang$frostc$parser$Token _185;
_0 = (frost$core$Int) {0u};
_1 = param1.value;
_2 = _0.value;
_3 = _1 >= _2;
...
_45 = _44.value;
_46 = ((org$frostlang$frostc$parser$Token*)_43)[_45];
*(&local0) = _46;
...
_111 = _110.value;
_112 = ((org$frostlang$frostc$parser$Token*)_109)[_111];
...
_139 = _138.value;
((org$frostlang$frostc$parser$Token*)_137)[_139] = _112;
_143 = *(&local1);
_144 = _61.value;
_145 = _143.value;
_146 = _144 - _145;
...
org$frostlang$frostc$parser$Token _54;
...
_32 = $tmp66->methods[1];
_33 = _32(_26);
_34 = ((org$frostlang$frostc$parser$Token$wrapper*) _33)->value;
*(&local2) = _34;
...
$tmp69 = (org$frostlang$frostc$parser$Token$wrapper*) frostObjectAlloc(sizeof(org$frostlang$frostc$parser$Token$wrapper), (frost$core$Class*) &org$frostlang$frostc$parser$Token$wrapperclass);
$tmp69->value = _54;
