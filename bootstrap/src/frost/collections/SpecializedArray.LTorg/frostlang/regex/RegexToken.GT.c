...
void frost$collections$SpecializedArray$LTorg$frostlang$regex$RegexToken$GT$init$frost$unsafe$NewPointer$LTorg$frostlang$regex$RegexToken$GT$frost$core$Int(void* rawSelf, frost$unsafe$NewPointer param1, frost$core$Int param2) {
frost$collections$SpecializedArray$LTorg$frostlang$regex$RegexToken$GT* param0 = (frost$collections$SpecializedArray$LTorg$frostlang$regex$RegexToken$GT*) rawSelf;
