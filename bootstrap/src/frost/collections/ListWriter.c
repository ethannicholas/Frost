...
struct { frost$core$Class* cl; ITable* next; void* methods[3]; } frost$collections$ListWriter$_frost$collections$ListWriter = { (frost$core$Class*) &frost$collections$ListWriter$class, NULL, { NULL, NULL, NULL} };

struct { frost$core$Class* cl; ITable* next; void* methods[3]; } frost$collections$ListWriter$_frost$collections$CollectionWriter = { (frost$core$Class*) &frost$collections$CollectionWriter$class, (ITable*) &frost$collections$ListWriter$_frost$collections$ListWriter, { NULL, frost$collections$CollectionWriter$addAll$frost$collections$CollectionView$LTfrost$collections$CollectionWriter$T$GT, NULL} };
