...
struct { frost$core$Class* cl; ITable* next; void* methods[4]; } frost$collections$Collection$_frost$collections$CollectionWriter = { (frost$core$Class*) &frost$collections$CollectionWriter$class, (ITable*) &frost$collections$Collection$_frost$collections$Iterable, { NULL, NULL, frost$collections$CollectionWriter$addAll$frost$collections$CollectionView$LTfrost$collections$CollectionWriter$T$GT, NULL} };
