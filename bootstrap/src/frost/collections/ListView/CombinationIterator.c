...
block2:;
frost$core$Int $tmp21 = (frost$core$Int) {115u};
...
block2:;
frost$core$Int $tmp161 = (frost$core$Int) {134u};
...
// begin inline call to function frost.core.Int.=(other:frost.core.Int):frost.core.Bit from ListView.frost:138:26
