...
frost$collections$HashMap$KeyIterator$class_type frost$collections$HashMap$KeyIterator$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, (ITable*) &frost$collections$HashMap$KeyIterator$_frost$collections$Iterator, { frost$core$Object$convert$R$frost$core$String, frost$collections$HashMap$KeyIterator$cleanup, frost$collections$HashMap$KeyIterator$get_done$R$frost$core$Bit, frost$collections$HashMap$KeyIterator$next$R$frost$collections$HashMap$KeyIterator$K$shim} };
