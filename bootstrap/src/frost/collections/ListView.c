...
_82 = (frost$collections$ListView$CombinationIterator*) frostObjectAlloc(sizeof(frost$collections$ListView$CombinationIterator), (frost$core$Class*) &frost$collections$ListView$CombinationIterator$class);
_83 = _82;
_84 = param0;
