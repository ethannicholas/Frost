...
block2:;
frost$core$Int64 $tmp66 = (frost$core$Int64) {52};
...
block2:;
frost$core$Int64 $tmp240 = (frost$core$Int64) {133};
...
block22:;
frost$core$Int64 $tmp316 = (frost$core$Int64) {166};
...
block2:;
frost$core$Int64 $tmp440 = (frost$core$Int64) {210};
...
block2:;
frost$core$Int64 $tmp525 = (frost$core$Int64) {220};
...
ITable* $tmp605 = ((frost$collections$CollectionView*) param0)->$class->itable;
while ($tmp605->$class != (frost$core$Class*) &frost$collections$CollectionView$class) {
    $tmp605 = $tmp605->next;
}
$fn607 $tmp606 = $tmp605->methods[0];
frost$core$Int64 $tmp608 = $tmp606(((frost$collections$CollectionView*) param0));
...
frost$core$Frost$sort$frost$collections$List$LTfrost$core$Frost$sort$T$GT$frost$core$Int64$frost$core$Int64$$LPfrost$core$Frost$sort$T$Cfrost$core$Frost$sort$T$RP$EQ$AM$GT$LPfrost$core$Bit$RP(((frost$collections$List*) $tmp603), $tmp604, $tmp613, param1);
// line 247
