...
typedef void (*$fn187)(panda$core$MutableString*, panda$core$String*);
typedef void (*$fn189)(panda$core$MutableString*, panda$core$Object*);
typedef panda$core$String* (*$fn201)(panda$core$MutableString*);
typedef void (*$fn207)(panda$core$MutableString*, panda$core$String*);
...
typedef void (*$fn227)(panda$core$MutableString*, panda$core$String*);
typedef void (*$fn229)(panda$core$MutableString*, panda$core$Object*);
typedef void (*$fn231)(panda$core$MutableString*, panda$core$String*);
typedef void (*$fn233)(panda$core$MutableString*, panda$core$String*);
typedef panda$core$String* (*$fn234)(panda$core$MutableString*);
...
static panda$core$String $s158 = { (panda$core$Class*) &panda$core$String$class, 2, (panda$core$Char8*) "\x2C\x20", 2 };
static panda$core$String $s161 = { (panda$core$Class*) &panda$core$String$class, 2, (panda$core$Char8*) "", 0 };
static panda$core$String $s206 = { (panda$core$Class*) &panda$core$String$class, 2, (panda$core$Char8*) "\x5B", 1 };
static panda$core$String $s209 = { (panda$core$Class*) &panda$core$String$class, 2, (panda$core$Char8*) "", 0 };
static panda$core$String $s228 = { (panda$core$Class*) &panda$core$String$class, 2, (panda$core$Char8*) "\x2C\x20", 2 };
static panda$core$String $s230 = { (panda$core$Class*) &panda$core$String$class, 2, (panda$core$Char8*) "\x3C\x6E\x75\x6C\x6C\x3E", 6 };
static panda$core$String $s232 = { (panda$core$Class*) &panda$core$String$class, 2, (panda$core$Char8*) "\x5D", 1 };
...
void panda$collections$Array$insert$panda$core$Int64$panda$collections$Array$T(panda$collections$Array* self, panda$core$Int64 p_index, panda$core$Object* p_value) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp24, ((panda$core$Object*) wrap_panda$core$Int64(self->count)), ((panda$core$Object*) wrap_panda$core$Int64(p_index)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { -1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp26 = ((panda$core$Int64$wrapper*) $tmp24.start)->value.value;
    panda$core$Int64 i25 = { $tmp26 };
    int64_t $tmp28 = ((panda$core$Int64$wrapper*) $tmp24.end)->value.value;
...
panda$collections$Array* panda$collections$Array$$IDX$panda$core$Range$LTpanda$core$Int64$Q$GT$R$panda$collections$Array$LTpanda$collections$Array$T$GT(panda$collections$Array* self, panda$core$Range p_r) {
    ...
    {
        current58 = ((panda$core$Int64) (p_r.start != NULL ? ((panda$core$Int64$nullable) { ((panda$core$Int64$wrapper*) p_r.start)->value, true }) : (panda$core$Int64$nullable) { .nonnull = 0 }).value);
    }
    }
    else {
    ...
    {
        end62 = ((panda$core$Int64) (p_r.end != NULL ? ((panda$core$Int64$nullable) { ((panda$core$Int64$wrapper*) p_r.end)->value, true }) : (panda$core$Int64$nullable) { .nonnull = 0 }).value);
    }
    }
    else {
    ...
    if ($tmp81) goto $l82;
    $tmp81 = ((panda$core$Bit) { !(p_r.end != NULL ? ((panda$core$Int64$nullable) { ((panda$core$Int64$wrapper*) p_r.end)->value, true }) : (panda$core$Int64$nullable) { .nonnull = 0 }).nonnull }).value;
    $l82:;
...
void panda$collections$Array$removeIndex$panda$core$Int64(panda$collections$Array* self, panda$core$Int64 p_index) {
    panda$core$Range $tmp122;
    panda$core$Int64 $tmp123 = panda$core$Int64$$SUB$panda$core$Int64$R$panda$core$Int64(self->count, ((panda$core$Int64) { 1 }));
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp122, ((panda$core$Object*) wrap_panda$core$Int64(p_index)), ((panda$core$Object*) wrap_panda$core$Int64($tmp123)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp125 = ((panda$core$Int64$wrapper*) $tmp122.start)->value.value;
    panda$core$Int64 i124 = { $tmp125 };
    int64_t $tmp127 = ((panda$core$Int64$wrapper*) $tmp122.end)->value.value;
...
panda$core$String* panda$collections$Array$join$panda$core$String$R$panda$core$String(panda$collections$Array* self, panda$core$String* p_separator) {
    ...
    result162 = $tmp163;
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp168, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 1 }))), ((panda$core$Object*) wrap_panda$core$Int64(self->count)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp170 = ((panda$core$Int64$wrapper*) $tmp168.start)->value.value;
    panda$core$Int64 i169 = { $tmp170 };
    int64_t $tmp172 = ((panda$core$Int64$wrapper*) $tmp168.end)->value.value;
    ...
    $l175:;
    {
        (($fn187) result162->$class->vtable[3])(result162, p_separator);
        panda$core$Object* $tmp188 = panda$collections$Array$$IDX$panda$core$Int64$R$panda$collections$Array$T(self, i169);
        (($fn189) result162->$class->vtable[5])(result162, $tmp188);
    }
    $l178:;
    if ($tmp181) goto $l191; else goto $l192;
    $l191:;
    int64_t $tmp193 = $tmp172 - i169.value;
    if ($tmp174) goto $l194; else goto $l195;
    $l194:;
    if ($tmp193 >= $tmp173) goto $l190; else goto $l177;
    $l195:;
    if ($tmp193 > $tmp173) goto $l190; else goto $l177;
    $l192:;
    int64_t $tmp197 = i169.value - $tmp172;
    if ($tmp174) goto $l198; else goto $l199;
    $l198:;
    if ($tmp197 >= -$tmp173) goto $l190; else goto $l177;
    $l199:;
    if ($tmp197 > -$tmp173) goto $l190; else goto $l177;
    $l190:;
    i169.value += $tmp173;
    goto $l175;
    $l177:;
    panda$core$String* $tmp202 = (($fn201) result162->$class->vtable[0])(result162);
    return $tmp202;
}
panda$core$String* panda$collections$Array$convert$R$panda$core$String(panda$collections$Array* self) {
    ...
    panda$collections$Iterator* v$Iter210;
    panda$core$Object* v222;
    ...
    panda$core$MutableString$init($tmp204);
    result203 = $tmp204;
    (($fn207) result203->$class->vtable[3])(result203, &$s206);
    separator208 = &$s209;
    {
        ITable* $tmp211 = ((panda$collections$Iterable*) self)->$class->itable;
        while ($tmp211->$class != (panda$core$Class*) &panda$collections$Iterable$class) {
            $tmp211 = $tmp211->next;
        }
        $fn213 $tmp212 = $tmp211->methods[0];
        panda$collections$Iterator* $tmp214 = $tmp212(((panda$collections$Iterable*) self));
        v$Iter210 = $tmp214;
        $l215:;
        ITable* $tmp217 = v$Iter210->$class->itable;
        while ($tmp217->$class != (panda$core$Class*) &panda$collections$Iterator$class) {
            $tmp217 = $tmp217->next;
        }
        $fn219 $tmp218 = $tmp217->methods[0];
        panda$core$Bit $tmp220 = $tmp218(v$Iter210);
        panda$core$Bit $tmp221 = panda$core$Bit$$NOT$R$panda$core$Bit($tmp220);
        if (!$tmp221.value) goto $l216;
        {
            ITable* $tmp223 = v$Iter210->$class->itable;
            while ($tmp223->$class != (panda$core$Class*) &panda$collections$Iterator$class) {
                $tmp223 = $tmp223->next;
            }
            $fn225 $tmp224 = $tmp223->methods[1];
            panda$core$Object* $tmp226 = $tmp224(v$Iter210);
            v222 = $tmp226;
            (($fn227) result203->$class->vtable[3])(result203, separator208);
            separator208 = &$s228;
            if (((panda$core$Bit) { v222 != NULL }).value) {
            {
                (($fn229) result203->$class->vtable[5])(result203, v222);
            }
            }
            else {
            {
                (($fn231) result203->$class->vtable[3])(result203, &$s230);
            }
            }
        }
        goto $l215;
    ...
    (($fn233) result203->$class->vtable[3])(result203, &$s232);
    panda$core$String* $tmp235 = (($fn234) result203->$class->vtable[0])(result203);
    return $tmp235;
}
...
panda$core$Bit panda$collections$Array$ArrayIterator$get_done$R$panda$core$Bit(panda$collections$Array$ArrayIterator* self) {
    panda$core$Bit $tmp236 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit(self->index, self->array->count);
    return $tmp236;
}
panda$core$Object* panda$collections$Array$ArrayIterator$next$R$panda$collections$Array$ArrayIterator$T(panda$collections$Array$ArrayIterator* self) {
    panda$core$Int64 $tmp237 = panda$core$Int64$$ADD$panda$core$Int64$R$panda$core$Int64(self->index, ((panda$core$Int64) { 1 }));
    self->index = $tmp237;
    panda$core$Int64 $tmp238 = panda$core$Int64$$SUB$panda$core$Int64$R$panda$core$Int64(self->index, ((panda$core$Int64) { 1 }));
    panda$core$Object* $tmp239 = panda$collections$Array$$IDX$panda$core$Int64$R$panda$collections$Array$T(self->array, $tmp238);
    return $tmp239;
}
