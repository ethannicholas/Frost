...
panda$core$String* panda$core$UInt16$convert$R$panda$core$String(panda$core$UInt16 self) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp187, ((panda$core$Object*) wrap_panda$core$Int64(index160)), ((panda$core$Object*) wrap_panda$core$Int64(max158)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp189 = ((panda$core$Int64$wrapper*) $tmp187.start)->value.value;
    panda$core$Int64 i188 = { $tmp189 };
    int64_t $tmp191 = ((panda$core$Int64$wrapper*) $tmp187.end)->value.value;
