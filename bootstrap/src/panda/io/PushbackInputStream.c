...
$tmp57 = (panda$core$UInt8$wrapper*) frostObjectAlloc(13, (panda$core$Class*) &panda$core$UInt8$wrapperclass);
$tmp57->value = param1;
...
$tmp61 = (panda$core$UInt8$wrapper*) frostObjectAlloc(13, (panda$core$Class*) &panda$core$UInt8$wrapperclass);
$tmp61->value = $tmp60;
