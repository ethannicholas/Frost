...
void panda$io$LineNumberInputStream$init$panda$io$InputStream(panda$io$LineNumberInputStream* self, panda$io$InputStream* p_source) {
    ...
    {
        panda$io$InputStream* $tmp2 = self->source;
        panda$io$InputStream* $tmp3 = p_source;
        self->source = $tmp3;
...
panda$core$UInt8$nullable panda$io$LineNumberInputStream$read$R$panda$core$UInt8$Q(panda$io$LineNumberInputStream* self) {
    ...
    panda$core$UInt8$nullable $match$37_138;
    panda$core$UInt8$nullable $tmp6 = (($fn5) self->source->$class->vtable[2])(self->source);
    result4 = $tmp6;
    if (((panda$core$Bit) { !result4.nonnull }).value) {
    {
        panda$core$UInt8$nullable $tmp7 = ((panda$core$UInt8$nullable) { .nonnull = false });
        return $tmp7;
    }
    }
    {
        $match$37_138 = result4;
        panda$core$Bit $tmp9 = panda$core$UInt8$$EQ$panda$core$UInt8$R$panda$core$Bit(((panda$core$UInt8) $match$37_138.value), ((panda$core$UInt8) { 10 }));
        if ($tmp9.value) {
        {
            panda$core$Int64 $tmp10 = panda$core$Int64$$ADD$panda$core$Int64$R$panda$core$Int64(self->line, ((panda$core$Int64) { 1 }));
            self->line = $tmp10;
            self->column = ((panda$core$Int64) { 1 });
        }
        }
        else {
        panda$core$Bit $tmp11 = panda$core$UInt8$$EQ$panda$core$UInt8$R$panda$core$Bit(((panda$core$UInt8) $match$37_138.value), ((panda$core$UInt8) { 9 }));
        if ($tmp11.value) {
        {
            panda$core$Int64 $tmp12 = panda$core$Int64$$REM$panda$core$Int64$R$panda$core$Int64(self->column, ((panda$core$Int64) { 4 }));
            panda$core$Int64 $tmp13 = panda$core$Int64$$SUB$panda$core$Int64$R$panda$core$Int64(((panda$core$Int64) { 4 }), $tmp12);
            panda$core$Int64 $tmp14 = panda$core$Int64$$ADD$panda$core$Int64$R$panda$core$Int64(self->column, $tmp13);
            self->column = $tmp14;
        }
        }
        else {
        {
            panda$core$Int64 $tmp15 = panda$core$Int64$$ADD$panda$core$Int64$R$panda$core$Int64(self->column, ((panda$core$Int64) { 1 }));
            self->column = $tmp15;
        }
        }
        }
    }
    panda$core$UInt8$nullable $tmp16 = result4;
    return $tmp16;
}
