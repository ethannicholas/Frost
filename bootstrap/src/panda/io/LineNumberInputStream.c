...
panda$core$UInt8$nullable panda$io$LineNumberInputStream$read$R$panda$core$UInt8$Q(panda$io$LineNumberInputStream* self) {
    ...
    panda$core$UInt8$nullable $match$37_134;
    ...
    {
        $match$37_134 = result1;
        panda$core$Bit $tmp5 = panda$core$UInt8$$EQ$panda$core$UInt8$R$panda$core$Bit(((panda$core$UInt8) $match$37_134.value), ((panda$core$UInt8) { 10 }));
        if ($tmp5.value) {
        {
        ...
        panda$core$Bit $tmp7 = panda$core$UInt8$$EQ$panda$core$UInt8$R$panda$core$Bit(((panda$core$UInt8) $match$37_134.value), ((panda$core$UInt8) { 9 }));
        if ($tmp7.value) {
        {
