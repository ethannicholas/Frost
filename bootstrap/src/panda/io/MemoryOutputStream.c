...
void panda$io$MemoryOutputStream$init$panda$core$Int64(panda$io$MemoryOutputStream* self, panda$core$Int64 p_capacity) {
    self->data = NULL;
    {
        panda$core$MutableString* $tmp1 = (panda$core$MutableString*) pandaZAlloc(48);
