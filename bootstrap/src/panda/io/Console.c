...
void panda$io$Console$print$panda$core$String(panda$core$String* p_s) {
    panda$core$SimpleRange$LTpanda$core$Int64$GT $tmp1;
    panda$core$SimpleRange$LTpanda$core$Int64$GT$init$panda$core$Int64$panda$core$Int64$panda$core$Bit(&$tmp1, ((panda$core$Int64) { 0 }), p_s->_length, ((panda$core$Bit) { false }));
