...
panda$io$File* panda$io$File$parent$R$panda$io$File$Q(panda$io$File* self) {
    ...
    panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT $tmp29;
    ...
    if (((panda$core$Bit) { index24.nonnull }).value) {
    {
        ...
        panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$init$panda$core$String$Index$Q$panda$core$String$Index$Q$panda$core$Bit(&$tmp29, ((panda$core$String$Index$nullable) { .nonnull = false }), index24, ((panda$core$Bit) { false }));
        panda$core$String* $tmp30 = panda$core$String$$IDX$panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$R$panda$core$String(self->path, $tmp29);
...
panda$core$String* panda$io$File$name$R$panda$core$String(panda$io$File* self) {
    ...
    panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT $tmp36;
    ...
    if (((panda$core$Bit) { index33.nonnull }).value) {
    {
        ...
        panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$init$panda$core$String$Index$Q$panda$core$String$Index$Q$panda$core$Bit(&$tmp36, ((panda$core$String$Index$nullable) { $tmp37, true }), ((panda$core$String$Index$nullable) { .nonnull = false }), ((panda$core$Bit) { false }));
        panda$core$String* $tmp38 = panda$core$String$$IDX$panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$R$panda$core$String(self->path, $tmp36);
        return $tmp38;
    }
    }
    else {
...
panda$core$String* panda$io$File$simpleName$R$panda$core$String(panda$io$File* self) {
    ...
    panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT $tmp44;
    ...
    panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$init$panda$core$String$Index$Q$panda$core$String$Index$Q$panda$core$Bit(&$tmp44, ((panda$core$String$Index$nullable) { .nonnull = false }), index41, ((panda$core$Bit) { false }));
    panda$core$String* $tmp45 = panda$core$String$$IDX$panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$R$panda$core$String(result39, $tmp44);
    return $tmp45;
}
