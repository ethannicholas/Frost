...
void panda$io$File$init$panda$core$String(panda$io$File* self, panda$core$String* p_path) {
    {
        panda$core$Object* $tmp1 = panda$core$Panda$ref$panda$core$Object$R$panda$core$Object(((panda$core$Object*) p_path));
        self->path = ((panda$core$String*) $tmp1);
    }
}
...
panda$core$String* panda$io$File$simpleName$R$panda$core$String(panda$io$File* self) {
    ...
    panda$core$String$Index$nullable index43;
    panda$core$Range$LTpanda$core$String$Index$Q$GT $tmp46;
    panda$core$String* $tmp41 = panda$io$File$name$R$panda$core$String(self);
    panda$core$Object* $tmp42 = panda$core$Panda$ref$panda$core$Object$R$panda$core$Object(((panda$core$Object*) $tmp41));
    result40 = ((panda$core$String*) $tmp42);
    panda$core$String$Index$nullable $tmp45 = panda$core$String$lastIndexOf$panda$core$String$R$panda$core$String$Index$Q(result40, &$s44);
    index43 = $tmp45;
    if (((panda$core$Bit) { !index43.nonnull }).value) {
    {
        return result40;
    }
    }
    panda$core$Range$LTpanda$core$String$Index$Q$GT$init$panda$core$String$Index$Q$panda$core$String$Index$Q$panda$core$Bit(&$tmp46, ((panda$core$String$Index$nullable) { .nonnull = false }), index43, ((panda$core$Bit) { false }));
    panda$core$String* $tmp47 = panda$core$String$$IDX$panda$core$Range$LTpanda$core$String$Index$Q$GT$R$panda$core$String(result40, $tmp46);
    return $tmp47;
}
...
void panda$io$File$createDirectories(panda$io$File* self) {
    ...
    panda$core$Object* $tmp54 = panda$core$Panda$ref$panda$core$Object$R$panda$core$Object(((panda$core$Object*) $tmp53));
    p52 = ((panda$io$File*) $tmp54);
    bool $tmp55 = ((panda$core$Bit) { p52 != NULL }).value;
    if (!$tmp55) goto $l56;
    panda$io$File$exists$R$panda$core$Bit(&$tmp57, p52);
