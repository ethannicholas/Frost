...
panda$json$JSON* panda$json$JSON$get$panda$core$String$R$panda$json$JSON$Q(panda$json$JSON* self, panda$core$String* p_path) {
                    ...
                    int $tmp159;
                    {
                        ...
                        if ($tmp163.value) {
                        {
                            ...
                            nodes164 = *$tmp165;
                            {
                                ...
                                panda$core$Panda$unref$panda$core$Object$Q($tmp168);
    ...
    $l82:;
    panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) current89));
    current89 = NULL;
    switch ($tmp84) {
        case 2: goto $l173;
        case 1: goto $l148;
...
panda$core$Int64$nullable panda$json$JSON$getInt$panda$core$String$R$panda$core$Int64$Q(panda$json$JSON* self, panda$core$String* p_path) {
    ...
    goto $l185;
    $l185:;
    panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) result188));
    result188 = NULL;
    switch ($tmp187) {
        case -1: goto $l212;
        case 1: goto $l206;
...
panda$core$Bit$nullable panda$json$JSON$getBit$panda$core$String$R$panda$core$Bit$Q(panda$json$JSON* self, panda$core$String* p_path) {
    ...
    goto $l249;
    $l249:;
    panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) result252));
    result252 = NULL;
    switch ($tmp251) {
        case -1: goto $l276;
        case 2: goto $l273;
...
panda$core$String* panda$json$JSON$getString$panda$core$String$R$panda$core$String$Q(panda$json$JSON* self, panda$core$String* p_path) {
    ...
    goto $l281;
    $l281:;
    panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) result284));
    result284 = NULL;
    switch ($tmp283) {
        case 2: goto $l308;
        case -1: goto $l311;
...
panda$collections$ListView* panda$json$JSON$getArray$panda$core$String$R$panda$collections$ListView$LTpanda$json$JSON$GT$Q(panda$json$JSON* self, panda$core$String* p_path) {
    ...
    goto $l316;
    $l316:;
    panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) result319));
    result319 = NULL;
    switch ($tmp318) {
        case -1: goto $l346;
        case 1: goto $l339;
...
panda$collections$MapView* panda$json$JSON$getObject$panda$core$String$R$panda$collections$MapView$LTpanda$core$String$Cpanda$json$JSON$GT$Q(panda$json$JSON* self, panda$core$String* p_path) {
    ...
    goto $l351;
    $l351:;
    panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) result354));
    result354 = NULL;
    switch ($tmp353) {
        case 2: goto $l378;
        case 0: goto $l361;
...
panda$core$String* panda$json$JSON$convert$R$panda$core$String(panda$json$JSON* self) {
    ...
    int $tmp553;
    {
        ...
        if ($tmp595.value) {
        {
            ...
            int $tmp600;
            {
                ...
                panda$core$Panda$ref$panda$core$Object$Q(((panda$core$Object*) $tmp607));
                {
                    int $tmp611;
                    {
                        ...
                        if (!$tmp618) goto $l617;
                        {
                            int $tmp626;
                            {
                                ...
                                panda$core$Panda$unref$panda$core$Object$Q($tmp652);
                            ...
                            goto $l624;
                            $l624:;
                            panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) k627));
                            k627 = NULL;
                            switch ($tmp626) {
                                case -1: goto $l660;
                            }
                    ...
                    goto $l609;
                    $l609:;
                    panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) Iter$322$17612));
                    Iter$322$17612 = NULL;
                    switch ($tmp611) {
                        case -1: goto $l661;
                    }
            ...
            $l598:;
            panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) separator606));
            panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) result601));
            result601 = NULL;
            separator606 = NULL;
            switch ($tmp600) {
                case 0: goto $l666;
        ...
        if ($tmp671.value) {
        {
                ...
                panda$core$Panda$ref$panda$core$Object$Q(((panda$core$Object*) $tmp683));
                {
                    int $tmp687;
                    {
                        ...
                        if (!$tmp697) goto $l696;
                        {
                            ...
                            goto $l703;
                            $l703:;
                            panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) n706));
                            n706 = NULL;
                            switch ($tmp705) {
                                case -1: goto $l726;
                            }
                    ...
                    goto $l685;
                    $l685:;
                    panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) Iter$331$17688));
                    Iter$331$17688 = NULL;
                    switch ($tmp687) {
                        case -1: goto $l727;
                    }
            ...
            $l674:;
            panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) separator682));
            panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) result677));
            result677 = NULL;
            separator682 = NULL;
            switch ($tmp676) {
                case 0: goto $l733;
    ...
    int $tmp754;
    {
        int $tmp757;
        {
            ...
            if ($tmp769.value) {
            {
                ...
                _f0770 = *$tmp771;
                panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) _f0770));
            }
            }
            else {
            ...
            if ($tmp777.value) {
            {
                ...
                _f0778 = *$tmp779;
                panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) _f0778));
            }
            }
            else {
            ...
            if ($tmp781.value) {
            {
                ...
                _f0782 = *$tmp783;
                panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) _f0782));
            }
            }
            else {
...
void panda$json$JSON$init$panda$core$Int64$panda$core$String(panda$json$JSON* self, panda$core$Int64 p_rv, panda$core$String* p_f0) {
    ...
    self->$rawValue = p_rv;
    {
        ...
        $tmp793 = p_f0;
        *$tmp792 = $tmp793;
        panda$core$Panda$ref$panda$core$Object$Q(((panda$core$Object*) $tmp793));
