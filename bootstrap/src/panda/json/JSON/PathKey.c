...
void panda$json$JSON$PathKey$cleanup(panda$json$JSON$PathKey* self) {
    ...
    int $tmp11;
    {
        int $tmp14;
        {
            ...
            panda$core$Bit $tmp17 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit($match$15_515->$rawValue, ((panda$core$Int64) { 0 }));
            if ($tmp17.value) {
            {
                panda$core$String** $tmp19 = ((panda$core$String**) ((char*) $match$15_515->$data + 0));
                _f018 = *$tmp19;
                panda$core$String$Index* $tmp21 = ((panda$core$String$Index*) ((char*) $match$15_515->$data + 8));
                _f120 = *$tmp21;
                panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) _f018));
            }
            }
            else {
            panda$core$Bit $tmp22 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit($match$15_515->$rawValue, ((panda$core$Int64) { 1 }));
            if ($tmp22.value) {
            {
                panda$core$Int64* $tmp24 = ((panda$core$Int64*) ((char*) $match$15_515->$data + 0));
                _f023 = *$tmp24;
                panda$core$String$Index* $tmp26 = ((panda$core$String$Index*) ((char*) $match$15_515->$data + 8));
                _f125 = *$tmp26;
            }
            }
            }
