...
typedef panda$core$Bit (*$fn25)(panda$collections$HashMap$EntryIterator*);
...
static panda$core$String $s30 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x48\x61\x73\x68\x4d\x61\x70\x2e\x70\x61\x6e\x64\x61", 13, 1817269292024755533, NULL };
...
static panda$core$String $s37 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x48\x61\x73\x68\x4d\x61\x70\x2e\x70\x61\x6e\x64\x61", 13, 1817269292024755533, NULL };
static panda$core$String $s41 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x48\x61\x73\x68\x4d\x61\x70\x2e\x70\x61\x6e\x64\x61", 13, 1817269292024755533, NULL };
static panda$core$String $s62 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x48\x61\x73\x68\x4d\x61\x70\x2e\x70\x61\x6e\x64\x61", 13, 1817269292024755533, NULL };
...
void panda$collections$HashMap$EntryIterator$init$panda$collections$HashMap$LTpanda$collections$HashMap$EntryIterator$K$Cpanda$collections$HashMap$EntryIterator$V$GT(panda$collections$HashMap$EntryIterator* self, panda$collections$HashMap* p_map) {
    ...
    panda$collections$HashMap$EntryIterator* $tmp13;
    panda$core$Int64 $tmp14;
    panda$collections$HashMap$Entry* $tmp17;
    panda$collections$HashMap$Entry* $tmp18;
    self->map = NULL;
    self->entry = NULL;
...
panda$collections$HashMap$Entry* panda$collections$HashMap$EntryIterator$next$R$panda$collections$HashMap$Entry$LTpanda$collections$HashMap$EntryIterator$K$Cpanda$collections$HashMap$EntryIterator$V$GT(panda$collections$HashMap$EntryIterator* self) {
    panda$collections$HashMap$Entry* result42 = NULL;
    panda$collections$HashMap$Entry* $tmp43;
    panda$collections$HashMap$Entry* $tmp44;
    panda$collections$HashMap$Entry* $tmp45;
    panda$collections$HashMap$EntryIterator* $tmp49;
    panda$core$Int64 $tmp50;
    panda$collections$HashMap$Entry* $tmp53;
    panda$collections$HashMap$Entry* $tmp54;
    panda$collections$HashMap$Entry* $returnValue55;
    panda$collections$HashMap$Entry* $tmp56;
    ...
    $l29:;
    panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64$panda$core$String(&$s30, (panda$core$Int64) { 62 }, &$s31);
    abort();
    $l28:;
    int $tmp34;
    {
        ...
        $l36:;
        panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64(&$s37, (panda$core$Int64) { 63 });
        abort();
        $l35:;
        ...
        $l40:;
        panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64(&$s41, (panda$core$Int64) { 64 });
        abort();
        $l39:;
        $tmp43 = self->entry;
        result42 = $tmp43;
    ...
    $l61:;
    panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64$panda$core$String(&$s62, (panda$core$Int64) { 62 }, &$s63);
    abort();
    $l60:;
    abort();
}
