...
struct { panda$core$Class* cl; ITable* next; void* methods[5]; } panda$collections$MapView$_panda$collections$MapView = { (panda$core$Class*) &panda$collections$MapView$class, NULL, { NULL, NULL, NULL, NULL, NULL} };
