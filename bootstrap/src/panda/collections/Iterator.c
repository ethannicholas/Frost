    ...
    int $tmp112;
    {
        int $tmp115;
        {
            ...
            panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) $tmp118));
            {
                int $tmp122;
                {
                    ...
                    if (!$tmp127) goto $l126;
                    {
                        int $tmp135;
                        {
                            ...
                            $tmp137 = $tmp138;
                            v136 = $tmp137;
                            panda$core$Panda$ref$panda$core$Object($tmp137);
                        ...
                        goto $l133;
                        $l133:;
                        panda$core$Panda$unref$panda$core$Object(v136);
                        v136 = NULL;
                        switch ($tmp135) {
                            case -1: goto $l143;
                        }
                ...
                goto $l120;
                $l120:;
                panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) Iter$193$9123));
                Iter$193$9123 = NULL;
                switch ($tmp122) {
                    case -1: goto $l144;
                }
        ...
        $l113:;
        panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) result116));
        result116 = NULL;
        switch ($tmp115) {
            case 0: goto $l147;
        }
    ...
    {
        {
            int $tmp169;
            {
                ...
                if (!$tmp174) goto $l173;
                {
                    int $tmp182;
                    {
                        ...
                        $tmp184 = $tmp185;
                        v183 = $tmp184;
                        panda$core$Panda$ref$panda$core$Object($tmp184);
                    ...
                    goto $l180;
                    $l180:;
                    panda$core$Panda$unref$panda$core$Object(v183);
                    v183 = NULL;
                    switch ($tmp182) {
                        case -1: goto $l192;
                    }
            ...
            goto $l167;
            $l167:;
            panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) Iter$210$9170));
            Iter$210$9170 = NULL;
            switch ($tmp169) {
                case -1: goto $l193;
            }
...
panda$core$Object* panda$collections$Iterator$fold$$LPpanda$collections$Iterator$T$Cpanda$collections$Iterator$T$RP$EQ$GT$LPpanda$collections$Iterator$T$RP$R$panda$collections$Iterator$T(panda$collections$Iterator* self, panda$core$MutableMethod* p_f) {
    ...
    int $tmp205;
    {
        ...
        int $tmp217;
        {
            ...
            panda$core$Panda$ref$panda$core$Object($tmp245);
            $tmp217 = 0;
            goto $l215;
            $l246:;
            $tmp205 = 0;
        ...
        $l215:;
        panda$core$Panda$unref$panda$core$Object(result218);
        result218 = NULL;
        switch ($tmp217) {
            case 0: goto $l246;
        }
...
panda$core$Object* panda$collections$Iterator$fold$$LPpanda$collections$Iterator$T$Cpanda$collections$Iterator$T$RP$EQ$GT$LPpanda$collections$Iterator$T$RP$panda$collections$Iterator$T$R$panda$collections$Iterator$T(panda$collections$Iterator* self, panda$core$MutableMethod* p_f, panda$core$Object* p_start) {
    ...
    int $tmp265;
    {
        int $tmp268;
        {
            $tmp270 = p_start;
            result269 = $tmp270;
            panda$core$Panda$ref$panda$core$Object($tmp270);
            $l271:;
            ...
            {
                {
                    ...
                    $tmp280 = $tmp281;
                    result269 = $tmp280;
                    panda$core$Panda$ref$panda$core$Object($tmp280);
            ...
            panda$core$Panda$ref$panda$core$Object($tmp291);
            $tmp268 = 0;
            goto $l266;
            $l292:;
            $tmp265 = 0;
        ...
        $l266:;
        panda$core$Panda$unref$panda$core$Object(result269);
        result269 = NULL;
        switch ($tmp268) {
            case 0: goto $l292;
        }
