...
panda$collections$Iterator* panda$collections$Iterator$$IDX$panda$core$Range$LTpanda$core$Int64$Q$GT$R$panda$collections$Iterator$LTpanda$collections$Iterator$T$GT(panda$collections$Iterator* self, panda$core$Range$LTpanda$core$Int64$Q$GT p_range) {
    ...
    $l70:;
    panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64$panda$core$String(&$s71, (panda$core$Int64) { 164 }, &$s72);
    abort();
    $l69:;
...
panda$collections$Iterator* panda$collections$Iterator$$IDX$panda$core$SteppedRange$LTpanda$core$Int64$Q$Cpanda$core$Int64$GT$R$panda$collections$Iterator$LTpanda$collections$Iterator$T$GT(panda$collections$Iterator* self, panda$core$SteppedRange$LTpanda$core$Int64$Q$Cpanda$core$Int64$GT p_range) {
    ...
    $l98:;
    panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64$panda$core$String(&$s99, (panda$core$Int64) { 181 }, &$s100);
    abort();
    $l97:;
...
panda$collections$Array* panda$collections$Iterator$all$R$panda$collections$Array$LTpanda$collections$Iterator$T$GT(panda$collections$Iterator* self) {
    ...
    panda$collections$Iterator* Iter$193$9119 = NULL;
    ...
    int $tmp108;
    {
        int $tmp111;
        {
            ...
            panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) $tmp114));
            {
                ...
                goto $l116;
                $l116:;
                panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) Iter$193$9119));
                Iter$193$9119 = NULL;
                switch ($tmp118) {
                    case -1: goto $l140;
                }
    ...
    $l153:;
    panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64$panda$core$String(&$s154, (panda$core$Int64) { 191 }, &$s155);
    abort();
    $l152:;
    switch ($tmp108) {
        case -1: goto $l147;
...
void panda$collections$Iterator$apply$$LPpanda$collections$Iterator$T$RP$EQ$AM$GT$LP$RP(panda$collections$Iterator* self, panda$core$MutableMethod* p_m) {
    panda$collections$Iterator* Iter$210$9162 = NULL;
    ...
    {
        {
            ...
            goto $l159;
            $l159:;
            panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) Iter$210$9162));
            Iter$210$9162 = NULL;
            switch ($tmp161) {
                case -1: goto $l185;
            }
    ...
    $l192:;
    panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64$panda$core$String(&$s193, (panda$core$Int64) { 209 }, &$s194);
    abort();
    $l191:;
    switch ($tmp158) {
        case -1: goto $l186;
...
panda$core$Object* panda$collections$Iterator$fold$$LPpanda$collections$Iterator$T$Cpanda$collections$Iterator$T$RP$EQ$GT$LPpanda$collections$Iterator$T$RP$R$panda$collections$Iterator$T(panda$collections$Iterator* self, panda$core$MutableMethod* p_f) {
    ...
    int $tmp197;
    {
        ...
        $l204:;
        panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64$panda$core$String(&$s205, (panda$core$Int64) { 242 }, &$s206);
        abort();
        $l203:;
        int $tmp209;
        {
    ...
    $l248:;
    panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64$panda$core$String(&$s249, (panda$core$Int64) { 242 }, &$s250);
    abort();
    $l247:;
    switch ($tmp197) {
        case -1: goto $l242;
...
panda$core$Object* panda$collections$Iterator$fold$$LPpanda$collections$Iterator$T$Cpanda$collections$Iterator$T$RP$EQ$GT$LPpanda$collections$Iterator$T$RP$panda$collections$Iterator$T$R$panda$collections$Iterator$T(panda$collections$Iterator* self, panda$core$MutableMethod* p_f, panda$core$Object* p_start) {
    ...
    $l290:;
    panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64$panda$core$String(&$s291, (panda$core$Int64) { 263 }, &$s292);
    abort();
    $l289:;
    switch ($tmp253) {
        case -1: goto $l284;
