...
panda$core$Panda$ref$panda$core$Object$Q(((panda$core$Object*) &$s705));
panda$core$String* $tmp706 = *(&local1);
...
*(&local3) = $tmp766;
// line 256
panda$core$Panda$ref$panda$core$Object$Q(((panda$core$Object*) &$s768));
panda$core$String* $tmp769 = *(&local1);
