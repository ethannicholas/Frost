...
org$pandalanguage$regex$RegexToken$nullable* $tmp9 = ((org$pandalanguage$regex$RegexToken$nullable*) pandaZAlloc($tmp8 * 56));
...
block9:;
// line 81
org$pandalanguage$regex$RegexToken$nullable** $tmp142 = &param0->data;
org$pandalanguage$regex$RegexToken$nullable* $tmp143 = *$tmp142;
int64_t $tmp144 = param1.value;
$tmp143[$tmp144] = ((org$pandalanguage$regex$RegexToken$nullable) { param2, true });
return;
...
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$ensureCapacity$panda$core$Int64(param0, $tmp153);
// line 87
...
panda$core$Int64 $tmp196 = (panda$core$Int64) {1};
...
org$pandalanguage$regex$RegexToken $tmp201 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Int64$R$org$pandalanguage$regex$RegexToken(param0, $tmp200);
panda$core$Int64 $tmp202 = *(&local0);
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDXEQ$panda$core$Int64$org$pandalanguage$regex$RegexToken(param0, $tmp202, $tmp201);
goto block3;
block3:;
...
org$pandalanguage$regex$RegexToken* $tmp263 = ((org$pandalanguage$regex$RegexToken*) pandaZAlloc($tmp262 * 48));
*(&local2) = $tmp263;
// line 107
...
block3:;
// line 108
org$pandalanguage$regex$RegexToken* $tmp284 = *(&local2);
panda$core$Int64 $tmp285 = param1.min;
panda$core$Int64 $tmp286 = *(&local3);
int64_t $tmp287 = $tmp285.value;
int64_t $tmp288 = $tmp286.value;
int64_t $tmp289 = $tmp287 + $tmp288;
panda$core$Int64 $tmp290 = (panda$core$Int64) {$tmp289};
org$pandalanguage$regex$RegexToken $tmp291 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Int64$R$org$pandalanguage$regex$RegexToken(param0, $tmp290);
panda$core$Int64 $tmp292 = *(&local3);
int64_t $tmp293 = $tmp292.value;
$tmp284[$tmp293] = $tmp291;
goto block5;
block5:;
...
block4:;
// line 110
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $tmp314 = (panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT*) pandaObjectAlloc(40, (panda$core$Class*) &panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$class);
org$pandalanguage$regex$RegexToken* $tmp315 = *(&local2);
panda$core$Int64 $tmp316 = *(&local1);
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$init$panda$unsafe$Pointer$LTorg$pandalanguage$regex$RegexToken$GT$panda$core$Int64($tmp314, $tmp315, $tmp316);
...
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $tmp340 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Range$LTpanda$core$Int64$GT$R$panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT(param0, $tmp339);
...
block17:;
// line 179
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $tmp391 = *(&local3);
panda$core$Int64 $tmp392 = *(&local1);
org$pandalanguage$regex$RegexToken $tmp393 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Int64$R$org$pandalanguage$regex$RegexToken(param0, $tmp392);
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$add$org$pandalanguage$regex$RegexToken($tmp391, $tmp393);
// line 180
...
if ($tmp426) goto block24; else goto block25;
block24:;
*(&local6) = $tmp425;
goto block26;
block25:;
...
if ($tmp435) goto block30; else goto block31;
block30:;
...
if ($tmp444) goto block33; else goto block34;
block33:;
// line 191
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $tmp445 = *(&local3);
panda$core$Int64 $tmp446 = *(&local1);
org$pandalanguage$regex$RegexToken $tmp447 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Int64$R$org$pandalanguage$regex$RegexToken(param0, $tmp446);
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$add$org$pandalanguage$regex$RegexToken($tmp445, $tmp447);
goto block34;
block34:;
// line 193
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $tmp448 = *(&local3);
panda$core$Panda$ref$panda$core$Object$Q(((panda$core$Object*) $tmp448));
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $tmp449 = *(&local3);
...
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$ensureCapacity$panda$core$Int64(param0, $tmp456);
// line 199
org$pandalanguage$regex$RegexToken$nullable** $tmp457 = &param0->data;
org$pandalanguage$regex$RegexToken$nullable* $tmp458 = *$tmp457;
panda$core$Int64* $tmp459 = &param0->_count;
panda$core$Int64 $tmp460 = *$tmp459;
int64_t $tmp461 = $tmp460.value;
$tmp458[$tmp461] = ((org$pandalanguage$regex$RegexToken$nullable) { param1, true });
// line 200
...
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$ensureCapacity$panda$core$Int64(param0, $tmp479);
// line 206
...
org$pandalanguage$regex$RegexToken$nullable* $tmp494 = *$tmp493;
org$pandalanguage$regex$RegexToken $tmp495 = *(&local0);
panda$core$Int64* $tmp496 = &param0->_count;
panda$core$Int64 $tmp497 = *$tmp496;
int64_t $tmp498 = $tmp497.value;
$tmp494[$tmp498] = ((org$pandalanguage$regex$RegexToken$nullable) { $tmp495, true });
// line 208
...
block7:;
// line 221
org$pandalanguage$regex$RegexToken$nullable** $tmp541 = &param0->data;
org$pandalanguage$regex$RegexToken$nullable* $tmp542 = *$tmp541;
...
org$pandalanguage$regex$RegexToken$nullable* $tmp548 = (org$pandalanguage$regex$RegexToken$nullable*) pandaRealloc($tmp542, $tmp546 * 8, $tmp547 * 8);
org$pandalanguage$regex$RegexToken$nullable** $tmp549 = &param0->data;
*$tmp549 = $tmp548;
return;
...
panda$collections$Iterator* panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$iterator$R$panda$collections$Iterator$LTorg$pandalanguage$regex$RegexToken$GT(panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* param0) {

// line 231
panda$collections$SpecializedArrayIterator$LTorg$pandalanguage$regex$RegexToken$GT* $tmp552 = (panda$collections$SpecializedArrayIterator$LTorg$pandalanguage$regex$RegexToken$GT*) pandaObjectAlloc(32, (panda$core$Class*) &panda$collections$SpecializedArrayIterator$LTorg$pandalanguage$regex$RegexToken$GT$class);
panda$collections$SpecializedArrayIterator$LTorg$pandalanguage$regex$RegexToken$GT$init$panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT($tmp552, param0);
...
block4:;
// line 236
org$pandalanguage$regex$RegexToken $tmp572 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Int64$R$org$pandalanguage$regex$RegexToken(param0, param1);
*(&local1) = $tmp572;
// line 237
...
panda$core$Int64 $tmp599 = (panda$core$Int64) {1};
int64_t $tmp600 = $tmp598.value;
int64_t $tmp601 = $tmp599.value;
int64_t $tmp602 = $tmp600 + $tmp601;
panda$core$Int64 $tmp603 = (panda$core$Int64) {$tmp602};
org$pandalanguage$regex$RegexToken $tmp604 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Int64$R$org$pandalanguage$regex$RegexToken(param0, $tmp603);
panda$core$Int64 $tmp605 = *(&local2);
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDXEQ$panda$core$Int64$org$pandalanguage$regex$RegexToken(param0, $tmp605, $tmp604);
goto block8;
block8:;
...
*$tmp633 = $tmp632;
// line 241
org$pandalanguage$regex$RegexToken$nullable** $tmp634 = &param0->data;
org$pandalanguage$regex$RegexToken$nullable* $tmp635 = *$tmp634;
panda$core$Int64* $tmp636 = &param0->_count;
panda$core$Int64 $tmp637 = *$tmp636;
int64_t $tmp638 = $tmp637.value;
$tmp635[$tmp638] = ((org$pandalanguage$regex$RegexToken$nullable) { .nonnull = false });
// line 242
org$pandalanguage$regex$RegexToken $tmp639 = *(&local1);
return $tmp639;
...
block1:;
// line 249
org$pandalanguage$regex$RegexToken$nullable** $tmp663 = &param0->data;
org$pandalanguage$regex$RegexToken$nullable* $tmp664 = *$tmp663;
panda$core$Int64 $tmp665 = *(&local0);
int64_t $tmp666 = $tmp665.value;
$tmp664[$tmp666] = ((org$pandalanguage$regex$RegexToken$nullable) { .nonnull = false });
goto block3;
block3:;
...
org$pandalanguage$regex$RegexToken $tmp716 = *(&local2);
org$pandalanguage$regex$RegexToken$wrapper* $tmp717;
$tmp717 = (org$pandalanguage$regex$RegexToken$wrapper*) pandaObjectAlloc(64, (panda$core$Class*) &org$pandalanguage$regex$RegexToken$wrapperclass);
$tmp717->value = $tmp716;
