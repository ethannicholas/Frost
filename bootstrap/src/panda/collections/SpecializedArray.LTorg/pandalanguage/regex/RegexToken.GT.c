...
org$pandalanguage$regex$RegexToken $tmp202 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Int64$R$org$pandalanguage$regex$RegexToken(param0, $tmp201);
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDXEQ$panda$core$Int64$org$pandalanguage$regex$RegexToken(param0, $tmp195, $tmp202);
goto block3;
block3:;
...
org$pandalanguage$regex$RegexToken $tmp292 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Int64$R$org$pandalanguage$regex$RegexToken(param0, $tmp291);
...
org$pandalanguage$regex$RegexToken $tmp497 = *(&local0);
int64_t $tmp498 = $tmp496.value;
$tmp494[$tmp498] = ((org$pandalanguage$regex$RegexToken$nullable) { $tmp497, true });
// line 208
...
org$pandalanguage$regex$RegexToken $tmp605 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Int64$R$org$pandalanguage$regex$RegexToken(param0, $tmp604);
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDXEQ$panda$core$Int64$org$pandalanguage$regex$RegexToken(param0, $tmp598, $tmp605);
goto block8;
block8:;
