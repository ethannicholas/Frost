...
void panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$init(panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* self) {
    ...
    panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$init$panda$core$Int64(self, $tmp3);
}
...
void panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$init$panda$collections$ListView$LTorg$pandalanguage$regex$RegexToken$GT(panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* self, panda$collections$ListView* p_list) {
    ...
    org$pandalanguage$regex$RegexToken v29;
    ...
    panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$init$panda$core$Int64(self, $tmp10);
    {
        int $tmp13;
        {
            ...
            if (!$tmp23) goto $l22;
            {
                ...
                $tmp30 = $tmp34;
                v29 = ((org$pandalanguage$regex$RegexToken$wrapper*) $tmp30)->value;
                panda$core$Panda$unref$panda$core$Object($tmp30);
                panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$add$org$pandalanguage$regex$RegexToken(self, v29);
            }
            goto $l21;
            $l22:;
        }
...
org$pandalanguage$regex$RegexToken panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Int64$R$org$pandalanguage$regex$RegexToken(panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* self, panda$core$Int64 p_index) {
    ...
    org$pandalanguage$regex$RegexToken $returnValue76;
    ...
    if (!$tmp41) goto $l44;
    panda$core$Int64 $tmp45 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$get_count$R$panda$core$Int64(self);
...
void panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDXEQ$panda$core$Int64$org$pandalanguage$regex$RegexToken(panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* self, panda$core$Int64 p_index, org$pandalanguage$regex$RegexToken p_value) {
    ...
    if (!$tmp78) goto $l81;
    panda$core$Int64 $tmp82 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$get_count$R$panda$core$Int64(self);
...
void panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$insert$panda$core$Int64$org$pandalanguage$regex$RegexToken(panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* self, panda$core$Int64 p_index, org$pandalanguage$regex$RegexToken p_value) {
    ...
    panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$ensureCapacity$panda$core$Int64(self, $tmp114);
    ...
    $l124:;
    {
        ...
        org$pandalanguage$regex$RegexToken $tmp138 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Int64$R$org$pandalanguage$regex$RegexToken(self, $tmp137);
        panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDXEQ$panda$core$Int64$org$pandalanguage$regex$RegexToken(self, i118, $tmp138);
    }
    $l127:;
...
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Range$LTpanda$core$Int64$GT$R$panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT(panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* self, panda$core$Range$LTpanda$core$Int64$GT p_r) {
    ...
    org$pandalanguage$regex$RegexToken* result157;
    panda$core$Range$LTpanda$core$Int64$GT $tmp158;
    panda$core$Int64 $tmp159;
    panda$core$Bit $tmp160;
    panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $returnValue182;
    panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $tmp183;
    ...
    count155 = $tmp156;
    result157 = ((org$pandalanguage$regex$RegexToken*) pandaZAlloc(count155.value * 48));
    ...
    $l166:;
    {
        ...
        org$pandalanguage$regex$RegexToken $tmp175 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Int64$R$org$pandalanguage$regex$RegexToken(self, $tmp174);
    ...
    goto $l166;
    $l168:;
    panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $tmp185 = (panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT*) pandaObjectAlloc(40, (panda$core$Class*) &panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$class);
    panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$init$panda$unsafe$Pointer$LTorg$pandalanguage$regex$RegexToken$GT$panda$core$Int64($tmp185, result157, count155);
    $tmp184 = $tmp185;
    $tmp183 = $tmp184;
...
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Range$LTpanda$core$Int64$Q$GT$R$panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT(panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* self, panda$core$Range$LTpanda$core$Int64$Q$GT p_r) {
    ...
    panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $returnValue193;
    ...
    {
        panda$core$Int64 $tmp190 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$get_count$R$panda$core$Int64(self);
        end189 = $tmp190;
        if (p_r.inclusive.value) {
        {
    ...
    panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $tmp197 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Range$LTpanda$core$Int64$GT$R$panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT(self, $tmp196);
    $tmp195 = $tmp197;
    $tmp194 = $tmp195;
...
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$SteppedRange$LTpanda$core$Int64$Q$Cpanda$core$Int64$GT$R$panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT(panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* self, panda$core$SteppedRange$LTpanda$core$Int64$Q$Cpanda$core$Int64$GT p_r) {
    ...
    panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* result215 = NULL;
    panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $tmp216;
    ...
    panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $returnValue251;
    panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $tmp252;
    int $tmp201;
    {
        step202 = p_r.step;
        ...
        {
            panda$core$Int64 $tmp207 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$get_count$R$panda$core$Int64(self);
        ...
        if ($tmp212.value) {
        {
            panda$core$Int64 $tmp213 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$get_count$R$panda$core$Int64(self);
            end210 = $tmp213;
        }
        }
        else {
        ...
        panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $tmp218 = (panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT*) pandaObjectAlloc(40, (panda$core$Class*) &panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$class);
        panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$init($tmp218);
        $tmp217 = $tmp218;
        $tmp216 = $tmp217;
        result215 = $tmp216;
        ...
        if ($tmp220.value) {
        {
            ...
            if (!$tmp223) goto $l222;
            {
                org$pandalanguage$regex$RegexToken $tmp225 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Int64$R$org$pandalanguage$regex$RegexToken(self, current203);
                panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$add$org$pandalanguage$regex$RegexToken(result215, $tmp225);
        ...
        else {
        {
            ...
            if (!$tmp234) goto $l233;
            {
                org$pandalanguage$regex$RegexToken $tmp236 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Int64$R$org$pandalanguage$regex$RegexToken(self, current203);
                panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$add$org$pandalanguage$regex$RegexToken(result215, $tmp236);
        ...
        if (!$tmp238) goto $l246;
        panda$core$Int64 $tmp247 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$get_count$R$panda$core$Int64(self);
        ...
        if ($tmp249.value) {
        {
            org$pandalanguage$regex$RegexToken $tmp250 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Int64$R$org$pandalanguage$regex$RegexToken(self, current203);
            panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$add$org$pandalanguage$regex$RegexToken(result215, $tmp250);
        }
        }
        $tmp252 = result215;
...
void panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$add$org$pandalanguage$regex$RegexToken(panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* self, org$pandalanguage$regex$RegexToken p_value) {
    ...
    panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$ensureCapacity$panda$core$Int64(self, $tmp257);
...
void panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$addAll$panda$collections$CollectionView$LTorg$pandalanguage$regex$RegexToken$GT(panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* self, panda$collections$CollectionView* p_c) {
    ...
    org$pandalanguage$regex$RegexToken v283;
    ...
    panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$ensureCapacity$panda$core$Int64(self, $tmp264);
    {
        int $tmp267;
        {
            ...
            if (!$tmp277) goto $l276;
            {
                ...
                $tmp284 = $tmp288;
                v283 = ((org$pandalanguage$regex$RegexToken$wrapper*) $tmp284)->value;
...
void panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$ensureCapacity$panda$core$Int64(panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* self, panda$core$Int64 p_newCapacity) {
    ...
    goto $l299;
    $l300:;
    self->data = ((org$pandalanguage$regex$RegexToken*) pandaRealloc(self->data, oldCapacity298.value * 48, self->capacity.value * 48));
}
...
void panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$removeIndex$panda$core$Int64(panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* self, panda$core$Int64 p_index) {
    ...
    if (!$tmp307) goto $l310;
    panda$core$Int64 $tmp311 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$get_count$R$panda$core$Int64(self);
    ...
    $l327:;
    {
        ...
        org$pandalanguage$regex$RegexToken $tmp337 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Int64$R$org$pandalanguage$regex$RegexToken(self, $tmp336);
        panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDXEQ$panda$core$Int64$org$pandalanguage$regex$RegexToken(self, i322, $tmp337);
    }
    $l330:;
...
panda$collections$Iterator* panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$iterator$R$panda$collections$Iterator$LTorg$pandalanguage$regex$RegexToken$GT(panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* self) {
    ...
    panda$collections$SpecializedArrayIterator$LTorg$pandalanguage$regex$RegexToken$GT* $tmp348;
    panda$collections$SpecializedArrayIterator$LTorg$pandalanguage$regex$RegexToken$GT* $tmp349 = (panda$collections$SpecializedArrayIterator$LTorg$pandalanguage$regex$RegexToken$GT*) pandaObjectAlloc(32, (panda$core$Class*) &panda$collections$SpecializedArrayIterator$LTorg$pandalanguage$regex$RegexToken$GT$class);
    panda$collections$SpecializedArrayIterator$LTorg$pandalanguage$regex$RegexToken$GT$init$panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT($tmp349, self);
    $tmp348 = $tmp349;
...
panda$core$String* panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$convert$R$panda$core$String(panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* self) {
    ...
    org$pandalanguage$regex$RegexToken v382;
        ...
        panda$core$Panda$ref$panda$core$Object(((panda$core$Object*) $tmp362));
        {
            int $tmp366;
            {
                ...
                if (!$tmp376) goto $l375;
                {
                    ...
                    $tmp383 = $tmp387;
                    v382 = ((org$pandalanguage$regex$RegexToken$wrapper*) $tmp383)->value;
                    ...
                    {
                        org$pandalanguage$regex$RegexToken$wrapper* $tmp392;
                        $tmp392 = (org$pandalanguage$regex$RegexToken$wrapper*) pandaObjectAlloc(64, (panda$core$Class*) &org$pandalanguage$regex$RegexToken$wrapperclass);
                        $tmp392->value = v382;
