...
void panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$init$panda$core$Int64(panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT* self, panda$core$Int64 p_capacity) {
    ...
    self->data = ((org$pandalanguage$pandac$parser$Token$nullable*) pandaZAlloc(p_capacity.value * 49));
}
...
void panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$init$panda$unsafe$Pointer$LTorg$pandalanguage$pandac$parser$Token$GT$panda$core$Int64(panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT* self, org$pandalanguage$pandac$parser$Token* p_data, panda$core$Int64 p_count) {
    ...
    self->_count = $tmp37;
    self->data = ((org$pandalanguage$pandac$parser$Token$nullable*) p_data);
    self->_count = p_count;
...
org$pandalanguage$pandac$parser$Token panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$$IDX$panda$core$Int64$R$org$pandalanguage$pandac$parser$Token(panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT* self, panda$core$Int64 p_index) {
    ...
    abort();
    $l60:;
    $returnValue79 = ((org$pandalanguage$pandac$parser$Token) self->data[p_index.value].value);
...
void panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$$IDXEQ$panda$core$Int64$org$pandalanguage$pandac$parser$Token(panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT* self, panda$core$Int64 p_index, org$pandalanguage$pandac$parser$Token p_value) {
    ...
    abort();
    $l99:;
    self->data[p_index.value] = ((org$pandalanguage$pandac$parser$Token$nullable) { p_value, true });
}
...
void panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$add$org$pandalanguage$pandac$parser$Token(panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT* self, org$pandalanguage$pandac$parser$Token p_value) {
    ...
    panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT* $tmp266;
    ...
    self->data[self->_count.value] = ((org$pandalanguage$pandac$parser$Token$nullable) { p_value, true });
    $tmp266 = self;
...
void panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$addAll$panda$collections$CollectionView$LTorg$pandalanguage$pandac$parser$Token$GT(panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT* self, panda$collections$CollectionView* p_c) {
    ...
    panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT* $tmp298;
    ...
    panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$ensureCapacity$panda$core$Int64(self, $tmp273);
    {
        int $tmp276;
        {
            ...
            if (!$tmp286) goto $l285;
            {
                ...
                self->data[self->_count.value] = ((org$pandalanguage$pandac$parser$Token$nullable) { v292, true });
                $tmp298 = self;
...
void panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$ensureCapacity$panda$core$Int64(panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT* self, panda$core$Int64 p_newCapacity) {
    ...
    panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT* $tmp313;
    ...
    goto $l309;
    $l310:;
    self->data = ((org$pandalanguage$pandac$parser$Token$nullable*) pandaRealloc(self->data, oldCapacity308.value * 49, self->capacity.value * 49));
}
...
panda$collections$Iterator* panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$iterator$R$panda$collections$Iterator$LTorg$pandalanguage$pandac$parser$Token$GT(panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT* self) {
    ...
    panda$collections$SpecializedArrayIterator$LTorg$pandalanguage$pandac$parser$Token$GT* $tmp320;
    panda$collections$SpecializedArrayIterator$LTorg$pandalanguage$pandac$parser$Token$GT* $tmp321 = (panda$collections$SpecializedArrayIterator$LTorg$pandalanguage$pandac$parser$Token$GT*) pandaObjectAlloc(32, (panda$core$Class*) &panda$collections$SpecializedArrayIterator$LTorg$pandalanguage$pandac$parser$Token$GT$class);
    panda$collections$SpecializedArrayIterator$LTorg$pandalanguage$pandac$parser$Token$GT$init$panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT($tmp321, self);
    $tmp320 = $tmp321;
...
org$pandalanguage$pandac$parser$Token panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$removeIndex$panda$core$Int64$R$org$pandalanguage$pandac$parser$Token(panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT* self, panda$core$Int64 p_index) {
    ...
    org$pandalanguage$pandac$parser$Token result334;
    panda$core$Range$LTpanda$core$Int64$GT $tmp336;
    panda$core$Int64 $tmp337;
    panda$core$Bit $tmp339;
    panda$core$Int64 $tmp353;
    panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT* $tmp362;
    panda$core$Int64 $tmp363;
    org$pandalanguage$pandac$parser$Token $returnValue365;
    ...
    if (!$tmp323) goto $l326;
    panda$core$Int64 $tmp327 = panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$get_count$R$panda$core$Int64(self);
    ...
    abort();
    $l330:;
    org$pandalanguage$pandac$parser$Token $tmp335 = panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$$IDX$panda$core$Int64$R$org$pandalanguage$pandac$parser$Token(self, p_index);
    result334 = $tmp335;
    ...
    $l345:;
    {
        ...
        org$pandalanguage$pandac$parser$Token $tmp355 = panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$$IDX$panda$core$Int64$R$org$pandalanguage$pandac$parser$Token(self, $tmp354);
        panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$$IDXEQ$panda$core$Int64$org$pandalanguage$pandac$parser$Token(self, i340, $tmp355);
    }
    $l348:;
    ...
    self->data[self->_count.value] = ((org$pandalanguage$pandac$parser$Token$nullable) { .nonnull = false });
...
void panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$clear(panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT* self) {
    ...
    $l376:;
    {
        self->data[i371.value] = ((org$pandalanguage$pandac$parser$Token$nullable) { .nonnull = false });
    }
    $l379:;
...
panda$core$String* panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$convert$R$panda$core$String(panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT* self) {
    ...
    org$pandalanguage$pandac$parser$Token v420;
        ...
        panda$core$Panda$ref$panda$core$Object$Q(((panda$core$Object*) $tmp400));
        {
            int $tmp404;
            {
                ...
                if (!$tmp414) goto $l413;
                {
                    ...
                    $tmp421 = $tmp425;
                    v420 = ((org$pandalanguage$pandac$parser$Token$wrapper*) $tmp421)->value;
                    ...
                    {
                        org$pandalanguage$pandac$parser$Token$wrapper* $tmp430;
                        $tmp430 = (org$pandalanguage$pandac$parser$Token$wrapper*) pandaObjectAlloc(64, (panda$core$Class*) &org$pandalanguage$pandac$parser$Token$wrapperclass);
                        $tmp430->value = v420;
