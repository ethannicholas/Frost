...
org$pandalanguage$pandac$parser$Token $tmp201 = panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$$IDX$panda$core$Int64$R$org$pandalanguage$pandac$parser$Token(param0, $tmp200);
panda$core$Int64 $tmp202 = *(&local0);
panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$$IDXEQ$panda$core$Int64$org$pandalanguage$pandac$parser$Token(param0, $tmp202, $tmp201);
goto block3;
block3:;
...
org$pandalanguage$pandac$parser$Token $tmp291 = panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$$IDX$panda$core$Int64$R$org$pandalanguage$pandac$parser$Token(param0, $tmp290);
...
org$pandalanguage$pandac$parser$Token $tmp495 = *(&local0);
panda$core$Int64* $tmp496 = &param0->_count;
panda$core$Int64 $tmp497 = *$tmp496;
int64_t $tmp498 = $tmp497.value;
$tmp494[$tmp498] = ((org$pandalanguage$pandac$parser$Token$nullable) { $tmp495, true });
// line 208
...
org$pandalanguage$pandac$parser$Token $tmp604 = panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$$IDX$panda$core$Int64$R$org$pandalanguage$pandac$parser$Token(param0, $tmp603);
panda$core$Int64 $tmp605 = *(&local2);
panda$collections$SpecializedArray$LTorg$pandalanguage$pandac$parser$Token$GT$$IDXEQ$panda$core$Int64$org$pandalanguage$pandac$parser$Token(param0, $tmp605, $tmp604);
goto block8;
block8:;
