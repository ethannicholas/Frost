...
static panda$core$String $s33 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x49\x6d\x6d\x75\x74\x61\x62\x6c\x65\x48\x61\x73\x68\x4d\x61\x70\x2e\x70\x61\x6e\x64\x61", 22, -2445868376336884971, NULL };
...
panda$collections$ImmutableHashMap$Entry* panda$collections$ImmutableHashMap$EntryIterator$next$R$panda$collections$ImmutableHashMap$Entry$LTpanda$collections$ImmutableHashMap$EntryIterator$K$Cpanda$collections$ImmutableHashMap$EntryIterator$V$GT(panda$collections$ImmutableHashMap$EntryIterator* self) {
    panda$collections$ImmutableHashMap$Entry* result34 = NULL;
    panda$collections$ImmutableHashMap$Entry* $tmp35;
    panda$collections$ImmutableHashMap$Entry* $tmp36;
    panda$collections$ImmutableHashMap$Entry* $tmp37;
    panda$core$Int64 $tmp41;
    panda$collections$ImmutableHashMap$Entry* $tmp44;
    panda$collections$ImmutableHashMap$Entry* $tmp45;
    panda$collections$ImmutableHashMap$Entry* $returnValue46;
    panda$collections$ImmutableHashMap$Entry* $tmp47;
    int $tmp26;
    {
        if (((panda$core$Bit) { self->entry != NULL }).value) goto $l27; else goto $l28;
        $l28:;
        panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64(&$s29, (panda$core$Int64) { 55 });
        abort();
        $l27:;
        ...
        $l32:;
        panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64(&$s33, (panda$core$Int64) { 56 });
        abort();
        $l31:;
        $tmp35 = self->entry;
        result34 = $tmp35;
