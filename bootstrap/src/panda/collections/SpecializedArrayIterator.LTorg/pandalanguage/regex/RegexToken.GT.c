...
*$tmp33 = $tmp32;
// line 25
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT** $tmp34 = &param0->array;
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $tmp35 = *$tmp34;
...
org$pandalanguage$regex$RegexToken $tmp43 = panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$$IDX$panda$core$Int64$R$org$pandalanguage$regex$RegexToken($tmp35, $tmp42);
return $tmp43;
...
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT** $tmp44 = &param0->array;
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $tmp45 = *$tmp44;
