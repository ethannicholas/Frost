...
__attribute__((weak)) panda$collections$Iterator* panda$collections$ImmutableArray$get_iterator$R$panda$collections$Iterator$LTpanda$collections$ImmutableArray$T$GT$shim(panda$collections$ImmutableArray* p0) {
    panda$collections$Iterator* result = panda$collections$ImmutableArray$get_iterator$R$panda$collections$Iterator$LTpanda$collections$ImmutableArray$T$GT(p0);
...
struct { panda$core$Class* cl; ITable* next; void* methods[1]; } panda$collections$ImmutableArray$_panda$collections$Iterable = { (panda$core$Class*) &panda$collections$Iterable$class, NULL, { panda$collections$ImmutableArray$get_iterator$R$panda$collections$Iterator$LTpanda$collections$ImmutableArray$T$GT$shim} };
...
static panda$core$String $s158 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x49\x6d\x6d\x75\x74\x61\x62\x6c\x65\x41\x72\x72\x61\x79\x2e\x66\x72\x6f\x73\x74", 20, -475546343703461448, NULL };
...
static panda$core$String $s177 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x49\x6d\x6d\x75\x74\x61\x62\x6c\x65\x41\x72\x72\x61\x79\x2e\x66\x72\x6f\x73\x74", 20, -475546343703461448, NULL };
static panda$core$String $s185 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x49\x6d\x6d\x75\x74\x61\x62\x6c\x65\x41\x72\x72\x61\x79\x2e\x66\x72\x6f\x73\x74", 20, -475546343703461448, NULL };
static panda$core$String $s186 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "", 107, 7888719971458596045, NULL };
static panda$core$String $s193 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x5b", 1, 192, NULL };
...
static panda$core$String $s213 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x2c\x20", 2, 14677, NULL };
static panda$core$String $s215 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x2c\x20", 2, 14677, NULL };
static panda$core$String $s222 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x3c\x6e\x75\x6c\x6c\x3e", 6, 1703694482666, NULL };
static panda$core$String $s225 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x5d", 1, 194, NULL };
...
panda$core$Immutable** $tmp6 = ((panda$core$Immutable**) frostAlloc($tmp5 * 8));
...
panda$core$Immutable** $tmp16 = ((panda$core$Immutable**) frostAlloc($tmp15 * 8));
...
panda$core$Immutable** $tmp81 = (panda$core$Immutable**) frostRealloc(((panda$core$Immutable**) $tmp74), $tmp79 * 8, $tmp80 * 8);
panda$core$Object*** $tmp82 = &param0->data;
*$tmp82 = ((panda$core$Object**) $tmp81);
// line 68
panda$collections$ImmutableArray* $tmp83 = (panda$collections$ImmutableArray*) frostObjectAlloc(40, (panda$core$Class*) &panda$collections$ImmutableArray$class);
...
if ($tmp183) goto block11; else goto block12;
block12:;
panda$core$Int64 $tmp184 = (panda$core$Int64) {84};
...
// line 89
panda$core$Int64* $tmp187 = &param0->_count;
panda$core$Int64 $tmp188 = *$tmp187;
return $tmp188;

}
panda$collections$Iterator* panda$collections$ImmutableArray$get_iterator$R$panda$collections$Iterator$LTpanda$collections$ImmutableArray$T$GT(panda$collections$ImmutableArray* param0) {

// line 94
panda$collections$ImmutableArray$ImmutableArrayIterator* $tmp189 = (panda$collections$ImmutableArray$ImmutableArrayIterator*) frostObjectAlloc(32, (panda$core$Class*) &panda$collections$ImmutableArray$ImmutableArrayIterator$class);
panda$collections$ImmutableArray$ImmutableArrayIterator$init$panda$collections$ImmutableArray$LTpanda$collections$ImmutableArray$ImmutableArrayIterator$T$GT($tmp189, param0);
panda$core$Panda$ref$panda$core$Object$Q(((panda$core$Object*) ((panda$collections$Iterator*) $tmp189)));
...
return ((panda$collections$Iterator*) $tmp189);
...
// line 99
panda$core$MutableString* $tmp190 = (panda$core$MutableString*) frostObjectAlloc(48, (panda$core$Class*) &panda$core$MutableString$class);
panda$core$MutableString$init($tmp190);
*(&local0) = ((panda$core$MutableString*) NULL);
panda$core$Panda$ref$panda$core$Object$Q(((panda$core$Object*) $tmp190));
panda$core$MutableString* $tmp191 = *(&local0);
...
*(&local1) = &$s196;
// line 102
ITable* $tmp197 = ((panda$collections$Iterable*) param0)->$class->itable;
while ($tmp197->$class != (panda$core$Class*) &panda$collections$Iterable$class) {
    $tmp197 = $tmp197->next;
}
$fn199 $tmp198 = $tmp197->methods[0];
panda$collections$Iterator* $tmp200 = $tmp198(((panda$collections$Iterable*) param0));
goto block1;
block1:;
...
panda$core$Bit $tmp204 = $tmp202($tmp200);
bool $tmp205 = $tmp204.value;
if ($tmp205) goto block3; else goto block2;
block2:;
*(&local2) = ((panda$core$Immutable*) NULL);
ITable* $tmp206 = $tmp200->$class->itable;
while ($tmp206->$class != (panda$core$Class*) &panda$collections$Iterator$class) {
    $tmp206 = $tmp206->next;
}
$fn208 $tmp207 = $tmp206->methods[1];
panda$core$Object* $tmp209 = $tmp207($tmp200);
panda$core$Panda$ref$panda$core$Object$Q(((panda$core$Object*) ((panda$core$Immutable*) $tmp209)));
panda$core$Immutable* $tmp210 = *(&local2);
panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) $tmp210));
*(&local2) = ((panda$core$Immutable*) $tmp209);
// line 103
panda$core$MutableString* $tmp211 = *(&local0);
panda$core$String* $tmp212 = *(&local1);
panda$core$MutableString$append$panda$core$String($tmp211, $tmp212);
// line 104
...
*(&local1) = &$s215;
// line 105
panda$core$Immutable* $tmp216 = *(&local2);
panda$core$Bit $tmp217 = panda$core$Bit$init$builtin_bit(true);
bool $tmp218 = $tmp217.value;
if ($tmp218) goto block4; else goto block6;
block4:;
// line 106
panda$core$MutableString* $tmp219 = *(&local0);
panda$core$Immutable* $tmp220 = *(&local2);
panda$core$MutableString$append$panda$core$Object($tmp219, ((panda$core$Object*) $tmp220));
goto block5;
block6:;
// line 1
// line 109
...
panda$core$Immutable* $tmp223 = *(&local2);
...
panda$core$String* $tmp227 = panda$core$MutableString$finish$R$panda$core$String($tmp226);
