...
struct { panda$core$Class* cl; ITable* next; void* methods[1]; } panda$collections$Map$_panda$collections$MapWriter = { (panda$core$Class*) &panda$collections$MapWriter$class, NULL, { NULL} };
