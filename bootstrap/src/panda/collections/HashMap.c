...
static panda$core$String $s748 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "", 0, 1, NULL };
...
// unreffing REF($87:panda.collections.HashMap.Entry<panda.collections.HashMap.K, panda.collections.HashMap.V>)
// line 224
...
panda$collections$HashMap$Entry* $tmp302 = *(&local1);
...
panda$collections$HashMap$Entry* $tmp341 = *(&local1);
panda$collections$HashMap$Entry** $tmp342 = &$tmp341->next;
panda$collections$HashMap$Entry* $tmp343 = *$tmp342;
...
block12:;
panda$core$Int64 $tmp383 = (panda$core$Int64) {262};
...
panda$collections$Key** $tmp659 = &$tmp658->key;
panda$collections$Key* $tmp660 = *$tmp659;
panda$collections$HashMap$Entry* $tmp661 = *(&local4);
panda$core$Object** $tmp662 = &$tmp661->value;
panda$core$Object* $tmp663 = *$tmp662;
panda$collections$HashMap$$IDXEQ$panda$collections$HashMap$K$panda$collections$HashMap$V(param0, $tmp660, $tmp663);
// line 303
...
panda$core$Panda$ref$panda$core$Object$Q(((panda$core$Object*) &$s748));
...
*(&local3) = $tmp809;
// line 359
panda$core$Panda$ref$panda$core$Object$Q(((panda$core$Object*) &$s811));
panda$core$String* $tmp812 = *(&local1);
...
// unreffing REF($2:panda.collections.ImmutableHashMap<panda.collections.HashMap.K, panda.collections.HashMap.V>)
// line 374
