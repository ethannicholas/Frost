...
void panda$collections$ImmutableHashMap$cleanup(panda$collections$ImmutableHashMap* self) {
    ...
    int $tmp7;
    {
        ...
        $l16:;
        {
            ...
            {
                panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) self->contents[i11.value]));
            }
            }
        }
        $l19:;
...
panda$core$Object* panda$collections$ImmutableHashMap$$IDX$panda$collections$ImmutableHashMap$K$R$panda$collections$ImmutableHashMap$V$Q(panda$collections$ImmutableHashMap* self, panda$collections$Key* p_key) {
    ...
    int $tmp56;
    {
        ...
        if (((panda$core$Bit) { e65 != NULL }).value) {
        {
            $tmp79 = e65->value;
            $returnValue59 = $tmp79;
            panda$core$Panda$ref$panda$core$Object$Q($tmp79);
            $tmp56 = 1;
            goto $l54;
            $l80:;
            return $returnValue59;
    ...
    goto $l54;
    $l54:;
    panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) e65));
    e65 = NULL;
    switch ($tmp56) {
        case 1: goto $l80;
        case 2: goto $l83;
...
panda$core$Bit panda$collections$ImmutableHashMap$contains$panda$collections$ImmutableHashMap$K$R$panda$core$Bit(panda$collections$ImmutableHashMap* self, panda$collections$Key* p_key) {
    ...
    $l90:;
    panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) e101));
    e101 = NULL;
    switch ($tmp92) {
        case 1: goto $l115;
        case 0: goto $l97;
...
panda$core$String* panda$collections$ImmutableHashMap$convert$R$panda$core$String(panda$collections$ImmutableHashMap* self) {
    ...
    int $tmp136;
    {
        ...
        $l154:;
        {
            ...
            goto $l162;
            $l162:;
            panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) entry165));
            entry165 = NULL;
            switch ($tmp164) {
                case -1: goto $l179;
            }
    ...
    $l134:;
    panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) separator143));
    panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) result137));
    result137 = NULL;
    separator143 = NULL;
    switch ($tmp136) {
        case 0: goto $l192;
