...
// line 48
panda$threads$Thread* $tmp2 = (panda$threads$Thread*) frostObjectAlloc(12, (panda$core$Class*) &panda$threads$Thread$class);
...
panda$threads$Thread* local0 = NULL;
// line 55
panda$threads$Thread* $tmp7 = (panda$threads$Thread*) frostObjectAlloc(12, (panda$core$Class*) &panda$threads$Thread$class);
...
panda$threads$Thread* local0 = NULL;
// line 62
panda$threads$Thread* $tmp13 = (panda$threads$Thread*) frostObjectAlloc(12, (panda$core$Class*) &panda$threads$Thread$class);
...
panda$threads$Thread* local0 = NULL;
// line 69
panda$threads$Thread* $tmp18 = (panda$threads$Thread*) frostObjectAlloc(12, (panda$core$Class*) &panda$threads$Thread$class);
