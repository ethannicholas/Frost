...
void panda$core$UInt64$init$builtin_uint64(panda$core$UInt64* self, int64_t p_value) {
    self->value = p_value;
}
...
panda$core$UInt64 panda$core$UInt64$$BAND$panda$core$UInt64$R$panda$core$UInt64(panda$core$UInt64 self, panda$core$UInt64 p_other) {
    int64_t $tmp30 = self.value & p_other.value;
...
panda$core$UInt64 panda$core$UInt64$$BOR$panda$core$UInt64$R$panda$core$UInt64(panda$core$UInt64 self, panda$core$UInt64 p_other) {
    int64_t $tmp38 = self.value | p_other.value;
...
panda$core$UInt64 panda$core$UInt64$$BXOR$panda$core$UInt64$R$panda$core$UInt64(panda$core$UInt64 self, panda$core$UInt64 p_other) {
    int64_t $tmp46 = self.value ^ p_other.value;
...
panda$core$UInt64 panda$core$UInt64$$SHR$panda$core$UInt64$R$panda$core$UInt64(panda$core$UInt64 self, panda$core$UInt64 p_other) {
    int64_t $tmp62 = self.value >> p_other.value;
...
panda$core$UInt64 panda$core$UInt64$min$panda$core$UInt8$R$panda$core$UInt64(panda$core$UInt64 self, panda$core$UInt8 p_other) {
    ...
    return ((panda$core$UInt64) { ((int64_t) p_other.value) });
}
...
panda$core$String* panda$core$UInt64$convert$R$panda$core$String(panda$core$UInt64 self) {
    ...
    panda$core$SimpleRange$LTpanda$core$Int64$GT $tmp146;
    ...
    panda$core$SimpleRange$LTpanda$core$Int64$GT$init$panda$core$Int64$panda$core$Int64$panda$core$Bit(&$tmp146, index121, max119, ((panda$core$Bit) { false }));
    ...
    bool $tmp158 = 1 > 0;
    if ($tmp158) goto $l156; else goto $l157;
    $l156:;
    if ($tmp151) goto $l159; else goto $l160;
    $l159:;
    if ($tmp148 <= $tmp150) goto $l152; else goto $l154;
    $l160:;
    if ($tmp148 < $tmp150) goto $l152; else goto $l154;
    $l157:;
    if ($tmp151) goto $l161; else goto $l162;
    $l161:;
    if ($tmp148 >= $tmp150) goto $l152; else goto $l154;
    $l162:;
    if ($tmp148 > $tmp150) goto $l152; else goto $l154;
    $l152:;
    {
        panda$core$Int64 $tmp164 = panda$core$Int64$$SUB$panda$core$Int64$R$panda$core$Int64(i147, index121);
        result145[$tmp164.value] = chars120[i147.value];
    }
    $l155:;
    if ($tmp158) goto $l166; else goto $l167;
    $l166:;
    int64_t $tmp168 = $tmp150 - i147.value;
    if ($tmp151) goto $l169; else goto $l170;
    $l169:;
    if ($tmp168 >= 1) goto $l165; else goto $l154;
    $l170:;
    if ($tmp168 > 1) goto $l165; else goto $l154;
    $l167:;
    int64_t $tmp172 = i147.value - $tmp150;
    if ($tmp151) goto $l173; else goto $l174;
    $l173:;
    if ($tmp172 >= -1) goto $l165; else goto $l154;
    $l174:;
    if ($tmp172 > -1) goto $l165; else goto $l154;
    $l165:;
    i147.value += 1;
