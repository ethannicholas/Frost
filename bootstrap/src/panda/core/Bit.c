...
static panda$core$String $s55 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x42\x69\x74\x2e\x70\x61\x6e\x64\x61", 9, 1819751751153946550, NULL };
static panda$core$String $s58 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x69\x6e\x76\x61\x6c\x69\x64\x20\x66\x6f\x72\x6d\x61\x74\x20\x73\x74\x72\x69\x6e\x67\x20\x27", 23, 6494996805396556951, NULL };
...
panda$core$String* panda$core$Bit$format$panda$core$String$R$panda$core$String(panda$core$Bit self, panda$core$String* p_fmt) {
    panda$collections$Array* s45 = NULL;
    ...
    int $tmp44;
    {
        panda$collections$Array* $tmp49 = panda$core$String$split$panda$core$String$R$panda$collections$Array$LTpanda$core$String$GT(p_fmt, &$s48);
        $tmp47 = $tmp49;
        $tmp46 = $tmp47;
        s45 = $tmp46;
        ...
        panda$core$Int64 $tmp50 = panda$collections$Array$get_count$R$panda$core$Int64(s45);
        panda$core$Int64$init$builtin_int64(&$tmp51, 2);
        panda$core$Bit $tmp52 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit($tmp50, $tmp51);
        if ($tmp52.value) goto $l53; else goto $l54;
        $l54:;
        panda$core$String* $tmp59 = panda$core$String$$ADD$panda$core$String$R$panda$core$String(&$s58, p_fmt);
        $tmp57 = $tmp59;
        panda$core$String* $tmp61 = panda$core$String$$ADD$panda$core$String$R$panda$core$String($tmp57, &$s60);
        $tmp56 = $tmp61;
        panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64$panda$core$String(&$s55, (panda$core$Int64) { 66 }, $tmp56);
        abort();
        $l53:;
        if (self.value) {
        {
            panda$core$Int64$init$builtin_int64(&$tmp65, 0);
            panda$core$Object* $tmp66 = panda$collections$Array$$IDX$panda$core$Int64$R$panda$collections$Array$T(s45, $tmp65);
            $tmp64 = $tmp66;
            $tmp63 = ((panda$core$String*) $tmp64);
            $returnValue62 = $tmp63;
        ...
        panda$core$Int64$init$builtin_int64(&$tmp71, 1);
        panda$core$Object* $tmp72 = panda$collections$Array$$IDX$panda$core$Int64$R$panda$collections$Array$T(s45, $tmp71);
        $tmp70 = $tmp72;
        $tmp69 = ((panda$core$String*) $tmp70);
        $returnValue62 = $tmp69;
