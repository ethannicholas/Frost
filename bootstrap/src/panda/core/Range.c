...
panda$core$Range$wrapperclass_type panda$core$Range$wrapperclass = { (panda$core$Class*) &panda$core$Class$class, 1, (panda$core$Class*) &panda$core$Value$class, NULL, { panda$core$Range$convert$R$panda$core$String$wrappershim, panda$core$Object$cleanup} };typedef void (*$fn4)(panda$core$MutableString*, panda$core$Object*);
