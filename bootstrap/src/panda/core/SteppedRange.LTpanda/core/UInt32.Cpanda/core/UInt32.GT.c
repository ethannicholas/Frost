...
void panda$core$SteppedRange$LTpanda$core$UInt32$Cpanda$core$UInt32$GT$init$panda$core$UInt32$panda$core$UInt32$panda$core$UInt32$panda$core$Bit(panda$core$SteppedRange$LTpanda$core$UInt32$Cpanda$core$UInt32$GT* self, panda$core$UInt32 p_start, panda$core$UInt32 p_end, panda$core$UInt32 p_step, panda$core$Bit p_inclusive) {
    self->start = p_start;
    self->end = p_end;
    self->step = p_step;
    self->inclusive = p_inclusive;
}
panda$core$String* panda$core$SteppedRange$LTpanda$core$UInt32$Cpanda$core$UInt32$GT$convert$R$panda$core$String(panda$core$SteppedRange$LTpanda$core$UInt32$Cpanda$core$UInt32$GT self) {
    ...
    int $tmp5;
    {
        ...
        panda$core$UInt32$wrapper* $tmp18;
        $tmp18 = (panda$core$UInt32$wrapper*) pandaObjectAlloc(16, (panda$core$Class*) &panda$core$UInt32$wrapperclass);
...
void panda$core$SteppedRange$LTpanda$core$UInt32$Cpanda$core$UInt32$GT$cleanup(panda$core$SteppedRange$LTpanda$core$UInt32$Cpanda$core$UInt32$GT self) {
}
