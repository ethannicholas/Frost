...
panda$core$SteppedRange$LTpanda$core$Int8$Cpanda$core$Int8$GT panda$core$SteppedRange$LTpanda$core$Int8$Cpanda$core$Int8$GT$init$panda$core$Int8$panda$core$Int8$panda$core$Int8$panda$core$Bit(panda$core$Int8 param0, panda$core$Int8 param1, panda$core$Int8 param2, panda$core$Bit param3) {

panda$core$SteppedRange$LTpanda$core$Int8$Cpanda$core$Int8$GT local0;
// line 43
panda$core$Int8* $tmp3 = &(&local0)->start;
*$tmp3 = param0;
// line 44
panda$core$Int8* $tmp4 = &(&local0)->end;
*$tmp4 = param1;
// line 45
panda$core$Int8* $tmp5 = &(&local0)->step;
*$tmp5 = param2;
// line 46
panda$core$Bit* $tmp6 = &(&local0)->inclusive;
*$tmp6 = param3;
panda$core$SteppedRange$LTpanda$core$Int8$Cpanda$core$Int8$GT $tmp7 = *(&local0);
return $tmp7;

}
panda$core$String* panda$core$SteppedRange$LTpanda$core$Int8$Cpanda$core$Int8$GT$convert$R$panda$core$String(panda$core$SteppedRange$LTpanda$core$Int8$Cpanda$core$Int8$GT param0) {
...
// line 52
panda$core$Int8 $tmp10 = param0.start;
...
panda$core$Int8 $tmp14 = param0.start;
panda$core$Int8$wrapper* $tmp15;
$tmp15 = (panda$core$Int8$wrapper*) frostObjectAlloc(13, (panda$core$Class*) &panda$core$Int8$wrapperclass);
$tmp15->value = $tmp14;
...
block4:;
// line 61
panda$core$Int8 $tmp22 = param0.end;
...
panda$core$Int8 $tmp26 = param0.end;
panda$core$Int8$wrapper* $tmp27;
$tmp27 = (panda$core$Int8$wrapper*) frostObjectAlloc(13, (panda$core$Class*) &panda$core$Int8$wrapperclass);
$tmp27->value = $tmp26;
...
panda$core$Int8 $tmp31 = param0.step;
panda$core$Int8$wrapper* $tmp32;
$tmp32 = (panda$core$Int8$wrapper*) frostObjectAlloc(13, (panda$core$Class*) &panda$core$Int8$wrapperclass);
$tmp32->value = $tmp31;
...
void panda$core$SteppedRange$LTpanda$core$Int8$Cpanda$core$Int8$GT$cleanup(panda$core$SteppedRange$LTpanda$core$Int8$Cpanda$core$Int8$GT param0) {
