...
static panda$core$String $s5 = { (panda$core$Class*) &panda$core$String$class, 2, (panda$core$Char8*) "\x2e\x2e\x2e", 3, 1504239, NULL };
static panda$core$String $s6 = { (panda$core$Class*) &panda$core$String$class, 2, (panda$core$Char8*) "\x2e\x2e", 2, 14893, NULL };
static panda$core$String $s8 = { (panda$core$Class*) &panda$core$String$class, 2, (panda$core$Char8*) "\x20\x62\x79\x20", 4, 138041984, NULL };
...
panda$core$String* panda$core$SteppedRange$LTpanda$core$Int64$Cpanda$core$Int64$GT$convert$R$panda$core$String(panda$core$SteppedRange$LTpanda$core$Int64$Cpanda$core$Int64$GT self) {
    ...
    if (((panda$core$Bit) { true }).value) {
    {
        ...
        $tmp4 = (panda$core$Int64$wrapper*) malloc(24);
        $tmp4->cl = (panda$core$Class*) &panda$core$Int64$wrapperclass;
        $tmp4->refCount = 1;
        $tmp4->value = self.start;
    ...
    if (((panda$core$Bit) { true }).value) {
    {
        ...
        $tmp7 = (panda$core$Int64$wrapper*) malloc(24);
    ...
    panda$core$String* $tmp10 = panda$core$MutableString$finish$R$panda$core$String(result1);
    return $tmp10;
}
