...
__attribute__((weak)) panda$core$String* panda$core$SteppedRange$LTpanda$core$String$Index$Q$Cpanda$core$Int64$GT$convert$R$panda$core$String$shim(panda$core$Object* p0) {
...
__attribute__((weak)) void panda$core$SteppedRange$LTpanda$core$String$Index$Q$Cpanda$core$Int64$GT$cleanup$shim(panda$core$Object* p0) {
...
panda$core$SteppedRange$LTpanda$core$String$Index$Q$Cpanda$core$Int64$GT panda$core$SteppedRange$LTpanda$core$String$Index$Q$Cpanda$core$Int64$GT$init$panda$core$String$Index$Q$panda$core$String$Index$Q$panda$core$Int64$panda$core$Bit(panda$core$String$Index$nullable param0, panda$core$String$Index$nullable param1, panda$core$Int64 param2, panda$core$Bit param3) {

panda$core$SteppedRange$LTpanda$core$String$Index$Q$Cpanda$core$Int64$GT local0;
// line 43
panda$core$String$Index$nullable* $tmp3 = &(&local0)->start;
*$tmp3 = param0;
// line 44
panda$core$String$Index$nullable* $tmp4 = &(&local0)->end;
*$tmp4 = param1;
// line 45
...
*$tmp6 = param3;
panda$core$SteppedRange$LTpanda$core$String$Index$Q$Cpanda$core$Int64$GT $tmp7 = *(&local0);
return $tmp7;

}
panda$core$String* panda$core$SteppedRange$LTpanda$core$String$Index$Q$Cpanda$core$Int64$GT$convert$R$panda$core$String(panda$core$SteppedRange$LTpanda$core$String$Index$Q$Cpanda$core$Int64$GT param0) {
...
// line 52
panda$core$String$Index$nullable $tmp10 = param0.start;
...
panda$core$String$Index$nullable $tmp14 = param0.start;
panda$core$Object* $tmp15;
if ($tmp14.nonnull) {
    panda$core$String$Index$wrapper* $tmp16;
    $tmp16 = (panda$core$String$Index$wrapper*) pandaObjectAlloc(24, (panda$core$Class*) &panda$core$String$Index$wrapperclass);
    $tmp16->value = ((panda$core$String$Index) $tmp14.value);
...
block4:;
// line 61
panda$core$String$Index$nullable $tmp23 = param0.end;
...
panda$core$String$Index$nullable $tmp27 = param0.end;
...
if ($tmp27.nonnull) {
    ...
    $tmp29->value = ((panda$core$String$Index) $tmp27.value);
...
void panda$core$SteppedRange$LTpanda$core$String$Index$Q$Cpanda$core$Int64$GT$cleanup(panda$core$SteppedRange$LTpanda$core$String$Index$Q$Cpanda$core$Int64$GT param0) {
