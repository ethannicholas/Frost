...
panda$core$String* panda$core$Int8$format$panda$core$String$R$panda$core$String(panda$core$Int8 self, panda$core$String* p_fmt) {
    bool $tmp213 = self.value < 0;
    panda$core$Int8 $tmp214 = panda$core$Int8$abs$R$panda$core$Int8(self);
    panda$core$UInt64 $tmp215 = panda$core$Int8$convert$R$panda$core$UInt64($tmp214);
    panda$core$String* $tmp216 = panda$core$Panda$format$panda$core$Bit$panda$core$UInt64$panda$core$UInt64$panda$core$String$R$panda$core$String(((panda$core$Bit) { $tmp213 }), $tmp215, ((panda$core$UInt64) { 255 }), p_fmt);
    return $tmp216;
}
