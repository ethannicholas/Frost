...
panda$core$String* panda$core$UInt16$format$panda$core$String$R$panda$core$String(panda$core$UInt16 self, panda$core$String* p_fmt) {
    panda$core$UInt64 $tmp216 = panda$core$UInt16$convert$R$panda$core$UInt64(self);
    panda$core$String* $tmp217 = panda$core$Panda$format$panda$core$Bit$panda$core$UInt64$panda$core$UInt64$panda$core$String$R$panda$core$String(((panda$core$Bit) { false }), $tmp216, ((panda$core$UInt64) { 65535 }), p_fmt);
    return $tmp217;
}
