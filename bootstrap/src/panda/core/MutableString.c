...
void panda$core$MutableString$append$panda$core$Char32(panda$core$MutableString* self, panda$core$Char32 p_c) {
    ...
    if (((panda$core$Bit) { $tmp25 }).value) {
    {
        ...
        panda$core$Char8$init$panda$core$UInt8(&$tmp27, ((panda$core$UInt8) { ((int8_t) value24) }));
    ...
    if (((panda$core$Bit) { $tmp29 }).value) {
    {
        ...
        panda$core$Char8$init$panda$core$UInt8(&$tmp36, ((panda$core$UInt8) { ((int8_t) $tmp38) }));
    ...
    if (((panda$core$Bit) { $tmp40 }).value) {
    {
        ...
        panda$core$Char8$init$panda$core$UInt8(&$tmp43, ((panda$core$UInt8) { ((int8_t) $tmp45) }));
    ...
    else {
    {
        ...
        panda$core$Char8$init$panda$core$UInt8(&$tmp58, ((panda$core$UInt8) { ((int8_t) $tmp60) }));
        ...
        panda$core$Char8$init$panda$core$UInt8(&$tmp62, ((panda$core$UInt8) { ((int8_t) $tmp65) }));
        ...
        panda$core$Char8$init$panda$core$UInt8(&$tmp67, ((panda$core$UInt8) { ((int8_t) $tmp70) }));
        ...
        panda$core$Char8$init$panda$core$UInt8(&$tmp72, ((panda$core$UInt8) { ((int8_t) $tmp74) }));
