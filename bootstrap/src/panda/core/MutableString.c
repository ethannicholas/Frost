...
void panda$core$MutableString$ensureCapacity$panda$core$Int64(panda$core$MutableString* self, panda$core$Int64 p_newSize) {
    ...
    oldMax126 = self->maxLength;
    $l127:;
    panda$core$Bit $tmp129 = panda$core$Int64$$LT$panda$core$Int64$R$panda$core$Bit(self->maxLength, p_newSize);
    if (!$tmp129.value) goto $l128;
    {
        panda$core$Int64 $tmp130 = panda$core$Int64$$MUL$panda$core$Int64$R$panda$core$Int64(self->maxLength, ((panda$core$Int64) { 2 }));
        self->maxLength = $tmp130;
    }
    goto $l127;
    $l128:;
    self->data = ((panda$core$Char8*) pandaRealloc(self->data, oldMax126.value * 1, self->maxLength.value * 1));
}
...
panda$core$String* panda$core$MutableString$convert$R$panda$core$String(panda$core$MutableString* self) {
    ...
    int64_t $tmp136 = $tmp132.max.value;
    bool $tmp137 = $tmp132.inclusive.value;
    if ($tmp137) goto $l144; else goto $l145;
    $l144:;
    if ($tmp134 <= $tmp136) goto $l138; else goto $l140;
    $l145:;
    if ($tmp134 < $tmp136) goto $l138; else goto $l140;
    $l138:;
    {
        result131[i133.value] = self->data[i133.value];
    }
    $l141:;
    int64_t $tmp147 = $tmp136 - i133.value;
    if ($tmp137) goto $l148; else goto $l149;
    $l148:;
    if ((uint64_t) $tmp147 >= 1) goto $l146; else goto $l140;
    $l149:;
    if ((uint64_t) $tmp147 > 1) goto $l146; else goto $l140;
    $l146:;
    i133.value += 1;
