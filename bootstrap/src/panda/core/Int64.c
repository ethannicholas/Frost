...
panda$core$Int64$wrapperclass_type panda$core$Int64$wrapperclass = { (panda$core$Class*) &panda$core$Class$class, 1, (panda$core$Class*) &panda$core$Value$class, (ITable*) &panda$core$Int64$wrapper_panda$collections$Key, { panda$core$Int64$convert$R$panda$core$String$wrappershim, panda$core$Int64$cleanup$wrappershim} };
...
panda$core$String* panda$core$Int64$convert$R$panda$core$String(panda$core$Int64 self) {
    ...
    chars133 = ((panda$core$Char8*) pandaZAlloc(max132.value * 1));
    ...
    goto $l166;
    $l168:;
    panda$core$String* $tmp181 = (panda$core$String*) pandaZAlloc(48);
