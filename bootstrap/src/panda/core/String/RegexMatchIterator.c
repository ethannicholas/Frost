...
static panda$core$String $s26 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x53\x74\x72\x69\x6e\x67\x2e\x66\x72\x6f\x73\x74", 12, -7878295538840852540, NULL };
...
block1:;
// line 308
panda$core$String$Match* $tmp28 = (panda$core$String$Match*) frostObjectAlloc(40, (panda$core$Class*) &panda$core$String$Match$class);
