...
static panda$core$String $s11 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x53\x74\x72\x69\x6e\x67\x2e\x66\x72\x6f\x73\x74", 12, -7878295538840852540, NULL };
...
static panda$core$String $s30 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x53\x74\x72\x69\x6e\x67\x2e\x66\x72\x6f\x73\x74", 12, -7878295538840852540, NULL };
...
panda$core$Int64 $tmp33 = *$tmp32;
panda$core$Int64 $tmp34 = (panda$core$Int64) {1};
int64_t $tmp35 = $tmp33.value;
int64_t $tmp36 = $tmp34.value;
int64_t $tmp37 = $tmp35 + $tmp36;
panda$core$Int64 $tmp38 = (panda$core$Int64) {$tmp37};
panda$core$Int64* $tmp39 = &param0->index;
*$tmp39 = $tmp38;
// line 148
panda$core$UInt16 $tmp40 = (panda$core$UInt16) {1};
panda$core$Char16 $tmp41 = panda$core$Char16$init$panda$core$UInt16($tmp40);
return $tmp41;
...
panda$core$String** $tmp42 = &param0->str;
