...
if ($tmp13.nonnull) {
    ...
    $tmp20->value = ((panda$core$Int64) $tmp13.value);
...
block6:;
// line 47
panda$core$Int64$nullable $tmp27 = param0.max;
...
panda$core$Int64$nullable $tmp31 = param0.max;
...
if ($tmp31.nonnull) {
    ...
    $tmp38->value = ((panda$core$Int64) $tmp31.value);
