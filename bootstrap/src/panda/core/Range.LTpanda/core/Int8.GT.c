...
$tmp14 = (panda$core$Int8$wrapper*) frostObjectAlloc(13, (panda$core$Class*) &panda$core$Int8$wrapperclass);
$tmp14->value = $tmp13;
...
$tmp26 = (panda$core$Int8$wrapper*) frostObjectAlloc(13, (panda$core$Class*) &panda$core$Int8$wrapperclass);
$tmp26->value = $tmp25;
