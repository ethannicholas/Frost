...
panda$core$String* panda$core$Range$LTpanda$core$Int64$GT$convert$R$panda$core$String$shim(panda$core$Object* p0) {
...
void panda$core$Range$LTpanda$core$Int64$GT$cleanup$shim(panda$core$Object* p0) {
