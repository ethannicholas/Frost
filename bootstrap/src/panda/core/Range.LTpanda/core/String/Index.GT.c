...
panda$core$String* panda$core$Range$LTpanda$core$String$Index$GT$convert$R$panda$core$String$shim(panda$core$Object* p0) {
...
void panda$core$Range$LTpanda$core$String$Index$GT$cleanup$shim(panda$core$Object* p0) {
