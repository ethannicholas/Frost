...
panda$core$Range$LTpanda$core$UInt32$GT panda$core$Range$LTpanda$core$UInt32$GT$init$panda$core$UInt32$panda$core$UInt32$panda$core$Bit(panda$core$UInt32 param0, panda$core$UInt32 param1, panda$core$Bit param2) {

panda$core$Range$LTpanda$core$UInt32$GT local0;
// line 30
panda$core$UInt32* $tmp3 = &(&local0)->min;
*$tmp3 = param0;
// line 31
panda$core$UInt32* $tmp4 = &(&local0)->max;
*$tmp4 = param1;
// line 32
panda$core$Bit* $tmp5 = &(&local0)->inclusive;
*$tmp5 = param2;
panda$core$Range$LTpanda$core$UInt32$GT $tmp6 = *(&local0);
return $tmp6;

}
panda$core$String* panda$core$Range$LTpanda$core$UInt32$GT$convert$R$panda$core$String(panda$core$Range$LTpanda$core$UInt32$GT param0) {
...
// line 38
panda$core$UInt32 $tmp9 = param0.min;
...
panda$core$UInt32 $tmp13 = param0.min;
panda$core$UInt32$wrapper* $tmp14;
$tmp14 = (panda$core$UInt32$wrapper*) pandaObjectAlloc(16, (panda$core$Class*) &panda$core$UInt32$wrapperclass);
$tmp14->value = $tmp13;
...
block4:;
// line 47
panda$core$UInt32 $tmp21 = param0.max;
...
panda$core$UInt32 $tmp25 = param0.max;
panda$core$UInt32$wrapper* $tmp26;
$tmp26 = (panda$core$UInt32$wrapper*) pandaObjectAlloc(16, (panda$core$Class*) &panda$core$UInt32$wrapperclass);
$tmp26->value = $tmp25;
...
void panda$core$Range$LTpanda$core$UInt32$GT$cleanup(panda$core$Range$LTpanda$core$UInt32$GT param0) {
