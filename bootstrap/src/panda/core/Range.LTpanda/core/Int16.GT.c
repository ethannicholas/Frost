...
$tmp14 = (panda$core$Int16$wrapper*) frostObjectAlloc(14, (panda$core$Class*) &panda$core$Int16$wrapperclass);
$tmp14->value = $tmp13;
...
$tmp26 = (panda$core$Int16$wrapper*) frostObjectAlloc(14, (panda$core$Class*) &panda$core$Int16$wrapperclass);
$tmp26->value = $tmp25;
