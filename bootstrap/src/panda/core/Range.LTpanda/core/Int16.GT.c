...
void panda$core$Range$LTpanda$core$Int16$GT$init$panda$core$Int16$panda$core$Int16$panda$core$Bit(panda$core$Range$LTpanda$core$Int16$GT* self, panda$core$Int16 p_min, panda$core$Int16 p_max, panda$core$Bit p_inclusive) {
    self->min = p_min;
    self->max = p_max;
