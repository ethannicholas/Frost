...
static panda$core$String $s17 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x52\x61\x6e\x67\x65\x2e\x66\x72\x6f\x73\x74", 11, -6437309674450156934, NULL };
static panda$core$String $s18 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "", 86, 3883486436660199913, NULL };
static panda$core$String $s24 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x2e\x2e\x2e", 3, 1504239, NULL };
static panda$core$String $s26 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x2e\x2e", 2, 14893, NULL };
static panda$core$String $s35 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x52\x61\x6e\x67\x65\x2e\x66\x72\x6f\x73\x74", 11, -6437309674450156934, NULL };
static panda$core$String $s36 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "", 86, 3883486436660199913, NULL };
...
panda$core$Bit $tmp14 = panda$core$Bit$init$builtin_bit($tmp13.nonnull);
bool $tmp15 = $tmp14.value;
if ($tmp15) goto block3; else goto block4;
block4:;
panda$core$Int64 $tmp16 = (panda$core$Int64) {39};
...
if ($tmp13.nonnull) {
    panda$core$MutableString$Index$wrapper* $tmp20;
    $tmp20 = (panda$core$MutableString$Index$wrapper*) frostObjectAlloc(24, (panda$core$Class*) &panda$core$MutableString$Index$wrapperclass);
    $tmp20->value = ((panda$core$MutableString$Index) $tmp13.value);
    $tmp19 = ((panda$core$Object*) $tmp20);
}
else {
    $tmp19 = NULL;
}
panda$core$MutableString$append$panda$core$Object($tmp12, $tmp19);
panda$core$Panda$unref$panda$core$Object$Q($tmp19);
// unreffing REF($29:panda.core.Object)
goto block2;
block2:;
// line 41
panda$core$Bit $tmp21 = param0.inclusive;
bool $tmp22 = $tmp21.value;
if ($tmp22) goto block5; else goto block7;
block5:;
// line 42
panda$core$MutableString* $tmp23 = *(&local0);
panda$core$MutableString$append$panda$core$String($tmp23, &$s24);
goto block6;
block7:;
// line 1
// line 45
panda$core$MutableString* $tmp25 = *(&local0);
panda$core$MutableString$append$panda$core$String($tmp25, &$s26);
goto block6;
block6:;
// line 47
panda$core$MutableString$Index$nullable $tmp27 = param0.max;
panda$core$Bit $tmp28 = panda$core$Bit$init$builtin_bit($tmp27.nonnull);
bool $tmp29 = $tmp28.value;
if ($tmp29) goto block8; else goto block9;
block8:;
// line 48
panda$core$MutableString* $tmp30 = *(&local0);
panda$core$MutableString$Index$nullable $tmp31 = param0.max;
panda$core$Bit $tmp32 = panda$core$Bit$init$builtin_bit($tmp31.nonnull);
bool $tmp33 = $tmp32.value;
if ($tmp33) goto block10; else goto block11;
block11:;
panda$core$Int64 $tmp34 = (panda$core$Int64) {48};
panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64$panda$core$String(&$s35, $tmp34, &$s36);
abort(); // unreachable
block10:;
panda$core$Object* $tmp37;
if ($tmp31.nonnull) {
    panda$core$MutableString$Index$wrapper* $tmp38;
    $tmp38 = (panda$core$MutableString$Index$wrapper*) frostObjectAlloc(24, (panda$core$Class*) &panda$core$MutableString$Index$wrapperclass);
    $tmp38->value = ((panda$core$MutableString$Index) $tmp31.value);
    $tmp37 = ((panda$core$Object*) $tmp38);
}
else {
    $tmp37 = NULL;
}
panda$core$MutableString$append$panda$core$Object($tmp30, $tmp37);
