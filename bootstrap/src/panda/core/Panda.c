...
void panda$core$Panda$countDeallocation$panda$core$Class(panda$core$Panda* self, panda$core$Class* p_cl) {
    ...
    goto $l61;
    $l61:;
    panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) name64));
    name64 = NULL;
    switch ($tmp63) {
        case -1: goto $l76;
    }
    ...
    panda$core$Object* $tmp155;
    {
        int $tmp79;
        {
            ...
            if (!$tmp86) goto $l85;
            {
                ...
                goto $l92;
                $l92:;
                panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) k95));
                k95 = NULL;
                switch ($tmp94) {
                    case -1: goto $l120;
                }
        ...
        goto $l77;
        $l77:;
        panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) Iter$61$980));
        Iter$61$980 = NULL;
        switch ($tmp79) {
            case -1: goto $l121;
        }
    ...
    }
    {
        int $tmp124;
        {
            ...
            if (!$tmp131) goto $l130;
            {
                ...
                goto $l137;
                $l137:;
                panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) k140));
                k140 = NULL;
                switch ($tmp139) {
                    case -1: goto $l161;
                }
...
void panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64$panda$core$String(panda$core$String* p_file, panda$core$Int64 p_line, panda$core$String* p_msg) {
    ...
    panda$core$Panda$unref$panda$core$Object($tmp199);
...
panda$core$String* panda$core$Panda$format$panda$core$Bit$panda$core$UInt64$panda$core$UInt64$panda$core$String$R$panda$core$String(panda$core$Bit p_sign, panda$core$UInt64 p_rawValue, panda$core$UInt64 p_mask, panda$core$String* p_fmt) {
    ...
    $l378:;
    panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) digits385));
    digits385 = NULL;
    switch ($tmp380) {
        case 0: goto $l520;
    }
