...
typedef panda$core$Object* (*$fn466)(panda$collections$ListView*, panda$core$Int64);
...
$tmp164->value = ((panda$core$Int64) ((panda$core$Int64$nullable) { $tmp163, true }).value);
...
if ($tmp215) goto block9; else goto block10;
block9:;
// line 121
...
if ($tmp232) goto block11; else goto block12;
block11:;
...
if ($tmp279) goto block9; else goto block10;
block9:;
// line 143
return ((panda$core$UInt64$nullable) { .nonnull = false });
block10:;
...
block19:;
panda$core$Int64 $tmp363 = (panda$core$Int64) {194};
...
block18:;
panda$core$Int64 $tmp432 = (panda$core$Int64) {225};
...
if ($tmp435) goto block19; else goto block20;
block19:;
...
if ($tmp443) goto block22; else goto block24;
block22:;
// line 230
...
panda$collections$ListView* $tmp459 = *(&local2);
panda$core$UInt64 $tmp460 = *(&local3);
panda$core$UInt64 $tmp461 = *(&local1);
panda$core$UInt64 $tmp462 = panda$core$UInt64$$REM$panda$core$UInt64$R$panda$core$UInt64($tmp460, $tmp461);
panda$core$Int64 $tmp463 = panda$core$UInt64$convert$R$panda$core$Int64($tmp462);
ITable* $tmp464 = $tmp459->$class->itable;
while ($tmp464->$class != (panda$core$Class*) &panda$collections$ListView$class) {
    $tmp464 = $tmp464->next;
}
$fn466 $tmp465 = $tmp464->methods[0];
panda$core$Object* $tmp467 = $tmp465($tmp459, $tmp463);
panda$core$Int64 $tmp468 = *(&local7);
int64_t $tmp469 = $tmp468.value;
$tmp458[$tmp469] = ((panda$core$Char8$wrapper*) $tmp467)->value;
...
if ($tmp489) goto block28; else goto block29;
block28:;
...
if ($tmp494) goto block31; else goto block32;
block31:;
// line 245
panda$core$Char8* $tmp495 = *(&local6);
panda$core$UInt8 $tmp496 = (panda$core$UInt8) {45};
panda$core$Char8 $tmp497 = panda$core$Char8$init$panda$core$UInt8($tmp496);
panda$core$Int64 $tmp498 = *(&local7);
int64_t $tmp499 = $tmp498.value;
$tmp495[$tmp499] = $tmp497;
// line 246
...
panda$core$Char8* $tmp539 = *(&local6);
panda$core$Int64 $tmp540 = *(&local10);
panda$core$Int64 $tmp541 = *(&local7);
...
int64_t $tmp546 = $tmp545.value;
panda$core$Char8 $tmp547 = $tmp539[$tmp546];
panda$core$Int64 $tmp548 = *(&local10);
int64_t $tmp549 = $tmp548.value;
$tmp538[$tmp549] = $tmp547;
goto block35;
block35:;
