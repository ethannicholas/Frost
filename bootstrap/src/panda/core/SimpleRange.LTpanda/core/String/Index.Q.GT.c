...
panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$wrapper* wrap_panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT(panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT self) {
    panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$wrapper* result = (panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$wrapper*) malloc(37);
    result->cl = (panda$core$Class*) &panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$wrapperclass;
    result->value = self;
    return result;
}
...
panda$core$String* panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$convert$R$panda$core$String$wrappershim(panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$wrapper* self) {
    return panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$convert$R$panda$core$String(self->value);
}

panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$class_type panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$class = { (panda$core$Class*) &panda$core$Class$class, 1, (panda$core$Class*) &panda$core$Value$class, NULL, { panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$convert$R$panda$core$String, panda$core$Object$cleanup} };

panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$wrapperclass_type panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$wrapperclass = { (panda$core$Class*) &panda$core$Class$class, 1, (panda$core$Class*) &panda$core$Value$class, NULL, { panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$convert$R$panda$core$String$wrappershim, panda$core$Object$cleanup} };
...
panda$core$String* panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT$convert$R$panda$core$String(panda$core$SimpleRange$LTpanda$core$String$Index$Q$GT self) {
    ...
    {
        panda$core$MutableString$append$panda$core$Object(result1, ((panda$core$Object*) wrap_panda$core$String$Index(((panda$core$String$Index) self.min.value))));
    }
    }
