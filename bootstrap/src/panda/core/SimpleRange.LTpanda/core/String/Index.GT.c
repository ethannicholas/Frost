...
panda$core$SimpleRange$LTpanda$core$String$Index$GT$wrapper* wrap_panda$core$SimpleRange$LTpanda$core$String$Index$GT(panda$core$SimpleRange$LTpanda$core$String$Index$GT self) {
    panda$core$SimpleRange$LTpanda$core$String$Index$GT$wrapper* result = (panda$core$SimpleRange$LTpanda$core$String$Index$GT$wrapper*) malloc(33);
    result->cl = (panda$core$Class*) &panda$core$SimpleRange$LTpanda$core$String$Index$GT$wrapperclass;
    result->value = self;
    return result;
}
...
panda$core$String* panda$core$SimpleRange$LTpanda$core$String$Index$GT$convert$R$panda$core$String$wrappershim(panda$core$SimpleRange$LTpanda$core$String$Index$GT$wrapper* self) {
    return panda$core$SimpleRange$LTpanda$core$String$Index$GT$convert$R$panda$core$String(self->value);
}

panda$core$SimpleRange$LTpanda$core$String$Index$GT$class_type panda$core$SimpleRange$LTpanda$core$String$Index$GT$class = { (panda$core$Class*) &panda$core$Class$class, 1, (panda$core$Class*) &panda$core$Value$class, NULL, { panda$core$SimpleRange$LTpanda$core$String$Index$GT$convert$R$panda$core$String, panda$core$Object$cleanup} };

panda$core$SimpleRange$LTpanda$core$String$Index$GT$wrapperclass_type panda$core$SimpleRange$LTpanda$core$String$Index$GT$wrapperclass = { (panda$core$Class*) &panda$core$Class$class, 1, (panda$core$Class*) &panda$core$Value$class, NULL, { panda$core$SimpleRange$LTpanda$core$String$Index$GT$convert$R$panda$core$String$wrappershim, panda$core$Object$cleanup} };
