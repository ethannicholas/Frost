...
struct { panda$core$Class* cl; ITable* next; void* methods[1]; } panda$core$Int16$_panda$collections$Key = { (panda$core$Class*) &panda$collections$Key$class, NULL, { panda$core$Int16$hash$R$panda$core$Int64} };
...
panda$core$String* panda$core$Int16$convert$R$panda$core$String(panda$core$Int16 self) {
    ...
    index162 = $tmp163;
    value164 = self;
    panda$core$Bit $tmp165 = panda$core$Int16$$GE$panda$core$Int16$R$panda$core$Bit(value164, ((panda$core$Int16) { 0 }));
    if ($tmp165.value) {
    {
        $l166:;
        {
            panda$core$Int32 $tmp169 = panda$core$Int16$$REM$panda$core$Int16$R$panda$core$Int32(value164, ((panda$core$Int16) { 10 }));
            ...
            panda$core$Int32 $tmp171 = panda$core$Int16$$INTDIV$panda$core$Int16$R$panda$core$Int32(value164, ((panda$core$Int16) { 10 }));
            panda$core$Int16 $tmp172 = panda$core$Int32$convert$R$panda$core$Int16($tmp171);
            value164 = $tmp172;
            panda$core$Int64 $tmp173 = panda$core$Int64$$SUB$panda$core$Int64$R$panda$core$Int64(index162, ((panda$core$Int64) { 1 }));
            index162 = $tmp173;
        }
        panda$core$Bit $tmp174 = panda$core$Int16$$GT$panda$core$Int16$R$panda$core$Bit(value164, ((panda$core$Int16) { 0 }));
    ...
    else {
    {
        $l176:;
        {
            panda$core$Int32 $tmp179 = panda$core$Int16$$REM$panda$core$Int16$R$panda$core$Int32(value164, ((panda$core$Int16) { 10 }));
            ...
            panda$core$Int32 $tmp181 = panda$core$Int16$$INTDIV$panda$core$Int16$R$panda$core$Int32(value164, ((panda$core$Int16) { 10 }));
            panda$core$Int16 $tmp182 = panda$core$Int32$convert$R$panda$core$Int16($tmp181);
            value164 = $tmp182;
            panda$core$Int64 $tmp183 = panda$core$Int64$$SUB$panda$core$Int64$R$panda$core$Int64(index162, ((panda$core$Int64) { 1 }));
            index162 = $tmp183;
        }
        panda$core$Bit $tmp184 = panda$core$Int16$$LT$panda$core$Int16$R$panda$core$Bit(value164, ((panda$core$Int16) { 0 }));
