...
panda$core$SpecializedRange$LTpanda$core$String$Index$GT$wrapper* wrap_panda$core$SpecializedRange$LTpanda$core$String$Index$GT(panda$core$SpecializedRange$LTpanda$core$String$Index$GT self) {
    panda$core$SpecializedRange$LTpanda$core$String$Index$GT$wrapper* result = (panda$core$SpecializedRange$LTpanda$core$String$Index$GT$wrapper*) malloc(41);
    result->cl = (panda$core$Class*) &panda$core$SpecializedRange$LTpanda$core$String$Index$GT$wrapperclass;
    result->value = self;
    return result;
}
...
panda$core$String* panda$core$SpecializedRange$LTpanda$core$String$Index$GT$convert$R$panda$core$String$wrappershim(panda$core$SpecializedRange$LTpanda$core$String$Index$GT$wrapper* self) {
    return panda$core$SpecializedRange$LTpanda$core$String$Index$GT$convert$R$panda$core$String(self->value);
}

panda$core$SpecializedRange$LTpanda$core$String$Index$GT$class_type panda$core$SpecializedRange$LTpanda$core$String$Index$GT$class = { (panda$core$Class*) &panda$core$Class$class, 1, (panda$core$Class*) &panda$core$Value$class, NULL, { panda$core$SpecializedRange$LTpanda$core$String$Index$GT$convert$R$panda$core$String, panda$core$Object$cleanup} };

panda$core$SpecializedRange$LTpanda$core$String$Index$GT$wrapperclass_type panda$core$SpecializedRange$LTpanda$core$String$Index$GT$wrapperclass = { (panda$core$Class*) &panda$core$Class$class, 1, (panda$core$Class*) &panda$core$Value$class, NULL, { panda$core$SpecializedRange$LTpanda$core$String$Index$GT$convert$R$panda$core$String$wrappershim, panda$core$Object$cleanup} };typedef void (*$fn4)(panda$core$MutableString*, panda$core$Object*);
...
panda$core$String* panda$core$SpecializedRange$LTpanda$core$String$Index$GT$convert$R$panda$core$String(panda$core$SpecializedRange$LTpanda$core$String$Index$GT self) {
    ...
    {
        (($fn4) result1->$class->vtable[5])(result1, ((panda$core$Object*) wrap_panda$core$String$Index(self.start)));
    }
    }
    ...
    if (((panda$core$Bit) { true }).value) {
    {
        (($fn9) result1->$class->vtable[5])(result1, ((panda$core$Object*) wrap_panda$core$String$Index(self.end)));
    }
    }
