...
panda$core$SpecializedRange$LTpanda$core$Object$Q$GT$wrapper* wrap_panda$core$SpecializedRange$LTpanda$core$Object$Q$GT(panda$core$SpecializedRange$LTpanda$core$Object$Q$GT self) {
    panda$core$SpecializedRange$LTpanda$core$Object$Q$GT$wrapper* result = (panda$core$SpecializedRange$LTpanda$core$Object$Q$GT$wrapper*) malloc(41);
    result->cl = (panda$core$Class*) &panda$core$SpecializedRange$LTpanda$core$Object$Q$GT$wrapperclass;
    result->value = self;
    return result;
}
...
panda$core$String* panda$core$SpecializedRange$LTpanda$core$Object$Q$GT$convert$R$panda$core$String$wrappershim(panda$core$SpecializedRange$LTpanda$core$Object$Q$GT$wrapper* self) {
    return panda$core$SpecializedRange$LTpanda$core$Object$Q$GT$convert$R$panda$core$String(self->value);
}

panda$core$SpecializedRange$LTpanda$core$Object$Q$GT$class_type panda$core$SpecializedRange$LTpanda$core$Object$Q$GT$class = { (panda$core$Class*) &panda$core$Class$class, 1, (panda$core$Class*) &panda$core$Value$class, NULL, { panda$core$SpecializedRange$LTpanda$core$Object$Q$GT$convert$R$panda$core$String, panda$core$Object$cleanup} };

panda$core$SpecializedRange$LTpanda$core$Object$Q$GT$wrapperclass_type panda$core$SpecializedRange$LTpanda$core$Object$Q$GT$wrapperclass = { (panda$core$Class*) &panda$core$Class$class, 1, (panda$core$Class*) &panda$core$Value$class, NULL, { panda$core$SpecializedRange$LTpanda$core$Object$Q$GT$convert$R$panda$core$String$wrappershim, panda$core$Object$cleanup} };typedef void (*$fn4)(panda$core$MutableString*, panda$core$Object*);
