...
panda$core$String* panda$core$UInt32$convert$R$panda$core$String(panda$core$UInt32 self) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp185, ((panda$core$Object*) wrap_panda$core$Int64(index160)), ((panda$core$Object*) wrap_panda$core$Int64(max158)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp187 = ((panda$core$Int64$wrapper*) $tmp185.start)->value.value;
    panda$core$Int64 i186 = { $tmp187 };
    int64_t $tmp189 = ((panda$core$Int64$wrapper*) $tmp185.end)->value.value;
    ...
    $l194:;
    free(chars159);
    panda$core$String* $tmp216 = (panda$core$String*) malloc(32);
    $tmp216->$class = (panda$core$Class*) &panda$core$String$class;
    $tmp216->refCount.value = 1;
    panda$core$String$init$panda$unsafe$Pointer$LTpanda$core$Char8$GT$panda$core$Int64($tmp216, result184, size182);
    return $tmp216;
}
