...
struct { panda$core$Class* cl; ITable* next; void* methods[2]; } panda$core$String$Index$_panda$core$Equatable = { (panda$core$Class*) &panda$core$Equatable$class, NULL, { panda$core$String$Index$$EQ$panda$core$String$Index$R$panda$core$Bit$shim, panda$core$String$Index$$NEQ$panda$core$String$Index$R$panda$core$Bit$shim} };

struct { panda$core$Class* cl; ITable* next; void* methods[1]; } panda$core$String$Index$_panda$collections$Key = { (panda$core$Class*) &panda$collections$Key$class, (ITable*) &panda$core$String$Index$_panda$core$Equatable, { panda$core$String$Index$hash$R$panda$core$Int64} };

panda$core$String$Index$class_type panda$core$String$Index$class = { (panda$core$Class*) &panda$core$Class$class, 1, (panda$core$Class*) &panda$core$Value$class, (ITable*) &panda$core$String$Index$_panda$collections$Key, { panda$core$Object$convert$R$panda$core$String, panda$core$Object$cleanup, panda$core$String$Index$$EQ$panda$core$String$Index$R$panda$core$Bit$shim, panda$core$String$Index$$NEQ$panda$core$String$Index$R$panda$core$Bit$shim, panda$core$String$Index$hash$R$panda$core$Int64} };

struct { panda$core$Class* cl; ITable* itable; void* methods[2]; } panda$core$String$Index$wrapper_panda$core$Equatable = { (panda$core$Class*) &panda$core$Equatable$class, NULL, { panda$core$String$Index$$EQ$panda$core$String$Index$R$panda$core$Bit$wrappershim, panda$core$String$Index$$NEQ$panda$core$String$Index$R$panda$core$Bit$wrappershim} };

struct { panda$core$Class* cl; ITable* itable; void* methods[1]; } panda$core$String$Index$wrapper_panda$collections$Key = { (panda$core$Class*) &panda$collections$Key$class, (ITable*) &panda$core$String$Index$wrapper_panda$core$Equatable, { panda$core$String$Index$hash$R$panda$core$Int64$wrappershim} };

panda$core$String$Index$wrapperclass_type panda$core$String$Index$wrapperclass = { (panda$core$Class*) &panda$core$Class$class, 1, (panda$core$Class*) &panda$core$Value$class, (ITable*) &panda$core$String$Index$wrapper_panda$collections$Key, { panda$core$Object$convert$R$panda$core$String, panda$core$Object$cleanup} };struct { panda$core$Class* cl; ITable* next; void* methods[1]; } panda$core$String$UTF8List$_panda$collections$CollectionView = { (panda$core$Class*) &panda$collections$CollectionView$class, NULL, { panda$core$String$UTF8List$get_count$R$panda$core$Int64} };
...
void panda$core$String$init$panda$collections$ListView$LTpanda$core$Char8$GT(panda$core$String* self, panda$collections$ListView* p_chars) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp5, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Object*) wrap_panda$core$Int64(self->_length)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp7 = ((panda$core$Int64$wrapper*) $tmp5.start)->value.value;
    panda$core$Int64 i6 = { $tmp7 };
    int64_t $tmp9 = ((panda$core$Int64$wrapper*) $tmp5.end)->value.value;
...
panda$core$Bit panda$core$String$startsWith$panda$core$String$R$panda$core$Bit(panda$core$String* self, panda$core$String* p_other) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp60, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Object*) wrap_panda$core$Int64(p_other->_length)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp62 = ((panda$core$Int64$wrapper*) $tmp60.start)->value.value;
    panda$core$Int64 i61 = { $tmp62 };
    int64_t $tmp64 = ((panda$core$Int64$wrapper*) $tmp60.end)->value.value;
...
panda$core$Bit panda$core$String$endsWith$panda$core$String$R$panda$core$Bit(panda$core$String* self, panda$core$String* p_other) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp92, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Object*) wrap_panda$core$Int64(p_other->_length)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp94 = ((panda$core$Int64$wrapper*) $tmp92.start)->value.value;
    panda$core$Int64 i93 = { $tmp94 };
    int64_t $tmp96 = ((panda$core$Int64$wrapper*) $tmp92.end)->value.value;
...
panda$core$String* panda$core$String$trimmed$R$panda$core$String(panda$core$String* self) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp145, (((panda$core$String$Index$nullable) { $tmp146, true }).nonnull ? ((panda$core$Object*) wrap_panda$core$String$Index(((panda$core$String$Index) ((panda$core$String$Index$nullable) { $tmp146, true }).value))) : NULL), (((panda$core$String$Index$nullable) { $tmp147, true }).nonnull ? ((panda$core$Object*) wrap_panda$core$String$Index(((panda$core$String$Index) ((panda$core$String$Index$nullable) { $tmp147, true }).value))) : NULL), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { true }));
...
panda$core$String* panda$core$String$$ADD$panda$core$String$R$panda$core$String(panda$core$String* self, panda$core$String* p_other) {
    ...
    panda$core$Range $tmp151;
    panda$core$Range $tmp181;
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp151, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Object*) wrap_panda$core$Int64(self->_length)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp153 = ((panda$core$Int64$wrapper*) $tmp151.start)->value.value;
    panda$core$Int64 i152 = { $tmp153 };
    int64_t $tmp155 = ((panda$core$Int64$wrapper*) $tmp151.end)->value.value;
    ...
    goto $l158;
    $l160:;
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp181, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Object*) wrap_panda$core$Int64(p_other->_length)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp183 = ((panda$core$Int64$wrapper*) $tmp181.start)->value.value;
    panda$core$Int64 i182 = { $tmp183 };
    int64_t $tmp185 = ((panda$core$Int64$wrapper*) $tmp181.end)->value.value;
...
panda$core$String* panda$core$String$$MUL$panda$core$Int64$R$panda$core$String(panda$core$String* self, panda$core$Int64 p_count) {
    ...
    result218 = $tmp219;
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp221, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Object*) wrap_panda$core$Int64(p_count)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp223 = ((panda$core$Int64$wrapper*) $tmp221.start)->value.value;
    panda$core$Int64 i222 = { $tmp223 };
    int64_t $tmp225 = ((panda$core$Int64$wrapper*) $tmp221.end)->value.value;
...
panda$core$Bit panda$core$String$$EQ$panda$core$String$R$panda$core$Bit(panda$core$String* self, panda$core$String* p_other) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp258, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Object*) wrap_panda$core$Int64(self->_length)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp260 = ((panda$core$Int64$wrapper*) $tmp258.start)->value.value;
    panda$core$Int64 i259 = { $tmp260 };
    int64_t $tmp262 = ((panda$core$Int64$wrapper*) $tmp258.end)->value.value;
...
panda$core$String* panda$core$String$$IDX$panda$core$Range$LTpanda$core$String$Index$Q$GT$R$panda$core$String(panda$core$String* self, panda$core$Range p_r) {
    ...
    panda$core$Range $tmp373;
    panda$core$String$Index $tmp395;
    panda$core$Char8 c411;
    panda$core$Int64 old413;
    panda$core$Range $tmp436;
    panda$core$String$Index $tmp458;
    panda$core$Char8 c482;
    step341 = p_r.step;
    if (((panda$core$Bit) { (p_r.start != NULL ? ((panda$core$String$Index$nullable) { ((panda$core$String$Index$wrapper*) p_r.start)->value, true }) : (panda$core$String$Index$nullable) { .nonnull = 0 }).nonnull }).value) {
    {
        current342 = ((panda$core$String$Index) (p_r.start != NULL ? ((panda$core$String$Index$nullable) { ((panda$core$String$Index$wrapper*) p_r.start)->value, true }) : (panda$core$String$Index$nullable) { .nonnull = 0 }).value).value;
    }
    }
    else {
    ...
    if (((panda$core$Bit) { (p_r.end != NULL ? ((panda$core$String$Index$nullable) { ((panda$core$String$Index$wrapper*) p_r.end)->value, true }) : (panda$core$String$Index$nullable) { .nonnull = 0 }).nonnull }).value) {
    {
        end347 = ((panda$core$String$Index) (p_r.end != NULL ? ((panda$core$String$Index$nullable) { ((panda$core$String$Index$wrapper*) p_r.end)->value, true }) : (panda$core$String$Index$nullable) { .nonnull = 0 }).value).value;
    }
    }
    else {
    ...
    if ($tmp354.value) {
    {
        ...
        if (!$tmp357.value) goto $l356;
        {
            ...
            panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp373, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 1 }))), ((panda$core$Object*) wrap_panda$core$Int64(step341)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
            int64_t $tmp375 = ((panda$core$Int64$wrapper*) $tmp373.start)->value.value;
            panda$core$Int64 i374 = { $tmp375 };
            int64_t $tmp377 = ((panda$core$Int64$wrapper*) $tmp373.end)->value.value;
    ...
    else {
    {
        ...
        if (!$tmp410.value) goto $l409;
        {
            ...
            goto $l427;
            $l428:;
            panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp436, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { -1 }))), ((panda$core$Object*) wrap_panda$core$Int64(step341)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { -1 }), true }), ((panda$core$Bit) { false }));
            int64_t $tmp438 = ((panda$core$Int64$wrapper*) $tmp436.start)->value.value;
            panda$core$Int64 i437 = { $tmp438 };
            int64_t $tmp440 = ((panda$core$Int64$wrapper*) $tmp436.end)->value.value;
    ...
    if ($tmp473) goto $l474;
    $tmp473 = ((panda$core$Bit) { !(p_r.end != NULL ? ((panda$core$String$Index$nullable) { ((panda$core$String$Index$wrapper*) p_r.end)->value, true }) : (panda$core$String$Index$nullable) { .nonnull = 0 }).nonnull }).value;
    $l474:;
...
panda$core$String* panda$core$String$$IDX$panda$core$Range$LTpanda$core$Int64$Q$GT$R$panda$core$String(panda$core$String* self, panda$core$Range p_r) {
    ...
    if (((panda$core$Bit) { (p_r.start != NULL ? ((panda$core$Int64$nullable) { ((panda$core$Int64$wrapper*) p_r.start)->value, true }) : (panda$core$Int64$nullable) { .nonnull = 0 }).nonnull }).value) {
    {
        ...
        panda$core$String$Index $tmp500 = panda$core$String$offset$panda$core$String$Index$panda$core$Int64$R$panda$core$String$Index(self, $tmp499, ((panda$core$Int64) (p_r.start != NULL ? ((panda$core$Int64$nullable) { ((panda$core$Int64$wrapper*) p_r.start)->value, true }) : (panda$core$Int64$nullable) { .nonnull = 0 }).value));
    ...
    if (((panda$core$Bit) { (p_r.end != NULL ? ((panda$core$Int64$nullable) { ((panda$core$Int64$wrapper*) p_r.end)->value, true }) : (panda$core$Int64$nullable) { .nonnull = 0 }).nonnull }).value) {
    {
        ...
        panda$core$String$Index $tmp503 = panda$core$String$offset$panda$core$String$Index$panda$core$Int64$R$panda$core$String$Index(self, $tmp502, ((panda$core$Int64) (p_r.end != NULL ? ((panda$core$Int64$nullable) { ((panda$core$Int64$wrapper*) p_r.end)->value, true }) : (panda$core$Int64$nullable) { .nonnull = 0 }).value));
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp504, (start498.nonnull ? ((panda$core$Object*) wrap_panda$core$String$Index(((panda$core$String$Index) start498.value))) : NULL), (end501.nonnull ? ((panda$core$Object*) wrap_panda$core$String$Index(((panda$core$String$Index) end501.value))) : NULL), ((panda$core$Int64$nullable) { p_r.step, true }), p_r.inclusive);
...
panda$core$Bit panda$core$String$contains$panda$core$Char8$R$panda$core$Bit(panda$core$String* self, panda$core$Char8 p_c) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp506, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Object*) wrap_panda$core$Int64(self->_length)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp508 = ((panda$core$Int64$wrapper*) $tmp506.start)->value.value;
    panda$core$Int64 i507 = { $tmp508 };
    int64_t $tmp510 = ((panda$core$Int64$wrapper*) $tmp506.end)->value.value;
...
panda$core$String$Index$nullable panda$core$String$indexOf$panda$core$String$panda$core$String$Index$R$panda$core$String$Index$Q(panda$core$String* self, panda$core$String* p_s, panda$core$String$Index p_start) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp541, ((panda$core$Object*) wrap_panda$core$Int64(p_start.value)), ((panda$core$Object*) wrap_panda$core$Int64($tmp542)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { true }));
    int64_t $tmp544 = ((panda$core$Int64$wrapper*) $tmp541.start)->value.value;
    panda$core$Int64 i543 = { $tmp544 };
    int64_t $tmp546 = ((panda$core$Int64$wrapper*) $tmp541.end)->value.value;
    ...
    $l549:;
    {
        panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp561, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Object*) wrap_panda$core$Int64(p_s->_length)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
        int64_t $tmp563 = ((panda$core$Int64$wrapper*) $tmp561.start)->value.value;
        panda$core$Int64 j562 = { $tmp563 };
        int64_t $tmp565 = ((panda$core$Int64$wrapper*) $tmp561.end)->value.value;
...
panda$core$String$Index$nullable panda$core$String$lastIndexOf$panda$core$String$panda$core$String$Index$R$panda$core$String$Index$Q(panda$core$String* self, panda$core$String* p_s, panda$core$String$Index p_start) {
    ...
    panda$core$Range $tmp611;
    panda$core$Range $tmp630;
    ...
    startPos608 = $tmp610;
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp611, ((panda$core$Object*) wrap_panda$core$Int64(startPos608)), ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Int64$nullable) { ((panda$core$Int64) { -1 }), true }), ((panda$core$Bit) { true }));
    int64_t $tmp613 = ((panda$core$Int64$wrapper*) $tmp611.start)->value.value;
    panda$core$Int64 i612 = { $tmp613 };
    int64_t $tmp615 = ((panda$core$Int64$wrapper*) $tmp611.end)->value.value;
    ...
    $l618:;
    {
        panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp630, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Object*) wrap_panda$core$Int64(p_s->_length)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
        int64_t $tmp632 = ((panda$core$Int64$wrapper*) $tmp630.start)->value.value;
        panda$core$Int64 j631 = { $tmp632 };
        int64_t $tmp634 = ((panda$core$Int64$wrapper*) $tmp630.end)->value.value;
...
panda$core$String* panda$core$String$replace$panda$core$String$panda$core$String$R$panda$core$String(panda$core$String* self, panda$core$String* p_search, panda$core$String* p_replacement) {
    ...
    panda$core$Range $tmp683;
    panda$core$Range $tmp686;
    ...
    while (true) {
    {
        ...
        {
            panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp683, (((panda$core$String$Index$nullable) { index677, true }).nonnull ? ((panda$core$Object*) wrap_panda$core$String$Index(((panda$core$String$Index) ((panda$core$String$Index$nullable) { index677, true }).value))) : NULL), (((panda$core$String$Index$nullable) { .nonnull = false }).nonnull ? ((panda$core$Object*) wrap_panda$core$String$Index(((panda$core$String$Index) ((panda$core$String$Index$nullable) { .nonnull = false }).value))) : NULL), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
        ...
        panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp686, (((panda$core$String$Index$nullable) { index677, true }).nonnull ? ((panda$core$Object*) wrap_panda$core$String$Index(((panda$core$String$Index) ((panda$core$String$Index$nullable) { index677, true }).value))) : NULL), (nextIndex681.nonnull ? ((panda$core$Object*) wrap_panda$core$String$Index(((panda$core$String$Index) nextIndex681.value))) : NULL), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
...
panda$core$String$Index panda$core$String$offset$panda$core$String$Index$panda$core$Int64$R$panda$core$String$Index(panda$core$String* self, panda$core$String$Index p_index, panda$core$Int64 p_offset) {
    ...
    panda$core$Range $tmp723;
    panda$core$Range $tmp754;
    result721 = p_index;
    panda$core$Bit $tmp722 = panda$core$Int64$$GT$panda$core$Int64$R$panda$core$Bit(p_offset, ((panda$core$Int64) { 0 }));
    if ($tmp722.value) {
    {
        panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp723, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Object*) wrap_panda$core$Int64(p_offset)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
        int64_t $tmp725 = ((panda$core$Int64$wrapper*) $tmp723.start)->value.value;
        panda$core$Int64 i724 = { $tmp725 };
        int64_t $tmp727 = ((panda$core$Int64$wrapper*) $tmp723.end)->value.value;
    ...
    {
        panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp754, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Object*) wrap_panda$core$Int64(p_offset)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { -1 }), true }), ((panda$core$Bit) { false }));
        int64_t $tmp756 = ((panda$core$Int64$wrapper*) $tmp754.start)->value.value;
        panda$core$Int64 i755 = { $tmp756 };
        int64_t $tmp758 = ((panda$core$Int64$wrapper*) $tmp754.end)->value.value;
...
panda$collections$Array* panda$core$String$split$panda$core$String$panda$core$Int64$R$panda$collections$Array$LTpanda$core$String$GT(panda$core$String* self, panda$core$String* p_delimiter, panda$core$Int64 p_maxResults) {
    ...
    panda$core$Range $tmp802;
    panda$core$Range $tmp804;
    ...
    while (true) {
    {
        ...
        if ($tmp801.value) {
        {
            panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp802, (((panda$core$String$Index$nullable) { index789, true }).nonnull ? ((panda$core$Object*) wrap_panda$core$String$Index(((panda$core$String$Index) ((panda$core$String$Index$nullable) { index789, true }).value))) : NULL), (((panda$core$String$Index$nullable) { .nonnull = false }).nonnull ? ((panda$core$Object*) wrap_panda$core$String$Index(((panda$core$String$Index) ((panda$core$String$Index$nullable) { .nonnull = false }).value))) : NULL), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
        ...
        panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp804, (((panda$core$String$Index$nullable) { index789, true }).nonnull ? ((panda$core$Object*) wrap_panda$core$String$Index(((panda$core$String$Index) ((panda$core$String$Index$nullable) { index789, true }).value))) : NULL), (nextIndex793.nonnull ? ((panda$core$Object*) wrap_panda$core$String$Index(((panda$core$String$Index) nextIndex793.value))) : NULL), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
...
panda$core$Int64$nullable panda$core$String$convert$R$panda$core$Int64$Q(panda$core$String* self) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp812, ((panda$core$Object*) wrap_panda$core$Int64(start809)), ((panda$core$Object*) wrap_panda$core$Int64(self->_length)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp814 = ((panda$core$Int64$wrapper*) $tmp812.start)->value.value;
    panda$core$Int64 i813 = { $tmp814 };
    int64_t $tmp816 = ((panda$core$Int64$wrapper*) $tmp812.end)->value.value;
...
panda$core$UInt64$nullable panda$core$String$convert$R$panda$core$UInt64$Q(panda$core$String* self) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp856, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Object*) wrap_panda$core$Int64(self->_length)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp858 = ((panda$core$Int64$wrapper*) $tmp856.start)->value.value;
    panda$core$Int64 i857 = { $tmp858 };
    int64_t $tmp860 = ((panda$core$Int64$wrapper*) $tmp856.end)->value.value;
...
panda$core$Int64 panda$core$String$hash$R$panda$core$Int64(panda$core$String* self) {
    ...
    panda$core$Range $tmp896;
    result895 = ((panda$core$Int64) { 0 });
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp896, ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Object*) wrap_panda$core$Int64(self->_length)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp898 = ((panda$core$Int64$wrapper*) $tmp896.start)->value.value;
    panda$core$Int64 i897 = { $tmp898 };
    int64_t $tmp900 = ((panda$core$Int64$wrapper*) $tmp896.end)->value.value;
...
panda$core$Bit panda$core$String$Index$$EQ$panda$core$String$Index$R$panda$core$Bit(panda$core$String$Index self, panda$core$String$Index p_other) {
    panda$core$Bit $tmp928 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit(self.value, p_other.value);
    return $tmp928;
}
panda$core$Bit panda$core$String$Index$$NEQ$panda$core$String$Index$R$panda$core$Bit(panda$core$String$Index self, panda$core$String$Index p_other) {
    panda$core$Bit $tmp929 = panda$core$String$Index$$EQ$panda$core$String$Index$R$panda$core$Bit(self, p_other);
...
panda$collections$Iterator* panda$core$String$UTF8List$iterator$R$panda$collections$Iterator$LTpanda$core$Char8$GT(panda$core$String$UTF8List* self) {
    panda$core$String$UTF8Iterator* $tmp931 = (panda$core$String$UTF8Iterator*) malloc(32);
    $tmp931->$class = (panda$core$Class*) &panda$core$String$UTF8Iterator$class;
    $tmp931->refCount.value = 1;
    panda$core$String$UTF8Iterator$init$panda$core$String($tmp931, self->str);
    return ((panda$collections$Iterator*) $tmp931);
}
...
panda$core$Bit panda$core$String$UTF8Iterator$get_done$R$panda$core$Bit(panda$core$String$UTF8Iterator* self) {
    panda$core$Bit $tmp933 = panda$core$Int64$$GE$panda$core$Int64$R$panda$core$Bit(self->index, self->str->_length);
    return $tmp933;
}
panda$core$Char8 panda$core$String$UTF8Iterator$next$R$panda$core$Char8(panda$core$String$UTF8Iterator* self) {
    panda$core$Int64 $tmp934 = panda$core$Int64$$ADD$panda$core$Int64$R$panda$core$Int64(self->index, ((panda$core$Int64) { 1 }));
    self->index = $tmp934;
    panda$core$Int64 $tmp935 = panda$core$Int64$$SUB$panda$core$Int64$R$panda$core$Int64(self->index, ((panda$core$Int64) { 1 }));
    return self->str->data[$tmp935.value];
}
...
panda$core$Bit panda$core$String$UTF16Iterator$get_done$R$panda$core$Bit(panda$core$String$UTF16Iterator* self) {
    panda$core$Bit $tmp936 = panda$core$Int64$$GE$panda$core$Int64$R$panda$core$Bit(self->index, self->str->_length);
    return $tmp936;
}
panda$core$Char16 panda$core$String$UTF16Iterator$next$R$panda$core$Char16(panda$core$String$UTF16Iterator* self) {
    panda$core$Char16 $tmp938;
    panda$core$Int64 $tmp937 = panda$core$Int64$$ADD$panda$core$Int64$R$panda$core$Int64(self->index, ((panda$core$Int64) { 1 }));
    self->index = $tmp937;
    panda$core$Char16$init$panda$core$UInt16(&$tmp938, ((panda$core$UInt16) { 1 }));
    return $tmp938;
}
...
panda$core$Bit panda$core$String$UTF32Iterator$get_done$R$panda$core$Bit(panda$core$String$UTF32Iterator* self) {
    panda$core$Bit $tmp939 = panda$core$Int64$$GE$panda$core$Int64$R$panda$core$Bit(self->index, self->str->_length);
    return $tmp939;
}
panda$core$Char32 panda$core$String$UTF32Iterator$next$R$panda$core$Char32(panda$core$String$UTF32Iterator* self) {
    panda$core$Char8 c940;
    panda$core$Int32 result941;
    panda$core$Char32 $tmp946;
    panda$core$Char32 $tmp956;
    panda$core$Char32 $tmp971;
    panda$core$Char32 $tmp989;
    c940 = self->str->data[self->index.value];
    panda$core$Int32 $tmp942 = panda$core$Char8$convert$R$panda$core$Int32(c940);
    result941 = $tmp942;
    int64_t $tmp943 = ((int64_t) c940.value) & 255;
    bool $tmp944 = $tmp943 < 128;
    if (((panda$core$Bit) { $tmp944 }).value) {
    {
        panda$core$Int64 $tmp945 = panda$core$Int64$$ADD$panda$core$Int64$R$panda$core$Int64(self->index, ((panda$core$Int64) { 1 }));
        self->index = $tmp945;
        panda$core$Char32$init$panda$core$Int32(&$tmp946, result941);
        return $tmp946;
    }
    }
    int64_t $tmp947 = ((int64_t) c940.value) & 255;
    bool $tmp948 = $tmp947 < 192;
    if (((panda$core$Bit) { $tmp948 }).value) {
    {
        panda$core$Int32 $tmp949 = panda$core$Int32$$BAND$panda$core$Int32$R$panda$core$Int32(result941, ((panda$core$Int32) { 31 }));
        panda$core$Int32 $tmp950 = panda$core$Int32$$SHL$panda$core$Int32$R$panda$core$Int32($tmp949, ((panda$core$Int32) { 6 }));
        panda$core$Int64 $tmp951 = panda$core$Int64$$ADD$panda$core$Int64$R$panda$core$Int64(self->index, ((panda$core$Int64) { 1 }));
        panda$core$Int32 $tmp952 = panda$core$Char8$convert$R$panda$core$Int32(self->str->data[$tmp951.value]);
        panda$core$Int32 $tmp953 = panda$core$Int32$$BAND$panda$core$Int32$R$panda$core$Int32($tmp952, ((panda$core$Int32) { 63 }));
        panda$core$Int32 $tmp954 = panda$core$Int32$$ADD$panda$core$Int32$R$panda$core$Int32($tmp950, $tmp953);
        result941 = $tmp954;
        panda$core$Int64 $tmp955 = panda$core$Int64$$ADD$panda$core$Int64$R$panda$core$Int64(self->index, ((panda$core$Int64) { 2 }));
        self->index = $tmp955;
        panda$core$Char32$init$panda$core$Int32(&$tmp956, result941);
        return $tmp956;
    }
    }
    int64_t $tmp957 = ((int64_t) c940.value) & 255;
    bool $tmp958 = $tmp957 < 224;
    if (((panda$core$Bit) { $tmp958 }).value) {
    {
        panda$core$Int32 $tmp959 = panda$core$Int32$$BAND$panda$core$Int32$R$panda$core$Int32(result941, ((panda$core$Int32) { 15 }));
        panda$core$Int32 $tmp960 = panda$core$Int32$$SHL$panda$core$Int32$R$panda$core$Int32($tmp959, ((panda$core$Int32) { 12 }));
        panda$core$Int64 $tmp961 = panda$core$Int64$$ADD$panda$core$Int64$R$panda$core$Int64(self->index, ((panda$core$Int64) { 1 }));
        panda$core$Int32 $tmp962 = panda$core$Char8$convert$R$panda$core$Int32(self->str->data[$tmp961.value]);
        panda$core$Int32 $tmp963 = panda$core$Int32$$BAND$panda$core$Int32$R$panda$core$Int32($tmp962, ((panda$core$Int32) { 63 }));
        panda$core$Int32 $tmp964 = panda$core$Int32$$SHL$panda$core$Int32$R$panda$core$Int32($tmp963, ((panda$core$Int32) { 6 }));
        panda$core$Int32 $tmp965 = panda$core$Int32$$ADD$panda$core$Int32$R$panda$core$Int32($tmp960, $tmp964);
        panda$core$Int64 $tmp966 = panda$core$Int64$$ADD$panda$core$Int64$R$panda$core$Int64(self->index, ((panda$core$Int64) { 2 }));
        panda$core$Int32 $tmp967 = panda$core$Char8$convert$R$panda$core$Int32(self->str->data[$tmp966.value]);
        panda$core$Int32 $tmp968 = panda$core$Int32$$BAND$panda$core$Int32$R$panda$core$Int32($tmp967, ((panda$core$Int32) { 63 }));
        panda$core$Int32 $tmp969 = panda$core$Int32$$ADD$panda$core$Int32$R$panda$core$Int32($tmp965, $tmp968);
        result941 = $tmp969;
        panda$core$Int64 $tmp970 = panda$core$Int64$$ADD$panda$core$Int64$R$panda$core$Int64(self->index, ((panda$core$Int64) { 3 }));
        self->index = $tmp970;
        panda$core$Char32$init$panda$core$Int32(&$tmp971, result941);
        return $tmp971;
    }
    }
    panda$core$Int32 $tmp972 = panda$core$Int32$$BAND$panda$core$Int32$R$panda$core$Int32(result941, ((panda$core$Int32) { 7 }));
    panda$core$Int32 $tmp973 = panda$core$Int32$$SHL$panda$core$Int32$R$panda$core$Int32($tmp972, ((panda$core$Int32) { 18 }));
    panda$core$Int64 $tmp974 = panda$core$Int64$$ADD$panda$core$Int64$R$panda$core$Int64(self->index, ((panda$core$Int64) { 1 }));
    panda$core$Int32 $tmp975 = panda$core$Char8$convert$R$panda$core$Int32(self->str->data[$tmp974.value]);
    panda$core$Int32 $tmp976 = panda$core$Int32$$BAND$panda$core$Int32$R$panda$core$Int32($tmp975, ((panda$core$Int32) { 63 }));
    panda$core$Int32 $tmp977 = panda$core$Int32$$SHL$panda$core$Int32$R$panda$core$Int32($tmp976, ((panda$core$Int32) { 12 }));
    panda$core$Int32 $tmp978 = panda$core$Int32$$ADD$panda$core$Int32$R$panda$core$Int32($tmp973, $tmp977);
    panda$core$Int64 $tmp979 = panda$core$Int64$$ADD$panda$core$Int64$R$panda$core$Int64(self->index, ((panda$core$Int64) { 2 }));
    panda$core$Int32 $tmp980 = panda$core$Char8$convert$R$panda$core$Int32(self->str->data[$tmp979.value]);
    panda$core$Int32 $tmp981 = panda$core$Int32$$BAND$panda$core$Int32$R$panda$core$Int32($tmp980, ((panda$core$Int32) { 63 }));
    panda$core$Int32 $tmp982 = panda$core$Int32$$SHL$panda$core$Int32$R$panda$core$Int32($tmp981, ((panda$core$Int32) { 6 }));
    panda$core$Int32 $tmp983 = panda$core$Int32$$ADD$panda$core$Int32$R$panda$core$Int32($tmp978, $tmp982);
    panda$core$Int64 $tmp984 = panda$core$Int64$$ADD$panda$core$Int64$R$panda$core$Int64(self->index, ((panda$core$Int64) { 3 }));
    panda$core$Int32 $tmp985 = panda$core$Char8$convert$R$panda$core$Int32(self->str->data[$tmp984.value]);
    panda$core$Int32 $tmp986 = panda$core$Int32$$BAND$panda$core$Int32$R$panda$core$Int32($tmp985, ((panda$core$Int32) { 63 }));
    panda$core$Int32 $tmp987 = panda$core$Int32$$ADD$panda$core$Int32$R$panda$core$Int32($tmp983, $tmp986);
    result941 = $tmp987;
    panda$core$Int64 $tmp988 = panda$core$Int64$$ADD$panda$core$Int64$R$panda$core$Int64(self->index, ((panda$core$Int64) { 4 }));
    self->index = $tmp988;
    panda$core$Char32$init$panda$core$Int32(&$tmp989, result941);
    return $tmp989;
}
