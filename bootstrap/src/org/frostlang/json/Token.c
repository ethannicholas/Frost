...
org$frostlang$json$Token$class_type org$frostlang$json$Token$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$Object$convert$R$frost$core$String, org$frostlang$json$Token$cleanup$shim} };

static frost$core$String $s2;
org$frostlang$json$Token$wrapperclass_type org$frostlang$json$Token$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, &$s2, (frost$core$Class*) &frost$core$Value$class, NULL, { frost$core$Object$convert$R$frost$core$String, org$frostlang$json$Token$cleanup$shim} };
