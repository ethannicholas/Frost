...
org$frostlang$frostc$LLVMCodeGenerator$ClassConstant$class_type org$frostlang$frostc$LLVMCodeGenerator$ClassConstant$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Immutable$class, NULL, { frost$core$Object$get_asString$R$frost$core$String, org$frostlang$frostc$LLVMCodeGenerator$ClassConstant$cleanup$shim} };
