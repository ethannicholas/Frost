...
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x2e\x66\x72\x6f\x73\x74\x63\x2e\x70\x61\x73\x73\x2e\x41\x6e\x61\x6c\x79\x7a\x65\x72\x2e\x44\x65\x66\x69\x6e\x69\x74\x69\x6f\x6e", 45, -2258664296644250430, NULL };
static frost$core$String $s5 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x43\x4f\x4e\x53\x54\x52\x55\x43\x54\x4f\x52\x28\x69\x64\x29", 15, 5840846683693172779, NULL };
static frost$core$String $s6 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x43\x4f\x4e\x53\x54\x52\x55\x43\x54\x4f\x52\x28\x69\x64\x29", 15, 5840846683693172779, NULL };
static frost$core$String $s8 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x46\x49\x45\x4c\x44\x28", 6, -2129528048268295747, NULL };
...
static frost$core$String $s13 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x4c\x4f\x43\x41\x4c\x28", 6, -1523601060637538272, NULL };
static frost$core$String $s14 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x29", 1, -5808618445805089436, NULL };
static frost$core$String $s17 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x50\x41\x52\x41\x4d\x45\x54\x45\x52\x28", 10, 8631742952335322280, NULL };
static frost$core$String $s18 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x29", 1, -5808618445805089436, NULL };
static frost$core$String $s19 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x55\x4e\x53\x50\x45\x43\x49\x46\x49\x45\x44", 11, -5143693783589769076, NULL };
static frost$core$String $s20 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x55\x4e\x53\x50\x45\x43\x49\x46\x49\x45\x44", 11, -5143693783589769076, NULL };
static frost$core$String $s21 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x41\x6e\x61\x6c\x79\x7a\x65\x72\x2e\x66\x72\x6f\x73\x74", 14, -791630141084995549, NULL };
static frost$core$String $s24 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x41\x6e\x61\x6c\x79\x7a\x65\x72\x2e\x66\x72\x6f\x73\x74", 14, -791630141084995549, NULL };

frost$core$String* org$frostlang$frostc$pass$Analyzer$Definition$get_asString$R$frost$core$String(void* rawSelf) {
org$frostlang$frostc$pass$Analyzer$Definition* param0 = (org$frostlang$frostc$pass$Analyzer$Definition*) rawSelf;
...
block2:;
_13 = &param0->$data.$CONSTRUCTOR.field0;
_14 = *_13;
*(&local0) = _14;
...
block9:;
_99 = &param0->$data.$LOCAL.field0;
_100 = *_99;
*(&local3) = _100;
// /Users/ethannicholas/Dropbox/Frost/src/frostc/org/frostlang/frostc/pass/Analyzer.frost:33
_103 = *(&local3);
frost$core$Int$wrapper* $tmp11;
$tmp11 = (frost$core$Int$wrapper*) frostObjectAlloc(sizeof(frost$core$Int$wrapper), (frost$core$Class*) &frost$core$Int$wrapperclass);
$tmp11->value = _103;
...
block13:;
_137 = &param0->$data.$PARAMETER.field0;
_138 = *_137;
*(&local4) = _138;
// /Users/ethannicholas/Dropbox/Frost/src/frostc/org/frostlang/frostc/pass/Analyzer.frost:36
_141 = *(&local4);
frost$core$Int$wrapper* $tmp15;
$tmp15 = (frost$core$Int$wrapper*) frostObjectAlloc(sizeof(frost$core$Int$wrapper), (frost$core$Class*) &frost$core$Int$wrapperclass);
$tmp15->value = _141;
...
frost$core$Bit org$frostlang$frostc$pass$Analyzer$Definition$matches$org$frostlang$frostc$pass$Analyzer$Definition$R$frost$core$Bit(void* rawSelf, org$frostlang$frostc$pass$Analyzer$Definition* param1) {
org$frostlang$frostc$pass$Analyzer$Definition* param0 = (org$frostlang$frostc$pass$Analyzer$Definition*) rawSelf;
...
block6:;
_29 = &param1->$data.$CONSTRUCTOR.field0;
_30 = *_29;
*(&local1) = _30;
...
// /Users/ethannicholas/Dropbox/Frost/src/frostc/org/frostlang/frostc/IR.frost:155
_37 = _33.value;
_38 = _34.value;
// begin inline call to function frost.core.Int.=(other:frost.core.Int):frost.core.Bit from IR.frost:155:30
// /Users/ethannicholas/Dropbox/Frost/src/frost/core/Int.frost:426
_41 = _37.value;
_42 = _38.value;
_43 = _41 == _42;
...
block26:;
_207 = &param0->$data.$PARAMETER.field0;
_208 = *_207;
*(&local9) = _208;
...
block30:;
_223 = &param1->$data.$PARAMETER.field0;
_224 = *_223;
*(&local10) = _224;
...
block11:;
_86 = &param0->$data.$PARAMETER.field0;
_87 = *_86;
*(&local4) = _87;
goto block1;
block12:;
...
void org$frostlang$frostc$pass$Analyzer$Definition$init$frost$core$Int$org$frostlang$frostc$IR$Statement$ID(void* rawSelf, frost$core$Int param1, org$frostlang$frostc$IR$Statement$ID param2) {
org$frostlang$frostc$pass$Analyzer$Definition* param0 = (org$frostlang$frostc$pass$Analyzer$Definition*) rawSelf;
...
*_1 = param1;
// /Users/ethannicholas/Dropbox/Frost/src/frostc/org/frostlang/frostc/pass/Analyzer.frost:16
_4 = &param0->$data.$CONSTRUCTOR.field0;
*_4 = param2;
return;

}
void org$frostlang$frostc$pass$Analyzer$Definition$init$frost$core$Int$org$frostlang$frostc$pass$Analyzer$Definition$org$frostlang$frostc$FieldDecl(void* rawSelf, frost$core$Int param1, org$frostlang$frostc$pass$Analyzer$Definition* param2, org$frostlang$frostc$FieldDecl* param3) {
org$frostlang$frostc$pass$Analyzer$Definition* param0 = (org$frostlang$frostc$pass$Analyzer$Definition*) rawSelf;
...
_11 = &param0->$data.$FIELD.field1;
*_11 = param3;
return;

}
void org$frostlang$frostc$pass$Analyzer$Definition$init$frost$core$Int$frost$core$Int(void* rawSelf, frost$core$Int param1, frost$core$Int param2) {
org$frostlang$frostc$pass$Analyzer$Definition* param0 = (org$frostlang$frostc$pass$Analyzer$Definition*) rawSelf;
...
void org$frostlang$frostc$pass$Analyzer$Definition$init$frost$core$Int(void* rawSelf, frost$core$Int param1) {
org$frostlang$frostc$pass$Analyzer$Definition* param0 = (org$frostlang$frostc$pass$Analyzer$Definition*) rawSelf;
