...
org$frostlang$frostc$Code$PrimitiveType$_Closure5$class_type org$frostlang$frostc$Code$PrimitiveType$_Closure5$class = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s1, (frost$core$Class*) &frost$core$Object$class, NULL, { frost$core$Object$get_asString$R$frost$core$String, org$frostlang$frostc$Code$PrimitiveType$_Closure5$cleanup, org$frostlang$frostc$Code$PrimitiveType$_Closure5$$anonymous4$frost$collections$CollectionView$T$frost$collections$CollectionView$T$R$frost$collections$CollectionView$T} };
...
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x2e\x66\x72\x6f\x73\x74\x63\x2e\x43\x6f\x64\x65\x2e\x50\x72\x69\x6d\x69\x74\x69\x76\x65\x54\x79\x70\x65\x2e\x5f\x43\x6c\x6f\x73\x75\x72\x65\x35", 49, -6188576140772372231, NULL };

void org$frostlang$frostc$Code$PrimitiveType$_Closure5$init$$LPfrost$core$Int$Cfrost$core$Int$RP$EQ$GT$LPfrost$core$Int$RP(void* rawSelf, frost$core$MutableMethod* param1) {
org$frostlang$frostc$Code$PrimitiveType$_Closure5* param0 = (org$frostlang$frostc$Code$PrimitiveType$_Closure5*) rawSelf;
...
void org$frostlang$frostc$Code$PrimitiveType$_Closure5$cleanup(void* rawSelf) {
org$frostlang$frostc$Code$PrimitiveType$_Closure5* param0 = (org$frostlang$frostc$Code$PrimitiveType$_Closure5*) rawSelf;
...
frost$core$Object* org$frostlang$frostc$Code$PrimitiveType$_Closure5$$anonymous4$frost$collections$CollectionView$T$frost$collections$CollectionView$T$R$frost$collections$CollectionView$T(void* rawSelf, frost$core$Object* param1, frost$core$Object* param2) {
org$frostlang$frostc$Code$PrimitiveType$_Closure5* param0 = (org$frostlang$frostc$Code$PrimitiveType$_Closure5*) rawSelf;
