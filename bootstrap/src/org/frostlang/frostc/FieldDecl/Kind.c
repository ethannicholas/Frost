...
struct { frost$core$Class* cl; ITable* next; void* methods[1]; } org$frostlang$frostc$FieldDecl$Kind$_frost$collections$Key = { (frost$core$Class*) &frost$collections$Key$class, NULL, { org$frostlang$frostc$FieldDecl$Kind$get_hash$R$frost$core$Int$shim} };

struct { frost$core$Class* cl; ITable* next; void* methods[2]; } org$frostlang$frostc$FieldDecl$Kind$_frost$core$Equatable = { (frost$core$Class*) &frost$core$Equatable$class, (ITable*) &org$frostlang$frostc$FieldDecl$Kind$_frost$collections$Key, { org$frostlang$frostc$FieldDecl$Kind$$EQ$org$frostlang$frostc$FieldDecl$Kind$R$frost$core$Bit$shim, frost$core$Equatable$$NEQ$frost$core$Equatable$T$R$frost$core$Bit} };
...
struct { frost$core$Class* cl; ITable* itable; void* methods[1]; } org$frostlang$frostc$FieldDecl$Kind$wrapper_frost$collections$Key = { (frost$core$Class*) &frost$collections$Key$class, NULL, { org$frostlang$frostc$FieldDecl$Kind$get_hash$R$frost$core$Int$shim} };

struct { frost$core$Class* cl; ITable* itable; void* methods[2]; } org$frostlang$frostc$FieldDecl$Kind$wrapper_frost$core$Equatable = { (frost$core$Class*) &frost$core$Equatable$class, (ITable*) &org$frostlang$frostc$FieldDecl$Kind$wrapper_frost$collections$Key, { org$frostlang$frostc$FieldDecl$Kind$$EQ$org$frostlang$frostc$FieldDecl$Kind$R$frost$core$Bit$shim, frost$core$Equatable$$NEQ$frost$core$Equatable$T$R$frost$core$Bit} };
...
static frost$core$String $s44 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x46\x69\x65\x6c\x64\x44\x65\x63\x6c\x2e\x66\x72\x6f\x73\x74", 15, 6034765482031789227, NULL };
...
static frost$core$String $s79 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x46\x69\x65\x6c\x64\x44\x65\x63\x6c\x2e\x66\x72\x6f\x73\x74", 15, 6034765482031789227, NULL };
...
*$tmp3 = param0;
org$frostlang$frostc$FieldDecl$Kind $tmp4 = *(&local0);
return $tmp4;
...
block2:;
// /Users/ethannicholas/Dropbox/Frost/src/frostc/org/frostlang/frostc/FieldDecl.frost:5
frost$core$Int $tmp21 = (frost$core$Int) {8994148639201449172u};
return $tmp21;
block3:;
...
block5:;
// /Users/ethannicholas/Dropbox/Frost/src/frostc/org/frostlang/frostc/FieldDecl.frost:5
frost$core$Int $tmp28 = (frost$core$Int) {17988297278402898344u};
return $tmp28;
block6:;
...
block8:;
// /Users/ethannicholas/Dropbox/Frost/src/frostc/org/frostlang/frostc/FieldDecl.frost:5
frost$core$Int $tmp35 = (frost$core$Int) {8535701843894795900u};
return $tmp35;
block9:;
...
block11:;
// /Users/ethannicholas/Dropbox/Frost/src/frostc/org/frostlang/frostc/FieldDecl.frost:5
frost$core$Int $tmp42 = (frost$core$Int) {17529850483096245072u};
return $tmp42;
block12:;
// /Users/ethannicholas/Dropbox/Frost/src/frostc/org/frostlang/frostc/FieldDecl.frost:5
frost$core$Int $tmp43 = (frost$core$Int) {5u};
