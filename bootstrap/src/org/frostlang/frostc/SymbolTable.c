...
frost$collections$Array$init$frost$collections$CollectionView$LTfrost$collections$Array$T$GT($tmp280, ((frost$collections$CollectionView*) $tmp282));
...
frost$collections$Array$init$frost$collections$CollectionView$LTfrost$collections$Array$T$GT($tmp309, ((frost$collections$CollectionView*) $tmp311));
