...
org$frostlang$frostc$Alias$class_type org$frostlang$frostc$Alias$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &org$frostlang$frostc$Symbol$class, NULL, { org$frostlang$frostc$Alias$convert$R$frost$core$String, org$frostlang$frostc$Alias$cleanup, org$frostlang$frostc$Symbol$get_heritable$R$frost$core$Bit} };
...
void org$frostlang$frostc$Alias$init$frost$core$String$frost$core$String$org$frostlang$frostc$Position(org$frostlang$frostc$Alias* param0, frost$core$String* param1, frost$core$String* param2, org$frostlang$frostc$Position param3) {

// line 8
frost$core$Int64 $tmp2 = (frost$core$Int64) {0};
org$frostlang$frostc$Symbol$Kind $tmp3 = org$frostlang$frostc$Symbol$Kind$init$frost$core$Int64($tmp2);
org$frostlang$frostc$Symbol$init$org$frostlang$frostc$Symbol$Kind$org$frostlang$frostc$Position$frost$core$String(((org$frostlang$frostc$Symbol*) param0), $tmp3, param3, param1);
// line 9
...
frost$core$String* org$frostlang$frostc$Alias$convert$R$frost$core$String(org$frostlang$frostc$Alias* param0) {

// line 14
frost$core$String** $tmp7 = &((org$frostlang$frostc$Symbol*) param0)->name;
