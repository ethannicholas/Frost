...
org$frostlang$frostc$frostdoc$Markdown$LinkDefinition* _459;
...
_451 = _450.value;
if (_451) goto block35; else goto block36;
block36:;
_453 = (frost$core$Int) {1070u};
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int$frost$core$String(&$s66, _453, &$s67);
abort(); // unreachable
block35:;
