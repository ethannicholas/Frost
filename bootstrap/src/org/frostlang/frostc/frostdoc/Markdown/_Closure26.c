...
org$frostlang$frostc$frostdoc$Markdown$_Closure26$class_type org$frostlang$frostc$frostdoc$Markdown$_Closure26$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, NULL, { frost$core$Object$convert$R$frost$core$String, org$frostlang$frostc$frostdoc$Markdown$_Closure26$cleanup, org$frostlang$frostc$frostdoc$Markdown$_Closure26$$anonymous25$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$Object} };
...
typedef frost$core$String* (*$fn105)(org$frostlang$frostc$frostdoc$Protector*, frost$core$String*);
...
org$frostlang$frostc$frostdoc$Markdown** $tmp100 = &param0->$self;
org$frostlang$frostc$frostdoc$Markdown* $tmp101 = *$tmp100;
org$frostlang$frostc$frostdoc$Protector** $tmp102 = &$tmp101->charProtector;
org$frostlang$frostc$frostdoc$Protector* $tmp103 = *$tmp102;
...
org$frostlang$frostc$frostdoc$Markdown$LinkDefinition* $tmp137 = *(&local4);
