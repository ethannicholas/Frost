#include "org/frostlang/frostc/LLVMBackend/_Closure2.h"
...
org$frostlang$frostc$LLVMBackend$_Closure2$class_type org$frostlang$frostc$LLVMBackend$_Closure2$class = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s1, (frost$core$Class*) &frost$core$Object$class, NULL, { frost$core$Object$get_asString$R$frost$core$String, org$frostlang$frostc$LLVMBackend$_Closure2$cleanup, org$frostlang$frostc$LLVMBackend$_Closure2$$anonymous1$org$frostlang$frostc$Code$Value$R$frost$core$String} };
...
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x2e\x66\x72\x6f\x73\x74\x63\x2e\x4c\x4c\x56\x4d\x42\x61\x63\x6b\x65\x6e\x64\x2e\x5f\x43\x6c\x6f\x73\x75\x72\x65\x32", 42, -5644436275156059695, NULL };
static frost$core$String $s4 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x20", 1, -5808626142386486913, NULL };

void org$frostlang$frostc$LLVMBackend$_Closure2$init$org$frostlang$frostc$LLVMBackend(void* rawSelf, org$frostlang$frostc$LLVMBackend* param1) {
org$frostlang$frostc$LLVMBackend$_Closure2* param0 = (org$frostlang$frostc$LLVMBackend$_Closure2*) rawSelf;
...
// /Users/ethannicholas/Dropbox/Frost/src/frostc/org/frostlang/frostc/LLVMBackend.frost:193
...
void org$frostlang$frostc$LLVMBackend$_Closure2$cleanup(void* rawSelf) {
org$frostlang$frostc$LLVMBackend$_Closure2* param0 = (org$frostlang$frostc$LLVMBackend$_Closure2*) rawSelf;
...
frost$core$String* org$frostlang$frostc$LLVMBackend$_Closure2$$anonymous1$org$frostlang$frostc$Code$Value$R$frost$core$String(void* rawSelf, org$frostlang$frostc$Code$Value* param1) {
org$frostlang$frostc$LLVMBackend$_Closure2* param0 = (org$frostlang$frostc$LLVMBackend$_Closure2*) rawSelf;
...
_1 = &param0->$dummy1;
_2 = *_1;
// begin inline call to method org.frostlang.frostc.LLVMBackend.getTypedReference(v:org.frostlang.frostc.Code.Value):frost.core.String from LLVMBackend.frost:193:43
