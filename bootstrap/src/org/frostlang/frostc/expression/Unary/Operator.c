...
static frost$core$String $s33 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x21", 1, 134, NULL };
static frost$core$String $s34 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x21", 1, 134, NULL };
static frost$core$String $s38 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x21\x21", 2, 13567, NULL };
static frost$core$String $s39 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x21\x21", 2, 13567, NULL };
static frost$core$String $s43 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x2d", 1, 146, NULL };
static frost$core$String $s44 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x2d", 1, 146, NULL };
static frost$core$String $s48 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x55\x6e\x61\x72\x79\x2e\x66\x72\x6f\x73\x74", 11, 6986272374594638012, NULL };
...
frost$core$Bit $tmp36 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp29, $tmp35);
...
frost$core$Bit $tmp41 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp29, $tmp40);
...
if ($tmp46) goto block8; else goto block9;
block9:;
frost$core$Int64 $tmp47 = (frost$core$Int64) {38};
...
frost$core$Bit $tmp51 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp49, $tmp50);
bool $tmp52 = $tmp51.value;
if ($tmp52) goto block2; else goto block3;
block2:;
goto block1;
block3:;
frost$core$Int64 $tmp53 = (frost$core$Int64) {1};
frost$core$Bit $tmp54 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp49, $tmp53);
bool $tmp55 = $tmp54.value;
if ($tmp55) goto block4; else goto block5;
block4:;
goto block1;
block5:;
frost$core$Int64 $tmp56 = (frost$core$Int64) {2};
frost$core$Bit $tmp57 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp49, $tmp56);
bool $tmp58 = $tmp57.value;
if ($tmp58) goto block6; else goto block1;
block6:;
goto block1;
block1:;
return;
...
// line 17
frost$core$Int64* $tmp59 = &(&local0)->$rawValue;
*$tmp59 = param0;
org$frostlang$frostc$expression$Unary$Operator $tmp60 = *(&local0);
return $tmp60;
...
// line 17
frost$core$Int64 $tmp61 = param0.$rawValue;
frost$core$Int64 $tmp62 = param1.$rawValue;
