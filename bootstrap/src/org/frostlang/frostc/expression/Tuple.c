...
static frost$core$String $s27 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x54\x75\x70\x6c\x65\x2e\x66\x72\x6f\x73\x74", 11, 4603043468144271925, NULL };
...
static frost$core$String $s39 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x54\x79\x70\x65\x2e\x66\x72\x6f\x73\x74", 10, -6889415344013242207, NULL };
...
static frost$core$String $s46 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x54\x75\x70\x6c\x65\x2e\x66\x72\x6f\x73\x74", 11, 4603043468144271925, NULL };
...
static frost$core$String $s49 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x54\x75\x70\x6c\x65\x2e\x66\x72\x6f\x73\x74", 11, 4603043468144271925, NULL };
...
static frost$core$String $s52 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x54\x75\x70\x6c\x65\x2e\x66\x72\x6f\x73\x74", 11, 4603043468144271925, NULL };
...
static frost$core$String $s68 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x54\x75\x70\x6c\x65\x2e\x66\x72\x6f\x73\x74", 11, 4603043468144271925, NULL };
...
static frost$core$String $s73 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x54\x75\x70\x6c\x65\x2e\x66\x72\x6f\x73\x74", 11, 4603043468144271925, NULL };
...
_143 = (org$frostlang$frostc$expression$Tuple$_Closure2*) frostObjectAlloc(sizeof(org$frostlang$frostc$expression$Tuple$_Closure2), (frost$core$Class*) &org$frostlang$frostc$expression$Tuple$_Closure2$class);
...
_146 = (frost$core$MutableMethod*) frostObjectAlloc(sizeof(frost$core$MutableMethod), (frost$core$Class*) &frost$core$MutableMethod$class);
...
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int$frost$core$String(&$s27, _82, &$s28);
abort(); // unreachable
block6:;
_85 = _77;
...
_102 = (frost$collections$Array*) frostObjectAlloc(sizeof(frost$collections$Array), (frost$core$Class*) &frost$collections$Array$class);
_103 = _102;
...
$tmp37->value = _13;
_14 = ((frost$core$Equatable*) $tmp37);
ITable* $tmp38 = _4->$class->itable;
...
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int$frost$core$String(&$s39, _31, &$s40);
abort(); // unreachable
block6:;
_34 = _26;
...
block16:;
_97 = (frost$core$Int) {246u};
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int$frost$core$String(&$s44, _97, &$s45);
abort(); // unreachable
block15:;
_100 = _92;
...
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int$frost$core$String(&$s46, _145, &$s47);
abort(); // unreachable
block19:;
_148 = _140;
_149 = &_148->second;
...
_187 = (org$frostlang$frostc$Pair*) frostObjectAlloc(sizeof(org$frostlang$frostc$Pair), (frost$core$Class*) &org$frostlang$frostc$Pair$class);
_188 = _187;
...
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int$frost$core$String(&$s49, _232, &$s50);
abort(); // unreachable
block26:;
_235 = _227;
ITable* $tmp51 = _235->$class->itable;
while ($tmp51->$class != (frost$core$Class*) &frost$collections$CollectionView$class) {
    $tmp51 = $tmp51->next;
}
_236 = $tmp51->methods[0];
_237 = _236(_235);
...
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int(&$s52, _248);
abort(); // unreachable
block29:;
...
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int$frost$core$String(&$s53, _257, &$s54);
abort(); // unreachable
block31:;
_260 = ((frost$collections$Iterable*) _252);
ITable* $tmp55 = _260->$class->itable;
while ($tmp55->$class != (frost$core$Class*) &frost$collections$Iterable$class) {
    $tmp55 = $tmp55->next;
}
_261 = $tmp55->methods[0];
_262 = _261(_260);
_263 = _262;
_264 = _263;
ITable* $tmp56 = _264->$class->itable;
while ($tmp56->$class != (frost$core$Class*) &frost$collections$Iterator$class) {
    $tmp56 = $tmp56->next;
}
_265 = $tmp56->methods[1];
_266 = _265(_264);
_267 = ((org$frostlang$frostc$Type*) _266);
// begin inline call to method org.frostlang.frostc.Compiler.coercionCost(type:org.frostlang.frostc.Type, target:org.frostlang.frostc.Type):org.frostlang.frostc.Pair<org.frostlang.frostc.Type, frost.core.Int>? from Tuple.frost:59:37
// /Users/ethannicholas/Dropbox/Frost/src/frostc/org/frostlang/frostc/Compiler.frost:2106
_270 = (frost$core$Bit) {true};
_271 = org$frostlang$frostc$Compiler$coercionCost$org$frostlang$frostc$Type$org$frostlang$frostc$Type$frost$core$Bit$R$org$frostlang$frostc$Pair$LTorg$frostlang$frostc$Type$Cfrost$core$Int$GT$Q(param0, _267, param2, _270);
_272 = ((frost$core$Object*) _271);
frost$core$Frost$ref$frost$core$Object$Q(_272);
_274 = ((frost$core$Object*) _271);
frost$core$Frost$unref$frost$core$Object$Q(_274);
_277 = ((frost$core$Object*) _271);
...
org$frostlang$frostc$expression$Tuple$_Closure4* _226;
frost$core$Int8* _228;
frost$core$MutableMethod* _229;
frost$core$Object* _230;
frost$core$Int8** _233;
frost$core$Object** _237;
frost$core$Object* _238;
frost$core$Object** _240;
frost$core$MutableMethod* _243;
frost$core$MutableMethod* _244;
$fn60 _245;
...
org$frostlang$frostc$Compiler$TypeContext* _267;
frost$core$Int _268;
...
org$frostlang$frostc$IR$Value* _311;
...
$tmp62->value = _41;
_42 = ((frost$core$Equatable*) $tmp62);
ITable* $tmp63 = _32->$class->itable;
...
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int$frost$core$String(&$s64, _61, &$s65);
abort(); // unreachable
block10:;
_64 = _56;
...
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int$frost$core$String(&$s68, _92, &$s69);
abort(); // unreachable
block13:;
_95 = _87;
_96 = &_95->type;
...
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int$frost$core$String(&$s70, _107, &$s71);
abort(); // unreachable
block16:;
_110 = _102;
...
_133 = (org$frostlang$frostc$IR$Value*) frostObjectAlloc(sizeof(org$frostlang$frostc$IR$Value), (frost$core$Class*) &org$frostlang$frostc$IR$Value$class);
...
_138 = *_137;
_139 = (frost$collections$Array*) frostObjectAlloc(sizeof(frost$collections$Array), (frost$core$Class*) &frost$collections$Array$class);
_140 = _139;
...
_164 = (org$frostlang$frostc$Compiler$TypeContext*) frostObjectAlloc(sizeof(org$frostlang$frostc$Compiler$TypeContext), (frost$core$Class*) &org$frostlang$frostc$Compiler$TypeContext$class);
...
_168 = *(&local0);
// begin inline call to method org.frostlang.frostc.Compiler.cast(position:org.frostlang.frostc.Position, value:org.frostlang.frostc.IR.Value?, target:org.frostlang.frostc.Type):org.frostlang.frostc.IR.Value? from Tuple.frost:69:41
// /Users/ethannicholas/Dropbox/Frost/src/frostc/org/frostlang/frostc/Compiler.frost:4079
_171 = (frost$core$Bit) {false};
_172 = org$frostlang$frostc$Compiler$cast$org$frostlang$frostc$Position$org$frostlang$frostc$IR$Value$Q$org$frostlang$frostc$Type$frost$core$Bit$R$org$frostlang$frostc$IR$Value$Q(param0, param1, _167, _168, _171);
...
_204 = (frost$core$Int) {43u};
org$frostlang$frostc$ASTNode$init$frost$core$Int$org$frostlang$frostc$Position$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$ASTNode$GT(_203, _204, param1, param2);
_206 = org$frostlang$frostc$Compiler$preferredType$org$frostlang$frostc$ASTNode$R$org$frostlang$frostc$Type$Q(param0, _203);
...
*(&local5) = _206;
_214 = ((frost$core$Object*) _206);
frost$core$Frost$unref$frost$core$Object$Q(_214);
_216 = ((frost$core$Object*) _203);
...
_225 = ((frost$collections$CollectionView*) param2);
_226 = (org$frostlang$frostc$expression$Tuple$_Closure4*) frostObjectAlloc(sizeof(org$frostlang$frostc$expression$Tuple$_Closure4), (frost$core$Class*) &org$frostlang$frostc$expression$Tuple$_Closure4$class);
org$frostlang$frostc$expression$Tuple$_Closure4$init$org$frostlang$frostc$Compiler(_226, param0);
_228 = ((frost$core$Int8*) org$frostlang$frostc$expression$Tuple$_Closure4$$anonymous3$org$frostlang$frostc$ASTNode$R$org$frostlang$frostc$Type);
_229 = (frost$core$MutableMethod*) frostObjectAlloc(sizeof(frost$core$MutableMethod), (frost$core$Class*) &frost$core$MutableMethod$class);
...
_243 = _229;
_244 = _243;
ITable* $tmp72 = _225->$class->itable;
while ($tmp72->$class != (frost$core$Class*) &frost$collections$CollectionView$class) {
    $tmp72 = $tmp72->next;
}
_245 = $tmp72->methods[9];
_246 = _245(_225, _244);
_247 = _246;
_248 = ((frost$collections$ListView*) _247);
_249 = org$frostlang$frostc$Type$tuple$frost$collections$ListView$LTorg$frostlang$frostc$Type$GT$R$org$frostlang$frostc$Type(_248);
_250 = _249;
...
_267 = (org$frostlang$frostc$Compiler$TypeContext*) frostObjectAlloc(sizeof(org$frostlang$frostc$Compiler$TypeContext), (frost$core$Class*) &org$frostlang$frostc$Compiler$TypeContext$class);
_268 = (frost$core$Int) {3u};
_269 = *(&local5);
_270 = _269 != NULL;
_271 = (frost$core$Bit) {_270};
_272 = _271.value;
if (_272) goto block24; else goto block25;
block25:;
_274 = (frost$core$Int) {78u};
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int$frost$core$String(&$s73, _274, &$s74);
abort(); // unreachable
block24:;
_277 = _269;
_278 = (frost$core$Bit) {false};
org$frostlang$frostc$Compiler$TypeContext$init$frost$core$Int$org$frostlang$frostc$Type$frost$core$Bit(_267, _268, _277, _278);
_280 = org$frostlang$frostc$expression$Tuple$compile$org$frostlang$frostc$Compiler$org$frostlang$frostc$Position$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$ASTNode$GT$org$frostlang$frostc$Compiler$TypeContext$R$org$frostlang$frostc$IR$Value$Q(param0, param1, param2, _267);
...
*(&local6) = _280;
_288 = ((frost$core$Object*) _280);
frost$core$Frost$unref$frost$core$Object$Q(_288);
_290 = ((frost$core$Object*) _267);
...
_296 = _295.value;
if (_296) goto block26; else goto block27;
block26:;
// /Users/ethannicholas/Dropbox/Frost/src/frostc/org/frostlang/frostc/expression/Tuple.frost:80
_299 = ((frost$core$Object*) ((org$frostlang$frostc$IR$Value*) NULL));
...
_311 = *(&local6);
_312 = org$frostlang$frostc$Compiler$coerce$org$frostlang$frostc$Position$org$frostlang$frostc$IR$Value$Q$org$frostlang$frostc$Compiler$TypeContext$R$org$frostlang$frostc$IR$Value$Q(param0, param1, _311, param3);
