...
// /Users/ethannicholas/Dropbox/Frost/src/frostc/org/frostlang/frostc/expression/Call.frost:643
_1 = &(&local0)->$rawValue;
*_1 = param0;
_3 = *(&local0);
return _3;
...
// begin inline call to function frost.core.Int.=(other:frost.core.Int):frost.core.Bit from Call.frost:643:5
