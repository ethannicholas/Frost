...
static frost$core$String $s29 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x41\x74\x50\x72\x65\x2e\x66\x72\x6f\x73\x74", 11, 3976641262113472341, NULL };
...
block6:;
frost$core$Int $tmp28 = (frost$core$Int) {24u};
