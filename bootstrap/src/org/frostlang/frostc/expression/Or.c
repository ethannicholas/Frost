...
static frost$core$String $s141 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x6f\x72\x20\x6c\x65\x66\x74\x20\x66\x61\x6c\x73\x65", 13, -8489645149640048250, NULL };
...
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:15
...
*(&local0) = $tmp3;
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:17
...
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:18
...
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:19
*(&local2) = ((org$frostlang$frostc$IR$Value*) NULL);
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:20
...
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:21
...
block1:;
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:22
...
block2:;
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:24
...
*(&local3) = $tmp38;
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:25
...
*(&local4) = $tmp43;
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:26
...
*(&local5) = $tmp48;
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:27
...
org$frostlang$frostc$IR$Statement$init$frost$core$Int$org$frostlang$frostc$Position$org$frostlang$frostc$IR$Value$org$frostlang$frostc$IR$Block$ID$org$frostlang$frostc$IR$Block$ID($tmp51, $tmp52, param1, $tmp54, $tmp55, $tmp56);
...
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:29
org$frostlang$frostc$IR* $tmp60 = *(&local0);
org$frostlang$frostc$IR$Block$ID $tmp61 = *(&local3);
$fn63 $tmp62 = ($fn63) $tmp60->$class->vtable[4];
$tmp62($tmp60, $tmp61);
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:30
...
frost$core$Int $tmp66 = (frost$core$Int) {27u};
org$frostlang$frostc$IR$Value* $tmp67 = *(&local2);
org$frostlang$frostc$IR$Value* $tmp68 = *(&local1);
org$frostlang$frostc$IR$Statement$init$frost$core$Int$org$frostlang$frostc$Position$org$frostlang$frostc$IR$Value$org$frostlang$frostc$IR$Value($tmp65, $tmp66, param1, $tmp67, $tmp68);
$fn70 $tmp69 = ($fn70) $tmp64->$class->vtable[2];
org$frostlang$frostc$IR$Statement$ID $tmp71 = $tmp69($tmp64, $tmp65);
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp65));
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:31
...
org$frostlang$frostc$IR$Statement$init$frost$core$Int$org$frostlang$frostc$Position$org$frostlang$frostc$IR$Block$ID($tmp73, $tmp74, param1, $tmp75);
$fn77 $tmp76 = ($fn77) $tmp72->$class->vtable[2];
org$frostlang$frostc$IR$Statement$ID $tmp78 = $tmp76($tmp72, $tmp73);
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp73));
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:32
org$frostlang$frostc$IR* $tmp79 = *(&local0);
org$frostlang$frostc$IR$Block$ID $tmp80 = *(&local4);
$fn82 $tmp81 = ($fn82) $tmp79->$class->vtable[4];
$tmp81($tmp79, $tmp80);
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:33
*(&local6) = ((org$frostlang$frostc$IR$Value*) NULL);
// <no location>
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:35
...
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:36
FROST_ASSERT(40 == sizeof(org$frostlang$frostc$Compiler$TypeContext));
...
frost$core$Bit $tmp89 = (frost$core$Bit) {false};
org$frostlang$frostc$Compiler$TypeContext$init$frost$core$Int$org$frostlang$frostc$Type$frost$core$Bit($tmp85, $tmp86, $tmp88, $tmp89);
...
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:38
org$frostlang$frostc$IR$Value* $tmp92 = *(&local6);
frost$core$Bit $tmp93 = (frost$core$Bit) {$tmp92 == NULL};
bool $tmp94 = $tmp93.value;
if ($tmp94) goto block3; else goto block4;
block3:;
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:39
frost$core$Frost$ref$frost$core$Object$Q(((frost$core$Object*) ((org$frostlang$frostc$IR$Value*) NULL)));
...
*(&local7) = ((org$frostlang$frostc$Compiler$AutoUnrefs*) NULL);
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:42
...
frost$core$Int $tmp103 = (frost$core$Int) {27u};
org$frostlang$frostc$IR$Value* $tmp104 = *(&local6);
org$frostlang$frostc$IR$Value* $tmp105 = *(&local1);
org$frostlang$frostc$IR$Statement$init$frost$core$Int$org$frostlang$frostc$Position$org$frostlang$frostc$IR$Value$org$frostlang$frostc$IR$Value($tmp102, $tmp103, param1, $tmp104, $tmp105);
$fn107 $tmp106 = ($fn107) $tmp101->$class->vtable[2];
org$frostlang$frostc$IR$Statement$ID $tmp108 = $tmp106($tmp101, $tmp102);
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp102));
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:43
...
org$frostlang$frostc$IR$Statement$init$frost$core$Int$org$frostlang$frostc$Position$org$frostlang$frostc$IR$Block$ID($tmp110, $tmp111, param1, $tmp112);
$fn114 $tmp113 = ($fn114) $tmp109->$class->vtable[2];
org$frostlang$frostc$IR$Statement$ID $tmp115 = $tmp113($tmp109, $tmp110);
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp110));
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:44
...
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:45
...
frost$core$Int $tmp122 = (frost$core$Int) {14u};
org$frostlang$frostc$IR$Value* $tmp123 = *(&local1);
org$frostlang$frostc$IR$Statement$init$frost$core$Int$org$frostlang$frostc$Position$org$frostlang$frostc$IR$Value($tmp121, $tmp122, param1, $tmp123);
$fn125 $tmp124 = ($fn125) $tmp120->$class->vtable[2];
org$frostlang$frostc$IR$Statement$ID $tmp126 = $tmp124($tmp120, $tmp121);
*(&local8) = $tmp126;
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp121));
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:46
FROST_ASSERT(48 == sizeof(org$frostlang$frostc$IR$Value));
...
org$frostlang$frostc$IR$Value$init$frost$core$Int$org$frostlang$frostc$IR$Statement$ID$org$frostlang$frostc$Type($tmp127, $tmp128, $tmp129, $tmp131);
...
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:52
...
*(&local0) = $tmp140;
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:53
...
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:54
...
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:55
...
// /Users/ethannicholas/Dropbox/Frost-Int/src/frostc/org/frostlang/frostc/expression/Or.frost:11
