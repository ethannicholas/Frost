...
frost$core$UInt64 $tmp766 = frost$core$Int64$convert$R$frost$core$UInt64($tmp765);
...
frost$core$UInt64 $tmp812 = frost$core$Int64$convert$R$frost$core$UInt64($tmp811);
