...
struct { frost$core$Class* cl; ITable* next; void* methods[1]; } org$frostlang$frostc$Main$Format$_frost$collections$Key = { (frost$core$Class*) &frost$collections$Key$class, (ITable*) &org$frostlang$frostc$Main$Format$_frost$core$Equatable, { org$frostlang$frostc$Main$Format$get_hash$R$frost$core$Int$shim} };

static frost$core$String $s1;
org$frostlang$frostc$Main$Format$class_type org$frostlang$frostc$Main$Format$class = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s1, (frost$core$Class*) &frost$core$Value$class, (ITable*) &org$frostlang$frostc$Main$Format$_frost$collections$Key, { org$frostlang$frostc$Main$Format$get_asString$R$frost$core$String$shim, frost$core$Value$cleanup$shim, org$frostlang$frostc$Main$Format$cleanup$shim, org$frostlang$frostc$Main$Format$$EQ$org$frostlang$frostc$Main$Format$R$frost$core$Bit$shim, org$frostlang$frostc$Main$Format$get_hash$R$frost$core$Int$shim} };
...
struct { frost$core$Class* cl; ITable* itable; void* methods[1]; } org$frostlang$frostc$Main$Format$wrapper_frost$collections$Key = { (frost$core$Class*) &frost$collections$Key$class, (ITable*) &org$frostlang$frostc$Main$Format$wrapper_frost$core$Equatable, { org$frostlang$frostc$Main$Format$get_hash$R$frost$core$Int$shim} };

static frost$core$String $s2;
org$frostlang$frostc$Main$Format$wrapperclass_type org$frostlang$frostc$Main$Format$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s2, (frost$core$Class*) &frost$core$Value$class, (ITable*) &org$frostlang$frostc$Main$Format$wrapper_frost$collections$Key, { org$frostlang$frostc$Main$Format$get_asString$R$frost$core$String$shim, frost$core$Value$cleanup$shim} };
