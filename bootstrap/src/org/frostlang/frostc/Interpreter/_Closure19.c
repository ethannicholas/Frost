...
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x2e\x66\x72\x6f\x73\x74\x63\x2e\x49\x6e\x74\x65\x72\x70\x72\x65\x74\x65\x72\x2e\x5f\x43\x6c\x6f\x73\x75\x72\x65\x31\x39", 43, 7906577236993416088, NULL };

void org$frostlang$frostc$Interpreter$_Closure19$init$org$frostlang$frostc$Interpreter(void* rawSelf, org$frostlang$frostc$Interpreter* param1) {
org$frostlang$frostc$Interpreter$_Closure19* param0 = (org$frostlang$frostc$Interpreter$_Closure19*) rawSelf;
...
void org$frostlang$frostc$Interpreter$_Closure19$cleanup(void* rawSelf) {
org$frostlang$frostc$Interpreter$_Closure19* param0 = (org$frostlang$frostc$Interpreter$_Closure19*) rawSelf;
...
frost$core$Int64 org$frostlang$frostc$Interpreter$_Closure19$$anonymous18$org$frostlang$frostc$Interpreter$Context$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$IR$Value$GT$R$frost$core$Int64(void* rawSelf, org$frostlang$frostc$Interpreter$Context* param1, org$frostlang$frostc$FixedArray* param2) {
org$frostlang$frostc$Interpreter$_Closure19* param0 = (org$frostlang$frostc$Interpreter$_Closure19*) rawSelf;
...
_7 = _6(param1, _5);
// begin inline call to function frost.core.Int64.get_asInt():frost.core.Int from Interpreter.frost:301:71
