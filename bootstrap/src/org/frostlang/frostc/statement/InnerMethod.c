...
frost$core$Int $tmp19 = (frost$core$Int) {53u};
...
frost$core$Int* $tmp21 = &(&local3)->$rawValue;
*$tmp21 = $tmp20;
...
org$frostlang$frostc$ASTNode$init$frost$core$Int$org$frostlang$frostc$Position$org$frostlang$frostc$Variable$Kind$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$ASTNode$GT($tmp18, $tmp19, param1, $tmp23, $tmp27);
