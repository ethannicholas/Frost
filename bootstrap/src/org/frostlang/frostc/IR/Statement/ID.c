...
__attribute__((weak)) frost$core$String* org$frostlang$frostc$IR$Statement$ID$convert$R$frost$core$String$shim(frost$core$Object* p0) {
    frost$core$String* result = org$frostlang$frostc$IR$Statement$ID$convert$R$frost$core$String(((org$frostlang$frostc$IR$Statement$ID$wrapper*) p0)->value);
...
org$frostlang$frostc$IR$Statement$ID$class_type org$frostlang$frostc$IR$Statement$ID$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Value$class, (ITable*) &org$frostlang$frostc$IR$Statement$ID$_frost$collections$Key, { org$frostlang$frostc$IR$Statement$ID$convert$R$frost$core$String$shim, frost$core$Value$cleanup$shim, org$frostlang$frostc$IR$Statement$ID$get_hash$R$frost$core$Int64$shim, org$frostlang$frostc$IR$Statement$ID$$EQ$org$frostlang$frostc$IR$Statement$ID$R$frost$core$Bit$shim, org$frostlang$frostc$IR$Statement$ID$cleanup$shim} };
...
org$frostlang$frostc$IR$Statement$ID$wrapperclass_type org$frostlang$frostc$IR$Statement$ID$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, &$s2, (frost$core$Class*) &frost$core$Value$class, (ITable*) &org$frostlang$frostc$IR$Statement$ID$wrapper_frost$collections$Key, { org$frostlang$frostc$IR$Statement$ID$convert$R$frost$core$String$shim, frost$core$Value$cleanup$shim} };
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x2e\x66\x72\x6f\x73\x74\x63\x2e\x49\x52\x2e\x53\x74\x61\x74\x65\x6d\x65\x6e\x74\x2e\x49\x44", 36, 575152801094178889, NULL };
static frost$core$String $s2 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x2e\x66\x72\x6f\x73\x74\x63\x2e\x49\x52\x2e\x53\x74\x61\x74\x65\x6d\x65\x6e\x74\x2e\x49\x44", 36, 575152801094178889, NULL };
...
frost$core$String* org$frostlang$frostc$IR$Statement$ID$convert$R$frost$core$String(org$frostlang$frostc$IR$Statement$ID param0) {
