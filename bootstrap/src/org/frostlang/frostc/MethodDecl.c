...
frost$core$Object* _159;
org$frostlang$frostc$MethodDecl$Parameter* _162;
...
frost$core$Bit _174;
bool _175;
frost$collections$CollectionView* _177;
$fn30 _178;
frost$core$Int _179;
int64_t _180;
int64_t _181;
...
org$frostlang$frostc$MethodDecl$Parameter* _198;
...
_154 = &_131->data;
_155 = *_154;
_156 = frost$core$Int64$init$frost$core$Int(_132);
_157 = _156.value;
_158 = _155[_157];
_159 = _158;
frost$core$Frost$ref$frost$core$Object$Q(_159);
_162 = ((org$frostlang$frostc$MethodDecl$Parameter*) _158);
_163 = &_162->type;
_164 = *_163;
_165 = ((frost$core$Equatable*) _164);
_166 = &param1->parameters;
_167 = *_166;
_168 = *(&local5);
...
_175 = _174.value;
if (_175) goto block28; else goto block27;
block28:;
_177 = ((frost$collections$CollectionView*) _167);
ITable* $tmp47 = _177->$class->itable;
while ($tmp47->$class != (frost$core$Class*) &frost$collections$CollectionView$class) {
    $tmp47 = $tmp47->next;
}
_178 = $tmp47->methods[0];
_179 = _178(_177);
_180 = _168.value;
_181 = _179.value;
_182 = _180 < _181;
...
_184 = _183.value;
if (_184) goto block26; else goto block27;
block27:;
_186 = (frost$core$Int) {74u};
frost$core$Frost$assertionFailure$frost$core$String$frost$core$Int$frost$core$String(&$s48, _186, &$s49);
abort(); // unreachable
block26:;
// /Users/ethannicholas/Dropbox/Frost/src/frost/collections/Array.frost:75
_190 = &_167->data;
_191 = *_190;
_192 = frost$core$Int64$init$frost$core$Int(_168);
_193 = _192.value;
_194 = _191[_193];
_195 = _194;
frost$core$Frost$ref$frost$core$Object$Q(_195);
_198 = ((org$frostlang$frostc$MethodDecl$Parameter*) _194);
_199 = &_198->type;
_200 = *_199;
_201 = ((frost$core$Equatable*) _200);
ITable* $tmp50 = _165->$class->itable;
while ($tmp50->$class != (frost$core$Class*) &frost$core$Equatable$class) {
    $tmp50 = $tmp50->next;
}
_202 = $tmp50->methods[1];
_203 = _202(_165, _201);
_204 = _203.value;
_205 = _194;
...
_224 = _223.value;
if (_224) goto block29; else goto block15;
block31:;
_226 = _218.value;
_227 = _115.value;
_228 = _226 > _227;
...
_230 = _229.value;
if (_230) goto block29; else goto block15;
block29:;
_232 = _214.value;
_233 = _115.value;
_234 = _232 + _233;
