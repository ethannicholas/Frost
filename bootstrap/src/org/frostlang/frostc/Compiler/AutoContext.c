...
// begin inline call to function frost.collections.Stack.[](depth:frost.core.Int):frost.collections.Stack.T from Compiler.frost:209:46
...
block13:;
frost$core$Int $tmp95 = (frost$core$Int) {209u};
