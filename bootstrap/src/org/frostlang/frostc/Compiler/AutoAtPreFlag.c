...
org$frostlang$frostc$Compiler$AutoAtPreFlag$class_type org$frostlang$frostc$Compiler$AutoAtPreFlag$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, NULL, { frost$core$Object$convert$R$frost$core$String, org$frostlang$frostc$Compiler$AutoAtPreFlag$cleanup} };
...
block2:;
frost$core$Int64 $tmp12 = (frost$core$Int64) {269};
