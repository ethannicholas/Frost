...
void org$frostlang$frostc$MethodDecl$GenericParameter$init$org$frostlang$frostc$Position$frost$core$String$frost$core$String$org$frostlang$frostc$Type(void* rawSelf, org$frostlang$frostc$Position param1, frost$core$String* param2, frost$core$String* param3, org$frostlang$frostc$Type* param4) {
org$frostlang$frostc$MethodDecl$GenericParameter* param0 = (org$frostlang$frostc$MethodDecl$GenericParameter*) rawSelf;
