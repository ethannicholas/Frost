...
org$frostlang$frost$Int32List$class_type org$frostlang$frost$Int32List$class = { (frost$core$Class*) &frost$core$Class$class, -999, 0, &$s1, (frost$core$Class*) &frost$core$Object$class, (ITable*) &org$frostlang$frost$Int32List$_frost$collections$ListView, { org$frostlang$frost$Int32List$get_asString$R$frost$core$String, org$frostlang$frost$Int32List$cleanup, org$frostlang$frost$Int32List$get_count$R$frost$core$Int64, org$frostlang$frost$Int32List$$IDX$frost$core$Int64$R$frost$core$Int32$shim} };
...
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x2e\x66\x72\x6f\x73\x74\x2e\x49\x6e\x74\x33\x32\x4c\x69\x73\x74", 29, 8845844990016586585, NULL };
static frost$core$String $s133 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x49\x6e\x74\x33\x32\x4c\x69\x73\x74\x2e\x66\x72\x6f\x73\x74", 15, -5075525129274066703, NULL };
...
static frost$core$String $s157 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x5b", 1, 192, NULL };
static frost$core$String $s159 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x5d", 1, 194, NULL };
...
frost$core$Int64 $tmp49 = frost$core$Int64$init$builtin_int64(((int64_t) $tmp48));
*(&local0) = $tmp49;
goto block11;
block13:;
...
frost$core$Int32 $tmp59 = (frost$core$Int32) {0};
...
frost$core$Int32 $tmp73 = (frost$core$Int32) {18446744073709551615};
*(&local1) = $tmp73;
goto block15;
block16:;
// <no location>
...
frost$core$Int32 $tmp82 = (frost$core$Int32) {1};
*(&local1) = $tmp82;
goto block15;
block15:;
...
frost$core$Int64 $tmp106 = frost$core$Int64$init$builtin_int64(((int64_t) $tmp105));
*(&local2) = $tmp106;
goto block21;
block23:;
// /Users/ethannicholas/Dropbox/Frost/build/stubs/frost/core/Int32.stub:544
...
block2:;
frost$core$Int64 $tmp132 = (frost$core$Int64) {55};
