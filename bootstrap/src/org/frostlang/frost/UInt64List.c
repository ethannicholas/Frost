...
__attribute__((weak)) frost$core$Object* org$frostlang$frost$UInt64List$$IDX$frost$core$Int$R$frost$core$UInt64$shim(org$frostlang$frost$UInt64List* p0, frost$core$Int p1) {
    ...
    $tmp2 = (frost$core$UInt64$wrapper*) frostObjectAlloc(sizeof(frost$core$UInt64$wrapper), (frost$core$Class*) &frost$core$UInt64$wrapperclass);
    $tmp2->value = result;
...
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x2e\x66\x72\x6f\x73\x74\x2e\x55\x49\x6e\x74\x36\x34\x4c\x69\x73\x74", 30, 311478962839702771, NULL };
static frost$core$String $s5 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x55\x49\x6e\x74\x36\x34\x4c\x69\x73\x74\x2e\x66\x72\x6f\x73\x74", 16, -1590601688145268021, NULL };
...
void org$frostlang$frost$UInt64List$init$frost$core$SteppedRange$LTfrost$core$UInt64$Cfrost$core$UInt64$GT(void* rawSelf, frost$core$SteppedRange$LTfrost$core$UInt64$Cfrost$core$UInt64$GT param1) {
org$frostlang$frost$UInt64List* param0 = (org$frostlang$frost$UInt64List*) rawSelf;
...
frost$core$UInt64 org$frostlang$frost$UInt64List$$IDX$frost$core$Int$R$frost$core$UInt64(void* rawSelf, frost$core$Int param1) {
org$frostlang$frost$UInt64List* param0 = (org$frostlang$frost$UInt64List*) rawSelf;
