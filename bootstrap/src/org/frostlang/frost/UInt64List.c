...
static frost$core$String $s113 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (frost$core$Char8*) "\x55\x49\x6e\x74\x36\x34\x4c\x69\x73\x74\x2e\x66\x72\x6f\x73\x74", 16, -6963972527162133793, NULL };
...
frost$core$UInt64 $tmp60 = (frost$core$UInt64) {1};
*(&local1) = $tmp60;
...
block2:;
frost$core$Int64 $tmp112 = (frost$core$Int64) {45};
