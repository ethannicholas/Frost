...
__attribute__((weak)) frost$core$Object* org$frostlang$frost$UInt16List$$IDX$frost$core$Int$R$frost$core$UInt16$shim(org$frostlang$frost$UInt16List* p0, frost$core$Int p1) {
    ...
    $tmp2 = (frost$core$UInt16$wrapper*) frostObjectAlloc(sizeof(frost$core$UInt16$wrapper), (frost$core$Class*) &frost$core$UInt16$wrapperclass);
    $tmp2->value = result;
...
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x2e\x66\x72\x6f\x73\x74\x2e\x55\x49\x6e\x74\x31\x36\x4c\x69\x73\x74", 30, 4039612249519127878, NULL };
static frost$core$String $s5 = { (frost$core$Class*) &frost$core$String$class, -999, 0, (intptr_t) "\x55\x49\x6e\x74\x31\x36\x4c\x69\x73\x74\x2e\x66\x72\x6f\x73\x74", 16, -7249708953424587494, NULL };
...
void org$frostlang$frost$UInt16List$init$frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT(void* rawSelf, frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT param1) {
org$frostlang$frost$UInt16List* param0 = (org$frostlang$frost$UInt16List*) rawSelf;

frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT* _1;
frost$core$Int _4;
frost$core$Int* _5;
...
_4 = org$frostlang$frost$UInt16List$computeCount$frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT$R$frost$core$Int(param1);
_5 = &param0->_count;
*_5 = _4;
return;
...
frost$core$UInt16 _6;
uint16_t _7;
uint16_t _8;
bool _9;
frost$core$Bit _10;
bool _11;
frost$core$UInt16 _14;
...
bool _20;
frost$core$Int _23;
frost$core$UInt16 _27;
frost$core$UInt16 _28;
uint16_t _29;
uint16_t _30;
bool _31;
frost$core$Bit _32;
...
_40 = param0.end;
_41 = frost$core$UInt32$init$frost$core$UInt16(_40);
_42 = param0.start;
_43 = frost$core$UInt32$init$frost$core$UInt16(_42);
_44 = _41.value;
_45 = _43.value;
_46 = _44 - _45;
_47 = (frost$core$UInt32) {_46};
_48 = param0.step;
_49 = frost$core$UInt32$init$frost$core$UInt16(_48);
_50 = _47.value;
_51 = _49.value;
_52 = _50 / _51;
...
_93 = (frost$core$UInt16) {1u};
*(&local1) = _93;
// /Users/ethannicholas/Dropbox/Frost/src/org/frostlang/frost/UInt16List.frost:35
_96 = param0.end;
_97 = frost$core$UInt32$init$frost$core$UInt16(_96);
_98 = param0.start;
_99 = frost$core$UInt32$init$frost$core$UInt16(_98);
_100 = _97.value;
_101 = _99.value;
_102 = _100 - _101;
_103 = (frost$core$UInt32) {_102};
_104 = *(&local1);
_105 = frost$core$UInt32$init$frost$core$UInt16(_104);
_106 = _103.value;
_107 = _105.value;
_108 = _106 + _107;
_109 = (frost$core$UInt32) {_108};
_110 = param0.step;
_111 = frost$core$UInt32$init$frost$core$UInt16(_110);
_112 = _109.value;
_113 = _111.value;
_114 = _112 / _113;
...
frost$core$Int org$frostlang$frost$UInt16List$get_count$R$frost$core$Int(void* rawSelf) {
org$frostlang$frost$UInt16List* param0 = (org$frostlang$frost$UInt16List*) rawSelf;
...
frost$core$UInt16 org$frostlang$frost$UInt16List$$IDX$frost$core$Int$R$frost$core$UInt16(void* rawSelf, frost$core$Int param1) {
org$frostlang$frost$UInt16List* param0 = (org$frostlang$frost$UInt16List*) rawSelf;
...
bool _14;
frost$core$Int _16;
frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT* _20;
frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT _21;
frost$core$UInt16 _22;
frost$core$UInt32 _23;
frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT* _24;
frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT _25;
frost$core$UInt16 _26;
...
_21 = *_20;
_22 = _21.start;
_23 = frost$core$UInt32$init$frost$core$UInt16(_22);
_24 = &param0->range;
_25 = *_24;
_26 = _25.step;
_27 = frost$core$UInt32$init$frost$core$UInt16(_26);
...
_30 = param1.value;
_31 = ((uint16_t) _30);
_32 = (frost$core$UInt16) {_31};
_34 = frost$core$UInt32$init$frost$core$UInt16(_32);
_35 = _27.value;
_36 = _34.value;
_37 = _35 * _36;
...
_45 = _42.value;
_46 = ((uint16_t) _45);
_47 = (frost$core$UInt16) {_46};
return _47;

}
frost$core$String* org$frostlang$frost$UInt16List$get_asString$R$frost$core$String(void* rawSelf) {
org$frostlang$frost$UInt16List* param0 = (org$frostlang$frost$UInt16List*) rawSelf;
...
void org$frostlang$frost$UInt16List$cleanup(void* rawSelf) {
org$frostlang$frost$UInt16List* param0 = (org$frostlang$frost$UInt16List*) rawSelf;
