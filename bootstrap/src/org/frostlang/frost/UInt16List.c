...
static frost$core$String $s101 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x55\x49\x6e\x74\x31\x36\x4c\x69\x73\x74\x2e\x66\x72\x6f\x73\x74", 16, -7863730697579519904, NULL };
...
block4:;
// line 46
frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT* $tmp103 = &param0->range;
frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT $tmp104 = *$tmp103;
frost$core$UInt16 $tmp105 = $tmp104.start;
frost$core$UInt32 $tmp106 = frost$core$UInt32$init$frost$core$UInt16($tmp105);
frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT* $tmp107 = &param0->range;
frost$core$SteppedRange$LTfrost$core$UInt16$Cfrost$core$UInt16$GT $tmp108 = *$tmp107;
frost$core$UInt16 $tmp109 = $tmp108.step;
frost$core$UInt32 $tmp110 = frost$core$UInt32$init$frost$core$UInt16($tmp109);
frost$core$UInt16 $tmp111 = frost$core$Int64$get_asUInt16$R$frost$core$UInt16(param1);
frost$core$UInt32 $tmp112 = frost$core$UInt32$init$frost$core$UInt16($tmp111);
...
frost$core$UInt16 $tmp121 = frost$core$UInt32$get_asUInt16$R$frost$core$UInt16($tmp120);
return $tmp121;
