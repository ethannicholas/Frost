...
__attribute__((weak)) frost$core$Object* org$frostlanguage$frost$UInt8List$$IDX$frost$core$Int64$R$frost$core$UInt8$shim(org$frostlanguage$frost$UInt8List* p0, frost$core$Int64 p1) {
    frost$core$UInt8 result = org$frostlanguage$frost$UInt8List$$IDX$frost$core$Int64$R$frost$core$UInt8(p0, p1);
...
struct { frost$core$Class* cl; ITable* next; void* methods[7]; } org$frostlanguage$frost$UInt8List$_frost$collections$CollectionView = { (frost$core$Class*) &frost$collections$CollectionView$class, NULL, { org$frostlanguage$frost$UInt8List$get_count$R$frost$core$Int64, frost$collections$CollectionView$join$R$frost$core$String, frost$collections$CollectionView$join$frost$core$String$R$frost$core$String, frost$collections$CollectionView$fold$$LPfrost$collections$CollectionView$T$Cfrost$collections$CollectionView$T$RP$EQ$GT$LPfrost$collections$CollectionView$T$RP$R$frost$collections$CollectionView$T, frost$collections$CollectionView$fold$$LPfrost$collections$CollectionView$T$Cfrost$collections$CollectionView$T$RP$EQ$GT$LPfrost$collections$CollectionView$T$RP$frost$collections$CollectionView$T$R$frost$collections$CollectionView$T, frost$collections$CollectionView$apply$$LPfrost$collections$CollectionView$T$RP$EQ$AM$GT$LP$RP, frost$collections$CollectionView$map$$LPfrost$collections$CollectionView$T$RP$EQ$GT$LPfrost$collections$CollectionView$map$U$RP$R$frost$collections$Array$LTfrost$collections$CollectionView$map$U$GT} };

struct { frost$core$Class* cl; ITable* next; void* methods[1]; } org$frostlanguage$frost$UInt8List$_frost$collections$Iterable = { (frost$core$Class*) &frost$collections$Iterable$class, (ITable*) &org$frostlanguage$frost$UInt8List$_frost$collections$CollectionView, { frost$collections$ListView$get_iterator$R$frost$collections$Iterator$LTfrost$collections$ListView$T$GT$shim} };

struct { frost$core$Class* cl; ITable* next; void* methods[7]; } org$frostlanguage$frost$UInt8List$_frost$collections$ListView = { (frost$core$Class*) &frost$collections$ListView$class, (ITable*) &org$frostlanguage$frost$UInt8List$_frost$collections$Iterable, { org$frostlanguage$frost$UInt8List$$IDX$frost$core$Int64$R$frost$core$UInt8$shim, frost$collections$ListView$$IDX$frost$core$Range$LTfrost$core$Int64$GT$R$frost$collections$ListView$LTfrost$collections$ListView$T$GT, frost$collections$ListView$$IDX$frost$core$Range$LTfrost$core$Int64$Q$GT$R$frost$collections$ListView$LTfrost$collections$ListView$T$GT, frost$collections$ListView$$IDX$frost$core$SteppedRange$LTfrost$core$Int64$Q$Cfrost$core$Int64$GT$R$frost$collections$ListView$LTfrost$collections$ListView$T$GT, frost$collections$ListView$filter$$LPfrost$collections$ListView$T$RP$EQ$GT$LPfrost$core$Bit$RP$R$frost$collections$ListView$LTfrost$collections$ListView$T$GT, frost$collections$ListView$get_iterator$R$frost$collections$Iterator$LTfrost$collections$ListView$T$GT$shim, frost$collections$ListView$sort$$LPfrost$collections$ListView$T$Cfrost$collections$ListView$T$RP$EQ$GT$LPfrost$core$Bit$RP$R$frost$collections$ListView$LTfrost$collections$ListView$T$GT} };

static frost$core$String $s1;
org$frostlanguage$frost$UInt8List$class_type org$frostlanguage$frost$UInt8List$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, (ITable*) &org$frostlanguage$frost$UInt8List$_frost$collections$ListView, { org$frostlanguage$frost$UInt8List$convert$R$frost$core$String, org$frostlanguage$frost$UInt8List$cleanup, org$frostlanguage$frost$UInt8List$get_count$R$frost$core$Int64, org$frostlanguage$frost$UInt8List$$IDX$frost$core$Int64$R$frost$core$UInt8$shim} };
...
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x66\x72\x6f\x73\x74\x2e\x55\x49\x6e\x74\x38\x4c\x69\x73\x74", 33, 4664491090728470043, NULL };
...
void org$frostlanguage$frost$UInt8List$init$frost$core$SteppedRange$LTfrost$core$UInt8$Cfrost$core$UInt8$GT(org$frostlanguage$frost$UInt8List* param0, frost$core$SteppedRange$LTfrost$core$UInt8$Cfrost$core$UInt8$GT param1) {

// line 16
frost$core$SteppedRange$LTfrost$core$UInt8$Cfrost$core$UInt8$GT* $tmp3 = &param0->range;
*$tmp3 = param1;
// line 17
frost$core$Int64 $tmp4 = org$frostlanguage$frost$UInt8List$computeCount$frost$core$SteppedRange$LTfrost$core$UInt8$Cfrost$core$UInt8$GT$R$frost$core$Int64(param1);
frost$core$Int64* $tmp5 = &param0->_count;
*$tmp5 = $tmp4;
return;

}
frost$core$Int64 org$frostlanguage$frost$UInt8List$computeCount$frost$core$SteppedRange$LTfrost$core$UInt8$Cfrost$core$UInt8$GT$R$frost$core$Int64(frost$core$SteppedRange$LTfrost$core$UInt8$Cfrost$core$UInt8$GT param0) {
...
frost$core$Int64 org$frostlanguage$frost$UInt8List$get_count$R$frost$core$Int64(org$frostlanguage$frost$UInt8List* param0) {
...
frost$core$UInt8 org$frostlanguage$frost$UInt8List$$IDX$frost$core$Int64$R$frost$core$UInt8(org$frostlanguage$frost$UInt8List* param0, frost$core$Int64 param1) {
...
frost$core$String* org$frostlanguage$frost$UInt8List$convert$R$frost$core$String(org$frostlanguage$frost$UInt8List* param0) {
...
void org$frostlanguage$frost$UInt8List$cleanup(org$frostlanguage$frost$UInt8List* param0) {
