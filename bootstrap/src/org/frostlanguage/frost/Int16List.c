...
__attribute__((weak)) frost$core$Object* org$frostlanguage$frost$Int16List$$IDX$frost$core$Int64$R$frost$core$Int16$shim(org$frostlanguage$frost$Int16List* p0, frost$core$Int64 p1) {
    frost$core$Int16 result = org$frostlanguage$frost$Int16List$$IDX$frost$core$Int64$R$frost$core$Int16(p0, p1);

    frost$core$Int16$wrapper* $tmp2;
    $tmp2 = (frost$core$Int16$wrapper*) frostObjectAlloc(14, (frost$core$Class*) &frost$core$Int16$wrapperclass);
    $tmp2->value = result;
...
struct { frost$core$Class* cl; ITable* next; void* methods[7]; } org$frostlanguage$frost$Int16List$_frost$collections$CollectionView = { (frost$core$Class*) &frost$collections$CollectionView$class, NULL, { org$frostlanguage$frost$Int16List$get_count$R$frost$core$Int64, frost$collections$CollectionView$join$R$frost$core$String, frost$collections$CollectionView$join$frost$core$String$R$frost$core$String, frost$collections$CollectionView$fold$$LPfrost$collections$CollectionView$T$Cfrost$collections$CollectionView$T$RP$EQ$GT$LPfrost$collections$CollectionView$T$RP$R$frost$collections$CollectionView$T, frost$collections$CollectionView$fold$$LPfrost$collections$CollectionView$T$Cfrost$collections$CollectionView$T$RP$EQ$GT$LPfrost$collections$CollectionView$T$RP$frost$collections$CollectionView$T$R$frost$collections$CollectionView$T, frost$collections$CollectionView$apply$$LPfrost$collections$CollectionView$T$RP$EQ$AM$GT$LP$RP, frost$collections$CollectionView$map$$LPfrost$collections$CollectionView$T$RP$EQ$GT$LPfrost$collections$CollectionView$map$U$RP$R$frost$collections$Array$LTfrost$collections$CollectionView$map$U$GT} };

struct { frost$core$Class* cl; ITable* next; void* methods[7]; } org$frostlanguage$frost$Int16List$_frost$collections$ListView = { (frost$core$Class*) &frost$collections$ListView$class, (ITable*) &org$frostlanguage$frost$Int16List$_frost$collections$CollectionView, { org$frostlanguage$frost$Int16List$$IDX$frost$core$Int64$R$frost$core$Int16$shim, frost$collections$ListView$$IDX$frost$core$Range$LTfrost$core$Int64$GT$R$frost$collections$ListView$LTfrost$collections$ListView$T$GT, frost$collections$ListView$$IDX$frost$core$Range$LTfrost$core$Int64$Q$GT$R$frost$collections$ListView$LTfrost$collections$ListView$T$GT, frost$collections$ListView$$IDX$frost$core$SteppedRange$LTfrost$core$Int64$Q$Cfrost$core$Int64$GT$R$frost$collections$ListView$LTfrost$collections$ListView$T$GT, frost$collections$ListView$filter$$LPfrost$collections$ListView$T$RP$EQ$GT$LPfrost$core$Bit$RP$R$frost$collections$ListView$LTfrost$collections$ListView$T$GT, frost$collections$ListView$get_iterator$R$frost$collections$Iterator$LTfrost$collections$ListView$T$GT$shim, frost$collections$ListView$sort$$LPfrost$collections$ListView$T$Cfrost$collections$ListView$T$RP$EQ$GT$LPfrost$core$Bit$RP$R$frost$collections$ListView$LTfrost$collections$ListView$T$GT} };

struct { frost$core$Class* cl; ITable* next; void* methods[1]; } org$frostlanguage$frost$Int16List$_frost$collections$Iterable = { (frost$core$Class*) &frost$collections$Iterable$class, (ITable*) &org$frostlanguage$frost$Int16List$_frost$collections$ListView, { frost$collections$ListView$get_iterator$R$frost$collections$Iterator$LTfrost$collections$ListView$T$GT$shim} };

static frost$core$String $s1;
org$frostlanguage$frost$Int16List$class_type org$frostlanguage$frost$Int16List$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, (ITable*) &org$frostlanguage$frost$Int16List$_frost$collections$Iterable, { org$frostlanguage$frost$Int16List$convert$R$frost$core$String, org$frostlanguage$frost$Int16List$cleanup, org$frostlanguage$frost$Int16List$get_count$R$frost$core$Int64, org$frostlanguage$frost$Int16List$$IDX$frost$core$Int64$R$frost$core$Int16$shim} };
...
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x66\x72\x6f\x73\x74\x2e\x49\x6e\x74\x31\x36\x4c\x69\x73\x74", 33, 4538520851591945605, NULL };
static frost$core$String $s107 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x49\x6e\x74\x31\x36\x4c\x69\x73\x74\x2e\x66\x72\x6f\x73\x74", 15, 1244863148404851675, NULL };
static frost$core$String $s108 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "", 164, -5392969347841299761, NULL };
static frost$core$String $s128 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x49\x6e\x74\x31\x36\x4c\x69\x73\x74\x2e\x66\x72\x6f\x73\x74", 15, 1244863148404851675, NULL };
static frost$core$String $s129 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "", 111, -3428697984548069404, NULL };
...
void org$frostlanguage$frost$Int16List$init$frost$core$SteppedRange$LTfrost$core$Int16$Cfrost$core$Int16$GT(org$frostlanguage$frost$Int16List* param0, frost$core$SteppedRange$LTfrost$core$Int16$Cfrost$core$Int16$GT param1) {

// line 16
frost$core$SteppedRange$LTfrost$core$Int16$Cfrost$core$Int16$GT* $tmp3 = &param0->range;
*$tmp3 = param1;
// line 17
frost$core$Int64 $tmp4 = org$frostlanguage$frost$Int16List$computeCount$frost$core$SteppedRange$LTfrost$core$Int16$Cfrost$core$Int16$GT$R$frost$core$Int64(param1);
frost$core$Int64* $tmp5 = &param0->_count;
*$tmp5 = $tmp4;
return;

}
frost$core$Int64 org$frostlanguage$frost$Int16List$computeCount$frost$core$SteppedRange$LTfrost$core$Int16$Cfrost$core$Int16$GT$R$frost$core$Int64(frost$core$SteppedRange$LTfrost$core$Int16$Cfrost$core$Int16$GT param0) {
...
frost$core$Int64 org$frostlanguage$frost$Int16List$get_count$R$frost$core$Int64(org$frostlanguage$frost$Int16List* param0) {
...
frost$core$Int16 org$frostlanguage$frost$Int16List$$IDX$frost$core$Int64$R$frost$core$Int16(org$frostlanguage$frost$Int16List* param0, frost$core$Int64 param1) {
...
block4:;
// line 56
frost$core$SteppedRange$LTfrost$core$Int16$Cfrost$core$Int16$GT* $tmp130 = &param0->range;
frost$core$SteppedRange$LTfrost$core$Int16$Cfrost$core$Int16$GT $tmp131 = *$tmp130;
frost$core$Int16 $tmp132 = $tmp131.start;
frost$core$Int32 $tmp133 = frost$core$Int32$init$frost$core$Int16($tmp132);
frost$core$SteppedRange$LTfrost$core$Int16$Cfrost$core$Int16$GT* $tmp134 = &param0->range;
frost$core$SteppedRange$LTfrost$core$Int16$Cfrost$core$Int16$GT $tmp135 = *$tmp134;
frost$core$Int16 $tmp136 = $tmp135.step;
frost$core$Int32 $tmp137 = frost$core$Int32$init$frost$core$Int16($tmp136);
frost$core$Int16 $tmp138 = frost$core$Int64$convert$R$frost$core$Int16(param1);
frost$core$Int32 $tmp139 = frost$core$Int32$init$frost$core$Int16($tmp138);
...
frost$core$Int16 $tmp148 = frost$core$Int32$convert$R$frost$core$Int16($tmp147);
return $tmp148;

}
frost$core$String* org$frostlanguage$frost$Int16List$convert$R$frost$core$String(org$frostlanguage$frost$Int16List* param0) {
...
void org$frostlanguage$frost$Int16List$cleanup(org$frostlanguage$frost$Int16List* param0) {
