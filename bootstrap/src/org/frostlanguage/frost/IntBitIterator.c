...
__attribute__((weak)) frost$core$Object* org$frostlanguage$frost$IntBitIterator$next$R$frost$core$Bit$shim(org$frostlanguage$frost$IntBitIterator* p0) {
    frost$core$Bit result = org$frostlanguage$frost$IntBitIterator$next$R$frost$core$Bit(p0);
...
struct { frost$core$Class* cl; ITable* next; void* methods[11]; } org$frostlanguage$frost$IntBitIterator$_frost$collections$Iterator = { (frost$core$Class*) &frost$collections$Iterator$class, NULL, { org$frostlanguage$frost$IntBitIterator$get_done$R$frost$core$Bit, org$frostlanguage$frost$IntBitIterator$next$R$frost$core$Bit$shim, frost$collections$Iterator$count$R$frost$core$Int64, frost$collections$Iterator$filter$$LPfrost$collections$Iterator$T$RP$EQ$GT$LPfrost$core$Bit$RP$R$frost$collections$Iterator$LTfrost$collections$Iterator$T$GT, frost$collections$Iterator$$IDX$frost$core$Range$LTfrost$core$Int64$Q$GT$R$frost$collections$Iterator$LTfrost$collections$Iterator$T$GT, frost$collections$Iterator$$IDX$frost$core$SteppedRange$LTfrost$core$Int64$Q$Cfrost$core$Int64$GT$R$frost$collections$Iterator$LTfrost$collections$Iterator$T$GT, frost$collections$Iterator$all$R$frost$collections$Array$LTfrost$collections$Iterator$T$GT, frost$collections$Iterator$apply$$LPfrost$collections$Iterator$T$RP$EQ$AM$GT$LP$RP, frost$collections$Iterator$fold$$LPfrost$collections$Iterator$T$Cfrost$collections$Iterator$T$RP$EQ$GT$LPfrost$collections$Iterator$T$RP$R$frost$collections$Iterator$T, frost$collections$Iterator$fold$$LPfrost$collections$Iterator$T$Cfrost$collections$Iterator$T$RP$EQ$GT$LPfrost$collections$Iterator$T$RP$frost$collections$Iterator$T$R$frost$collections$Iterator$T, frost$collections$Iterator$map$$LPfrost$collections$Iterator$T$RP$EQ$GT$LPfrost$collections$Iterator$map$U$RP$R$frost$collections$Iterator$LTfrost$collections$Iterator$map$U$GT} };

static frost$core$String $s1;
org$frostlanguage$frost$IntBitIterator$class_type org$frostlanguage$frost$IntBitIterator$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, (ITable*) &org$frostlanguage$frost$IntBitIterator$_frost$collections$Iterator, { frost$core$Object$convert$R$frost$core$String, org$frostlanguage$frost$IntBitIterator$cleanup, org$frostlanguage$frost$IntBitIterator$get_done$R$frost$core$Bit, org$frostlanguage$frost$IntBitIterator$next$R$frost$core$Bit$shim} };

typedef frost$core$Bit (*$fn11)(frost$collections$Iterator*);

static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x66\x72\x6f\x73\x74\x2e\x49\x6e\x74\x42\x69\x74\x49\x74\x65\x72\x61\x74\x6f\x72", 38, 6008823967204178023, NULL };
...
frost$core$Bit org$frostlanguage$frost$IntBitIterator$get_done$R$frost$core$Bit(org$frostlanguage$frost$IntBitIterator* param0) {
...
frost$core$Bit org$frostlanguage$frost$IntBitIterator$next$R$frost$core$Bit(org$frostlanguage$frost$IntBitIterator* param0) {
...
void org$frostlanguage$frost$IntBitIterator$cleanup(org$frostlanguage$frost$IntBitIterator* param0) {
