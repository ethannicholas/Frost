...
org$frostlanguage$plex$runtime$DFA$class_type org$frostlanguage$plex$runtime$DFA$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, NULL, { frost$core$Object$convert$R$frost$core$String, org$frostlanguage$plex$runtime$DFA$cleanup, org$frostlanguage$plex$runtime$DFA$next$R$org$frostlanguage$plex$runtime$RawToken} };


static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x70\x6c\x65\x78\x2e\x72\x75\x6e\x74\x69\x6d\x65\x2e\x44\x46\x41", 34, 852306375996421043, NULL };
...
void org$frostlanguage$plex$runtime$DFA$init$frost$core$Int64$frost$unsafe$Pointer$LTfrost$unsafe$Pointer$LTfrost$core$Int64$GT$GT$frost$unsafe$Pointer$LTfrost$core$Int64$GT(org$frostlanguage$plex$runtime$DFA* param0, frost$core$Int64 param1, frost$core$Int64** param2, frost$core$Int64* param3) {

// line 27
org$frostlanguage$plex$runtime$DFA$init$frost$core$String$frost$core$Int64$frost$unsafe$Pointer$LTfrost$unsafe$Pointer$LTfrost$core$Int64$GT$GT$frost$unsafe$Pointer$LTfrost$core$Int64$GT(param0, &$s2, param1, param2, param3);
return;

}
void org$frostlanguage$plex$runtime$DFA$init$frost$core$String$frost$core$Int64$frost$unsafe$Pointer$LTfrost$unsafe$Pointer$LTfrost$core$Int64$GT$GT$frost$unsafe$Pointer$LTfrost$core$Int64$GT(org$frostlanguage$plex$runtime$DFA* param0, frost$core$String* param1, frost$core$Int64 param2, frost$core$Int64** param3, frost$core$Int64* param4) {
...
org$frostlanguage$plex$runtime$RawToken org$frostlanguage$plex$runtime$DFA$next$R$org$frostlanguage$plex$runtime$RawToken(org$frostlanguage$plex$runtime$DFA* param0) {
...
org$frostlanguage$plex$runtime$RawToken $tmp35 = org$frostlanguage$plex$runtime$RawToken$init$frost$core$Int64$frost$core$String$Index$frost$core$String$Index$frost$core$Int64$frost$core$Int64($tmp24, $tmp27, $tmp30, $tmp32, $tmp34);
return $tmp35;
block2:;
// line 45
...
org$frostlanguage$plex$runtime$RawToken $tmp166 = org$frostlanguage$plex$runtime$RawToken$init$frost$core$Int64$frost$core$String$Index$frost$core$String$Index$frost$core$Int64$frost$core$Int64($tmp159, $tmp161, $tmp163, $tmp164, $tmp165);
return $tmp166;

}
void org$frostlanguage$plex$runtime$DFA$cleanup(org$frostlanguage$plex$runtime$DFA* param0) {
