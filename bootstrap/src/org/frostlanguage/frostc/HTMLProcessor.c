...
org$frostlanguage$frostc$HTMLProcessor$class_type org$frostlanguage$frostc$HTMLProcessor$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, NULL, { frost$core$Object$convert$R$frost$core$String, org$frostlanguage$frostc$HTMLProcessor$cleanup, org$frostlanguage$frostc$HTMLProcessor$prettyPrint$org$frostlanguage$frostc$parser$Parser$R$frost$core$String, org$frostlanguage$frostc$HTMLProcessor$process$frost$io$File$frost$io$File$frost$core$String} };
...
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x66\x72\x6f\x73\x74\x63\x2e\x48\x54\x4d\x4c\x50\x72\x6f\x63\x65\x73\x73\x6f\x72", 38, 1368168644655485463, NULL };
...
frost$core$String* org$frostlanguage$frostc$HTMLProcessor$prettyPrint$org$frostlanguage$frostc$parser$Parser$R$frost$core$String(org$frostlanguage$frostc$HTMLProcessor* param0, org$frostlanguage$frostc$parser$Parser* param1) {
...
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp6 = org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$init$frost$core$Int64($tmp5);
*(&local1) = $tmp6;
// line 11
org$frostlanguage$frostc$parser$SyntaxHighlighter** $tmp7 = &param1->syntaxHighlighter;
org$frostlanguage$frostc$parser$SyntaxHighlighter* $tmp8 = *$tmp7;
...
frost$core$Frost$ref$frost$core$Object$Q(((frost$core$Object*) ((org$frostlanguage$frostc$Pair*) $tmp23)));
org$frostlanguage$frostc$Pair* $tmp24 = *(&local2);
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp24));
*(&local2) = ((org$frostlanguage$frostc$Pair*) $tmp23);
// line 12
org$frostlanguage$frostc$Pair* $tmp25 = *(&local2);
frost$core$Object** $tmp26 = &$tmp25->second;
frost$core$Object* $tmp27 = *$tmp26;
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp28;
$tmp28 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp28->value = ((org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) $tmp27)->value;
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp29 = *(&local1);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp30;
$tmp30 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp30->value = $tmp29;
...
block6:;
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp36 = *(&local1);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp37;
$tmp37 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp37->value = $tmp36;
frost$core$Int64 $tmp38 = (frost$core$Int64) {0};
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp39 = org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$init$frost$core$Int64($tmp38);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp40;
$tmp40 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp40->value = $tmp39;
...
block5:;
// line 15
org$frostlanguage$frostc$Pair* $tmp49 = *(&local2);
frost$core$Object** $tmp50 = &$tmp49->second;
frost$core$Object* $tmp51 = *$tmp50;
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp52;
$tmp52 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp52->value = ((org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) $tmp51)->value;
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp53 = *(&local1);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp54;
$tmp54 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp54->value = $tmp53;
...
block9:;
// line 16
org$frostlanguage$frostc$Pair* $tmp60 = *(&local2);
frost$core$Object** $tmp61 = &$tmp60->second;
frost$core$Object* $tmp62 = *$tmp61;
*(&local1) = ((org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) $tmp62)->value;
// line 17
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp63 = *(&local1);
...
org$frostlanguage$frostc$Pair* $tmp131 = *(&local2);
frost$core$Object** $tmp132 = &$tmp131->first;
frost$core$Object* $tmp133 = *$tmp132;
frost$core$String* $tmp134 = org$frostlanguage$frostc$parser$Parser$text$org$frostlanguage$frostc$parser$Token$R$frost$core$String(param1, ((org$frostlanguage$frostc$parser$Token$wrapper*) $tmp133)->value);
...
// line 63
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp145 = *(&local1);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp146;
$tmp146 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp146->value = $tmp145;
frost$core$Int64 $tmp147 = (frost$core$Int64) {1};
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp148 = org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$init$frost$core$Int64($tmp147);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp149;
$tmp149 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp149->value = $tmp148;
...
block41:;
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp155 = *(&local1);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp156;
$tmp156 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp156->value = $tmp155;
frost$core$Int64 $tmp157 = (frost$core$Int64) {2};
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp158 = org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$init$frost$core$Int64($tmp157);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp159;
$tmp159 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp159->value = $tmp158;
...
// unreffing REF($269:frost.core.Equatable<org.frostlanguage.frostc.parser.SyntaxHighlighter.Kind>)
*(&local5) = $tmp163;
goto block43;
block42:;
*(&local5) = $tmp153;
...
// unreffing REF($259:frost.core.Equatable<org.frostlanguage.frostc.parser.SyntaxHighlighter.Kind>)
if ($tmp165) goto block39; else goto block40;
block39:;
// line 65
frost$core$MutableString* $tmp166 = *(&local0);
org$frostlanguage$frostc$Pair* $tmp167 = *(&local2);
frost$core$Object** $tmp168 = &$tmp167->first;
frost$core$Object* $tmp169 = *$tmp168;
org$frostlanguage$frostc$parser$Token$Kind $tmp170 = ((org$frostlanguage$frostc$parser$Token$wrapper*) $tmp169)->value.kind;
org$frostlanguage$frostc$parser$Token$Kind$wrapper* $tmp171;
$tmp171 = (org$frostlanguage$frostc$parser$Token$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$Token$Kind$wrapperclass);
$tmp171->value = $tmp170;
...
// line 68
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp178 = *(&local1);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp179;
$tmp179 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp179->value = $tmp178;
frost$core$Int64 $tmp180 = (frost$core$Int64) {1};
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp181 = org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$init$frost$core$Int64($tmp180);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp182;
$tmp182 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp182->value = $tmp181;
...
block46:;
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp188 = *(&local1);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp189;
$tmp189 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp189->value = $tmp188;
frost$core$Int64 $tmp190 = (frost$core$Int64) {2};
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp191 = org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$init$frost$core$Int64($tmp190);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp192;
$tmp192 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp192->value = $tmp191;
...
// unreffing REF($334:frost.core.Equatable<org.frostlanguage.frostc.parser.SyntaxHighlighter.Kind>)
*(&local6) = $tmp196;
goto block48;
block47:;
*(&local6) = $tmp186;
...
// unreffing REF($324:frost.core.Equatable<org.frostlanguage.frostc.parser.SyntaxHighlighter.Kind>)
...
org$frostlanguage$frostc$Pair* $tmp202 = *(&local2);
...
// line 73
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp203 = *(&local1);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp204;
$tmp204 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp204->value = $tmp203;
frost$core$Int64 $tmp205 = (frost$core$Int64) {0};
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp206 = org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$init$frost$core$Int64($tmp205);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp207;
$tmp207 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp207->value = $tmp206;
...
// unreffing REF($383:frost.core.Equatable<org.frostlanguage.frostc.parser.SyntaxHighlighter.Kind>)
...
void org$frostlanguage$frostc$HTMLProcessor$process$frost$io$File$frost$io$File$frost$core$String(org$frostlanguage$frostc$HTMLProcessor* param0, frost$io$File* param1, frost$io$File* param2, frost$core$String* param3) {

frost$threads$MessageQueue* local0 = NULL;
org$frostlanguage$frostc$parser$Parser* local1 = NULL;
...
// line 82
org$frostlanguage$frostc$parser$Parser* $tmp222 = (org$frostlanguage$frostc$parser$Parser*) frostObjectAlloc(96, (frost$core$Class*) &org$frostlanguage$frostc$parser$Parser$class);
frost$threads$MessageQueue* $tmp223 = *(&local0);
org$frostlanguage$frostc$parser$Parser$init$frost$threads$MessageQueue$LTorg$frostlanguage$frostc$Compiler$Error$GT($tmp222, $tmp223);
*(&local1) = ((org$frostlanguage$frostc$parser$Parser*) NULL);
frost$core$Frost$ref$frost$core$Object$Q(((frost$core$Object*) $tmp222));
org$frostlanguage$frostc$parser$Parser* $tmp224 = *(&local1);
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp224));
*(&local1) = $tmp222;
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp222));
// unreffing REF($15:org.frostlanguage.frostc.parser.Parser)
// line 83
org$frostlanguage$frostc$parser$Parser* $tmp225 = *(&local1);
org$frostlanguage$frostc$parser$SyntaxHighlighter* $tmp226 = (org$frostlanguage$frostc$parser$SyntaxHighlighter*) frostObjectAlloc(32, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$class);
org$frostlanguage$frostc$parser$SyntaxHighlighter$init($tmp226);
frost$core$Frost$ref$frost$core$Object$Q(((frost$core$Object*) $tmp226));
org$frostlanguage$frostc$parser$SyntaxHighlighter** $tmp227 = &$tmp225->syntaxHighlighter;
org$frostlanguage$frostc$parser$SyntaxHighlighter* $tmp228 = *$tmp227;
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp228));
org$frostlanguage$frostc$parser$SyntaxHighlighter** $tmp229 = &$tmp225->syntaxHighlighter;
*$tmp229 = $tmp226;
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp226));
// unreffing REF($30:org.frostlanguage.frostc.parser.SyntaxHighlighter)
// line 84
org$frostlanguage$frostc$parser$Parser* $tmp230 = *(&local1);
frost$core$String* $tmp231 = frost$io$File$readFully$R$frost$core$String(param1);
org$frostlanguage$frostc$parser$Parser$start$frost$io$File$frost$core$String($tmp230, param1, $tmp231);
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp231));
// unreffing REF($46:frost.core.String)
// line 85
org$frostlanguage$frostc$parser$Parser* $tmp232 = *(&local1);
org$frostlanguage$frostc$ASTNode* $tmp233 = org$frostlanguage$frostc$parser$Parser$file$R$org$frostlanguage$frostc$ASTNode$Q($tmp232);
...
frost$io$Console$printLine$frost$core$Object(((frost$core$Object*) ((org$frostlanguage$frostc$Compiler$Error*) $tmp240)));
...
block2:;
// line 90
org$frostlanguage$frostc$parser$Parser* $tmp241 = *(&local1);
frost$core$String* $tmp242 = org$frostlanguage$frostc$HTMLProcessor$prettyPrint$org$frostlanguage$frostc$parser$Parser$R$frost$core$String(param0, $tmp241);
...
// unreffing lines
*(&local2) = ((frost$collections$Array*) NULL);
org$frostlanguage$frostc$parser$Parser* $tmp405 = *(&local1);
...
void org$frostlanguage$frostc$HTMLProcessor$init(org$frostlanguage$frostc$HTMLProcessor* param0) {

return;

}
void org$frostlanguage$frostc$HTMLProcessor$cleanup(org$frostlanguage$frostc$HTMLProcessor* param0) {
