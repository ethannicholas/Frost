#include "org/frostlanguage/frostc/statement/Break.h"
...
org$frostlanguage$frostc$statement$Break$class_type org$frostlanguage$frostc$statement$Break$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, NULL, { frost$core$Object$convert$R$frost$core$String, org$frostlanguage$frostc$statement$Break$cleanup} };

typedef org$frostlanguage$frostc$IR$Statement$ID (*$fn25)(org$frostlanguage$frostc$IR*, org$frostlanguage$frostc$IR$Statement*);

static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x66\x72\x6f\x73\x74\x63\x2e\x73\x74\x61\x74\x65\x6d\x65\x6e\x74\x2e\x42\x72\x65\x61\x6b", 40, -9043700215096342986, NULL };
static frost$core$String $s30 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x42\x72\x65\x61\x6b\x2e\x66\x72\x6f\x73\x74", 11, -2897467709932721922, NULL };

void org$frostlanguage$frostc$statement$Break$compile$org$frostlanguage$frostc$Compiler$org$frostlanguage$frostc$Position$frost$core$String$Q(org$frostlanguage$frostc$Compiler* param0, org$frostlanguage$frostc$Position param1, frost$core$String* param2) {
...
void org$frostlanguage$frostc$statement$Break$init(org$frostlanguage$frostc$statement$Break* param0) {

return;

}
void org$frostlanguage$frostc$statement$Break$cleanup(org$frostlanguage$frostc$statement$Break* param0) {
