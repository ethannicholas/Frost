...
__attribute__((weak)) frost$core$Bit org$frostlanguage$frostc$Type$Kind$$EQ$org$frostlanguage$frostc$Type$Kind$R$frost$core$Bit$shim(frost$core$Object* p0, frost$core$Equatable* p1) {
    frost$core$Bit result = org$frostlanguage$frostc$Type$Kind$$EQ$org$frostlanguage$frostc$Type$Kind$R$frost$core$Bit(((org$frostlanguage$frostc$Type$Kind$wrapper*) p0)->value, ((org$frostlanguage$frostc$Type$Kind$wrapper*) p1)->value);
...
__attribute__((weak)) void org$frostlanguage$frostc$Type$Kind$cleanup$shim(frost$core$Object* p0) {
    org$frostlanguage$frostc$Type$Kind$cleanup(((org$frostlanguage$frostc$Type$Kind$wrapper*) p0)->value);

}

struct { frost$core$Class* cl; ITable* next; void* methods[2]; } org$frostlanguage$frostc$Type$Kind$_frost$core$Equatable = { (frost$core$Class*) &frost$core$Equatable$class, NULL, { org$frostlanguage$frostc$Type$Kind$$EQ$org$frostlanguage$frostc$Type$Kind$R$frost$core$Bit$shim, frost$core$Equatable$$NEQ$frost$core$Equatable$T$R$frost$core$Bit} };

static frost$core$String $s1;
org$frostlanguage$frostc$Type$Kind$class_type org$frostlanguage$frostc$Type$Kind$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Value$class, (ITable*) &org$frostlanguage$frostc$Type$Kind$_frost$core$Equatable, { frost$core$Object$convert$R$frost$core$String, frost$core$Value$cleanup$shim, org$frostlanguage$frostc$Type$Kind$cleanup$shim, org$frostlanguage$frostc$Type$Kind$$EQ$org$frostlanguage$frostc$Type$Kind$R$frost$core$Bit$shim} };

struct { frost$core$Class* cl; ITable* itable; void* methods[2]; } org$frostlanguage$frostc$Type$Kind$wrapper_frost$core$Equatable = { (frost$core$Class*) &frost$core$Equatable$class, NULL, { org$frostlanguage$frostc$Type$Kind$$EQ$org$frostlanguage$frostc$Type$Kind$R$frost$core$Bit$shim, frost$core$Equatable$$NEQ$frost$core$Equatable$T$R$frost$core$Bit} };

static frost$core$String $s2;
org$frostlanguage$frostc$Type$Kind$wrapperclass_type org$frostlanguage$frostc$Type$Kind$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, &$s2, (frost$core$Class*) &frost$core$Value$class, (ITable*) &org$frostlanguage$frostc$Type$Kind$wrapper_frost$core$Equatable, { frost$core$Object$convert$R$frost$core$String, frost$core$Value$cleanup$shim} };
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x66\x72\x6f\x73\x74\x63\x2e\x54\x79\x70\x65\x2e\x4b\x69\x6e\x64", 34, -7262300116460295712, NULL };
static frost$core$String $s2 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x66\x72\x6f\x73\x74\x63\x2e\x54\x79\x70\x65\x2e\x4b\x69\x6e\x64", 34, -7262300116460295712, NULL };

void org$frostlanguage$frostc$Type$Kind$cleanup(org$frostlanguage$frostc$Type$Kind param0) {
...
org$frostlanguage$frostc$Type$Kind org$frostlanguage$frostc$Type$Kind$init$frost$core$Int64(frost$core$Int64 param0) {

org$frostlanguage$frostc$Type$Kind local0;
// line 5
frost$core$Int64* $tmp64 = &(&local0)->$rawValue;
*$tmp64 = param0;
org$frostlanguage$frostc$Type$Kind $tmp65 = *(&local0);
return $tmp65;

}
frost$core$Bit org$frostlanguage$frostc$Type$Kind$$EQ$org$frostlanguage$frostc$Type$Kind$R$frost$core$Bit(org$frostlanguage$frostc$Type$Kind param0, org$frostlanguage$frostc$Type$Kind param1) {
