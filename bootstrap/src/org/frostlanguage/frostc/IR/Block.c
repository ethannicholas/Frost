...
org$frostlanguage$frostc$IR$Block$class_type org$frostlanguage$frostc$IR$Block$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, NULL, { org$frostlanguage$frostc$IR$Block$convert$R$frost$core$String, org$frostlanguage$frostc$IR$Block$cleanup} };

typedef frost$core$Int64 (*$fn23)(frost$collections$CollectionView*);

static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x66\x72\x6f\x73\x74\x63\x2e\x49\x52\x2e\x42\x6c\x6f\x63\x6b", 33, 6867233749478373034, NULL };
...
void org$frostlanguage$frostc$IR$Block$init$org$frostlanguage$frostc$IR$Block$ID(org$frostlanguage$frostc$IR$Block* param0, org$frostlanguage$frostc$IR$Block$ID param1) {
...
// unreffing REF($1:frost.collections.Array<org.frostlanguage.frostc.IR.Statement.ID>)
// line 289
...
// unreffing REF($16:frost.collections.Array<org.frostlanguage.frostc.IR.Statement>)
// line 292
org$frostlanguage$frostc$IR$Block$ID* $tmp10 = &param0->id;
*$tmp10 = param1;
return;

}
frost$core$String* org$frostlanguage$frostc$IR$Block$convert$R$frost$core$String(org$frostlanguage$frostc$IR$Block* param0) {
...
org$frostlanguage$frostc$IR$Block$ID* $tmp12 = &param0->id;
org$frostlanguage$frostc$IR$Block$ID $tmp13 = *$tmp12;
frost$core$String* $tmp14 = org$frostlanguage$frostc$IR$Block$ID$convert$R$frost$core$String($tmp13);
...
org$frostlanguage$frostc$IR$Statement$ID$wrapper* $tmp48;
$tmp48 = (org$frostlanguage$frostc$IR$Statement$ID$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$IR$Statement$ID$wrapperclass);
$tmp48->value = ((org$frostlanguage$frostc$IR$Statement$ID$wrapper*) $tmp47)->value;
...
frost$core$MutableString$append$frost$core$Object($tmp51, ((frost$core$Object*) ((org$frostlanguage$frostc$IR$Statement*) $tmp55)));
...
void org$frostlanguage$frostc$IR$Block$cleanup(org$frostlanguage$frostc$IR$Block* param0) {
