...
org$frostlanguage$frostc$ChoiceCase$class_type org$frostlanguage$frostc$ChoiceCase$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &org$frostlanguage$frostc$Symbol$class, NULL, { org$frostlanguage$frostc$ChoiceCase$convert$R$frost$core$String, org$frostlanguage$frostc$ChoiceCase$cleanup, org$frostlanguage$frostc$Symbol$get_heritable$R$frost$core$Bit} };


static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x66\x72\x6f\x73\x74\x63\x2e\x43\x68\x6f\x69\x63\x65\x43\x61\x73\x65", 35, 4047357576257846657, NULL };
...
void org$frostlanguage$frostc$ChoiceCase$init$org$frostlanguage$frostc$ClassDecl$org$frostlanguage$frostc$Position$frost$core$String$frost$core$String$Q$frost$core$Int64$frost$collections$ListView$LTorg$frostlanguage$frostc$Type$GT(org$frostlanguage$frostc$ChoiceCase* param0, org$frostlanguage$frostc$ClassDecl* param1, org$frostlanguage$frostc$Position param2, frost$core$String* param3, frost$core$String* param4, frost$core$Int64 param5, frost$collections$ListView* param6) {
...
org$frostlanguage$frostc$Compiler$Resolution $tmp7 = org$frostlanguage$frostc$Compiler$Resolution$init$frost$core$Int64($tmp6);
org$frostlanguage$frostc$Compiler$Resolution* $tmp8 = &param0->resolved;
*$tmp8 = $tmp7;
// line 21
...
// unreffing REF($22:frost.core.Weak<org.frostlanguage.frostc.ClassDecl>)
// line 22
...
org$frostlanguage$frostc$Symbol$Kind $tmp22 = org$frostlanguage$frostc$Symbol$Kind$init$frost$core$Int64($tmp21);
org$frostlanguage$frostc$Symbol$init$org$frostlanguage$frostc$Symbol$Kind$org$frostlanguage$frostc$Position$frost$core$String(((org$frostlanguage$frostc$Symbol*) param0), $tmp22, param2, param3);
return;

}
frost$core$String* org$frostlanguage$frostc$ChoiceCase$convert$R$frost$core$String(org$frostlanguage$frostc$ChoiceCase* param0) {
...
frost$core$String** $tmp26 = &((org$frostlanguage$frostc$ClassDecl*) $tmp25)->name;
...
frost$core$String** $tmp31 = &((org$frostlanguage$frostc$Symbol*) param0)->name;
