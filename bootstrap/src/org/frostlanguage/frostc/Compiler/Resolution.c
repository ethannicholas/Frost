...
__attribute__((weak)) frost$core$Bit org$frostlanguage$frostc$Compiler$Resolution$$EQ$org$frostlanguage$frostc$Compiler$Resolution$R$frost$core$Bit$shim(frost$core$Object* p0, frost$core$Equatable* p1) {
    frost$core$Bit result = org$frostlanguage$frostc$Compiler$Resolution$$EQ$org$frostlanguage$frostc$Compiler$Resolution$R$frost$core$Bit(((org$frostlanguage$frostc$Compiler$Resolution$wrapper*) p0)->value, ((org$frostlanguage$frostc$Compiler$Resolution$wrapper*) p1)->value);

    return result;
}
__attribute__((weak)) frost$core$String* org$frostlanguage$frostc$Compiler$Resolution$convert$R$frost$core$String$shim(frost$core$Object* p0) {
    frost$core$String* result = org$frostlanguage$frostc$Compiler$Resolution$convert$R$frost$core$String(((org$frostlanguage$frostc$Compiler$Resolution$wrapper*) p0)->value);
...
__attribute__((weak)) void org$frostlanguage$frostc$Compiler$Resolution$cleanup$shim(frost$core$Object* p0) {
    org$frostlanguage$frostc$Compiler$Resolution$cleanup(((org$frostlanguage$frostc$Compiler$Resolution$wrapper*) p0)->value);

}

struct { frost$core$Class* cl; ITable* next; void* methods[2]; } org$frostlanguage$frostc$Compiler$Resolution$_frost$core$Equatable = { (frost$core$Class*) &frost$core$Equatable$class, NULL, { org$frostlanguage$frostc$Compiler$Resolution$$EQ$org$frostlanguage$frostc$Compiler$Resolution$R$frost$core$Bit$shim, frost$core$Equatable$$NEQ$frost$core$Equatable$T$R$frost$core$Bit} };

static frost$core$String $s1;
org$frostlanguage$frostc$Compiler$Resolution$class_type org$frostlanguage$frostc$Compiler$Resolution$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Value$class, (ITable*) &org$frostlanguage$frostc$Compiler$Resolution$_frost$core$Equatable, { org$frostlanguage$frostc$Compiler$Resolution$convert$R$frost$core$String$shim, frost$core$Value$cleanup$shim, org$frostlanguage$frostc$Compiler$Resolution$cleanup$shim, org$frostlanguage$frostc$Compiler$Resolution$$EQ$org$frostlanguage$frostc$Compiler$Resolution$R$frost$core$Bit$shim} };

struct { frost$core$Class* cl; ITable* itable; void* methods[2]; } org$frostlanguage$frostc$Compiler$Resolution$wrapper_frost$core$Equatable = { (frost$core$Class*) &frost$core$Equatable$class, NULL, { org$frostlanguage$frostc$Compiler$Resolution$$EQ$org$frostlanguage$frostc$Compiler$Resolution$R$frost$core$Bit$shim, frost$core$Equatable$$NEQ$frost$core$Equatable$T$R$frost$core$Bit} };

static frost$core$String $s2;
org$frostlanguage$frostc$Compiler$Resolution$wrapperclass_type org$frostlanguage$frostc$Compiler$Resolution$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, &$s2, (frost$core$Class*) &frost$core$Value$class, (ITable*) &org$frostlanguage$frostc$Compiler$Resolution$wrapper_frost$core$Equatable, { org$frostlanguage$frostc$Compiler$Resolution$convert$R$frost$core$String$shim, frost$core$Value$cleanup$shim} };
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x66\x72\x6f\x73\x74\x63\x2e\x43\x6f\x6d\x70\x69\x6c\x65\x72\x2e\x52\x65\x73\x6f\x6c\x75\x74\x69\x6f\x6e", 44, -6963488216257383393, NULL };
static frost$core$String $s2 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x66\x72\x6f\x73\x74\x63\x2e\x43\x6f\x6d\x70\x69\x6c\x65\x72\x2e\x52\x65\x73\x6f\x6c\x75\x74\x69\x6f\x6e", 44, -6963488216257383393, NULL };
...
void org$frostlanguage$frostc$Compiler$Resolution$cleanup(org$frostlanguage$frostc$Compiler$Resolution param0) {
...
org$frostlanguage$frostc$Compiler$Resolution org$frostlanguage$frostc$Compiler$Resolution$init$frost$core$Int64(frost$core$Int64 param0) {

org$frostlanguage$frostc$Compiler$Resolution local0;
// line 37
frost$core$Int64* $tmp42 = &(&local0)->$rawValue;
*$tmp42 = param0;
org$frostlanguage$frostc$Compiler$Resolution $tmp43 = *(&local0);
return $tmp43;

}
frost$core$Bit org$frostlanguage$frostc$Compiler$Resolution$$EQ$org$frostlanguage$frostc$Compiler$Resolution$R$frost$core$Bit(org$frostlanguage$frostc$Compiler$Resolution param0, org$frostlanguage$frostc$Compiler$Resolution param1) {
