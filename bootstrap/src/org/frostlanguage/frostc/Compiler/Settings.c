...
__attribute__((weak)) void org$frostlanguage$frostc$Compiler$Settings$cleanup$shim(org$frostlanguage$frostc$Compiler$Settings* p0) {
    org$frostlanguage$frostc$Compiler$Settings$cleanup(p0);

}

static frost$core$String $s1;
org$frostlanguage$frostc$Compiler$Settings$class_type org$frostlanguage$frostc$Compiler$Settings$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Immutable$class, NULL, { frost$core$Object$convert$R$frost$core$String, org$frostlanguage$frostc$Compiler$Settings$cleanup$shim} };


static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x66\x72\x6f\x73\x74\x63\x2e\x43\x6f\x6d\x70\x69\x6c\x65\x72\x2e\x53\x65\x74\x74\x69\x6e\x67\x73", 42, -7217608596081710576, NULL };

void org$frostlanguage$frostc$Compiler$Settings$init$frost$io$File$frost$collections$ListView$LTfrost$io$File$GT$frost$core$Int64$frost$core$Int64$frost$core$Bit(org$frostlanguage$frostc$Compiler$Settings* param0, frost$io$File* param1, frost$collections$ListView* param2, frost$core$Int64 param3, frost$core$Int64 param4, frost$core$Bit param5) {
...
void org$frostlanguage$frostc$Compiler$Settings$cleanup(org$frostlanguage$frostc$Compiler$Settings* param0) {
