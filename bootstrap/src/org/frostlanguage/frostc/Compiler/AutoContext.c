...
org$frostlanguage$frostc$Compiler$AutoContext$class_type org$frostlanguage$frostc$Compiler$AutoContext$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, NULL, { frost$core$Object$convert$R$frost$core$String, org$frostlanguage$frostc$Compiler$AutoContext$cleanup} };


static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x66\x72\x6f\x73\x74\x63\x2e\x43\x6f\x6d\x70\x69\x6c\x65\x72\x2e\x41\x75\x74\x6f\x43\x6f\x6e\x74\x65\x78\x74", 45, 437252548590432505, NULL };
...
void org$frostlanguage$frostc$Compiler$AutoContext$init$org$frostlanguage$frostc$Compiler$org$frostlanguage$frostc$Compiler$EnclosingContext(org$frostlanguage$frostc$Compiler$AutoContext* param0, org$frostlanguage$frostc$Compiler* param1, org$frostlanguage$frostc$Compiler$EnclosingContext* param2) {
...
org$frostlanguage$frostc$Compiler$EnclosingContext** $tmp5 = &param0->context;
org$frostlanguage$frostc$Compiler$EnclosingContext* $tmp6 = *$tmp5;
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp6));
org$frostlanguage$frostc$Compiler$EnclosingContext** $tmp7 = &param0->context;
*$tmp7 = param2;
// line 175
...
void org$frostlanguage$frostc$Compiler$AutoContext$cleanup(org$frostlanguage$frostc$Compiler$AutoContext* param0) {

// line 180
org$frostlanguage$frostc$Compiler** $tmp10 = &param0->compiler;
...
org$frostlanguage$frostc$Compiler$EnclosingContext** $tmp16 = &param0->context;
org$frostlanguage$frostc$Compiler$EnclosingContext* $tmp17 = *$tmp16;
bool $tmp18 = ((org$frostlanguage$frostc$Compiler$EnclosingContext*) $tmp15) == $tmp17;
...
org$frostlanguage$frostc$Compiler$EnclosingContext** $tmp30 = &param0->context;
org$frostlanguage$frostc$Compiler$EnclosingContext* $tmp31 = *$tmp30;
