...
org$frostlanguage$frostc$Pair$class_type org$frostlanguage$frostc$Pair$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, NULL, { org$frostlanguage$frostc$Pair$convert$R$frost$core$String, org$frostlanguage$frostc$Pair$cleanup} };

typedef frost$core$String* (*$fn15)(frost$core$Object*);
typedef frost$core$String* (*$fn28)(frost$core$Object*);

static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x66\x72\x6f\x73\x74\x63\x2e\x50\x61\x69\x72", 29, 223357083735567398, NULL };
...
void org$frostlanguage$frostc$Pair$init$org$frostlanguage$frostc$Pair$A$org$frostlanguage$frostc$Pair$B(org$frostlanguage$frostc$Pair* param0, frost$core$Object* param1, frost$core$Object* param2) {
...
frost$core$String* org$frostlanguage$frostc$Pair$convert$R$frost$core$String(org$frostlanguage$frostc$Pair* param0) {
...
void org$frostlanguage$frostc$Pair$cleanup(org$frostlanguage$frostc$Pair* param0) {
