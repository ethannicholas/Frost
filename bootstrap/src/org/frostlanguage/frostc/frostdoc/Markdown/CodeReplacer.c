...
org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$class_type org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, NULL, { frost$core$Object$convert$R$frost$core$String, org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$cleanup, org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$replacement$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$String, org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$firstLine$frost$core$String$R$frost$core$String, org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$isLanguageIdentifier$frost$core$String$R$frost$core$Bit, org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$languageBlock$frost$core$String$frost$core$String$R$frost$core$String, org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$genericCodeBlock$frost$core$String$R$frost$core$String} };

typedef frost$core$Object* (*$fn8)(frost$collections$ListView*, frost$core$Int64);
typedef void (*$fn19)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn24)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef frost$core$String* (*$fn38)(org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer*, frost$core$String*);
typedef frost$core$Bit (*$fn43)(org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer*, frost$core$String*);
typedef frost$core$String* (*$fn49)(org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer*, frost$core$String*, frost$core$String*);
typedef frost$core$String* (*$fn54)(org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer*, frost$core$String*);
typedef frost$core$Bit (*$fn82)(frost$core$Equatable*, frost$core$Equatable*);

static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x66\x72\x6f\x73\x74\x63\x2e\x66\x72\x6f\x73\x74\x64\x6f\x63\x2e\x4d\x61\x72\x6b\x64\x6f\x77\x6e\x2e\x43\x6f\x64\x65\x52\x65\x70\x6c\x61\x63\x65\x72", 55, 6474094789187594274, NULL };
...
void org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$init$org$frostlanguage$frostc$frostdoc$Markdown(org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer* param0, org$frostlanguage$frostc$frostdoc$Markdown* param1) {

// line 446
frost$core$Frost$ref$frost$core$Object$Q(((frost$core$Object*) param1));
org$frostlanguage$frostc$frostdoc$Markdown** $tmp2 = &param0->markdown;
org$frostlanguage$frostc$frostdoc$Markdown* $tmp3 = *$tmp2;
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp3));
org$frostlanguage$frostc$frostdoc$Markdown** $tmp4 = &param0->markdown;
*$tmp4 = param1;
return;

}
frost$core$String* org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$replacement$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$String(org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer* param0, frost$collections$ListView* param1) {
...
org$frostlanguage$frostc$frostdoc$Markdown$outdent$frost$core$MutableString($tmp14);
// line 453
org$frostlanguage$frostc$frostdoc$Markdown** $tmp15 = &param0->markdown;
org$frostlanguage$frostc$frostdoc$Markdown* $tmp16 = *$tmp15;
frost$core$MutableString* $tmp17 = *(&local1);
$fn19 $tmp18 = ($fn19) $tmp16->$class->vtable[18];
$tmp18($tmp16, $tmp17);
// line 454
org$frostlanguage$frostc$frostdoc$Markdown** $tmp20 = &param0->markdown;
org$frostlanguage$frostc$frostdoc$Markdown* $tmp21 = *$tmp20;
...
frost$core$String* org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$firstLine$frost$core$String$R$frost$core$String(org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer* param0, frost$core$String* param1) {
...
frost$core$Bit org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$isLanguageIdentifier$frost$core$String$R$frost$core$Bit(org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer* param0, frost$core$String* param1) {
...
frost$core$String* org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$languageBlock$frost$core$String$frost$core$String$R$frost$core$String(org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer* param0, frost$core$String* param1, frost$core$String* param2) {
...
frost$core$String* org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$genericCodeBlock$frost$core$String$R$frost$core$String(org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer* param0, frost$core$String* param1) {
...
void org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$cleanup(org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer* param0) {

// line 440
frost$core$Object$cleanup(((frost$core$Object*) param0));
org$frostlanguage$frostc$frostdoc$Markdown** $tmp110 = &param0->markdown;
org$frostlanguage$frostc$frostdoc$Markdown* $tmp111 = *$tmp110;
