...
org$frostlanguage$frostc$frostdoc$Markdown$_Closure9$class_type org$frostlanguage$frostc$frostdoc$Markdown$_Closure9$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, NULL, { frost$core$Object$convert$R$frost$core$String, org$frostlanguage$frostc$frostdoc$Markdown$_Closure9$cleanup, org$frostlanguage$frostc$frostdoc$Markdown$_Closure9$$anonymous7$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$Object} };
...
void org$frostlanguage$frostc$frostdoc$Markdown$_Closure9$init$org$frostlanguage$frostc$frostdoc$Markdown(org$frostlanguage$frostc$frostdoc$Markdown$_Closure9* param0, org$frostlanguage$frostc$frostdoc$Markdown* param1) {
...
void org$frostlanguage$frostc$frostdoc$Markdown$_Closure9$cleanup(org$frostlanguage$frostc$frostdoc$Markdown$_Closure9* param0) {
...
frost$core$Object* org$frostlanguage$frostc$frostdoc$Markdown$_Closure9$$anonymous33$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$Object(frost$collections$ListView* param0) {
...
frost$core$Object* org$frostlanguage$frostc$frostdoc$Markdown$_Closure9$$anonymous7$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$Object(org$frostlanguage$frostc$frostdoc$Markdown$_Closure9* param0, frost$collections$ListView* param1) {
...
// unreffing REF($32:frost.core.RegularExpression)
// line 412
org$frostlanguage$frostc$frostdoc$Markdown** $tmp30 = &param0->$self;
org$frostlanguage$frostc$frostdoc$Markdown* $tmp31 = *$tmp30;
...
frost$core$Method$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Immutable$Q($tmp45, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$_Closure9$$anonymous33$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$Object), ((frost$core$Immutable*) NULL));
...
// unreffing REF($65:frost.core.Method)
// line 417
