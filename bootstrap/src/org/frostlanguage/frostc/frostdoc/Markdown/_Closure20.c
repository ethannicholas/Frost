...
org$frostlanguage$frostc$frostdoc$Markdown$_Closure20$class_type org$frostlanguage$frostc$frostdoc$Markdown$_Closure20$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, NULL, { frost$core$Object$convert$R$frost$core$String, org$frostlanguage$frostc$frostdoc$Markdown$_Closure20$cleanup, org$frostlanguage$frostc$frostdoc$Markdown$_Closure20$$anonymous19$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$String} };
...
void org$frostlanguage$frostc$frostdoc$Markdown$_Closure20$init$org$frostlanguage$frostc$frostdoc$Markdown(org$frostlanguage$frostc$frostdoc$Markdown$_Closure20* param0, org$frostlanguage$frostc$frostdoc$Markdown* param1) {
...
void org$frostlanguage$frostc$frostdoc$Markdown$_Closure20$cleanup(org$frostlanguage$frostc$frostdoc$Markdown$_Closure20* param0) {
...
frost$core$String* org$frostlanguage$frostc$frostdoc$Markdown$_Closure20$$anonymous19$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$String(org$frostlanguage$frostc$frostdoc$Markdown$_Closure20* param0, frost$collections$ListView* param1) {
