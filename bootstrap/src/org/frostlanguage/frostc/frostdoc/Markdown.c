...
#include "org/frostlanguage/frostc/frostdoc/Markdown/_Closure2.h"
...
#include "org/frostlanguage/frostc/frostdoc/Markdown/_Closure6.h"
#include "frost/collections/MapView.h"
#include "frost/core/Char32.h"
#include "frost/core/Real64.h"
#include "frost/core/Int32.h"
#include "org/frostlanguage/frostc/frostdoc/Markdown/_Closure9.h"
#include "frost/core/Immutable.h"
#include "org/frostlanguage/frostc/frostdoc/Markdown/CodeReplacer.h"
...
#include "org/frostlanguage/frostc/frostdoc/Markdown/_Closure12.h"
#include "org/frostlanguage/frostc/frostdoc/Markdown/_Closure14.h"
#include "org/frostlanguage/frostc/frostdoc/Markdown/_Closure16.h"
#include "org/frostlanguage/frostc/frostdoc/Markdown/_Closure18.h"
#include "org/frostlanguage/frostc/frostdoc/Markdown/_Closure20.h"
#include "org/frostlanguage/frostc/frostdoc/Markdown/_Closure22.h"
#include "frost/core/Matcher.h"
#include "frost/core/String/Index.h"
#include "frost/core/Comparable.h"
#include "org/frostlanguage/frostc/frostdoc/Markdown/HTMLToken.h"
#include "frost/core/Range.LTfrost/core/String/Index.GT.h"
#include "org/frostlanguage/frostc/frostdoc/Markdown/_Closure24.h"
#include "org/frostlanguage/frostc/frostdoc/Markdown/_Closure26.h"
#include "org/frostlanguage/frostc/frostdoc/Markdown/_Closure28.h"
#include "org/frostlanguage/frostc/frostdoc/Markdown/_Closure30.h"
#include "org/frostlanguage/frostc/frostdoc/Markdown/_Closure32.h"


static frost$core$String $s1;
org$frostlanguage$frostc$frostdoc$Markdown$class_type org$frostlanguage$frostc$frostdoc$Markdown$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Object$class, NULL, { frost$core$Object$convert$R$frost$core$String, org$frostlanguage$frostc$frostdoc$Markdown$cleanup, org$frostlanguage$frostc$frostdoc$Markdown$process$frost$core$String$R$frost$core$String, org$frostlanguage$frostc$frostdoc$Markdown$encodeBackslashEscapes$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$encodeEscapes$frost$core$MutableString$frost$collections$ListView$LTfrost$core$Char8$GT$frost$core$String, org$frostlanguage$frostc$frostdoc$Markdown$stripLinkDefinitions$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$runBlockGamut$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$doHorizontalRules$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$hashHTMLBlocks$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$formParagraphs$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$doAutoLinks$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$unescapeSpecialChars$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$encodeEmail$frost$core$String$R$frost$core$String, org$frostlanguage$frostc$frostdoc$Markdown$doBlockQuotes$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$detabify$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$doCodeBlocks$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$prettyPrint$org$frostlanguage$frostc$parser$Parser$R$frost$core$String, org$frostlanguage$frostc$frostdoc$Markdown$syntaxHighlight$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$encodeCode$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$doLists$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$processListItems$frost$core$String$R$frost$core$String, org$frostlanguage$frostc$frostdoc$Markdown$doHeaders$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$runSpanGamut$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$tokenizeHTML$frost$core$String$R$frost$collections$ListView$LTorg$frostlanguage$frostc$frostdoc$Markdown$HTMLToken$GT, org$frostlanguage$frostc$frostdoc$Markdown$escapeSpecialCharsWithinTagAttributes$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$doImages$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$doAnchors$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$doItalicsAndBold$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$encodeAmpsAndAngles$frost$core$MutableString, org$frostlanguage$frostc$frostdoc$Markdown$doCodeSpans$frost$core$MutableString} };

typedef void (*$fn62)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn69)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn72)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn75)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn78)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef frost$core$String* (*$fn93)(org$frostlanguage$frostc$frostdoc$Protector*, frost$core$String*);
typedef void (*$fn99)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*, frost$collections$ListView*, frost$core$String*);
typedef void (*$fn103)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*, frost$collections$ListView*, frost$core$String*);
...
typedef frost$core$String* (*$fn133)(org$frostlanguage$frostc$frostdoc$Protector*, frost$core$String*);
typedef frost$core$String* (*$fn151)(org$frostlanguage$frostc$frostdoc$Markdown$_Closure2*, frost$collections$ListView*);
typedef void (*$fn155)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn157)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn159)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn161)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn163)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn165)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn167)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
...
typedef frost$core$String* (*$fn296)(org$frostlanguage$frostc$frostdoc$Markdown$_Closure4*, frost$collections$ListView*);
typedef frost$core$Int64 (*$fn425)(frost$collections$CollectionView*);
typedef frost$core$String* (*$fn453)(org$frostlanguage$frostc$frostdoc$Protector*, frost$core$String*);
typedef void (*$fn467)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef frost$core$String* (*$fn503)(frost$collections$CollectionView*, frost$core$String*);
typedef frost$core$String* (*$fn515)(org$frostlanguage$frostc$frostdoc$Markdown$_Closure6*, frost$collections$ListView*);
...
typedef frost$core$String* (*$fn540)(org$frostlanguage$frostc$frostdoc$Protector*, frost$core$String*);
...
typedef frost$core$Object* (*$fn622)(org$frostlanguage$frostc$frostdoc$Markdown$_Closure9*, frost$collections$ListView*);
...
typedef frost$core$String* (*$fn680)(org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer*, frost$collections$ListView*);
...
typedef frost$core$String* (*$fn830)(org$frostlanguage$frostc$frostdoc$Protector*, frost$core$String*);
typedef frost$core$String* (*$fn838)(org$frostlanguage$frostc$frostdoc$Protector*, frost$core$String*);
typedef frost$core$String* (*$fn846)(org$frostlanguage$frostc$frostdoc$Protector*, frost$core$String*);
typedef frost$core$String* (*$fn854)(org$frostlanguage$frostc$frostdoc$Protector*, frost$core$String*);
typedef frost$core$String* (*$fn862)(org$frostlanguage$frostc$frostdoc$Protector*, frost$core$String*);
...
typedef frost$core$String* (*$fn970)(org$frostlanguage$frostc$frostdoc$Markdown*, org$frostlanguage$frostc$parser$Parser*);
typedef frost$core$Bit (*$fn991)(frost$core$Equatable*, frost$core$Equatable*);
typedef frost$core$String* (*$fn1015)(org$frostlanguage$frostc$frostdoc$Markdown*, org$frostlanguage$frostc$parser$Parser*);
typedef frost$core$Bit (*$fn1036)(frost$core$Equatable*, frost$core$Equatable*);
typedef frost$core$String* (*$fn1060)(org$frostlanguage$frostc$frostdoc$Markdown*, org$frostlanguage$frostc$parser$Parser*);
typedef frost$core$Bit (*$fn1082)(frost$core$Equatable*, frost$core$Equatable*);
typedef frost$core$String* (*$fn1090)(org$frostlanguage$frostc$frostdoc$Markdown*, org$frostlanguage$frostc$parser$Parser*);
typedef void (*$fn1098)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef frost$core$Object* (*$fn1133)(org$frostlanguage$frostc$frostdoc$Markdown$_Closure12*, frost$collections$ListView*);
typedef frost$core$Object* (*$fn1143)(org$frostlanguage$frostc$frostdoc$Markdown$_Closure14*, frost$collections$ListView*);
typedef frost$core$String* (*$fn1171)(org$frostlanguage$frostc$frostdoc$Markdown$_Closure16*, frost$collections$ListView*);
typedef frost$core$String* (*$fn1196)(org$frostlanguage$frostc$frostdoc$Markdown$_Closure18*, frost$collections$ListView*);
typedef frost$core$String* (*$fn1201)(org$frostlanguage$frostc$frostdoc$Markdown$_Closure20*, frost$collections$ListView*);
typedef frost$core$Object* (*$fn1209)(org$frostlanguage$frostc$frostdoc$Markdown$_Closure22*, frost$collections$ListView*);
typedef void (*$fn1213)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn1215)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn1217)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn1219)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn1221)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn1223)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn1225)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn1227)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
typedef void (*$fn1229)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$MutableString*);
...
typedef frost$collections$ListView* (*$fn1330)(org$frostlanguage$frostc$frostdoc$Markdown*, frost$core$String*);
...
typedef frost$core$String* (*$fn1363)(org$frostlanguage$frostc$frostdoc$Protector*, frost$core$String*);
typedef frost$core$String* (*$fn1373)(org$frostlanguage$frostc$frostdoc$Protector*, frost$core$String*);
typedef frost$core$String* (*$fn1383)(org$frostlanguage$frostc$frostdoc$Protector*, frost$core$String*);
typedef frost$core$String* (*$fn1393)(org$frostlanguage$frostc$frostdoc$Protector*, frost$core$String*);
typedef frost$core$String* (*$fn1430)(org$frostlanguage$frostc$frostdoc$Markdown$_Closure24*, frost$collections$ListView*);
typedef frost$core$Object* (*$fn1444)(org$frostlanguage$frostc$frostdoc$Markdown$_Closure26*, frost$collections$ListView*);
typedef frost$core$String* (*$fn1474)(org$frostlanguage$frostc$frostdoc$Markdown$_Closure28*, frost$collections$ListView*);
typedef frost$core$Object* (*$fn1488)(org$frostlanguage$frostc$frostdoc$Markdown$_Closure30*, frost$collections$ListView*);
typedef frost$core$String* (*$fn1508)(org$frostlanguage$frostc$frostdoc$Markdown$_Closure32*, frost$collections$ListView*);

static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x66\x72\x6f\x73\x74\x63\x2e\x66\x72\x6f\x73\x74\x64\x6f\x63\x2e\x4d\x61\x72\x6b\x64\x6f\x77\x6e", 42, -1651472982784267797, NULL };
...
void org$frostlanguage$frostc$frostdoc$Markdown$init(org$frostlanguage$frostc$frostdoc$Markdown* param0) {

// line 120
org$frostlanguage$frostc$frostdoc$Markdown$init$$LPfrost$core$String$RP$EQ$AM$GT$LPfrost$core$String$Q$RP$Q(param0, ((frost$core$MutableMethod*) NULL));
return;

}
void org$frostlanguage$frostc$frostdoc$Markdown$init$$LPfrost$core$String$RP$EQ$AM$GT$LPfrost$core$String$Q$RP$Q(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableMethod* param1) {
...
// unreffing REF($1:frost.threads.MessageQueue<org.frostlanguage.frostc.Compiler.Error>)
// line 100
org$frostlanguage$frostc$parser$Parser* $tmp6 = (org$frostlanguage$frostc$parser$Parser*) frostObjectAlloc(96, (frost$core$Class*) &org$frostlanguage$frostc$parser$Parser$class);
frost$threads$MessageQueue** $tmp7 = &param0->errorQueue;
frost$threads$MessageQueue* $tmp8 = *$tmp7;
org$frostlanguage$frostc$parser$Parser$init$frost$threads$MessageQueue$LTorg$frostlanguage$frostc$Compiler$Error$GT($tmp6, $tmp8);
frost$core$Frost$ref$frost$core$Object$Q(((frost$core$Object*) $tmp6));
org$frostlanguage$frostc$parser$Parser** $tmp9 = &param0->parser;
org$frostlanguage$frostc$parser$Parser* $tmp10 = *$tmp9;
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp10));
org$frostlanguage$frostc$parser$Parser** $tmp11 = &param0->parser;
*$tmp11 = $tmp6;
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp6));
// unreffing REF($16:org.frostlanguage.frostc.parser.Parser)
// line 105
...
// unreffing REF($32:frost.collections.HashMap<frost.core.String, org.frostlanguage.frostc.frostdoc.Markdown.LinkDefinition>)
// line 108
org$frostlanguage$frostc$frostdoc$Protector* $tmp16 = (org$frostlanguage$frostc$frostdoc$Protector*) frostObjectAlloc(40, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Protector$class);
org$frostlanguage$frostc$frostdoc$Protector$init($tmp16);
frost$core$Frost$ref$frost$core$Object$Q(((frost$core$Object*) $tmp16));
org$frostlanguage$frostc$frostdoc$Protector** $tmp17 = &param0->charProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp18 = *$tmp17;
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp18));
org$frostlanguage$frostc$frostdoc$Protector** $tmp19 = &param0->charProtector;
*$tmp19 = $tmp16;
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp16));
// unreffing REF($47:org.frostlanguage.frostc.frostdoc.Protector)
// line 111
org$frostlanguage$frostc$frostdoc$Protector* $tmp20 = (org$frostlanguage$frostc$frostdoc$Protector*) frostObjectAlloc(40, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Protector$class);
org$frostlanguage$frostc$frostdoc$Protector$init($tmp20);
frost$core$Frost$ref$frost$core$Object$Q(((frost$core$Object*) $tmp20));
org$frostlanguage$frostc$frostdoc$Protector** $tmp21 = &param0->htmlProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp22 = *$tmp21;
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp22));
org$frostlanguage$frostc$frostdoc$Protector** $tmp23 = &param0->htmlProtector;
*$tmp23 = $tmp20;
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp20));
// unreffing REF($61:org.frostlanguage.frostc.frostdoc.Protector)
// line 114
...
*$tmp37 = param1;
// line 126
org$frostlanguage$frostc$parser$Parser** $tmp38 = &param0->parser;
org$frostlanguage$frostc$parser$Parser* $tmp39 = *$tmp38;
org$frostlanguage$frostc$parser$SyntaxHighlighter* $tmp40 = (org$frostlanguage$frostc$parser$SyntaxHighlighter*) frostObjectAlloc(32, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$class);
org$frostlanguage$frostc$parser$SyntaxHighlighter$init($tmp40);
frost$core$Frost$ref$frost$core$Object$Q(((frost$core$Object*) $tmp40));
org$frostlanguage$frostc$parser$SyntaxHighlighter** $tmp41 = &$tmp39->syntaxHighlighter;
org$frostlanguage$frostc$parser$SyntaxHighlighter* $tmp42 = *$tmp41;
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp42));
org$frostlanguage$frostc$parser$SyntaxHighlighter** $tmp43 = &$tmp39->syntaxHighlighter;
*$tmp43 = $tmp40;
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp40));
// unreffing REF($117:org.frostlanguage.frostc.parser.SyntaxHighlighter)
return;

}
frost$core$String* org$frostlanguage$frostc$frostdoc$Markdown$process$frost$core$String$R$frost$core$String(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$String* param1) {
...
void org$frostlanguage$frostc$frostdoc$Markdown$encodeBackslashEscapes$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
// line 154
org$frostlanguage$frostc$frostdoc$Protector** $tmp90 = &param0->charProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp91 = *$tmp90;
...
void org$frostlanguage$frostc$frostdoc$Markdown$encodeEscapes$frost$core$MutableString$frost$collections$ListView$LTfrost$core$Char8$GT$frost$core$String(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1, frost$collections$ListView* param2, frost$core$String* param3) {
...
org$frostlanguage$frostc$frostdoc$Protector** $tmp128 = &param0->charProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp129 = *$tmp128;
...
void org$frostlanguage$frostc$frostdoc$Markdown$stripLinkDefinitions$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
org$frostlanguage$frostc$frostdoc$Markdown$_Closure2* $tmp150 = (org$frostlanguage$frostc$frostdoc$Markdown$_Closure2*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$_Closure2$class);
org$frostlanguage$frostc$frostdoc$Markdown$_Closure2$init$org$frostlanguage$frostc$frostdoc$Markdown($tmp150, param0);
...
frost$core$MutableMethod$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Object$Q($tmp152, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$_Closure2$$anonymous1$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$String), ((frost$core$Object*) $tmp150));
...
// unreffing REF($32:org.frostlanguage.frostc.frostdoc.Markdown._Closure2)
...
void org$frostlanguage$frostc$frostdoc$Markdown$runBlockGamut$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
void org$frostlanguage$frostc$frostdoc$Markdown$doHorizontalRules$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
void org$frostlanguage$frostc$frostdoc$Markdown$hashHTMLBlocks$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
// line 277
org$frostlanguage$frostc$frostdoc$Markdown$_Closure4* $tmp295 = (org$frostlanguage$frostc$frostdoc$Markdown$_Closure4*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$_Closure4$class);
org$frostlanguage$frostc$frostdoc$Markdown$_Closure4$init$org$frostlanguage$frostc$frostdoc$Markdown($tmp295, param0);
...
frost$core$MutableMethod$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Object$Q($tmp297, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$_Closure4$$anonymous3$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$String), ((frost$core$Object*) $tmp295));
// line 277
...
// unreffing REF($239:org.frostlanguage.frostc.frostdoc.Markdown._Closure4)
...
void org$frostlanguage$frostc$frostdoc$Markdown$formParagraphs$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
// line 343
org$frostlanguage$frostc$frostdoc$Protector** $tmp449 = &param0->htmlProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp450 = *$tmp449;
...
void org$frostlanguage$frostc$frostdoc$Markdown$doAutoLinks$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
org$frostlanguage$frostc$frostdoc$Markdown$_Closure6* $tmp514 = (org$frostlanguage$frostc$frostdoc$Markdown$_Closure6*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$_Closure6$class);
org$frostlanguage$frostc$frostdoc$Markdown$_Closure6$init$org$frostlanguage$frostc$frostdoc$Markdown($tmp514, param0);
...
frost$core$MutableMethod$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Object$Q($tmp516, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$_Closure6$$anonymous5$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$String), ((frost$core$Object*) $tmp514));
...
// unreffing REF($22:org.frostlanguage.frostc.frostdoc.Markdown._Closure6)
...
void org$frostlanguage$frostc$frostdoc$Markdown$unescapeSpecialChars$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {

frost$core$String* local0 = NULL;
frost$core$String* local1 = NULL;
// line 370
org$frostlanguage$frostc$frostdoc$Protector** $tmp518 = &param0->charProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp519 = *$tmp518;
...
// line 371
org$frostlanguage$frostc$frostdoc$Protector** $tmp536 = &param0->charProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp537 = *$tmp536;
...
frost$core$String* org$frostlanguage$frostc$frostdoc$Markdown$encodeEmail$frost$core$String$R$frost$core$String(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$String* param1) {
...
void org$frostlanguage$frostc$frostdoc$Markdown$doBlockQuotes$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
org$frostlanguage$frostc$frostdoc$Markdown$_Closure9* $tmp621 = (org$frostlanguage$frostc$frostdoc$Markdown$_Closure9*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$_Closure9$class);
org$frostlanguage$frostc$frostdoc$Markdown$_Closure9$init$org$frostlanguage$frostc$frostdoc$Markdown($tmp621, param0);
...
frost$core$MutableMethod$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Object$Q($tmp623, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$_Closure9$$anonymous7$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$Object), ((frost$core$Object*) $tmp621));
...
// unreffing REF($40:org.frostlanguage.frostc.frostdoc.Markdown._Closure9)
...
frost$core$String* org$frostlanguage$frostc$frostdoc$Markdown$$anonymous10$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$String(frost$collections$ListView* param0) {
...
void org$frostlanguage$frostc$frostdoc$Markdown$detabify$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
frost$core$Method$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Immutable$Q($tmp660, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$$anonymous10$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$String), ((frost$core$Immutable*) NULL));
...
void org$frostlanguage$frostc$frostdoc$Markdown$outdent$frost$core$MutableString(frost$core$MutableString* param0) {
...
void org$frostlanguage$frostc$frostdoc$Markdown$doCodeBlocks$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer* $tmp679 = (org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$class);
org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$init$org$frostlanguage$frostc$frostdoc$Markdown($tmp679, param0);
...
frost$core$MutableMethod$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Object$Q($tmp681, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$CodeReplacer$replacement$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$String), ((frost$core$Object*) $tmp679));
...
// unreffing REF($36:org.frostlanguage.frostc.frostdoc.Markdown.CodeReplacer)
...
frost$core$String* org$frostlanguage$frostc$frostdoc$Markdown$prettyPrint$org$frostlanguage$frostc$parser$Parser$R$frost$core$String(org$frostlanguage$frostc$frostdoc$Markdown* param0, org$frostlanguage$frostc$parser$Parser* param1) {

frost$core$MutableString* local0 = NULL;
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind local1;
...
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp687 = org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$init$frost$core$Int64($tmp686);
*(&local1) = $tmp687;
// line 507
org$frostlanguage$frostc$parser$SyntaxHighlighter** $tmp688 = &param1->syntaxHighlighter;
org$frostlanguage$frostc$parser$SyntaxHighlighter* $tmp689 = *$tmp688;
...
frost$core$Frost$ref$frost$core$Object$Q(((frost$core$Object*) ((org$frostlanguage$frostc$Pair*) $tmp704)));
org$frostlanguage$frostc$Pair* $tmp705 = *(&local2);
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp705));
*(&local2) = ((org$frostlanguage$frostc$Pair*) $tmp704);
// line 508
org$frostlanguage$frostc$Pair* $tmp706 = *(&local2);
frost$core$Object** $tmp707 = &$tmp706->second;
frost$core$Object* $tmp708 = *$tmp707;
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp709;
$tmp709 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp709->value = ((org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) $tmp708)->value;
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp710 = *(&local1);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp711;
$tmp711 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp711->value = $tmp710;
...
block6:;
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp717 = *(&local1);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp718;
$tmp718 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp718->value = $tmp717;
frost$core$Int64 $tmp719 = (frost$core$Int64) {0};
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp720 = org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$init$frost$core$Int64($tmp719);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp721;
$tmp721 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp721->value = $tmp720;
...
// unreffing REF($60:frost.core.Equatable<org.frostlanguage.frostc.parser.SyntaxHighlighter.Kind>)
*(&local3) = $tmp725;
goto block8;
block7:;
*(&local3) = $tmp715;
...
// unreffing REF($51:frost.core.Equatable<org.frostlanguage.frostc.parser.SyntaxHighlighter.Kind>)
...
block5:;
// line 511
org$frostlanguage$frostc$Pair* $tmp730 = *(&local2);
frost$core$Object** $tmp731 = &$tmp730->second;
frost$core$Object* $tmp732 = *$tmp731;
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp733;
$tmp733 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp733->value = ((org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) $tmp732)->value;
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp734 = *(&local1);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp735;
$tmp735 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp735->value = $tmp734;
...
// unreffing REF($96:frost.core.Equatable<org.frostlanguage.frostc.parser.SyntaxHighlighter.Kind>)
if ($tmp740) goto block9; else goto block10;
block9:;
// line 512
org$frostlanguage$frostc$Pair* $tmp741 = *(&local2);
frost$core$Object** $tmp742 = &$tmp741->second;
frost$core$Object* $tmp743 = *$tmp742;
*(&local1) = ((org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) $tmp743)->value;
// line 513
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp744 = *(&local1);
...
org$frostlanguage$frostc$Pair* $tmp812 = *(&local2);
frost$core$Object** $tmp813 = &$tmp812->first;
frost$core$Object* $tmp814 = *$tmp813;
frost$core$String* $tmp815 = org$frostlanguage$frostc$parser$Parser$text$org$frostlanguage$frostc$parser$Token$R$frost$core$String(param1, ((org$frostlanguage$frostc$parser$Token$wrapper*) $tmp814)->value);
...
org$frostlanguage$frostc$frostdoc$Protector** $tmp827 = &param0->charProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp828 = *$tmp827;
...
org$frostlanguage$frostc$frostdoc$Protector** $tmp835 = &param0->charProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp836 = *$tmp835;
...
org$frostlanguage$frostc$frostdoc$Protector** $tmp843 = &param0->charProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp844 = *$tmp843;
...
org$frostlanguage$frostc$frostdoc$Protector** $tmp851 = &param0->charProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp852 = *$tmp851;
...
org$frostlanguage$frostc$frostdoc$Protector** $tmp859 = &param0->charProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp860 = *$tmp859;
...
// line 564
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp866 = *(&local1);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp867;
$tmp867 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp867->value = $tmp866;
frost$core$Int64 $tmp868 = (frost$core$Int64) {1};
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp869 = org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$init$frost$core$Int64($tmp868);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp870;
$tmp870 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp870->value = $tmp869;
...
block41:;
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp876 = *(&local1);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp877;
$tmp877 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp877->value = $tmp876;
frost$core$Int64 $tmp878 = (frost$core$Int64) {2};
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp879 = org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$init$frost$core$Int64($tmp878);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp880;
$tmp880 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp880->value = $tmp879;
...
// unreffing REF($319:frost.core.Equatable<org.frostlanguage.frostc.parser.SyntaxHighlighter.Kind>)
*(&local5) = $tmp884;
goto block43;
block42:;
*(&local5) = $tmp874;
...
// unreffing REF($309:frost.core.Equatable<org.frostlanguage.frostc.parser.SyntaxHighlighter.Kind>)
if ($tmp886) goto block39; else goto block40;
block39:;
// line 566
frost$core$MutableString* $tmp887 = *(&local0);
org$frostlanguage$frostc$Pair* $tmp888 = *(&local2);
frost$core$Object** $tmp889 = &$tmp888->first;
frost$core$Object* $tmp890 = *$tmp889;
org$frostlanguage$frostc$parser$Token$Kind $tmp891 = ((org$frostlanguage$frostc$parser$Token$wrapper*) $tmp890)->value.kind;
org$frostlanguage$frostc$parser$Token$Kind$wrapper* $tmp892;
$tmp892 = (org$frostlanguage$frostc$parser$Token$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$Token$Kind$wrapperclass);
$tmp892->value = $tmp891;
...
// line 569
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp899 = *(&local1);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp900;
$tmp900 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp900->value = $tmp899;
frost$core$Int64 $tmp901 = (frost$core$Int64) {1};
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp902 = org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$init$frost$core$Int64($tmp901);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp903;
$tmp903 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp903->value = $tmp902;
...
block46:;
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp909 = *(&local1);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp910;
$tmp910 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp910->value = $tmp909;
frost$core$Int64 $tmp911 = (frost$core$Int64) {2};
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp912 = org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$init$frost$core$Int64($tmp911);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp913;
$tmp913 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp913->value = $tmp912;
...
// unreffing REF($384:frost.core.Equatable<org.frostlanguage.frostc.parser.SyntaxHighlighter.Kind>)
*(&local6) = $tmp917;
goto block48;
block47:;
*(&local6) = $tmp907;
...
// unreffing REF($374:frost.core.Equatable<org.frostlanguage.frostc.parser.SyntaxHighlighter.Kind>)
...
org$frostlanguage$frostc$Pair* $tmp923 = *(&local2);
...
// line 574
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp924 = *(&local1);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp925;
$tmp925 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp925->value = $tmp924;
frost$core$Int64 $tmp926 = (frost$core$Int64) {0};
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind $tmp927 = org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$init$frost$core$Int64($tmp926);
org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper* $tmp928;
$tmp928 = (org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$SyntaxHighlighter$Kind$wrapperclass);
$tmp928->value = $tmp927;
...
// unreffing REF($433:frost.core.Equatable<org.frostlanguage.frostc.parser.SyntaxHighlighter.Kind>)
...
void org$frostlanguage$frostc$frostdoc$Markdown$syntaxHighlight$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
// unreffing REF($6:frost.core.String)
// line 584
org$frostlanguage$frostc$parser$Parser** $tmp946 = &param0->parser;
org$frostlanguage$frostc$parser$Parser* $tmp947 = *$tmp946;
frost$io$File** $tmp948 = &param0->source;
frost$io$File* $tmp949 = *$tmp948;
frost$core$String* $tmp950 = *(&local0);
org$frostlanguage$frostc$parser$Parser$start$frost$io$File$frost$core$String($tmp947, $tmp949, $tmp950);
// line 585
org$frostlanguage$frostc$parser$Parser** $tmp951 = &param0->parser;
org$frostlanguage$frostc$parser$Parser* $tmp952 = *$tmp951;
org$frostlanguage$frostc$ASTNode* $tmp953 = org$frostlanguage$frostc$parser$Parser$file$R$org$frostlanguage$frostc$ASTNode$Q($tmp952);
*(&local1) = ((org$frostlanguage$frostc$ASTNode*) NULL);
frost$core$Frost$ref$frost$core$Object$Q(((frost$core$Object*) $tmp953));
org$frostlanguage$frostc$ASTNode* $tmp954 = *(&local1);
...
// line 586
org$frostlanguage$frostc$ASTNode* $tmp955 = *(&local1);
...
org$frostlanguage$frostc$parser$Parser** $tmp967 = &param0->parser;
org$frostlanguage$frostc$parser$Parser* $tmp968 = *$tmp967;
...
// line 588
org$frostlanguage$frostc$ASTNode* $tmp972 = *(&local1);
...
// line 592
org$frostlanguage$frostc$parser$Parser** $tmp976 = &param0->parser;
org$frostlanguage$frostc$parser$Parser* $tmp977 = *$tmp976;
frost$io$File** $tmp978 = &param0->source;
frost$io$File* $tmp979 = *$tmp978;
frost$core$String* $tmp980 = *(&local0);
org$frostlanguage$frostc$parser$Parser$start$frost$io$File$frost$core$String($tmp977, $tmp979, $tmp980);
// line 593
goto block6;
block6:;
org$frostlanguage$frostc$parser$Parser** $tmp981 = &param0->parser;
org$frostlanguage$frostc$parser$Parser* $tmp982 = *$tmp981;
org$frostlanguage$frostc$parser$Token $tmp983 = org$frostlanguage$frostc$parser$Parser$peek$R$org$frostlanguage$frostc$parser$Token($tmp982);
org$frostlanguage$frostc$parser$Token$Kind $tmp984 = $tmp983.kind;
org$frostlanguage$frostc$parser$Token$Kind$wrapper* $tmp985;
$tmp985 = (org$frostlanguage$frostc$parser$Token$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$Token$Kind$wrapperclass);
$tmp985->value = $tmp984;
frost$core$Int64 $tmp986 = (frost$core$Int64) {0};
org$frostlanguage$frostc$parser$Token$Kind $tmp987 = org$frostlanguage$frostc$parser$Token$Kind$init$frost$core$Int64($tmp986);
org$frostlanguage$frostc$parser$Token$Kind$wrapper* $tmp988;
$tmp988 = (org$frostlanguage$frostc$parser$Token$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$Token$Kind$wrapperclass);
$tmp988->value = $tmp987;
...
// unreffing REF($102:frost.core.Equatable<org.frostlanguage.frostc.parser.Token.Kind>)
if ($tmp1000) goto block7; else goto block8;
block7:;
// line 594
org$frostlanguage$frostc$parser$Parser** $tmp1001 = &param0->parser;
org$frostlanguage$frostc$parser$Parser* $tmp1002 = *$tmp1001;
org$frostlanguage$frostc$ASTNode* $tmp1003 = org$frostlanguage$frostc$parser$Parser$statement$R$org$frostlanguage$frostc$ASTNode$Q($tmp1002);
...
org$frostlanguage$frostc$parser$Parser** $tmp1012 = &param0->parser;
org$frostlanguage$frostc$parser$Parser* $tmp1013 = *$tmp1012;
...
// line 598
org$frostlanguage$frostc$ASTNode* $tmp1017 = *(&local1);
...
// line 602
org$frostlanguage$frostc$parser$Parser** $tmp1021 = &param0->parser;
org$frostlanguage$frostc$parser$Parser* $tmp1022 = *$tmp1021;
frost$io$File** $tmp1023 = &param0->source;
frost$io$File* $tmp1024 = *$tmp1023;
frost$core$String* $tmp1025 = *(&local0);
org$frostlanguage$frostc$parser$Parser$start$frost$io$File$frost$core$String($tmp1022, $tmp1024, $tmp1025);
// line 603
goto block14;
block14:;
org$frostlanguage$frostc$parser$Parser** $tmp1026 = &param0->parser;
org$frostlanguage$frostc$parser$Parser* $tmp1027 = *$tmp1026;
org$frostlanguage$frostc$parser$Token $tmp1028 = org$frostlanguage$frostc$parser$Parser$peek$R$org$frostlanguage$frostc$parser$Token($tmp1027);
org$frostlanguage$frostc$parser$Token$Kind $tmp1029 = $tmp1028.kind;
org$frostlanguage$frostc$parser$Token$Kind$wrapper* $tmp1030;
$tmp1030 = (org$frostlanguage$frostc$parser$Token$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$Token$Kind$wrapperclass);
$tmp1030->value = $tmp1029;
frost$core$Int64 $tmp1031 = (frost$core$Int64) {0};
org$frostlanguage$frostc$parser$Token$Kind $tmp1032 = org$frostlanguage$frostc$parser$Token$Kind$init$frost$core$Int64($tmp1031);
org$frostlanguage$frostc$parser$Token$Kind$wrapper* $tmp1033;
$tmp1033 = (org$frostlanguage$frostc$parser$Token$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$Token$Kind$wrapperclass);
...
// unreffing REF($188:frost.core.Equatable<org.frostlanguage.frostc.parser.Token.Kind>)
if ($tmp1045) goto block15; else goto block16;
block15:;
// line 604
org$frostlanguage$frostc$parser$Parser** $tmp1046 = &param0->parser;
org$frostlanguage$frostc$parser$Parser* $tmp1047 = *$tmp1046;
org$frostlanguage$frostc$ASTNode* $tmp1048 = org$frostlanguage$frostc$parser$Parser$expression$R$org$frostlanguage$frostc$ASTNode$Q($tmp1047);
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp1048));
// unreffing REF($219:org.frostlanguage.frostc.ASTNode?)
goto block14;
block16:;
// line 606
...
org$frostlanguage$frostc$parser$Parser** $tmp1057 = &param0->parser;
org$frostlanguage$frostc$parser$Parser* $tmp1058 = *$tmp1057;
...
// line 608
org$frostlanguage$frostc$ASTNode* $tmp1062 = *(&local1);
...
// line 612
org$frostlanguage$frostc$parser$Parser** $tmp1066 = &param0->parser;
org$frostlanguage$frostc$parser$Parser* $tmp1067 = *$tmp1066;
frost$io$File** $tmp1068 = &param0->source;
frost$io$File* $tmp1069 = *$tmp1068;
frost$core$String* $tmp1070 = *(&local0);
org$frostlanguage$frostc$parser$Parser$start$frost$io$File$frost$core$String($tmp1067, $tmp1069, $tmp1070);
// line 613
goto block22;
block22:;
// line 614
org$frostlanguage$frostc$parser$Parser** $tmp1071 = &param0->parser;
org$frostlanguage$frostc$parser$Parser* $tmp1072 = *$tmp1071;
org$frostlanguage$frostc$parser$Token $tmp1073 = org$frostlanguage$frostc$parser$Parser$next$R$org$frostlanguage$frostc$parser$Token($tmp1072);
*(&local5) = $tmp1073;
// line 615
org$frostlanguage$frostc$parser$Token $tmp1074 = *(&local5);
org$frostlanguage$frostc$parser$Token$Kind $tmp1075 = $tmp1074.kind;
org$frostlanguage$frostc$parser$Token$Kind$wrapper* $tmp1076;
$tmp1076 = (org$frostlanguage$frostc$parser$Token$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$Token$Kind$wrapperclass);
$tmp1076->value = $tmp1075;
frost$core$Int64 $tmp1077 = (frost$core$Int64) {0};
org$frostlanguage$frostc$parser$Token$Kind $tmp1078 = org$frostlanguage$frostc$parser$Token$Kind$init$frost$core$Int64($tmp1077);
org$frostlanguage$frostc$parser$Token$Kind$wrapper* $tmp1079;
$tmp1079 = (org$frostlanguage$frostc$parser$Token$Kind$wrapper*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$parser$Token$Kind$wrapperclass);
...
// unreffing REF($278:frost.core.Equatable<org.frostlanguage.frostc.parser.Token.Kind>)
...
org$frostlanguage$frostc$parser$Parser** $tmp1087 = &param0->parser;
org$frostlanguage$frostc$parser$Parser* $tmp1088 = *$tmp1087;
...
// unreffing REF($302:frost.core.String)
org$frostlanguage$frostc$ASTNode* $tmp1092 = *(&local1);
...
void org$frostlanguage$frostc$frostdoc$Markdown$encodeCode$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
void org$frostlanguage$frostc$frostdoc$Markdown$doLists$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
org$frostlanguage$frostc$frostdoc$Markdown$_Closure12* $tmp1132 = (org$frostlanguage$frostc$frostdoc$Markdown$_Closure12*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$_Closure12$class);
org$frostlanguage$frostc$frostdoc$Markdown$_Closure12$init$org$frostlanguage$frostc$frostdoc$Markdown($tmp1132, param0);
...
frost$core$MutableMethod$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Object$Q($tmp1134, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$_Closure12$$anonymous11$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$Object), ((frost$core$Object*) $tmp1132));
...
// unreffing REF($67:org.frostlanguage.frostc.frostdoc.Markdown._Closure12)
...
org$frostlanguage$frostc$frostdoc$Markdown$_Closure14* $tmp1142 = (org$frostlanguage$frostc$frostdoc$Markdown$_Closure14*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$_Closure14$class);
org$frostlanguage$frostc$frostdoc$Markdown$_Closure14$init$org$frostlanguage$frostc$frostdoc$Markdown($tmp1142, param0);
...
frost$core$MutableMethod$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Object$Q($tmp1144, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$_Closure14$$anonymous13$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$Object), ((frost$core$Object*) $tmp1142));
...
// unreffing REF($109:org.frostlanguage.frostc.frostdoc.Markdown._Closure14)
...
frost$core$String* org$frostlanguage$frostc$frostdoc$Markdown$processListItems$frost$core$String$R$frost$core$String(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$String* param1) {
...
org$frostlanguage$frostc$frostdoc$Markdown$_Closure16* $tmp1170 = (org$frostlanguage$frostc$frostdoc$Markdown$_Closure16*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$_Closure16$class);
org$frostlanguage$frostc$frostdoc$Markdown$_Closure16$init$org$frostlanguage$frostc$frostdoc$Markdown($tmp1170, param0);
...
frost$core$MutableMethod$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Object$Q($tmp1172, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$_Closure16$$anonymous15$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$String), ((frost$core$Object*) $tmp1170));
...
// unreffing REF($52:org.frostlanguage.frostc.frostdoc.Markdown._Closure16)
// line 753
...
frost$core$Bit org$frostlanguage$frostc$frostdoc$Markdown$hasParagraphBreak$frost$core$MutableString$R$frost$core$Bit(frost$core$MutableString* param0) {
...
frost$core$Bit org$frostlanguage$frostc$frostdoc$Markdown$isEmptyString$frost$core$String$Q$R$frost$core$Bit(frost$core$String* param0) {
...
void org$frostlanguage$frostc$frostdoc$Markdown$doHeaders$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
org$frostlanguage$frostc$frostdoc$Markdown$_Closure18* $tmp1195 = (org$frostlanguage$frostc$frostdoc$Markdown$_Closure18*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$_Closure18$class);
org$frostlanguage$frostc$frostdoc$Markdown$_Closure18$init$org$frostlanguage$frostc$frostdoc$Markdown($tmp1195, param0);
...
frost$core$MutableMethod$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Object$Q($tmp1197, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$_Closure18$$anonymous17$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$String), ((frost$core$Object*) $tmp1195));
...
// unreffing REF($3:org.frostlanguage.frostc.frostdoc.Markdown._Closure18)
...
org$frostlanguage$frostc$frostdoc$Markdown$_Closure20* $tmp1200 = (org$frostlanguage$frostc$frostdoc$Markdown$_Closure20*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$_Closure20$class);
org$frostlanguage$frostc$frostdoc$Markdown$_Closure20$init$org$frostlanguage$frostc$frostdoc$Markdown($tmp1200, param0);
...
frost$core$MutableMethod$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Object$Q($tmp1202, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$_Closure20$$anonymous19$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$String), ((frost$core$Object*) $tmp1200));
...
// unreffing REF($24:org.frostlanguage.frostc.frostdoc.Markdown._Closure20)
...
org$frostlanguage$frostc$frostdoc$Markdown$_Closure22* $tmp1208 = (org$frostlanguage$frostc$frostdoc$Markdown$_Closure22*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$_Closure22$class);
org$frostlanguage$frostc$frostdoc$Markdown$_Closure22$init$org$frostlanguage$frostc$frostdoc$Markdown($tmp1208, param0);
...
frost$core$MutableMethod$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Object$Q($tmp1210, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$_Closure22$$anonymous21$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$Object), ((frost$core$Object*) $tmp1208));
...
// unreffing REF($58:org.frostlanguage.frostc.frostdoc.Markdown._Closure22)
...
void org$frostlanguage$frostc$frostdoc$Markdown$runSpanGamut$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
frost$core$String* org$frostlanguage$frostc$frostdoc$Markdown$nestedTagsRegex$frost$core$Int64$R$frost$core$String(frost$core$Int64 param0) {
...
frost$core$String* $tmp1243 = org$frostlanguage$frostc$frostdoc$Markdown$nestedTagsRegex$frost$core$Int64$R$frost$core$String($tmp1242);
...
frost$collections$ListView* org$frostlanguage$frostc$frostdoc$Markdown$tokenizeHTML$frost$core$String$R$frost$collections$ListView$LTorg$frostlanguage$frostc$frostdoc$Markdown$HTMLToken$GT(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$String* param1) {
...
// unreffing REF($1:frost.collections.Array<org.frostlanguage.frostc.frostdoc.Markdown.HTMLToken>)
// line 830
frost$core$Int64 $tmp1255 = (frost$core$Int64) {6};
frost$core$String* $tmp1256 = org$frostlanguage$frostc$frostdoc$Markdown$nestedTagsRegex$frost$core$Int64$R$frost$core$String($tmp1255);
*(&local1) = ((frost$core$String*) NULL);
...
org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken* $tmp1286 = (org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken*) frostObjectAlloc(32, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken$class);
...
org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken$init$frost$core$Int64$frost$core$String($tmp1286, $tmp1287, $tmp1293);
...
// unreffing REF($96:org.frostlanguage.frostc.frostdoc.Markdown.HTMLToken)
goto block5;
block5:;
// line 846
frost$collections$Array* $tmp1294 = *(&local0);
org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken* $tmp1295 = (org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken*) frostObjectAlloc(32, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken$class);
...
org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken$init$frost$core$Int64$frost$core$String($tmp1295, $tmp1296, $tmp1303);
...
// unreffing REF($117:org.frostlanguage.frostc.frostdoc.Markdown.HTMLToken)
// line 847
...
org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken* $tmp1316 = (org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken*) frostObjectAlloc(32, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken$class);
...
org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken$init$frost$core$Int64$frost$core$String($tmp1316, $tmp1317, $tmp1322);
...
// unreffing REF($159:org.frostlanguage.frostc.frostdoc.Markdown.HTMLToken)
goto block7;
block7:;
// line 853
...
void org$frostlanguage$frostc$frostdoc$Markdown$escapeSpecialCharsWithinTagAttributes$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {

frost$collections$ListView* local0 = NULL;
org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken* local1 = NULL;
frost$core$String* local2 = NULL;
frost$core$String* local3 = NULL;
...
// unreffing REF($3:frost.collections.ListView<org.frostlanguage.frostc.frostdoc.Markdown.HTMLToken>)
...
block2:;
*(&local1) = ((org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken*) NULL);
...
frost$core$Frost$ref$frost$core$Object$Q(((frost$core$Object*) ((org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken*) $tmp1346)));
org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken* $tmp1347 = *(&local1);
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp1347));
*(&local1) = ((org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken*) $tmp1346);
// line 870
*(&local2) = ((frost$core$String*) NULL);
// line 871
org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken* $tmp1348 = *(&local1);
...
org$frostlanguage$frostc$frostdoc$Protector** $tmp1360 = &param0->charProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp1361 = *$tmp1360;
...
org$frostlanguage$frostc$frostdoc$Protector** $tmp1370 = &param0->charProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp1371 = *$tmp1370;
...
org$frostlanguage$frostc$frostdoc$Protector** $tmp1380 = &param0->charProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp1381 = *$tmp1380;
...
org$frostlanguage$frostc$frostdoc$Protector** $tmp1390 = &param0->charProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp1391 = *$tmp1390;
...
org$frostlanguage$frostc$frostdoc$Markdown$HTMLToken* $tmp1411 = *(&local1);
...
void org$frostlanguage$frostc$frostdoc$Markdown$doImages$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
org$frostlanguage$frostc$frostdoc$Markdown$_Closure24* $tmp1429 = (org$frostlanguage$frostc$frostdoc$Markdown$_Closure24*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$_Closure24$class);
org$frostlanguage$frostc$frostdoc$Markdown$_Closure24$init$org$frostlanguage$frostc$frostdoc$Markdown($tmp1429, param0);
...
frost$core$MutableMethod$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Object$Q($tmp1431, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$_Closure24$$anonymous23$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$String), ((frost$core$Object*) $tmp1429));
...
// unreffing REF($41:org.frostlanguage.frostc.frostdoc.Markdown._Closure24)
...
void org$frostlanguage$frostc$frostdoc$Markdown$doAnchors$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
org$frostlanguage$frostc$frostdoc$Markdown$_Closure26* $tmp1443 = (org$frostlanguage$frostc$frostdoc$Markdown$_Closure26*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$_Closure26$class);
org$frostlanguage$frostc$frostdoc$Markdown$_Closure26$init$org$frostlanguage$frostc$frostdoc$Markdown($tmp1443, param0);
...
frost$core$MutableMethod$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Object$Q($tmp1445, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$_Closure26$$anonymous25$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$Object), ((frost$core$Object*) $tmp1443));
...
// unreffing REF($27:org.frostlanguage.frostc.frostdoc.Markdown._Closure26)
// line 968
...
org$frostlanguage$frostc$frostdoc$Markdown$_Closure28* $tmp1473 = (org$frostlanguage$frostc$frostdoc$Markdown$_Closure28*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$_Closure28$class);
org$frostlanguage$frostc$frostdoc$Markdown$_Closure28$init$org$frostlanguage$frostc$frostdoc$Markdown($tmp1473, param0);
...
frost$core$MutableMethod$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Object$Q($tmp1475, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$_Closure28$$anonymous27$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$String), ((frost$core$Object*) $tmp1473));
...
// unreffing REF($102:org.frostlanguage.frostc.frostdoc.Markdown._Closure28)
// line 1019
...
org$frostlanguage$frostc$frostdoc$Markdown$_Closure30* $tmp1487 = (org$frostlanguage$frostc$frostdoc$Markdown$_Closure30*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$_Closure30$class);
org$frostlanguage$frostc$frostdoc$Markdown$_Closure30$init$org$frostlanguage$frostc$frostdoc$Markdown($tmp1487, param0);
...
frost$core$MutableMethod$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Object$Q($tmp1489, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$_Closure30$$anonymous29$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$Object), ((frost$core$Object*) $tmp1487));
...
// unreffing REF($145:org.frostlanguage.frostc.frostdoc.Markdown._Closure30)
...
void org$frostlanguage$frostc$frostdoc$Markdown$doItalicsAndBold$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
void org$frostlanguage$frostc$frostdoc$Markdown$encodeAmpsAndAngles$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
void org$frostlanguage$frostc$frostdoc$Markdown$doCodeSpans$frost$core$MutableString(org$frostlanguage$frostc$frostdoc$Markdown* param0, frost$core$MutableString* param1) {
...
org$frostlanguage$frostc$frostdoc$Markdown$_Closure32* $tmp1507 = (org$frostlanguage$frostc$frostdoc$Markdown$_Closure32*) frostObjectAlloc(24, (frost$core$Class*) &org$frostlanguage$frostc$frostdoc$Markdown$_Closure32$class);
org$frostlanguage$frostc$frostdoc$Markdown$_Closure32$init$org$frostlanguage$frostc$frostdoc$Markdown($tmp1507, param0);
...
frost$core$MutableMethod$init$frost$unsafe$Pointer$LTfrost$core$Int8$GT$frost$core$Object$Q($tmp1509, ((frost$core$Int8*) org$frostlanguage$frostc$frostdoc$Markdown$_Closure32$$anonymous31$frost$collections$ListView$LTfrost$core$String$Q$GT$R$frost$core$String), ((frost$core$Object*) $tmp1507));
...
// unreffing REF($3:org.frostlanguage.frostc.frostdoc.Markdown._Closure32)
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp1505));
// unreffing REF($1:frost.core.RegularExpression)
return;

}
void org$frostlanguage$frostc$frostdoc$Markdown$cleanup(org$frostlanguage$frostc$frostdoc$Markdown* param0) {
...
org$frostlanguage$frostc$parser$Parser** $tmp1514 = &param0->parser;
org$frostlanguage$frostc$parser$Parser* $tmp1515 = *$tmp1514;
...
org$frostlanguage$frostc$frostdoc$Protector** $tmp1520 = &param0->charProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp1521 = *$tmp1520;
frost$core$Frost$unref$frost$core$Object$Q(((frost$core$Object*) $tmp1521));
org$frostlanguage$frostc$frostdoc$Protector** $tmp1522 = &param0->htmlProtector;
org$frostlanguage$frostc$frostdoc$Protector* $tmp1523 = *$tmp1522;
