...
__attribute__((weak)) frost$core$Bit org$frostlanguage$json$Token$Kind$$EQ$org$frostlanguage$json$Token$Kind$R$frost$core$Bit$shim(frost$core$Object* p0, frost$core$Equatable* p1) {
    frost$core$Bit result = org$frostlanguage$json$Token$Kind$$EQ$org$frostlanguage$json$Token$Kind$R$frost$core$Bit(((org$frostlanguage$json$Token$Kind$wrapper*) p0)->value, ((org$frostlanguage$json$Token$Kind$wrapper*) p1)->value);

    return result;
}
__attribute__((weak)) frost$core$String* org$frostlanguage$json$Token$Kind$convert$R$frost$core$String$shim(frost$core$Object* p0) {
    frost$core$String* result = org$frostlanguage$json$Token$Kind$convert$R$frost$core$String(((org$frostlanguage$json$Token$Kind$wrapper*) p0)->value);
...
__attribute__((weak)) void org$frostlanguage$json$Token$Kind$cleanup$shim(frost$core$Object* p0) {
    org$frostlanguage$json$Token$Kind$cleanup(((org$frostlanguage$json$Token$Kind$wrapper*) p0)->value);

}

struct { frost$core$Class* cl; ITable* next; void* methods[2]; } org$frostlanguage$json$Token$Kind$_frost$core$Equatable = { (frost$core$Class*) &frost$core$Equatable$class, NULL, { org$frostlanguage$json$Token$Kind$$EQ$org$frostlanguage$json$Token$Kind$R$frost$core$Bit$shim, frost$core$Equatable$$NEQ$frost$core$Equatable$T$R$frost$core$Bit} };

static frost$core$String $s1;
org$frostlanguage$json$Token$Kind$class_type org$frostlanguage$json$Token$Kind$class = { (frost$core$Class*) &frost$core$Class$class, -999, &$s1, (frost$core$Class*) &frost$core$Value$class, (ITable*) &org$frostlanguage$json$Token$Kind$_frost$core$Equatable, { org$frostlanguage$json$Token$Kind$convert$R$frost$core$String$shim, frost$core$Value$cleanup$shim, org$frostlanguage$json$Token$Kind$cleanup$shim, org$frostlanguage$json$Token$Kind$$EQ$org$frostlanguage$json$Token$Kind$R$frost$core$Bit$shim} };

struct { frost$core$Class* cl; ITable* itable; void* methods[2]; } org$frostlanguage$json$Token$Kind$wrapper_frost$core$Equatable = { (frost$core$Class*) &frost$core$Equatable$class, NULL, { org$frostlanguage$json$Token$Kind$$EQ$org$frostlanguage$json$Token$Kind$R$frost$core$Bit$shim, frost$core$Equatable$$NEQ$frost$core$Equatable$T$R$frost$core$Bit} };

static frost$core$String $s2;
org$frostlanguage$json$Token$Kind$wrapperclass_type org$frostlanguage$json$Token$Kind$wrapperclass = { (frost$core$Class*) &frost$core$Class$class, -999, &$s2, (frost$core$Class*) &frost$core$Value$class, (ITable*) &org$frostlanguage$json$Token$Kind$wrapper_frost$core$Equatable, { org$frostlanguage$json$Token$Kind$convert$R$frost$core$String$shim, frost$core$Value$cleanup$shim} };
static frost$core$String $s1 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x6a\x73\x6f\x6e\x2e\x54\x6f\x6b\x65\x6e\x2e\x4b\x69\x6e\x64", 33, -4119853099252286240, NULL };
static frost$core$String $s2 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x6f\x72\x67\x2e\x66\x72\x6f\x73\x74\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x6a\x73\x6f\x6e\x2e\x54\x6f\x6b\x65\x6e\x2e\x4b\x69\x6e\x64", 33, -4119853099252286240, NULL };
...
static frost$core$String $s87 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "\x54\x6f\x6b\x65\x6e\x2e\x66\x72\x6f\x73\x74", 11, 8405089766299269894, NULL };
static frost$core$String $s88 = { (frost$core$Class*) &frost$core$String$class, -999, (frost$core$Char8*) "", 95, 4268812860280123199, NULL };

frost$core$String* org$frostlanguage$json$Token$Kind$convert$R$frost$core$String(org$frostlanguage$json$Token$Kind param0) {
...
block34:;
frost$core$Int64 $tmp86 = (frost$core$Int64) {30};
...
void org$frostlanguage$json$Token$Kind$cleanup(org$frostlanguage$json$Token$Kind param0) {

// line 11
frost$core$Int64 $tmp89 = param0.$rawValue;
frost$core$Int64 $tmp90 = (frost$core$Int64) {0};
frost$core$Bit $tmp91 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp89, $tmp90);
...
frost$core$Bit $tmp94 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp89, $tmp93);
...
frost$core$Bit $tmp97 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp89, $tmp96);
bool $tmp98 = $tmp97.value;
if ($tmp98) goto block6; else goto block7;
block6:;
goto block1;
block7:;
frost$core$Int64 $tmp99 = (frost$core$Int64) {3};
frost$core$Bit $tmp100 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp89, $tmp99);
bool $tmp101 = $tmp100.value;
if ($tmp101) goto block8; else goto block9;
block8:;
goto block1;
block9:;
frost$core$Int64 $tmp102 = (frost$core$Int64) {4};
frost$core$Bit $tmp103 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp89, $tmp102);
...
frost$core$Bit $tmp106 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp89, $tmp105);
...
frost$core$Bit $tmp109 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp89, $tmp108);
bool $tmp110 = $tmp109.value;
if ($tmp110) goto block14; else goto block15;
block14:;
goto block1;
block15:;
frost$core$Int64 $tmp111 = (frost$core$Int64) {7};
frost$core$Bit $tmp112 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp89, $tmp111);
...
frost$core$Bit $tmp115 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp89, $tmp114);
bool $tmp116 = $tmp115.value;
if ($tmp116) goto block18; else goto block19;
block18:;
goto block1;
block19:;
frost$core$Int64 $tmp117 = (frost$core$Int64) {9};
frost$core$Bit $tmp118 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp89, $tmp117);
bool $tmp119 = $tmp118.value;
if ($tmp119) goto block20; else goto block21;
block20:;
goto block1;
block21:;
frost$core$Int64 $tmp120 = (frost$core$Int64) {10};
frost$core$Bit $tmp121 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp89, $tmp120);
...
frost$core$Bit $tmp124 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp89, $tmp123);
...
frost$core$Bit $tmp127 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp89, $tmp126);
bool $tmp128 = $tmp127.value;
if ($tmp128) goto block26; else goto block27;
block26:;
goto block1;
block27:;
frost$core$Int64 $tmp129 = (frost$core$Int64) {13};
frost$core$Bit $tmp130 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp89, $tmp129);
...
frost$core$Bit $tmp133 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp89, $tmp132);
bool $tmp134 = $tmp133.value;
if ($tmp134) goto block30; else goto block31;
block30:;
goto block1;
block31:;
frost$core$Int64 $tmp135 = (frost$core$Int64) {15};
frost$core$Bit $tmp136 = frost$core$Int64$$EQ$frost$core$Int64$R$frost$core$Bit($tmp89, $tmp135);
...
org$frostlanguage$json$Token$Kind org$frostlanguage$json$Token$Kind$init$frost$core$Int64(frost$core$Int64 param0) {

org$frostlanguage$json$Token$Kind local0;
// line 11
frost$core$Int64* $tmp138 = &(&local0)->$rawValue;
*$tmp138 = param0;
org$frostlanguage$json$Token$Kind $tmp139 = *(&local0);
return $tmp139;

}
frost$core$Bit org$frostlanguage$json$Token$Kind$$EQ$org$frostlanguage$json$Token$Kind$R$frost$core$Bit(org$frostlanguage$json$Token$Kind param0, org$frostlanguage$json$Token$Kind param1) {

// line 11
frost$core$Int64 $tmp140 = param0.$rawValue;
frost$core$Int64 $tmp141 = param1.$rawValue;
...
block2:;
// line 11
frost$core$Bit $tmp148 = frost$core$Bit$init$builtin_bit(true);
return $tmp148;
