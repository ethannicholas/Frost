...
org$pandalanguage$plex$runtime$DFA** $tmp377 = &$tmp376->dfa;
org$pandalanguage$plex$runtime$DFA* $tmp378 = *$tmp377;
panda$core$Char8** $tmp379 = &$tmp378->source;
panda$core$Char8* $tmp380 = *$tmp379;
panda$core$Int64 $tmp381 = *(&local5);
int64_t $tmp382 = $tmp381.value;
panda$core$Char8 $tmp383 = $tmp380[$tmp382];
panda$core$Int64 $tmp384 = *(&local5);
panda$core$Int64 $tmp385 = *(&local1);
