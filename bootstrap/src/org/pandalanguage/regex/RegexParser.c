...
static panda$core$String $s156 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x52\x65\x67\x65\x78\x50\x61\x72\x73\x65\x72\x2e\x66\x72\x6f\x73\x74", 17, 16357834771717713, NULL };
...
static panda$core$String $s209 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x52\x65\x67\x65\x78\x50\x61\x72\x73\x65\x72\x2e\x66\x72\x6f\x73\x74", 17, 16357834771717713, NULL };
...
static panda$core$String $s283 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x52\x65\x67\x65\x78\x50\x61\x72\x73\x65\x72\x2e\x66\x72\x6f\x73\x74", 17, 16357834771717713, NULL };
...
// line 10
org$pandalanguage$regex$RegexLexer* $tmp2 = (org$pandalanguage$regex$RegexLexer*) frostObjectAlloc(40, (panda$core$Class*) &org$pandalanguage$regex$RegexLexer$class);
...
// line 18
panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT* $tmp6 = (panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT*) frostObjectAlloc(40, (panda$core$Class*) &panda$collections$SpecializedArray$LTorg$pandalanguage$regex$RegexToken$GT$class);
...
$tmp88 = (org$pandalanguage$regex$RegexToken$Kind$wrapper*) frostObjectAlloc(24, (panda$core$Class*) &org$pandalanguage$regex$RegexToken$Kind$wrapperclass);
$tmp88->value = $tmp87;
org$pandalanguage$regex$RegexToken$Kind$wrapper* $tmp89;
$tmp89 = (org$pandalanguage$regex$RegexToken$Kind$wrapper*) frostObjectAlloc(24, (panda$core$Class*) &org$pandalanguage$regex$RegexToken$Kind$wrapperclass);
$tmp89->value = param1;
...
$tmp101 = (org$pandalanguage$regex$RegexToken$Kind$wrapper*) frostObjectAlloc(24, (panda$core$Class*) &org$pandalanguage$regex$RegexToken$Kind$wrapperclass);
$tmp101->value = $tmp100;
org$pandalanguage$regex$RegexToken$Kind$wrapper* $tmp102;
$tmp102 = (org$pandalanguage$regex$RegexToken$Kind$wrapper*) frostObjectAlloc(24, (panda$core$Class*) &org$pandalanguage$regex$RegexToken$Kind$wrapperclass);
$tmp102->value = param1;
...
org$pandalanguage$pandac$Compiler$Error* $tmp122 = (org$pandalanguage$pandac$Compiler$Error*) frostObjectAlloc(56, (panda$core$Class*) &org$pandalanguage$pandac$Compiler$Error$class);
...
$tmp143 = (org$pandalanguage$regex$RegexToken$Kind$wrapper*) frostObjectAlloc(24, (panda$core$Class*) &org$pandalanguage$regex$RegexToken$Kind$wrapperclass);
$tmp143->value = $tmp142;
...
$tmp146 = (org$pandalanguage$regex$RegexToken$Kind$wrapper*) frostObjectAlloc(24, (panda$core$Class*) &org$pandalanguage$regex$RegexToken$Kind$wrapperclass);
$tmp146->value = $tmp145;
...
panda$core$Char8* $tmp353 = ((panda$core$Char8*) frostAlloc($tmp352 * 1));
*(&local4) = $tmp353;
// line 223
...
panda$core$Int64 $tmp412 = (panda$core$Int64) {38};
org$pandalanguage$pandac$Position $tmp413 = *(&local0);
panda$core$String* $tmp414 = (panda$core$String*) frostObjectAlloc(48, (panda$core$Class*) &panda$core$String$class);
