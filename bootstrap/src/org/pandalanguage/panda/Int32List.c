...
__attribute__((weak)) panda$core$Object* org$pandalanguage$panda$Int32List$$IDX$panda$core$Int64$R$panda$core$Int32$shim(org$pandalanguage$panda$Int32List* p0, panda$core$Int64 p1) {
    ...
    $tmp2 = (panda$core$Int32$wrapper*) frostObjectAlloc(16, (panda$core$Class*) &panda$core$Int32$wrapperclass);
    $tmp2->value = result;
...
static panda$core$String $s100 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x49\x6e\x74\x33\x32\x4c\x69\x73\x74\x2e\x66\x72\x6f\x73\x74", 15, -5075525129274066703, NULL };
...
static panda$core$String $s121 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x49\x6e\x74\x33\x32\x4c\x69\x73\x74\x2e\x66\x72\x6f\x73\x74", 15, -5075525129274066703, NULL };
