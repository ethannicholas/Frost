...
static panda$core$String $s43 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x49\x6e\x74\x38\x4c\x69\x73\x74\x2e\x70\x61\x6e\x64\x61", 14, 5509841090352121894, NULL };
...
static panda$core$String $s56 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x49\x6e\x74\x38\x4c\x69\x73\x74\x2e\x70\x61\x6e\x64\x61", 14, 5509841090352121894, NULL };
...
panda$core$Int8 org$pandalanguage$panda$Int8List$$IDX$panda$core$Int64$R$panda$core$Int8(org$pandalanguage$panda$Int8List* self, panda$core$Int64 p_index) {
    ...
    if (!$tmp47) goto $l50;
    panda$core$Int64 $tmp51 = org$pandalanguage$panda$Int8List$get_count$R$panda$core$Int64(self);
    ...
    abort();
    $l54:;
    panda$core$Int8 $tmp59 = panda$core$Int64$convert$R$panda$core$Int8(p_index);
    panda$core$Int32 $tmp60 = panda$core$Int8$$MUL$panda$core$Int8$R$panda$core$Int32(self->range.step, $tmp59);
    panda$core$Int32 $tmp61 = panda$core$Int8$$ADD$panda$core$Int32$R$panda$core$Int32(self->range.start, $tmp60);
    panda$core$Int8 $tmp62 = panda$core$Int32$convert$R$panda$core$Int8($tmp61);
    $returnValue58 = $tmp62;
