...
__attribute__((weak)) panda$core$Object* org$pandalanguage$panda$Int8List$$IDX$panda$core$Int64$R$panda$core$Int8$shim(org$pandalanguage$panda$Int8List* p0, panda$core$Int64 p1) {
    ...
    $tmp2 = (panda$core$Int8$wrapper*) frostObjectAlloc(13, (panda$core$Class*) &panda$core$Int8$wrapperclass);
    $tmp2->value = result;
...
static panda$core$String $s107 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x49\x6e\x74\x38\x4c\x69\x73\x74\x2e\x66\x72\x6f\x73\x74", 14, 5509841089329044736, NULL };
static panda$core$String $s108 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "", 161, 234662004760939906, NULL };
static panda$core$String $s128 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x49\x6e\x74\x38\x4c\x69\x73\x74\x2e\x66\x72\x6f\x73\x74", 14, 5509841089329044736, NULL };
...
*$tmp3 = param1;
// line 17
panda$core$Int64 $tmp4 = org$pandalanguage$panda$Int8List$computeCount$panda$core$SteppedRange$LTpanda$core$Int8$Cpanda$core$Int8$GT$R$panda$core$Int64(param1);
panda$core$Int64* $tmp5 = &param0->_count;
*$tmp5 = $tmp4;
return;

}
panda$core$Int64 org$pandalanguage$panda$Int8List$computeCount$panda$core$SteppedRange$LTpanda$core$Int8$Cpanda$core$Int8$GT$R$panda$core$Int64(panda$core$SteppedRange$LTpanda$core$Int8$Cpanda$core$Int8$GT param0) {
...
block1:;
// line 23
panda$core$Int8 $tmp8 = param0.step;
panda$core$Int8 $tmp9 = (panda$core$Int8) {0};
...
block4:;
// line 24
panda$core$Int8 $tmp15 = param0.end;
panda$core$Int8 $tmp16 = param0.start;
...
block6:;
// line 27
panda$core$Int8 $tmp23 = param0.end;
panda$core$Int8 $tmp24 = param0.start;
...
block5:;
// line 30
panda$core$Int8 $tmp31 = param0.end;
panda$core$Int32 $tmp32 = panda$core$Int32$init$panda$core$Int8($tmp31);
panda$core$Int8 $tmp33 = param0.start;
panda$core$Int32 $tmp34 = panda$core$Int32$init$panda$core$Int8($tmp33);
int32_t $tmp35 = $tmp32.value;
int32_t $tmp36 = $tmp34.value;
int32_t $tmp37 = $tmp35 - $tmp36;
panda$core$Int32 $tmp38 = (panda$core$Int32) {$tmp37};
panda$core$Int8 $tmp39 = param0.step;
panda$core$Int32 $tmp40 = panda$core$Int32$init$panda$core$Int8($tmp39);
...
// line 33
// line 34
panda$core$Int8 $tmp52 = param0.step;
panda$core$Int8 $tmp53 = (panda$core$Int8) {0};
...
block11:;
// line 35
panda$core$Int8 $tmp59 = param0.end;
panda$core$Int8 $tmp60 = param0.start;
...
block15:;
// line 38
panda$core$Int8 $tmp67 = (panda$core$Int8) {18446744073709551615};
*(&local0) = $tmp67;
goto block12;
block13:;
// line 1
// line 40
panda$core$Int8 $tmp68 = param0.end;
panda$core$Int8 $tmp69 = param0.start;
...
block17:;
// line 43
panda$core$Int8 $tmp76 = (panda$core$Int8) {1};
*(&local0) = $tmp76;
goto block12;
block12:;
// line 45
panda$core$Int8 $tmp77 = param0.end;
panda$core$Int32 $tmp78 = panda$core$Int32$init$panda$core$Int8($tmp77);
panda$core$Int8 $tmp79 = param0.start;
panda$core$Int32 $tmp80 = panda$core$Int32$init$panda$core$Int8($tmp79);
int32_t $tmp81 = $tmp78.value;
int32_t $tmp82 = $tmp80.value;
int32_t $tmp83 = $tmp81 - $tmp82;
panda$core$Int32 $tmp84 = (panda$core$Int32) {$tmp83};
panda$core$Int8 $tmp85 = *(&local0);
panda$core$Int32 $tmp86 = panda$core$Int32$init$panda$core$Int8($tmp85);
int32_t $tmp87 = $tmp84.value;
int32_t $tmp88 = $tmp86.value;
int32_t $tmp89 = $tmp87 + $tmp88;
panda$core$Int32 $tmp90 = (panda$core$Int32) {$tmp89};
panda$core$Int8 $tmp91 = param0.step;
panda$core$Int32 $tmp92 = panda$core$Int32$init$panda$core$Int8($tmp91);
...
block4:;
// line 56
panda$core$SteppedRange$LTpanda$core$Int8$Cpanda$core$Int8$GT* $tmp130 = &param0->range;
panda$core$SteppedRange$LTpanda$core$Int8$Cpanda$core$Int8$GT $tmp131 = *$tmp130;
panda$core$Int8 $tmp132 = $tmp131.start;
panda$core$Int32 $tmp133 = panda$core$Int32$init$panda$core$Int8($tmp132);
panda$core$SteppedRange$LTpanda$core$Int8$Cpanda$core$Int8$GT* $tmp134 = &param0->range;
panda$core$SteppedRange$LTpanda$core$Int8$Cpanda$core$Int8$GT $tmp135 = *$tmp134;
panda$core$Int8 $tmp136 = $tmp135.step;
panda$core$Int32 $tmp137 = panda$core$Int32$init$panda$core$Int8($tmp136);
panda$core$Int8 $tmp138 = panda$core$Int64$convert$R$panda$core$Int8(param1);
panda$core$Int32 $tmp139 = panda$core$Int32$init$panda$core$Int8($tmp138);
...
panda$core$Int8 $tmp148 = panda$core$Int32$convert$R$panda$core$Int8($tmp147);
return $tmp148;
