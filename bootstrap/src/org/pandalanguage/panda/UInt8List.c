...
__attribute__((weak)) panda$core$Object* org$pandalanguage$panda$UInt8List$$IDX$panda$core$Int64$R$panda$core$UInt8$shim(org$pandalanguage$panda$UInt8List* p0, panda$core$Int64 p1) {
    ...
    $tmp2 = (panda$core$UInt8$wrapper*) frostObjectAlloc(13, (panda$core$Class*) &panda$core$UInt8$wrapperclass);
    $tmp2->value = result;
    return ((panda$core$Object*) $tmp2);
}

struct { panda$core$Class* cl; ITable* next; void* methods[1]; } org$pandalanguage$panda$UInt8List$_panda$collections$Iterable = { (panda$core$Class*) &panda$collections$Iterable$class, NULL, { panda$collections$ListView$get_iterator$R$panda$collections$Iterator$LTpanda$collections$ListView$T$GT$shim} };
...
static panda$core$String $s85 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x55\x49\x6e\x74\x38\x4c\x69\x73\x74\x2e\x66\x72\x6f\x73\x74", 15, 1218913291890390689, NULL };
static panda$core$String $s86 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "", 164, 742982928231723485, NULL };
static panda$core$String $s106 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x55\x49\x6e\x74\x38\x4c\x69\x73\x74\x2e\x66\x72\x6f\x73\x74", 15, 1218913291890390689, NULL };
...
*$tmp3 = param1;
// line 17
panda$core$Int64 $tmp4 = org$pandalanguage$panda$UInt8List$computeCount$panda$core$SteppedRange$LTpanda$core$UInt8$Cpanda$core$UInt8$GT$R$panda$core$Int64(param1);
panda$core$Int64* $tmp5 = &param0->_count;
*$tmp5 = $tmp4;
return;

}
panda$core$Int64 org$pandalanguage$panda$UInt8List$computeCount$panda$core$SteppedRange$LTpanda$core$UInt8$Cpanda$core$UInt8$GT$R$panda$core$Int64(panda$core$SteppedRange$LTpanda$core$UInt8$Cpanda$core$UInt8$GT param0) {
...
block1:;
// line 23
panda$core$UInt8 $tmp8 = param0.step;
panda$core$UInt8 $tmp9 = (panda$core$UInt8) {0};
...
block4:;
// line 24
panda$core$UInt8 $tmp15 = param0.end;
panda$core$UInt8 $tmp16 = param0.start;
...
block6:;
// line 27
panda$core$UInt8 $tmp23 = param0.end;
panda$core$UInt8 $tmp24 = param0.start;
...
block5:;
// line 30
panda$core$UInt8 $tmp31 = param0.end;
panda$core$UInt32 $tmp32 = panda$core$UInt32$init$panda$core$UInt8($tmp31);
panda$core$UInt8 $tmp33 = param0.start;
panda$core$UInt32 $tmp34 = panda$core$UInt32$init$panda$core$UInt8($tmp33);
...
panda$core$UInt8 $tmp39 = param0.step;
panda$core$UInt32 $tmp40 = panda$core$UInt32$init$panda$core$UInt8($tmp39);
...
// line 33
// line 34
panda$core$UInt8 $tmp53 = (panda$core$UInt8) {1};
*(&local0) = $tmp53;
// line 35
panda$core$UInt8 $tmp54 = param0.end;
panda$core$UInt32 $tmp55 = panda$core$UInt32$init$panda$core$UInt8($tmp54);
panda$core$UInt8 $tmp56 = param0.start;
panda$core$UInt32 $tmp57 = panda$core$UInt32$init$panda$core$UInt8($tmp56);
...
panda$core$UInt8 $tmp62 = *(&local0);
panda$core$UInt32 $tmp63 = panda$core$UInt32$init$panda$core$UInt8($tmp62);
...
panda$core$UInt8 $tmp68 = param0.step;
panda$core$UInt32 $tmp69 = panda$core$UInt32$init$panda$core$UInt8($tmp68);
...
block4:;
// line 46
panda$core$SteppedRange$LTpanda$core$UInt8$Cpanda$core$UInt8$GT* $tmp108 = &param0->range;
panda$core$SteppedRange$LTpanda$core$UInt8$Cpanda$core$UInt8$GT $tmp109 = *$tmp108;
panda$core$UInt8 $tmp110 = $tmp109.start;
panda$core$UInt32 $tmp111 = panda$core$UInt32$init$panda$core$UInt8($tmp110);
panda$core$SteppedRange$LTpanda$core$UInt8$Cpanda$core$UInt8$GT* $tmp112 = &param0->range;
panda$core$SteppedRange$LTpanda$core$UInt8$Cpanda$core$UInt8$GT $tmp113 = *$tmp112;
panda$core$UInt8 $tmp114 = $tmp113.step;
panda$core$UInt32 $tmp115 = panda$core$UInt32$init$panda$core$UInt8($tmp114);
panda$core$UInt8 $tmp116 = panda$core$Int64$convert$R$panda$core$UInt8(param1);
panda$core$UInt32 $tmp117 = panda$core$UInt32$init$panda$core$UInt8($tmp116);
...
panda$core$UInt8 $tmp126 = panda$core$UInt32$convert$R$panda$core$UInt8($tmp125);
return $tmp126;
