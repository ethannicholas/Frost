...
__attribute__((weak)) panda$core$Object* org$pandalanguage$panda$Int16List$$IDX$panda$core$Int64$R$panda$core$Int16$shim(org$pandalanguage$panda$Int16List* p0, panda$core$Int64 p1) {
    ...
    $tmp2 = (panda$core$Int16$wrapper*) frostObjectAlloc(14, (panda$core$Class*) &panda$core$Int16$wrapperclass);
    $tmp2->value = result;
...
static panda$core$String $s107 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x49\x6e\x74\x31\x36\x4c\x69\x73\x74\x2e\x66\x72\x6f\x73\x74", 15, 1244863148404851675, NULL };
...
static panda$core$String $s128 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x49\x6e\x74\x31\x36\x4c\x69\x73\x74\x2e\x66\x72\x6f\x73\x74", 15, 1244863148404851675, NULL };
