...
__attribute__((weak)) panda$core$Object* org$pandalanguage$panda$UInt32List$$IDX$panda$core$Int64$R$panda$core$UInt32$shim(org$pandalanguage$panda$UInt32List* p0, panda$core$Int64 p1) {
    ...
    $tmp2 = (panda$core$UInt32$wrapper*) frostObjectAlloc(16, (panda$core$Class*) &panda$core$UInt32$wrapperclass);
    $tmp2->value = result;
    return ((panda$core$Object*) $tmp2);
}

struct { panda$core$Class* cl; ITable* next; void* methods[1]; } org$pandalanguage$panda$UInt32List$_panda$collections$Iterable = { (panda$core$Class*) &panda$collections$Iterable$class, NULL, { panda$collections$ListView$get_iterator$R$panda$collections$Iterator$LTpanda$collections$ListView$T$GT$shim} };
...
org$pandalanguage$panda$UInt32List$class_type org$pandalanguage$panda$UInt32List$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &panda$core$Object$class, (ITable*) &org$pandalanguage$panda$UInt32List$_panda$collections$CollectionView, { org$pandalanguage$panda$UInt32List$convert$R$panda$core$String, org$pandalanguage$panda$UInt32List$cleanup, org$pandalanguage$panda$UInt32List$get_count$R$panda$core$Int64, org$pandalanguage$panda$UInt32List$$IDX$panda$core$Int64$R$panda$core$UInt32$shim} };
...
static panda$core$String $s78 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x55\x49\x6e\x74\x33\x32\x4c\x69\x73\x74\x2e\x66\x72\x6f\x73\x74", 16, 4262625098451113334, NULL };
static panda$core$String $s79 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "", 167, -7014349090945512420, NULL };
static panda$core$String $s99 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x55\x49\x6e\x74\x33\x32\x4c\x69\x73\x74\x2e\x66\x72\x6f\x73\x74", 16, 4262625098451113334, NULL };
...
*$tmp3 = param1;
// line 17
panda$core$Int64 $tmp4 = org$pandalanguage$panda$UInt32List$computeCount$panda$core$SteppedRange$LTpanda$core$UInt32$Cpanda$core$UInt32$GT$R$panda$core$Int64(param1);
panda$core$Int64* $tmp5 = &param0->_count;
*$tmp5 = $tmp4;
return;

}
panda$core$Int64 org$pandalanguage$panda$UInt32List$computeCount$panda$core$SteppedRange$LTpanda$core$UInt32$Cpanda$core$UInt32$GT$R$panda$core$Int64(panda$core$SteppedRange$LTpanda$core$UInt32$Cpanda$core$UInt32$GT param0) {
...
block1:;
// line 23
panda$core$UInt32 $tmp8 = param0.step;
panda$core$UInt32 $tmp9 = (panda$core$UInt32) {0};
...
block4:;
// line 24
panda$core$UInt32 $tmp15 = param0.end;
panda$core$UInt32 $tmp16 = param0.start;
...
block6:;
// line 27
panda$core$UInt32 $tmp23 = param0.end;
panda$core$UInt32 $tmp24 = param0.start;
...
block5:;
// line 30
panda$core$UInt32 $tmp31 = param0.end;
panda$core$UInt32 $tmp32 = param0.start;
uint32_t $tmp33 = $tmp31.value;
uint32_t $tmp34 = $tmp32.value;
uint32_t $tmp35 = $tmp33 - $tmp34;
panda$core$UInt32 $tmp36 = (panda$core$UInt32) {$tmp35};
panda$core$UInt32 $tmp37 = param0.step;
uint32_t $tmp38 = $tmp36.value;
uint32_t $tmp39 = $tmp37.value;
uint32_t $tmp40 = $tmp38 / $tmp39;
panda$core$UInt32 $tmp41 = (panda$core$UInt32) {$tmp40};
panda$core$UInt32 $tmp42 = (panda$core$UInt32) {0};
panda$core$UInt32 $tmp43 = panda$core$UInt32$max$panda$core$UInt32$R$panda$core$UInt32($tmp41, $tmp42);
panda$core$Int64 $tmp44 = panda$core$Int64$init$panda$core$UInt32($tmp43);
...
// line 33
// line 34
panda$core$UInt32 $tmp50 = (panda$core$UInt32) {1};
*(&local0) = $tmp50;
// line 35
panda$core$UInt32 $tmp51 = param0.end;
panda$core$UInt32 $tmp52 = param0.start;
uint32_t $tmp53 = $tmp51.value;
uint32_t $tmp54 = $tmp52.value;
uint32_t $tmp55 = $tmp53 - $tmp54;
panda$core$UInt32 $tmp56 = (panda$core$UInt32) {$tmp55};
panda$core$UInt32 $tmp57 = *(&local0);
...
panda$core$UInt32 $tmp62 = param0.step;
...
panda$core$UInt32 $tmp67 = (panda$core$UInt32) {0};
panda$core$UInt32 $tmp68 = panda$core$UInt32$max$panda$core$UInt32$R$panda$core$UInt32($tmp66, $tmp67);
panda$core$Int64 $tmp69 = panda$core$Int64$init$panda$core$UInt32($tmp68);
...
block4:;
// line 46
panda$core$SteppedRange$LTpanda$core$UInt32$Cpanda$core$UInt32$GT* $tmp101 = &param0->range;
panda$core$SteppedRange$LTpanda$core$UInt32$Cpanda$core$UInt32$GT $tmp102 = *$tmp101;
panda$core$UInt32 $tmp103 = $tmp102.start;
panda$core$SteppedRange$LTpanda$core$UInt32$Cpanda$core$UInt32$GT* $tmp104 = &param0->range;
panda$core$SteppedRange$LTpanda$core$UInt32$Cpanda$core$UInt32$GT $tmp105 = *$tmp104;
panda$core$UInt32 $tmp106 = $tmp105.step;
panda$core$UInt32 $tmp107 = panda$core$Int64$convert$R$panda$core$UInt32(param1);
uint32_t $tmp108 = $tmp106.value;
uint32_t $tmp109 = $tmp107.value;
uint32_t $tmp110 = $tmp108 * $tmp109;
panda$core$UInt32 $tmp111 = (panda$core$UInt32) {$tmp110};
