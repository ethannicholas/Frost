...
typedef org$pandalanguage$pandac$Type* (*$fn119)(org$pandalanguage$pandac$lvalue$IndexLValue*);
...
typedef org$pandalanguage$pandac$Type* (*$fn283)(org$pandalanguage$pandac$lvalue$IndexLValue*);
...
static panda$core$String $s44 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x49\x6e\x64\x65\x78\x4c\x56\x61\x6c\x75\x65\x2e\x70\x61\x6e\x64\x61", 17, 540026523156146624, NULL };
static panda$core$String $s88 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x49\x6e\x64\x65\x78\x4c\x56\x61\x6c\x75\x65\x2e\x70\x61\x6e\x64\x61", 17, 540026523156146624, NULL };
...
static panda$core$String $s216 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x49\x6e\x64\x65\x78\x4c\x56\x61\x6c\x75\x65\x2e\x70\x61\x6e\x64\x61", 17, 540026523156146624, NULL };
static panda$core$String $s253 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x49\x6e\x64\x65\x78\x4c\x56\x61\x6c\x75\x65\x2e\x70\x61\x6e\x64\x61", 17, 540026523156146624, NULL };
...
block4:;
panda$core$Int64 $tmp43 = (panda$core$Int64) {43};
...
block6:;
panda$core$Int64 $tmp87 = (panda$core$Int64) {53};
...
block7:;
// line 59
org$pandalanguage$pandac$IR$Value* $tmp114 = (org$pandalanguage$pandac$IR$Value*) pandaObjectAlloc(48, (panda$core$Class*) &org$pandalanguage$pandac$IR$Value$class);
...
panda$core$Int64 $tmp129 = (panda$core$Int64) {26};
...
org$pandalanguage$pandac$IR$Value* $tmp144 = org$pandalanguage$pandac$expression$Binary$compile$org$pandalanguage$pandac$Compiler$org$pandalanguage$pandac$Position$org$pandalanguage$pandac$ASTNode$org$pandalanguage$pandac$parser$Token$Kind$org$pandalanguage$pandac$ASTNode$org$pandalanguage$pandac$Compiler$TypeContext$R$org$pandalanguage$pandac$IR$Value$Q($tmp125, $tmp127, $tmp128, $tmp135, $tmp136, $tmp142);
...
panda$core$Int64 $tmp199 = (panda$core$Int64) {5};
...
goto block7;
block9:;
panda$core$Int64 $tmp206 = (panda$core$Int64) {6};
...
block13:;
panda$core$Int64 $tmp215 = (panda$core$Int64) {90};
...
panda$core$Int64 $tmp224 = (panda$core$Int64) {26};
...
block17:;
panda$core$Int64 $tmp252 = (panda$core$Int64) {99};
...
block18:;
// line 105
org$pandalanguage$pandac$IR$Value* $tmp278 = (org$pandalanguage$pandac$IR$Value*) pandaObjectAlloc(48, (panda$core$Class*) &org$pandalanguage$pandac$IR$Value$class);
...
panda$core$Int64 $tmp297 = (panda$core$Int64) {26};
...
panda$core$Int64 $tmp304 = (panda$core$Int64) {26};
...
org$pandalanguage$pandac$IR$Value* $tmp316 = org$pandalanguage$pandac$expression$Call$compile$org$pandalanguage$pandac$Compiler$org$pandalanguage$pandac$Position$org$pandalanguage$pandac$IR$Value$panda$core$String$panda$collections$ListView$LTorg$pandalanguage$pandac$ASTNode$GT$org$pandalanguage$pandac$Compiler$TypeContext$R$org$pandalanguage$pandac$IR$Value$Q($tmp308, $tmp310, $tmp312, &$s317, ((panda$collections$ListView*) $tmp313), $tmp314);
