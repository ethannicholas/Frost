...
block10:;
panda$core$Int64 $tmp26 = (panda$core$Int64) {15};
...
panda$core$Bit $tmp46 = panda$core$Int64$$NEQ$panda$core$Int64$R$panda$core$Bit($tmp44, $tmp45);
...
block2:;
// line 8
panda$core$Bit $tmp49 = panda$core$Bit$init$builtin_bit(true);
return $tmp49;
