...
static panda$core$String $s9 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x43\x6f\x6d\x70\x69\x6c\x65\x72\x2e\x70\x61\x6e\x64\x61", 14, -3408958965109419534, NULL };
...
void org$pandalanguage$pandac$Compiler$AutoAtPreFlag$cleanup(org$pandalanguage$pandac$Compiler$AutoAtPreFlag* self) {
    int $tmp6;
    {
        if (self->compiler->inAtPre.value) goto $l7; else goto $l8;
        $l8:;
        panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64(&$s9, (panda$core$Int64) { 64 });
        abort();
        $l7:;
