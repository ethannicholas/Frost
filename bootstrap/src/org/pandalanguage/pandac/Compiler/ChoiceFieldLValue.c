#include "org/pandalanguage/pandac/Compiler/ChoiceFieldLValue.h"
...
struct { panda$core$Class* cl; ITable* next; void* methods[3]; } org$pandalanguage$pandac$Compiler$ChoiceFieldLValue$_org$pandalanguage$pandac$Compiler$LValue = { (panda$core$Class*) &org$pandalanguage$pandac$Compiler$LValue$class, NULL, { org$pandalanguage$pandac$Compiler$ChoiceFieldLValue$type$R$org$pandalanguage$pandac$Type, org$pandalanguage$pandac$Compiler$ChoiceFieldLValue$compileLoad$R$org$pandalanguage$pandac$IR$Value$Q, org$pandalanguage$pandac$Compiler$ChoiceFieldLValue$compileStore$org$pandalanguage$pandac$IR$Value} };

static panda$core$String $s1;
org$pandalanguage$pandac$Compiler$ChoiceFieldLValue$class_type org$pandalanguage$pandac$Compiler$ChoiceFieldLValue$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &panda$core$Object$class, (ITable*) &org$pandalanguage$pandac$Compiler$ChoiceFieldLValue$_org$pandalanguage$pandac$Compiler$LValue, { panda$core$Object$convert$R$panda$core$String, org$pandalanguage$pandac$Compiler$ChoiceFieldLValue$cleanup, org$pandalanguage$pandac$Compiler$ChoiceFieldLValue$type$R$org$pandalanguage$pandac$Type, org$pandalanguage$pandac$Compiler$ChoiceFieldLValue$compileLoad$R$org$pandalanguage$pandac$IR$Value$Q, org$pandalanguage$pandac$Compiler$ChoiceFieldLValue$compileStore$org$pandalanguage$pandac$IR$Value} };

typedef org$pandalanguage$pandac$Type* (*$fn31)(org$pandalanguage$pandac$Compiler$ChoiceFieldLValue*);
...
static panda$core$String $s1 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x6f\x72\x67\x2e\x70\x61\x6e\x64\x61\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x70\x61\x6e\x64\x61\x63\x2e\x43\x6f\x6d\x70\x69\x6c\x65\x72\x2e\x43\x68\x6f\x69\x63\x65\x46\x69\x65\x6c\x64\x4c\x56\x61\x6c\x75\x65", 51, -7089935338337917913, NULL };
...
block2:;
panda$core$Int64 $tmp21 = (panda$core$Int64) {5951};
...
block4:;
panda$core$Int64 $tmp25 = (panda$core$Int64) {5950};
...
org$pandalanguage$pandac$IR$Statement* $tmp41 = (org$pandalanguage$pandac$IR$Statement*) pandaObjectAlloc(72, (panda$core$Class*) &org$pandalanguage$pandac$IR$Statement$class);
...
org$pandalanguage$pandac$IR$Statement* $tmp58 = (org$pandalanguage$pandac$IR$Statement*) pandaObjectAlloc(72, (panda$core$Class*) &org$pandalanguage$pandac$IR$Statement$class);
...
org$pandalanguage$pandac$IR$Value* $tmp62 = (org$pandalanguage$pandac$IR$Value*) pandaObjectAlloc(40, (panda$core$Class*) &org$pandalanguage$pandac$IR$Value$class);
