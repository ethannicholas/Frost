...
void org$pandalanguage$pandac$CCodeGenerator$ExtraEffect$cleanup(org$pandalanguage$pandac$CCodeGenerator$ExtraEffect* self) {
    org$pandalanguage$pandac$CCodeGenerator$ExtraEffect* $match$199_58 = NULL;
    ...
    int $tmp4;
    {
        int $tmp7;
        {
            ...
            panda$core$Bit $tmp10 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit($match$199_58->$rawValue, ((panda$core$Int64) { 0 }));
            if ($tmp10.value) {
            {
                org$pandalanguage$pandac$IRNode** $tmp12 = ((org$pandalanguage$pandac$IRNode**) ((char*) $match$199_58->$data + 0));
                _f011 = *$tmp12;
                panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) _f011));
            }
            }
            else {
            panda$core$Bit $tmp13 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit($match$199_58->$rawValue, ((panda$core$Int64) { 1 }));
            if ($tmp13.value) {
            {
                panda$core$String** $tmp15 = ((panda$core$String**) ((char*) $match$199_58->$data + 0));
                _f014 = *$tmp15;
