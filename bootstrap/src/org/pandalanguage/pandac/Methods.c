...
static panda$core$String $s17 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x4d\x65\x74\x68\x6f\x64\x73\x2e\x66\x72\x6f\x73\x74", 13, -2524075234416817907, NULL };
...
// line 10
org$pandalanguage$pandac$FixedArray* $tmp29 = (org$pandalanguage$pandac$FixedArray*) frostObjectAlloc(40, (panda$core$Class*) &org$pandalanguage$pandac$FixedArray$class);
...
// line 15
panda$collections$HashSet* $tmp33 = (panda$collections$HashSet*) frostObjectAlloc(24, (panda$core$Class*) &panda$collections$HashSet$class);
...
// unreffing REF($90:panda.collections.Iterator.T)
...
// unreffing REF($79:panda.collections.Iterator<panda.collections.Iterable.T>)
goto block5;
block5:;
// line 25
