...
panda$core$String* org$pandalanguage$pandac$Position$convert$R$panda$core$String$shim(panda$core$Object* p0) {
...
void org$pandalanguage$pandac$Position$cleanup$shim(panda$core$Object* p0) {
    org$pandalanguage$pandac$Position$cleanup(((org$pandalanguage$pandac$Position$wrapper*) p0)->value);

}

static panda$core$String $s1;
org$pandalanguage$pandac$Position$class_type org$pandalanguage$pandac$Position$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &panda$core$Value$class, NULL, { org$pandalanguage$pandac$Position$convert$R$panda$core$String$shim, org$pandalanguage$pandac$Position$cleanup$shim} };

static panda$core$String $s2;
org$pandalanguage$pandac$Position$wrapperclass_type org$pandalanguage$pandac$Position$wrapperclass = { (panda$core$Class*) &panda$core$Class$class, -999, &$s2, (panda$core$Class*) &panda$core$Value$class, NULL, { org$pandalanguage$pandac$Position$convert$R$panda$core$String$shim, org$pandalanguage$pandac$Position$cleanup$shim} };
