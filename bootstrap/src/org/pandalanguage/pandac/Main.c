...
panda$io$File* $tmp108 = panda$io$File$get_parent$R$panda$io$File$Q($tmp107);
...
panda$core$String* $tmp112 = panda$io$File$get_simpleName$R$panda$core$String($tmp111);
...
block5:;
panda$core$Int64 $tmp118 = (panda$core$Int64) {96};
...
// unreffing REF($230:panda.core.System.Process?)
// line 108
...
// unreffing REF($258:panda.io.OutputStream)
// line 110
...
panda$io$File* $tmp263 = panda$io$File$get_parent$R$panda$io$File$Q($tmp262);
...
block86:;
panda$core$Int64 $tmp592 = (panda$core$Int64) {272};
...
panda$core$String* $tmp693 = panda$io$File$get_name$R$panda$core$String($tmp692);
