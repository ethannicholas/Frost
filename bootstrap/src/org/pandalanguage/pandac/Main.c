...
typedef panda$collections$Iterator* (*$fn340)(panda$collections$Iterable*);
typedef panda$core$Bit (*$fn346)(panda$collections$Iterator*);
typedef panda$core$Object* (*$fn352)(panda$collections$Iterator*);
...
static panda$core$String $s319 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x2e\x2e\x2f\x73\x72\x63", 6, 1549821160968, NULL };
static panda$core$String $s324 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x2f\x74\x6d\x70\x2f\x54\x65\x73\x74\x2e\x6c\x6c", 12, 5522965462756929718, NULL };
static panda$core$String $s330 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x2e\x2e\x2f\x73\x72\x63", 6, 1549821160968, NULL };
static panda$core$String $s335 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x2f\x74\x6d\x70\x2f\x54\x65\x73\x74\x2e\x70\x61\x6e\x64\x61", 15, -5645405478664216650, NULL };
...
void org$pandalanguage$pandac$Main$run$panda$collections$ListView$LTpanda$core$String$GT(org$pandalanguage$pandac$Main* self, panda$collections$ListView* p_rawArgs) {
    ...
    settings236 = $tmp237;
    org$pandalanguage$pandac$Compiler* $tmp239 = (org$pandalanguage$pandac$Compiler*) pandaObjectAlloc(161, (panda$core$Class*) &org$pandalanguage$pandac$Compiler$class);
...
void pandaMain(panda$collections$ListView* p_args) {
    panda$collections$Array* imports316;
    panda$core$Int64 optimizationLevel320;
    org$pandalanguage$pandac$LLVMCodeGenerator* cg321;
    panda$core$Int64 safetyLevel326;
    org$pandalanguage$pandac$Compiler$Settings* settings327;
    org$pandalanguage$pandac$Compiler* compiler331;
    panda$io$File* s333;
    panda$collections$Iterator* Iter$297$9336;
    org$pandalanguage$pandac$ClassDecl* cl349;
    if (((panda$core$Bit) { false }).value) {
    {
        ...
        panda$io$File$init$panda$core$String($tmp318, &$s319);
        panda$collections$Array$add$panda$collections$Array$T(imports316, ((panda$core$Object*) $tmp318));
        optimizationLevel320 = ((panda$core$Int64) { 3 });
        org$pandalanguage$pandac$LLVMCodeGenerator* $tmp322 = (org$pandalanguage$pandac$LLVMCodeGenerator*) pandaObjectAlloc(224, (panda$core$Class*) &org$pandalanguage$pandac$LLVMCodeGenerator$class);
        panda$io$File* $tmp323 = (panda$io$File*) pandaObjectAlloc(24, (panda$core$Class*) &panda$io$File$class);
        panda$io$File$init$panda$core$String($tmp323, &$s324);
        panda$io$OutputStream* $tmp325 = panda$io$File$openOutputStream$R$panda$io$OutputStream($tmp323);
        org$pandalanguage$pandac$LLVMCodeGenerator$init$panda$io$OutputStream($tmp322, $tmp325);
        cg321 = $tmp322;
        safetyLevel326 = ((panda$core$Int64) { 3 });
        org$pandalanguage$pandac$Compiler$Settings* $tmp328 = (org$pandalanguage$pandac$Compiler$Settings*) pandaObjectAlloc(48, (panda$core$Class*) &org$pandalanguage$pandac$Compiler$Settings$class);
        panda$io$File* $tmp329 = (panda$io$File*) pandaObjectAlloc(24, (panda$core$Class*) &panda$io$File$class);
        panda$io$File$init$panda$core$String($tmp329, &$s330);
        org$pandalanguage$pandac$Compiler$Settings$init$panda$io$File$panda$collections$ListView$LTpanda$io$File$GT$panda$core$Int64$panda$core$Int64($tmp328, $tmp329, ((panda$collections$ListView*) imports316), optimizationLevel320, safetyLevel326);
        settings327 = $tmp328;
        org$pandalanguage$pandac$Compiler* $tmp332 = (org$pandalanguage$pandac$Compiler*) pandaObjectAlloc(161, (panda$core$Class*) &org$pandalanguage$pandac$Compiler$class);
        org$pandalanguage$pandac$Compiler$init$org$pandalanguage$pandac$CodeGenerator$org$pandalanguage$pandac$Compiler$Settings($tmp332, ((org$pandalanguage$pandac$CodeGenerator*) cg321), settings327);
        compiler331 = $tmp332;
        ...
        s333 = $tmp334;
        {
            panda$collections$ListView* $tmp337 = org$pandalanguage$pandac$Compiler$scan$panda$io$File$R$panda$collections$ListView$LTorg$pandalanguage$pandac$ClassDecl$GT(compiler331, s333);
            ITable* $tmp338 = ((panda$collections$Iterable*) $tmp337)->$class->itable;
            while ($tmp338->$class != (panda$core$Class*) &panda$collections$Iterable$class) {
                $tmp338 = $tmp338->next;
            }
            $fn340 $tmp339 = $tmp338->methods[0];
            panda$collections$Iterator* $tmp341 = $tmp339(((panda$collections$Iterable*) $tmp337));
            Iter$297$9336 = $tmp341;
            $l342:;
            ITable* $tmp344 = Iter$297$9336->$class->itable;
            while ($tmp344->$class != (panda$core$Class*) &panda$collections$Iterator$class) {
                $tmp344 = $tmp344->next;
            }
            $fn346 $tmp345 = $tmp344->methods[0];
            panda$core$Bit $tmp347 = $tmp345(Iter$297$9336);
            panda$core$Bit $tmp348 = panda$core$Bit$$NOT$R$panda$core$Bit($tmp347);
            if (!$tmp348.value) goto $l343;
            {
                ITable* $tmp350 = Iter$297$9336->$class->itable;
                while ($tmp350->$class != (panda$core$Class*) &panda$collections$Iterator$class) {
                    $tmp350 = $tmp350->next;
                }
                $fn352 $tmp351 = $tmp350->methods[1];
                panda$core$Object* $tmp353 = $tmp351(Iter$297$9336);
                cl349 = ((org$pandalanguage$pandac$ClassDecl*) $tmp353);
                org$pandalanguage$pandac$Compiler$markNonExternal$org$pandalanguage$pandac$ClassDecl(compiler331, cl349);
                panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) cl349));
            }
            goto $l342;
            $l343:;
            panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) Iter$297$9336));
        }
        org$pandalanguage$pandac$Compiler$compile$panda$io$File(compiler331, s333);
        {
            panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) cg321));
            panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) s333));
            panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) settings327));
            panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) imports316));
            panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) compiler331));
        }
    }
    }
    else {
    {
        ...
        org$pandalanguage$pandac$Main* $tmp354 = (org$pandalanguage$pandac$Main*) pandaObjectAlloc(48, (panda$core$Class*) &org$pandalanguage$pandac$Main$class);
        org$pandalanguage$pandac$Main$init($tmp354);
        org$pandalanguage$pandac$Main$run$panda$collections$ListView$LTpanda$core$String$GT($tmp354, p_args);
    }
    }
}
