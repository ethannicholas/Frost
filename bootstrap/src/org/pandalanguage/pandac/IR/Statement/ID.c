...
__attribute__((weak)) panda$core$Int64 org$pandalanguage$pandac$IR$Statement$ID$hash$R$panda$core$Int64$shim(panda$core$Object* p0) {
    panda$core$Int64 result = org$pandalanguage$pandac$IR$Statement$ID$hash$R$panda$core$Int64(((org$pandalanguage$pandac$IR$Statement$ID$wrapper*) p0)->value);
...
struct { panda$core$Class* cl; ITable* next; void* methods[1]; } org$pandalanguage$pandac$IR$Statement$ID$_panda$collections$Key = { (panda$core$Class*) &panda$collections$Key$class, NULL, { org$pandalanguage$pandac$IR$Statement$ID$hash$R$panda$core$Int64$shim} };
...
org$pandalanguage$pandac$IR$Statement$ID$class_type org$pandalanguage$pandac$IR$Statement$ID$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &panda$core$Value$class, (ITable*) &org$pandalanguage$pandac$IR$Statement$ID$_panda$core$Equatable, { org$pandalanguage$pandac$IR$Statement$ID$convert$R$panda$core$String$shim, panda$core$Value$cleanup, org$pandalanguage$pandac$IR$Statement$ID$hash$R$panda$core$Int64$shim, org$pandalanguage$pandac$IR$Statement$ID$$EQ$org$pandalanguage$pandac$IR$Statement$ID$R$panda$core$Bit$shim, org$pandalanguage$pandac$IR$Statement$ID$cleanup$shim} };

struct { panda$core$Class* cl; ITable* itable; void* methods[1]; } org$pandalanguage$pandac$IR$Statement$ID$wrapper_panda$collections$Key = { (panda$core$Class*) &panda$collections$Key$class, NULL, { org$pandalanguage$pandac$IR$Statement$ID$hash$R$panda$core$Int64$shim} };
...
panda$core$Int64 org$pandalanguage$pandac$IR$Statement$ID$hash$R$panda$core$Int64(org$pandalanguage$pandac$IR$Statement$ID param0) {
