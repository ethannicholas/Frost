...
$tmp48 = (org$pandalanguage$pandac$IR$Statement$ID$wrapper*) frostObjectAlloc(24, (panda$core$Class*) &org$pandalanguage$pandac$IR$Statement$ID$wrapperclass);
...
// unreffing REF($58:panda.collections.Array.T)
// line 300
