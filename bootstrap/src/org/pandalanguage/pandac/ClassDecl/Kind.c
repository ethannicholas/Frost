...
org$pandalanguage$pandac$ClassDecl$Kind$wrapper* wrap_org$pandalanguage$pandac$ClassDecl$Kind(org$pandalanguage$pandac$ClassDecl$Kind self) {
    org$pandalanguage$pandac$ClassDecl$Kind$wrapper* result = (org$pandalanguage$pandac$ClassDecl$Kind$wrapper*) malloc(24);
    result->cl = (panda$core$Class*) &org$pandalanguage$pandac$ClassDecl$Kind$wrapperclass;
    result->value = self;
    return result;
}
