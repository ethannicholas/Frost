...
org$pandalanguage$pandac$pandadoc$Markdown$_Closure20$class_type org$pandalanguage$pandac$pandadoc$Markdown$_Closure20$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &panda$core$Object$class, NULL, { panda$core$Object$convert$R$panda$core$String, org$pandalanguage$pandac$pandadoc$Markdown$_Closure20$cleanup, org$pandalanguage$pandac$pandadoc$Markdown$_Closure20$$anonymous19$panda$collections$ListView$LTpanda$core$String$Q$GT$R$panda$core$String} };
...
static panda$core$String $s37 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x22\x3e\x3c\x2f\x61\x3e\x3c\x68\x32\x3e", 10, 751414109755816211, NULL };
static panda$core$String $s41 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x3c\x2f\x68\x32\x3e", 5, 16803214724, NULL };

void org$pandalanguage$pandac$pandadoc$Markdown$_Closure20$init$org$pandalanguage$pandac$pandadoc$Markdown(org$pandalanguage$pandac$pandadoc$Markdown$_Closure20* param0, org$pandalanguage$pandac$pandadoc$Markdown* param1) {
...
void org$pandalanguage$pandac$pandadoc$Markdown$_Closure20$cleanup(org$pandalanguage$pandac$pandadoc$Markdown$_Closure20* param0) {
...
panda$core$String* org$pandalanguage$pandac$pandadoc$Markdown$_Closure20$$anonymous19$panda$collections$ListView$LTpanda$core$String$Q$GT$R$panda$core$String(org$pandalanguage$pandac$pandadoc$Markdown$_Closure20* param0, panda$collections$ListView* param1) {
...
block2:;
panda$core$Int64 $tmp15 = (panda$core$Int64) {775};
...
block4:;
panda$core$Int64 $tmp31 = (panda$core$Int64) {777};
