#include "org/pandalanguage/pandac/statements/Loop.h"
...
org$pandalanguage$pandac$statements$Loop$class_type org$pandalanguage$pandac$statements$Loop$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &panda$core$Object$class, NULL, { panda$core$Object$convert$R$panda$core$String, org$pandalanguage$pandac$statements$Loop$cleanup} };
...
static panda$core$String $s1 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x6f\x72\x67\x2e\x70\x61\x6e\x64\x61\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x70\x61\x6e\x64\x61\x63\x2e\x73\x74\x61\x74\x65\x6d\x65\x6e\x74\x73\x2e\x4c\x6f\x6f\x70", 40, 6442015772493613678, NULL };
...
void org$pandalanguage$pandac$statements$Loop$compile$org$pandalanguage$pandac$Compiler$org$pandalanguage$pandac$Position$panda$core$String$Q$org$pandalanguage$pandac$FixedArray$LTorg$pandalanguage$pandac$ASTNode$GT(org$pandalanguage$pandac$Compiler* param0, org$pandalanguage$pandac$Position param1, panda$core$String* param2, org$pandalanguage$pandac$FixedArray* param3) {
...
void org$pandalanguage$pandac$statements$Loop$init(org$pandalanguage$pandac$statements$Loop* param0) {

return;

}
void org$pandalanguage$pandac$statements$Loop$cleanup(org$pandalanguage$pandac$statements$Loop* param0) {
