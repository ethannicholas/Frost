#include "org/pandalanguage/pandac/statements/Break.h"
...
org$pandalanguage$pandac$statements$Break$class_type org$pandalanguage$pandac$statements$Break$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &panda$core$Object$class, NULL, { panda$core$Object$convert$R$panda$core$String, org$pandalanguage$pandac$statements$Break$cleanup} };

typedef org$pandalanguage$pandac$IR$Statement$ID (*$fn25)(org$pandalanguage$pandac$IR*, org$pandalanguage$pandac$IR$Statement*);

static panda$core$String $s1 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x6f\x72\x67\x2e\x70\x61\x6e\x64\x61\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x70\x61\x6e\x64\x61\x63\x2e\x73\x74\x61\x74\x65\x6d\x65\x6e\x74\x73\x2e\x42\x72\x65\x61\x6b", 41, 5007550440983058393, NULL };
static panda$core$String $s30 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x42\x72\x65\x61\x6b\x2e\x70\x61\x6e\x64\x61", 11, -2897467708909644764, NULL };

void org$pandalanguage$pandac$statements$Break$compile$org$pandalanguage$pandac$Compiler$org$pandalanguage$pandac$Position$panda$core$String$Q(org$pandalanguage$pandac$Compiler* param0, org$pandalanguage$pandac$Position param1, panda$core$String* param2) {
...
void org$pandalanguage$pandac$statements$Break$init(org$pandalanguage$pandac$statements$Break* param0) {

return;

}
void org$pandalanguage$pandac$statements$Break$cleanup(org$pandalanguage$pandac$statements$Break* param0) {
