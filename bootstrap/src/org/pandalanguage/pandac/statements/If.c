#include "org/pandalanguage/pandac/statements/If.h"
...
org$pandalanguage$pandac$statements$If$class_type org$pandalanguage$pandac$statements$If$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &panda$core$Object$class, NULL, { panda$core$Object$convert$R$panda$core$String, org$pandalanguage$pandac$statements$If$cleanup} };
...
static panda$core$String $s1 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x6f\x72\x67\x2e\x70\x61\x6e\x64\x61\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x70\x61\x6e\x64\x61\x63\x2e\x73\x74\x61\x74\x65\x6d\x65\x6e\x74\x73\x2e\x49\x66", 38, 405696763874466227, NULL };
...
void org$pandalanguage$pandac$statements$If$compile$org$pandalanguage$pandac$Compiler$org$pandalanguage$pandac$Position$org$pandalanguage$pandac$ASTNode$org$pandalanguage$pandac$FixedArray$LTorg$pandalanguage$pandac$ASTNode$GT$org$pandalanguage$pandac$ASTNode$Q(org$pandalanguage$pandac$Compiler* param0, org$pandalanguage$pandac$Position param1, org$pandalanguage$pandac$ASTNode* param2, org$pandalanguage$pandac$FixedArray* param3, org$pandalanguage$pandac$ASTNode* param4) {
...
void org$pandalanguage$pandac$statements$If$init(org$pandalanguage$pandac$statements$If* param0) {

return;

}
void org$pandalanguage$pandac$statements$If$cleanup(org$pandalanguage$pandac$statements$If* param0) {
