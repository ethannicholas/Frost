#include "org/pandalanguage/pandac/statements/Assert.h"
...
org$pandalanguage$pandac$statements$Assert$class_type org$pandalanguage$pandac$statements$Assert$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &panda$core$Object$class, NULL, { panda$core$Object$convert$R$panda$core$String, org$pandalanguage$pandac$statements$Assert$cleanup} };
...
static panda$core$String $s1 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x6f\x72\x67\x2e\x70\x61\x6e\x64\x61\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x70\x61\x6e\x64\x61\x63\x2e\x73\x74\x61\x74\x65\x6d\x65\x6e\x74\x73\x2e\x41\x73\x73\x65\x72\x74", 42, 7700504538739429802, NULL };
...
void org$pandalanguage$pandac$statements$Assert$compileFail$org$pandalanguage$pandac$Compiler$org$pandalanguage$pandac$Position$org$pandalanguage$pandac$ASTNode$Q(org$pandalanguage$pandac$Compiler* param0, org$pandalanguage$pandac$Position param1, org$pandalanguage$pandac$ASTNode* param2) {
...
org$pandalanguage$pandac$IR$Value* $tmp59 = org$pandalanguage$pandac$statements$Call$compile$org$pandalanguage$pandac$Compiler$org$pandalanguage$pandac$Position$org$pandalanguage$pandac$IR$Value$Q$org$pandalanguage$pandac$MethodRef$panda$collections$ListView$LTorg$pandalanguage$pandac$ASTNode$GT$org$pandalanguage$pandac$Compiler$TypeContext$R$org$pandalanguage$pandac$IR$Value$Q(param0, param1, ((org$pandalanguage$pandac$IR$Value*) NULL), $tmp53, ((panda$collections$ListView*) $tmp56), $tmp57);
...
void org$pandalanguage$pandac$statements$Assert$compile$org$pandalanguage$pandac$Compiler$org$pandalanguage$pandac$Position$org$pandalanguage$pandac$ASTNode$org$pandalanguage$pandac$ASTNode$Q(org$pandalanguage$pandac$Compiler* param0, org$pandalanguage$pandac$Position param1, org$pandalanguage$pandac$ASTNode* param2, org$pandalanguage$pandac$ASTNode* param3) {
...
// line 53
org$pandalanguage$pandac$statements$Assert$compileFail$org$pandalanguage$pandac$Compiler$org$pandalanguage$pandac$Position$org$pandalanguage$pandac$ASTNode$Q(param0, param1, param3);
// line 54
...
void org$pandalanguage$pandac$statements$Assert$init(org$pandalanguage$pandac$statements$Assert* param0) {

return;

}
void org$pandalanguage$pandac$statements$Assert$cleanup(org$pandalanguage$pandac$statements$Assert* param0) {
