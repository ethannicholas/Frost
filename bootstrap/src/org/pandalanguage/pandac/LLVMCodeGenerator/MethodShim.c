...
void org$pandalanguage$pandac$LLVMCodeGenerator$MethodShim$init$panda$core$String$panda$core$String(org$pandalanguage$pandac$LLVMCodeGenerator$MethodShim* param0, panda$core$String* param1, panda$core$String* param2) {
...
void org$pandalanguage$pandac$LLVMCodeGenerator$MethodShim$cleanup(org$pandalanguage$pandac$LLVMCodeGenerator$MethodShim* param0) {
