...
static panda$core$String $s25 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x53\x79\x6d\x62\x6f\x6c\x2e\x70\x61\x6e\x64\x61", 12, 3933075218527676353, NULL };
static panda$core$String $s31 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x31", 1, 150, NULL };
static panda$core$String $s38 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x53\x79\x6d\x62\x6f\x6c\x2e\x70\x61\x6e\x64\x61", 12, 3933075218527676353, NULL };
...
$tmp20 = (panda$core$Int64$wrapper*) pandaObjectAlloc(24, (panda$core$Class*) &panda$core$Int64$wrapperclass);
$tmp20->value = $tmp19;
...
*$tmp30 = param3;
// line 30
ITable* $tmp32 = ((panda$core$Equatable*) param3)->$class->itable;
while ($tmp32->$class != (panda$core$Class*) &panda$core$Equatable$class) {
    $tmp32 = $tmp32->next;
}
$fn34 $tmp33 = $tmp32->methods[1];
panda$core$Bit $tmp35 = $tmp33(((panda$core$Equatable*) param3), ((panda$core$Equatable*) &$s31));
...
panda$core$String** $tmp40 = &param0->name;
