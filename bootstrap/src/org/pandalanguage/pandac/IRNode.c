...
typedef panda$core$String* (*$fn2361)(panda$core$Object*);
...
typedef panda$core$String* (*$fn2599)(panda$collections$ListView*);
typedef panda$core$String* (*$fn2621)(panda$collections$ListView*);
typedef panda$core$String* (*$fn2659)(panda$collections$ListView*);
typedef panda$core$String* (*$fn2681)(panda$collections$ListView*);
typedef panda$core$String* (*$fn2699)(org$pandalanguage$pandac$IRNode*);
typedef panda$core$String* (*$fn2783)(panda$collections$ListView*);
typedef panda$core$String* (*$fn2824)(panda$collections$ListView*);
typedef panda$core$String* (*$fn2833)(panda$collections$ListView*, panda$core$String*);
...
panda$core$String* org$pandalanguage$pandac$IRNode$convert$R$panda$core$String(org$pandalanguage$pandac$IRNode* self) {
    ...
    panda$collections$Iterator* Iter$584$172406 = NULL;
    ...
    org$pandalanguage$pandac$Variable$Kind $match$652_172767;
    ...
    panda$collections$Iterator* Iter$672$172869 = NULL;
    ...
    int $tmp1483;
    {
        ...
        if ($tmp2349.value) {
        {
            ...
            base2352 = *$tmp2353;
            org$pandalanguage$pandac$parser$Token$Kind$wrapper* $tmp2360;
            $tmp2360 = (org$pandalanguage$pandac$parser$Token$Kind$wrapper*) pandaObjectAlloc(24, (panda$core$Class*) &org$pandalanguage$pandac$parser$Token$Kind$wrapperclass);
            $tmp2360->value = op2350;
            $tmp2359 = ((panda$core$Object*) $tmp2360);
            panda$core$String* $tmp2362 = (($fn2361) $tmp2359->$class->vtable[0])($tmp2359);
            $tmp2358 = $tmp2362;
            panda$core$String* $tmp2364 = panda$core$String$$ADD$panda$core$String$R$panda$core$String($tmp2358, &$s2363);
            $tmp2357 = $tmp2364;
            panda$core$String* $tmp2365 = panda$core$String$$ADD$panda$core$Object$R$panda$core$String($tmp2357, ((panda$core$Object*) base2352));
            $tmp2356 = $tmp2365;
            panda$core$String* $tmp2367 = panda$core$String$$ADD$panda$core$String$R$panda$core$String($tmp2356, &$s2366);
            $tmp2355 = $tmp2367;
            $tmp2354 = $tmp2355;
            ...
            int $tmp2382;
            {
                ...
                panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) $tmp2395));
                {
                    int $tmp2405;
                    {
                        ...
                        $l2413:;
                        ITable* $tmp2416 = Iter$584$172406->$class->itable;
                        ...
                        panda$core$Bit $tmp2419 = $tmp2417(Iter$584$172406);
                        ...
                        if (!$tmp2415) goto $l2414;
                        {
                            int $tmp2423;
                            {
                                ITable* $tmp2427 = Iter$584$172406->$class->itable;
                                ...
                                panda$core$Object* $tmp2430 = $tmp2428(Iter$584$172406);
                                $tmp2426 = $tmp2430;
                    ...
                    goto $l2403;
                    $l2403:;
                    panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) Iter$584$172406));
                    Iter$584$172406 = NULL;
                    switch ($tmp2405) {
                        case -1: goto $l2435;
                    }
                    $l2435:;
        ...
        if ($tmp2582.value) {
        {
            ...
            $tmp2590 = $tmp2595;
            ITable* $tmp2597 = ((panda$collections$ListView*) args2585)->$class->itable;
            while ($tmp2597->$class != (panda$core$Class*) &panda$collections$ListView$class) {
                $tmp2597 = $tmp2597->next;
            }
            $fn2599 $tmp2598 = $tmp2597->methods[4];
            panda$core$String* $tmp2600 = $tmp2598(((panda$collections$ListView*) args2585));
            $tmp2596 = $tmp2600;
        ...
        if ($tmp2607.value) {
        {
            ...
            body2610 = *$tmp2611;
            ITable* $tmp2619 = ((panda$collections$ListView*) params2608)->$class->itable;
            while ($tmp2619->$class != (panda$core$Class*) &panda$collections$ListView$class) {
                $tmp2619 = $tmp2619->next;
            }
            $fn2621 $tmp2620 = $tmp2619->methods[4];
            panda$core$String* $tmp2622 = $tmp2620(((panda$collections$ListView*) params2608));
            $tmp2618 = $tmp2622;
        ...
        if ($tmp2632.value) {
        {
            ...
            if (((panda$core$Bit) { target2633 != NULL }).value) {
            {
                ...
                $tmp2642 = $tmp2655;
                ITable* $tmp2657 = ((panda$collections$ListView*) args2637)->$class->itable;
                while ($tmp2657->$class != (panda$core$Class*) &panda$collections$ListView$class) {
                    $tmp2657 = $tmp2657->next;
                }
                $fn2659 $tmp2658 = $tmp2657->methods[4];
                panda$core$String* $tmp2660 = $tmp2658(((panda$collections$ListView*) args2637));
                $tmp2656 = $tmp2660;
            ...
            else {
            {
                ...
                $tmp2669 = $tmp2677;
                ITable* $tmp2679 = ((panda$collections$ListView*) args2637)->$class->itable;
                while ($tmp2679->$class != (panda$core$Class*) &panda$collections$ListView$class) {
                    $tmp2679 = $tmp2679->next;
                }
                $fn2681 $tmp2680 = $tmp2679->methods[4];
                panda$core$String* $tmp2682 = $tmp2680(((panda$collections$ListView*) args2637));
                $tmp2678 = $tmp2682;
        ...
        if ($tmp2755.value) {
        {
            ...
            int $tmp2762;
            {
                ...
                {
                    $match$652_172767 = kind2756;
                    panda$core$Int64$init$builtin_int64(&$tmp2768, 0);
                    panda$core$Bit $tmp2769 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit($match$652_172767.$rawValue, $tmp2768);
                    if ($tmp2769.value) {
                    {
                    ...
                    panda$core$Bit $tmp2772 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit($match$652_172767.$rawValue, $tmp2771);
                    if ($tmp2772.value) {
                    {
                    ...
                    panda$core$Bit $tmp2775 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit($match$652_172767.$rawValue, $tmp2774);
                    if ($tmp2775.value) {
                    {
                    ...
                    panda$core$Bit $tmp2778 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit($match$652_172767.$rawValue, $tmp2777);
                    if ($tmp2778.value) {
                    {
                ...
                ITable* $tmp2781 = ((panda$collections$ListView*) decls2758)->$class->itable;
                while ($tmp2781->$class != (panda$core$Class*) &panda$collections$ListView$class) {
                    $tmp2781 = $tmp2781->next;
                }
                $fn2783 $tmp2782 = $tmp2781->methods[4];
                panda$core$String* $tmp2784 = $tmp2782(((panda$collections$ListView*) decls2758));
                $tmp2780 = $tmp2784;
        ...
        if ($tmp2810.value) {
        {
            ...
            ITable* $tmp2822 = ((panda$collections$ListView*) tests2811)->$class->itable;
            while ($tmp2822->$class != (panda$core$Class*) &panda$collections$ListView$class) {
                $tmp2822 = $tmp2822->next;
            }
            $fn2824 $tmp2823 = $tmp2822->methods[4];
            panda$core$String* $tmp2825 = $tmp2823(((panda$collections$ListView*) tests2811));
            $tmp2821 = $tmp2825;
            ...
            $tmp2818 = $tmp2828;
            ITable* $tmp2831 = ((panda$collections$ListView*) statements2813)->$class->itable;
            while ($tmp2831->$class != (panda$core$Class*) &panda$collections$ListView$class) {
                $tmp2831 = $tmp2831->next;
            }
            $fn2833 $tmp2832 = $tmp2831->methods[5];
            panda$core$String* $tmp2834 = $tmp2832(((panda$collections$ListView*) statements2813), &$s2830);
            $tmp2829 = $tmp2834;
            ...
            int $tmp2850;
            {
                ...
                panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) $tmp2861));
                {
                    int $tmp2868;
                    {
                        ...
                        $l2876:;
                        ITable* $tmp2879 = Iter$672$172869->$class->itable;
                        ...
                        panda$core$Bit $tmp2882 = $tmp2880(Iter$672$172869);
                        ...
                        if (!$tmp2878) goto $l2877;
                        {
                            int $tmp2886;
                            {
                                ITable* $tmp2890 = Iter$672$172869->$class->itable;
                                ...
                                panda$core$Object* $tmp2893 = $tmp2891(Iter$672$172869);
                                $tmp2889 = $tmp2893;
                    ...
                    goto $l2866;
                    $l2866:;
                    panda$core$Panda$unref$panda$core$Object(((panda$core$Object*) Iter$672$172869));
                    Iter$672$172869 = NULL;
                    switch ($tmp2868) {
                        case -1: goto $l2898;
                    }
                    $l2898:;
        ...
        else {
        {
            ...
            $l2910:;
            panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64(&$s2911, (panda$core$Int64) { 678 });
            abort();
            $l2909:;
        }
        }
