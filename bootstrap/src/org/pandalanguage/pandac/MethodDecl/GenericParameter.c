...
org$pandalanguage$pandac$MethodDecl$GenericParameter$class_type org$pandalanguage$pandac$MethodDecl$GenericParameter$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &org$pandalanguage$pandac$Symbol$class, NULL, { org$pandalanguage$pandac$MethodDecl$GenericParameter$convert$R$panda$core$String, org$pandalanguage$pandac$MethodDecl$GenericParameter$cleanup, org$pandalanguage$pandac$Symbol$get_heritable$R$panda$core$Bit} };


static panda$core$String $s1 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x6f\x72\x67\x2e\x70\x61\x6e\x64\x61\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x70\x61\x6e\x64\x61\x63\x2e\x4d\x65\x74\x68\x6f\x64\x44\x65\x63\x6c\x2e\x47\x65\x6e\x65\x72\x69\x63\x50\x61\x72\x61\x6d\x65\x74\x65\x72", 52, -2449585923312280977, NULL };
...
void org$pandalanguage$pandac$MethodDecl$GenericParameter$init$org$pandalanguage$pandac$Position$panda$core$String$panda$core$String$org$pandalanguage$pandac$Type(org$pandalanguage$pandac$MethodDecl$GenericParameter* param0, org$pandalanguage$pandac$Position param1, panda$core$String* param2, panda$core$String* param3, org$pandalanguage$pandac$Type* param4) {
...
*$tmp7 = param4;
// line 40
panda$core$Int64 $tmp8 = (panda$core$Int64) {4};
...
panda$core$String* org$pandalanguage$pandac$MethodDecl$GenericParameter$convert$R$panda$core$String(org$pandalanguage$pandac$MethodDecl$GenericParameter* param0) {
...
void org$pandalanguage$pandac$MethodDecl$GenericParameter$cleanup(org$pandalanguage$pandac$MethodDecl$GenericParameter* param0) {
