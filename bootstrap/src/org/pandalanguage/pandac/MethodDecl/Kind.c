...
void org$pandalanguage$pandac$MethodDecl$Kind$cleanup$wrappershim(org$pandalanguage$pandac$MethodDecl$Kind$wrapper* self) {
    org$pandalanguage$pandac$MethodDecl$Kind$cleanup(self->value);
}

static panda$core$String $s1;
org$pandalanguage$pandac$MethodDecl$Kind$class_type org$pandalanguage$pandac$MethodDecl$Kind$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &panda$core$Value$class, NULL, { panda$core$Object$convert$R$panda$core$String, org$pandalanguage$pandac$MethodDecl$Kind$cleanup} };
