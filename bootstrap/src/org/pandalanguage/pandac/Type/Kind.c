...
void org$pandalanguage$pandac$Type$Kind$cleanup$shim(panda$core$Object* p0) {
    org$pandalanguage$pandac$Type$Kind$cleanup(((org$pandalanguage$pandac$Type$Kind$wrapper*) p0)->value);

}

static panda$core$String $s1;
org$pandalanguage$pandac$Type$Kind$class_type org$pandalanguage$pandac$Type$Kind$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &panda$core$Value$class, NULL, { panda$core$Object$convert$R$panda$core$String, org$pandalanguage$pandac$Type$Kind$cleanup$shim} };

static panda$core$String $s2;
org$pandalanguage$pandac$Type$Kind$wrapperclass_type org$pandalanguage$pandac$Type$Kind$wrapperclass = { (panda$core$Class*) &panda$core$Class$class, -999, &$s2, (panda$core$Class*) &panda$core$Value$class, NULL, { panda$core$Object$convert$R$panda$core$String, org$pandalanguage$pandac$Type$Kind$cleanup$shim} };
