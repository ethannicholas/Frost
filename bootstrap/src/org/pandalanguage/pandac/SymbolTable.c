...
static panda$core$String $s29 = { (panda$core$Class*) &panda$core$String$class, 2, (panda$core$Char8*) "\x64\x75\x70\x6c\x69\x63\x61\x74\x65\x20\x73\x79\x6d\x62\x6f\x6c\x20\x27", 18, -8206331848375117879, NULL };
static panda$core$String $s31 = { (panda$core$Class*) &panda$core$String$class, 2, (panda$core$Char8*) "\x27\x20\x28\x70\x72\x65\x76\x69\x6f\x75\x73\x20\x64\x65\x63\x6c\x61\x72\x61\x74\x69\x6f\x6e\x20\x77\x61\x73\x20\x61\x74\x20", 31, 1047353836888504095, NULL };
static panda$core$String $s147 = { (panda$core$Class*) &panda$core$String$class, 2, (panda$core$Char8*) "\x53\x79\x6d\x62\x6f\x6c\x54\x61\x62\x6c\x65\x3c\x70\x61\x72\x65\x6e\x74\x73\x28", 20, 4852834911121343140, NULL };
static panda$core$String $s151 = { (panda$core$Class*) &panda$core$String$class, 2, (panda$core$Char8*) "\x29\x2c\x20\x73\x79\x6d\x62\x6f\x6c\x73\x3d", 11, -957388734828816992, NULL };
static panda$core$String $s154 = { (panda$core$Class*) &panda$core$String$class, 2, (panda$core$Char8*) "\x3e", 1, 163, NULL };
...
void org$pandalanguage$pandac$SymbolTable$add$org$pandalanguage$pandac$Symbol$panda$core$String(org$pandalanguage$pandac$SymbolTable* self, org$pandalanguage$pandac$Symbol* p_s, panda$core$String* p_name) {
    ...
    panda$core$Int64 $match$39_1716;
    ...
    {
        {
            $match$39_1716 = old13->kind;
            panda$core$Bit $tmp17 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit($match$39_1716, ((panda$core$Int64) { 204 }));
            if ($tmp17.value) {
            {
                ...
                org$pandalanguage$pandac$Methods* $tmp21 = (org$pandalanguage$pandac$Methods*) malloc(64);
            ...
            panda$core$Bit $tmp23 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit($match$39_1716, ((panda$core$Int64) { 205 }));
            if ($tmp23.value) {
            {
                ...
                org$pandalanguage$pandac$Methods* $tmp27 = (org$pandalanguage$pandac$Methods*) malloc(64);
    ...
    $tmp33 = (org$pandalanguage$pandac$Position$wrapper*) malloc(32);
...
org$pandalanguage$pandac$Symbol* org$pandalanguage$pandac$SymbolTable$merge$org$pandalanguage$pandac$Symbol$Q$org$pandalanguage$pandac$Symbol$Q$R$org$pandalanguage$pandac$Symbol$Q(org$pandalanguage$pandac$SymbolTable* self, org$pandalanguage$pandac$Symbol* p_symbol, org$pandalanguage$pandac$Symbol* p_inherited) {
    panda$core$Int64 $match$85_1361;
    panda$core$Int64 $match$87_2163;
    ...
    panda$core$Int64 $match$108_2195;
    ...
    {
        $match$85_1361 = p_symbol->kind;
        panda$core$Bit $tmp62 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit($match$85_1361, ((panda$core$Int64) { 204 }));
        if ($tmp62.value) {
        {
            {
                $match$87_2163 = p_inherited->kind;
                panda$core$Bit $tmp64 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit($match$87_2163, ((panda$core$Int64) { 205 }));
                if ($tmp64.value) {
                {
                    ...
                    org$pandalanguage$pandac$Methods* $tmp85 = (org$pandalanguage$pandac$Methods*) malloc(64);
                ...
                panda$core$Bit $tmp87 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit($match$87_2163, ((panda$core$Int64) { 204 }));
                if ($tmp87.value) {
                {
                    ...
                    org$pandalanguage$pandac$Methods* $tmp92 = (org$pandalanguage$pandac$Methods*) malloc(64);
        ...
        panda$core$Bit $tmp94 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit($match$85_1361, ((panda$core$Int64) { 205 }));
        if ($tmp94.value) {
        {
            {
                $match$108_2195 = p_inherited->kind;
                panda$core$Bit $tmp96 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit($match$108_2195, ((panda$core$Int64) { 205 }));
                if ($tmp96.value) {
                {
                    ...
                    org$pandalanguage$pandac$Methods* $tmp117 = (org$pandalanguage$pandac$Methods*) malloc(64);
                ...
                panda$core$Bit $tmp119 = panda$core$Int64$$EQ$panda$core$Int64$R$panda$core$Bit($match$108_2195, ((panda$core$Int64) { 204 }));
                if ($tmp119.value) {
                {
                    panda$collections$Array* $tmp121 = (panda$collections$Array*) malloc(40);
                    ...
                    org$pandalanguage$pandac$Methods* $tmp123 = (org$pandalanguage$pandac$Methods*) malloc(64);
...
panda$core$String* org$pandalanguage$pandac$SymbolTable$convert$R$panda$core$String(org$pandalanguage$pandac$SymbolTable* self) {
    panda$core$Int64 $tmp148 = panda$collections$Array$get_count$R$panda$core$Int64(self->parents);
    panda$core$Int64$wrapper* $tmp149;
    $tmp149 = (panda$core$Int64$wrapper*) malloc(24);
    $tmp149->cl = (panda$core$Class*) &panda$core$Int64$wrapperclass;
    $tmp149->refCount = 1;
    $tmp149->value = $tmp148;
    panda$core$String* $tmp150 = panda$core$String$$ADD$panda$core$Object$R$panda$core$String(&$s147, ((panda$core$Object*) $tmp149));
    panda$core$String* $tmp152 = panda$core$String$$ADD$panda$core$String$R$panda$core$String($tmp150, &$s151);
    panda$core$String* $tmp153 = panda$core$String$$ADD$panda$core$Object$R$panda$core$String($tmp152, ((panda$core$Object*) self->symbols));
