...
__attribute__((weak)) panda$core$Bit org$pandalanguage$pandac$Symbol$Kind$$EQ$org$pandalanguage$pandac$Symbol$Kind$R$panda$core$Bit$shim(panda$core$Object* p0, panda$core$Equatable* p1) {
    panda$core$Bit result = org$pandalanguage$pandac$Symbol$Kind$$EQ$org$pandalanguage$pandac$Symbol$Kind$R$panda$core$Bit(((org$pandalanguage$pandac$Symbol$Kind$wrapper*) p0)->value, ((org$pandalanguage$pandac$Symbol$Kind$wrapper*) p1)->value);
...
struct { panda$core$Class* cl; ITable* next; void* methods[2]; } org$pandalanguage$pandac$Symbol$Kind$_panda$core$Equatable = { (panda$core$Class*) &panda$core$Equatable$class, NULL, { org$pandalanguage$pandac$Symbol$Kind$$EQ$org$pandalanguage$pandac$Symbol$Kind$R$panda$core$Bit$shim, panda$core$Equatable$$NEQ$panda$core$Equatable$T$R$panda$core$Bit} };

static panda$core$String $s1;
org$pandalanguage$pandac$Symbol$Kind$class_type org$pandalanguage$pandac$Symbol$Kind$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &panda$core$Value$class, (ITable*) &org$pandalanguage$pandac$Symbol$Kind$_panda$core$Equatable, { panda$core$Object$convert$R$panda$core$String, panda$core$Value$cleanup$shim, org$pandalanguage$pandac$Symbol$Kind$cleanup$shim, org$pandalanguage$pandac$Symbol$Kind$$EQ$org$pandalanguage$pandac$Symbol$Kind$R$panda$core$Bit$shim} };

struct { panda$core$Class* cl; ITable* itable; void* methods[2]; } org$pandalanguage$pandac$Symbol$Kind$wrapper_panda$core$Equatable = { (panda$core$Class*) &panda$core$Equatable$class, NULL, { org$pandalanguage$pandac$Symbol$Kind$$EQ$org$pandalanguage$pandac$Symbol$Kind$R$panda$core$Bit$shim, panda$core$Equatable$$NEQ$panda$core$Equatable$T$R$panda$core$Bit} };

static panda$core$String $s2;
org$pandalanguage$pandac$Symbol$Kind$wrapperclass_type org$pandalanguage$pandac$Symbol$Kind$wrapperclass = { (panda$core$Class*) &panda$core$Class$class, -999, &$s2, (panda$core$Class*) &panda$core$Value$class, (ITable*) &org$pandalanguage$pandac$Symbol$Kind$wrapper_panda$core$Equatable, { panda$core$Object$convert$R$panda$core$String, panda$core$Value$cleanup$shim} };
...
void org$pandalanguage$pandac$Symbol$Kind$cleanup(org$pandalanguage$pandac$Symbol$Kind param0) {
...
if ($tmp30) goto block18; else goto block1;
block18:;
goto block1;
block1:;
return;
...
org$pandalanguage$pandac$Symbol$Kind org$pandalanguage$pandac$Symbol$Kind$init$panda$core$Int64(panda$core$Int64 param0) {

org$pandalanguage$pandac$Symbol$Kind local0;
// line 4
panda$core$Int64* $tmp31 = &(&local0)->$rawValue;
*$tmp31 = param0;
org$pandalanguage$pandac$Symbol$Kind $tmp32 = *(&local0);
return $tmp32;

}
panda$core$Bit org$pandalanguage$pandac$Symbol$Kind$$EQ$org$pandalanguage$pandac$Symbol$Kind$R$panda$core$Bit(org$pandalanguage$pandac$Symbol$Kind param0, org$pandalanguage$pandac$Symbol$Kind param1) {

// line 4
panda$core$Int64 $tmp33 = param0.$rawValue;
panda$core$Int64 $tmp34 = param1.$rawValue;
panda$core$Bit $tmp35 = panda$core$Int64$$NEQ$panda$core$Int64$R$panda$core$Bit($tmp33, $tmp34);
