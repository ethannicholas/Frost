...
void org$pandalanguage$pandac$parser$Token$cleanup$wrappershim(org$pandalanguage$pandac$parser$Token$wrapper* self) {
    org$pandalanguage$pandac$parser$Token$cleanup(self->value);
}

static panda$core$String $s1;
org$pandalanguage$pandac$parser$Token$class_type org$pandalanguage$pandac$parser$Token$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &panda$core$Value$class, NULL, { panda$core$Object$convert$R$panda$core$String, org$pandalanguage$pandac$parser$Token$cleanup} };

static panda$core$String $s2;
org$pandalanguage$pandac$parser$Token$wrapperclass_type org$pandalanguage$pandac$parser$Token$wrapperclass = { (panda$core$Class*) &panda$core$Class$class, -999, &$s2, (panda$core$Class*) &panda$core$Value$class, NULL, { panda$core$Object$convert$R$panda$core$String, org$pandalanguage$pandac$parser$Token$cleanup$wrappershim} };
