...
if ($tmp1732) goto block9; else goto block10;
block9:;
*(&local2) = $tmp1731;
goto block11;
block10:;
...
// unreffing REF($353:org.pandalanguage.pandac.ASTNode?)
// line 712
...
// unreffing REF($419:org.pandalanguage.pandac.ASTNode)
...
// unreffing REF($470:org.pandalanguage.pandac.ASTNode?)
return $tmp1907;
block46:;
...
// unreffing REF($497:panda.core.String)
panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) $tmp1916));
// unreffing REF($496:panda.core.String)
...
if ($tmp2938) goto block13; else goto block14;
block13:;
...
if ($tmp2950) goto block16; else goto block17;
block16:;
...
if ($tmp2962) goto block11; else goto block19;
block11:;
// line 1268
...
if ($tmp5116) goto block45; else goto block46;
block45:;
*(&local9) = $tmp5115;
goto block47;
block46:;
...
if ($tmp5128) goto block43; else goto block44;
block43:;
// line 2460
