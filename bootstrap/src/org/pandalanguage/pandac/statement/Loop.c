...
// line 1
// line 21
org$pandalanguage$pandac$Compiler$AutoContext* $tmp15 = (org$pandalanguage$pandac$Compiler$AutoContext*) frostObjectAlloc(32, (panda$core$Class*) &org$pandalanguage$pandac$Compiler$AutoContext$class);
org$pandalanguage$pandac$Compiler$EnclosingContext* $tmp16 = (org$pandalanguage$pandac$Compiler$EnclosingContext*) frostObjectAlloc(48, (panda$core$Class*) &org$pandalanguage$pandac$Compiler$EnclosingContext$class);
...
// line 22
org$pandalanguage$pandac$Compiler$AutoScope* $tmp21 = (org$pandalanguage$pandac$Compiler$AutoScope*) frostObjectAlloc(40, (panda$core$Class*) &org$pandalanguage$pandac$Compiler$AutoScope$class);
...
org$pandalanguage$pandac$IR$Statement* $tmp24 = (org$pandalanguage$pandac$IR$Statement*) frostObjectAlloc(72, (panda$core$Class*) &org$pandalanguage$pandac$IR$Statement$class);
...
org$pandalanguage$pandac$IR$Statement* $tmp59 = (org$pandalanguage$pandac$IR$Statement*) frostObjectAlloc(72, (panda$core$Class*) &org$pandalanguage$pandac$IR$Statement$class);
