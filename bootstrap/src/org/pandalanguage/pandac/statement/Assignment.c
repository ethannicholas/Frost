...
typedef org$pandalanguage$pandac$Type* (*$fn90)(org$pandalanguage$pandac$lvalue$LValue*);
typedef org$pandalanguage$pandac$IR$Value* (*$fn99)(org$pandalanguage$pandac$lvalue$LValue*);
typedef org$pandalanguage$pandac$Type* (*$fn107)(org$pandalanguage$pandac$lvalue$LValue*);
typedef void (*$fn120)(org$pandalanguage$pandac$lvalue$LValue*, org$pandalanguage$pandac$IR$Value*);
...
org$pandalanguage$pandac$IR$Value* $tmp62 = org$pandalanguage$pandac$expression$Call$compile$org$pandalanguage$pandac$Compiler$org$pandalanguage$pandac$Position$org$pandalanguage$pandac$IR$Value$panda$core$String$panda$collections$ListView$LTorg$pandalanguage$pandac$ASTNode$GT$org$pandalanguage$pandac$Compiler$TypeContext$R$org$pandalanguage$pandac$IR$Value$Q(param0, $tmp57, $tmp58, &$s63, ((panda$collections$ListView*) $tmp59), $tmp60);
...
block4:;
// line 39
org$pandalanguage$pandac$lvalue$LValue* $tmp70 = org$pandalanguage$pandac$lvalue$LValue$compile$org$pandalanguage$pandac$Compiler$org$pandalanguage$pandac$ASTNode$R$org$pandalanguage$pandac$lvalue$LValue$Q(param0, param2);
*(&local6) = ((org$pandalanguage$pandac$lvalue$LValue*) NULL);
panda$core$Panda$ref$panda$core$Object$Q(((panda$core$Object*) $tmp70));
org$pandalanguage$pandac$lvalue$LValue* $tmp71 = *(&local6);
...
// unreffing REF($196:org.pandalanguage.pandac.lvalue.LValue?)
// line 40
org$pandalanguage$pandac$lvalue$LValue* $tmp72 = *(&local6);
panda$core$Bit $tmp73 = panda$core$Bit$init$builtin_bit($tmp72 == NULL);
bool $tmp74 = $tmp73.value;
if ($tmp74) goto block11; else goto block12;
block11:;
// line 41
org$pandalanguage$pandac$lvalue$LValue* $tmp75 = *(&local6);
...
org$pandalanguage$pandac$lvalue$LValue* $tmp87 = *(&local6);
ITable* $tmp88 = $tmp87->$class->itable;
while ($tmp88->$class != (panda$core$Class*) &org$pandalanguage$pandac$lvalue$LValue$class) {
    $tmp88 = $tmp88->next;
}
...
org$pandalanguage$pandac$lvalue$LValue* $tmp96 = *(&local6);
ITable* $tmp97 = $tmp96->$class->itable;
while ($tmp97->$class != (panda$core$Class*) &org$pandalanguage$pandac$lvalue$LValue$class) {
    $tmp97 = $tmp97->next;
}
...
org$pandalanguage$pandac$lvalue$LValue* $tmp104 = *(&local6);
ITable* $tmp105 = $tmp104->$class->itable;
while ($tmp105->$class != (panda$core$Class*) &org$pandalanguage$pandac$lvalue$LValue$class) {
    $tmp105 = $tmp105->next;
}
...
org$pandalanguage$pandac$IR$Value* $tmp109 = org$pandalanguage$pandac$expression$Binary$compile$org$pandalanguage$pandac$Compiler$org$pandalanguage$pandac$Position$org$pandalanguage$pandac$ASTNode$org$pandalanguage$pandac$parser$Token$Kind$org$pandalanguage$pandac$ASTNode$org$pandalanguage$pandac$Compiler$TypeContext$R$org$pandalanguage$pandac$IR$Value$Q(param0, param1, $tmp94, $tmp101, param4, $tmp102);
...
// unreffing right
*(&local7) = ((org$pandalanguage$pandac$IR$Value*) NULL);
org$pandalanguage$pandac$lvalue$LValue* $tmp115 = *(&local6);
...
block17:;
// line 57
org$pandalanguage$pandac$lvalue$LValue* $tmp116 = *(&local6);
org$pandalanguage$pandac$IR$Value* $tmp117 = *(&local7);
ITable* $tmp118 = $tmp116->$class->itable;
while ($tmp118->$class != (panda$core$Class*) &org$pandalanguage$pandac$lvalue$LValue$class) {
    $tmp118 = $tmp118->next;
}
...
// unreffing right
*(&local7) = ((org$pandalanguage$pandac$IR$Value*) NULL);
org$pandalanguage$pandac$lvalue$LValue* $tmp122 = *(&local6);
