#include "org/pandalanguage/pandac/statement/Continue.h"
...
org$pandalanguage$pandac$statement$Continue$class_type org$pandalanguage$pandac$statement$Continue$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &panda$core$Object$class, NULL, { panda$core$Object$convert$R$panda$core$String, org$pandalanguage$pandac$statement$Continue$cleanup} };

typedef org$pandalanguage$pandac$IR$Statement$ID (*$fn30)(org$pandalanguage$pandac$IR*, org$pandalanguage$pandac$IR$Statement*);

static panda$core$String $s1 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x6f\x72\x67\x2e\x70\x61\x6e\x64\x61\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x70\x61\x6e\x64\x61\x63\x2e\x73\x74\x61\x74\x65\x6d\x65\x6e\x74\x2e\x43\x6f\x6e\x74\x69\x6e\x75\x65", 43, 2242836451721857726, NULL };
static panda$core$String $s11 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x43\x6f\x6e\x74\x69\x6e\x75\x65\x2e\x66\x72\x6f\x73\x74", 14, -7855305760879133046, NULL };
...
static panda$core$String $s35 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x43\x6f\x6e\x74\x69\x6e\x75\x65\x2e\x66\x72\x6f\x73\x74", 14, -7855305760879133046, NULL };

void org$pandalanguage$pandac$statement$Continue$compile$org$pandalanguage$pandac$Compiler$org$pandalanguage$pandac$Position$panda$core$String$Q(org$pandalanguage$pandac$Compiler* param0, org$pandalanguage$pandac$Position param1, panda$core$String* param2) {
...
void org$pandalanguage$pandac$statement$Continue$init(org$pandalanguage$pandac$statement$Continue* param0) {

return;

}
void org$pandalanguage$pandac$statement$Continue$cleanup(org$pandalanguage$pandac$statement$Continue* param0) {
