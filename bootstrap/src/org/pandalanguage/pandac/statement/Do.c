...
typedef void (*$fn115)(org$pandalanguage$pandac$IR*, org$pandalanguage$pandac$IR$Block$ID);
...
static panda$core$String $s92 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x44\x6f\x2e\x66\x72\x6f\x73\x74", 8, 18237410384707484, NULL };
...
static panda$core$String $s105 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x44\x6f\x2e\x66\x72\x6f\x73\x74", 8, 18237410384707484, NULL };
static panda$core$String $s106 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "", 105, -4427651744128623909, NULL };
...
org$pandalanguage$pandac$IR$Statement* $tmp64 = (org$pandalanguage$pandac$IR$Statement*) frostObjectAlloc(72, (panda$core$Class*) &org$pandalanguage$pandac$IR$Statement$class);
...
// line 1
// line 38
org$pandalanguage$pandac$Compiler$AutoUnrefs* $tmp74 = (org$pandalanguage$pandac$Compiler$AutoUnrefs*) frostObjectAlloc(32, (panda$core$Class*) &org$pandalanguage$pandac$Compiler$AutoUnrefs$class);
...
// line 39
org$pandalanguage$pandac$Compiler$TypeContext* $tmp76 = (org$pandalanguage$pandac$Compiler$TypeContext*) frostObjectAlloc(32, (panda$core$Class*) &org$pandalanguage$pandac$Compiler$TypeContext$class);
...
panda$core$Bit $tmp89 = panda$core$Bit$init$builtin_bit($tmp88 != NULL);
bool $tmp90 = $tmp89.value;
if ($tmp90) goto block8; else goto block9;
block9:;
panda$core$Int64 $tmp91 = (panda$core$Int64) {43};
panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64$panda$core$String(&$s92, $tmp91, &$s93);
abort(); // unreachable
block8:;
org$pandalanguage$pandac$IR$Value* $tmp94 = org$pandalanguage$pandac$Compiler$extractBuiltinBit$org$pandalanguage$pandac$Position$org$pandalanguage$pandac$IR$Value$R$org$pandalanguage$pandac$IR$Value(param0, param1, $tmp88);
panda$core$Panda$ref$panda$core$Object$Q(((panda$core$Object*) $tmp94));
org$pandalanguage$pandac$IR$Value* $tmp95 = *(&local7);
...
// unreffing REF($224:org.pandalanguage.pandac.IR.Value)
org$pandalanguage$pandac$IR$Value* $tmp96 = *(&local9);
panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) $tmp96));
// unreffing compiledTest
*(&local9) = ((org$pandalanguage$pandac$IR$Value*) NULL);
org$pandalanguage$pandac$Compiler$AutoUnrefs* $tmp97 = *(&local8);
panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) $tmp97));
// unreffing unrefs
*(&local8) = ((org$pandalanguage$pandac$Compiler$AutoUnrefs*) NULL);
// line 45
org$pandalanguage$pandac$IR* $tmp98 = *(&local0);
org$pandalanguage$pandac$IR$Statement* $tmp99 = (org$pandalanguage$pandac$IR$Statement*) frostObjectAlloc(72, (panda$core$Class*) &org$pandalanguage$pandac$IR$Statement$class);
panda$core$Int64 $tmp100 = (panda$core$Int64) {5};
org$pandalanguage$pandac$IR$Value* $tmp101 = *(&local7);
panda$core$Bit $tmp102 = panda$core$Bit$init$builtin_bit($tmp101 != NULL);
bool $tmp103 = $tmp102.value;
if ($tmp103) goto block10; else goto block11;
block11:;
panda$core$Int64 $tmp104 = (panda$core$Int64) {45};
panda$core$Panda$assertionFailure$panda$core$String$panda$core$Int64$panda$core$String(&$s105, $tmp104, &$s106);
abort(); // unreachable
block10:;
org$pandalanguage$pandac$IR$Block$ID $tmp107 = *(&local1);
org$pandalanguage$pandac$IR$Block$ID $tmp108 = *(&local3);
org$pandalanguage$pandac$IR$Statement$init$panda$core$Int64$org$pandalanguage$pandac$Position$org$pandalanguage$pandac$IR$Value$org$pandalanguage$pandac$IR$Block$ID$org$pandalanguage$pandac$IR$Block$ID($tmp99, $tmp100, param1, $tmp101, $tmp107, $tmp108);
$fn110 $tmp109 = ($fn110) $tmp98->$class->vtable[2];
org$pandalanguage$pandac$IR$Statement$ID $tmp111 = $tmp109($tmp98, $tmp99);
panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) $tmp99));
// unreffing REF($247:org.pandalanguage.pandac.IR.Statement)
// line 46
org$pandalanguage$pandac$IR* $tmp112 = *(&local0);
org$pandalanguage$pandac$IR$Block$ID $tmp113 = *(&local3);
$fn115 $tmp114 = ($fn115) $tmp112->$class->vtable[4];
$tmp114($tmp112, $tmp113);
org$pandalanguage$pandac$IR$Value* $tmp116 = *(&local7);
panda$core$Panda$unref$panda$core$Object$Q(((panda$core$Object*) $tmp116));
// unreffing testBit
*(&local7) = ((org$pandalanguage$pandac$IR$Value*) NULL);
org$pandalanguage$pandac$IR* $tmp117 = *(&local0);
