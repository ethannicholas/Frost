#include "org/pandalanguage/pandac/statement/Var.h"
...
org$pandalanguage$pandac$statement$Var$class_type org$pandalanguage$pandac$statement$Var$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &panda$core$Object$class, NULL, { panda$core$Object$convert$R$panda$core$String, org$pandalanguage$pandac$statement$Var$cleanup} };
...
static panda$core$String $s1 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x6f\x72\x67\x2e\x70\x61\x6e\x64\x61\x6c\x61\x6e\x67\x75\x61\x67\x65\x2e\x70\x61\x6e\x64\x61\x63\x2e\x73\x74\x61\x74\x65\x6d\x65\x6e\x74\x2e\x56\x61\x72", 38, 405696763803785934, NULL };
static panda$core$String $s38 = { (panda$core$Class*) &panda$core$String$class, -999, (panda$core$Char8*) "\x56\x61\x72\x2e\x66\x72\x6f\x73\x74", 9, 2035463259934498602, NULL };

void org$pandalanguage$pandac$statement$Var$compile$org$pandalanguage$pandac$Compiler$org$pandalanguage$pandac$Position$org$pandalanguage$pandac$Variable$Kind$org$pandalanguage$pandac$FixedArray$LTorg$pandalanguage$pandac$ASTNode$GT(org$pandalanguage$pandac$Compiler* param0, org$pandalanguage$pandac$Position param1, org$pandalanguage$pandac$Variable$Kind param2, org$pandalanguage$pandac$FixedArray* param3) {
...
void org$pandalanguage$pandac$statement$Var$init(org$pandalanguage$pandac$statement$Var* param0) {

return;

}
void org$pandalanguage$pandac$statement$Var$cleanup(org$pandalanguage$pandac$statement$Var* param0) {
