...
void org$pandalanguage$json$Token$cleanup$wrappershim(org$pandalanguage$json$Token$wrapper* self) {
    org$pandalanguage$json$Token$cleanup(self->value);
}

static panda$core$String $s1;
org$pandalanguage$json$Token$class_type org$pandalanguage$json$Token$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &panda$core$Value$class, NULL, { panda$core$Object$convert$R$panda$core$String, org$pandalanguage$json$Token$cleanup} };

static panda$core$String $s2;
org$pandalanguage$json$Token$wrapperclass_type org$pandalanguage$json$Token$wrapperclass = { (panda$core$Class*) &panda$core$Class$class, -999, &$s2, (panda$core$Class*) &panda$core$Value$class, NULL, { panda$core$Object$convert$R$panda$core$String, org$pandalanguage$json$Token$cleanup$wrappershim} };
