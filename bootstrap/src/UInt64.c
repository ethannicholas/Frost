...
panda$core$String* panda$core$UInt64$convert$R$panda$core$String(panda$core$UInt64 self) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp146, ((panda$core$Object*) wrap_panda$core$Int64(index121)), ((panda$core$Object*) wrap_panda$core$Int64(max119)), ((panda$core$Int64$nullable) { ((panda$core$Int64) { 1 }), true }), ((panda$core$Bit) { false }));
    int64_t $tmp148 = ((panda$core$Int64$wrapper*) $tmp146.start)->value.value;
    panda$core$Int64 i147 = { $tmp148 };
    int64_t $tmp150 = ((panda$core$Int64$wrapper*) $tmp146.end)->value.value;
    ...
    $l155:;
    free(chars120);
    panda$core$String* $tmp177 = (panda$core$String*) malloc(32);
    $tmp177->$class = (panda$core$Class*) &panda$core$String$class;
    $tmp177->refCount.value = 1;
    panda$core$String$init$panda$unsafe$Pointer$LTpanda$core$Char8$GT$panda$core$Int64($tmp177, result145, size143);
    return $tmp177;
}
