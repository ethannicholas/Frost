...
void panda$io$PushbackInputStream$pushback$panda$collections$ListView$LTpanda$core$UInt8$GT(panda$io$PushbackInputStream* self, panda$collections$ListView* p_v) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp14, ((panda$core$Object*) wrap_panda$core$Int64($tmp19)), ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Int64$nullable) { ((panda$core$Int64) { -1 }), true }), ((panda$core$Bit) { true }));
    int64_t $tmp21 = ((panda$core$Int64$wrapper*) $tmp14.start)->value.value;
    panda$core$Int64 i20 = { $tmp21 };
    int64_t $tmp23 = ((panda$core$Int64$wrapper*) $tmp14.end)->value.value;
...
void panda$io$PushbackInputStream$pushback$panda$collections$ListView$LTpanda$core$Int8$GT(panda$io$PushbackInputStream* self, panda$collections$ListView* p_v) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp54, ((panda$core$Object*) wrap_panda$core$Int64($tmp59)), ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Int64$nullable) { ((panda$core$Int64) { -1 }), true }), ((panda$core$Bit) { true }));
    int64_t $tmp61 = ((panda$core$Int64$wrapper*) $tmp54.start)->value.value;
    panda$core$Int64 i60 = { $tmp61 };
    int64_t $tmp63 = ((panda$core$Int64$wrapper*) $tmp54.end)->value.value;
...
void panda$io$PushbackInputStream$pushback$panda$collections$ListView$LTpanda$core$Char8$GT(panda$io$PushbackInputStream* self, panda$collections$ListView* p_c) {
    ...
    panda$core$Range$init$panda$core$Range$T$panda$core$Range$T$panda$core$Int64$Q$panda$core$Bit(&$tmp96, ((panda$core$Object*) wrap_panda$core$Int64($tmp101)), ((panda$core$Object*) wrap_panda$core$Int64(((panda$core$Int64) { 0 }))), ((panda$core$Int64$nullable) { ((panda$core$Int64) { -1 }), true }), ((panda$core$Bit) { true }));
    int64_t $tmp103 = ((panda$core$Int64$wrapper*) $tmp96.start)->value.value;
    panda$core$Int64 i102 = { $tmp103 };
    int64_t $tmp105 = ((panda$core$Int64$wrapper*) $tmp96.end)->value.value;
