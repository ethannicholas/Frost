...
frost$unsafe$NewPointer frost$unsafe$NewPointer$alloc$frost$core$Int$R$frost$unsafe$NewPointer$LTfrost$unsafe$NewPointer$T$GT(frost$core$Int p_count);
...
frost$core$Object* frost$unsafe$NewPointer$$IDX$frost$core$Int$R$frost$unsafe$NewPointer$T(frost$unsafe$NewPointer self, frost$core$Int p_index);
void frost$unsafe$NewPointer$$IDXEQ$frost$core$Int$frost$unsafe$NewPointer$T(frost$unsafe$NewPointer self, frost$core$Int p_index, frost$core$Object* p_value);
frost$unsafe$NewPointer frost$unsafe$NewPointer$realloc$frost$core$Int$R$frost$unsafe$NewPointer$LTfrost$unsafe$NewPointer$T$GT(frost$unsafe$NewPointer self, frost$core$Int p_newCount);
frost$unsafe$NewPointer frost$unsafe$NewPointer$$ADD$frost$core$Int$R$frost$unsafe$NewPointer$LTfrost$unsafe$NewPointer$T$GT(frost$unsafe$NewPointer self, frost$core$Int p_count);
