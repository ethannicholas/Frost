...
void frost$io$MemoryOutputStream$write$frost$core$UInt8(frost$io$MemoryOutputStream* self, frost$core$UInt8 p_i);
void frost$io$MemoryOutputStream$write$frost$unsafe$Pointer$LTfrost$core$UInt8$GT$frost$core$Int64(frost$io$MemoryOutputStream* self, frost$core$UInt8* p_ptr, frost$core$Int64 p_count);
