...
frost$core$Error* frost$io$FileOutputStream$write$frost$unsafe$Pointer$LTfrost$core$UInt8$GT$frost$core$Int$R$frost$core$Error$Q(frost$io$FileOutputStream* self, frost$core$UInt8* p_ptr, frost$core$Int p_size);
