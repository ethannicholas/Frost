...
frost$core$Int frost$io$FileInputStream$read$frost$unsafe$NewPointer$LTfrost$core$UInt8$GT$frost$core$Int$R$frost$core$Int(void* rawSelf, frost$unsafe$NewPointer p_buffer, frost$core$Int p_max);
void frost$io$FileInputStream$readImpl$frost$unsafe$NewPointer$LTfrost$core$UInt8$GT$frost$core$Int$R$frost$core$Int(frost$core$Int* result, void* rawSelf, frost$unsafe$NewPointer p_buffer, frost$core$Int p_max);
