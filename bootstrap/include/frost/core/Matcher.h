...
void frost$core$Matcher$get_groupCount$R$frost$core$Int(frost$core$Int* result, frost$core$Matcher* self);
frost$core$String* frost$core$Matcher$group$frost$core$Int$R$frost$core$String$Q(frost$core$Matcher* self, frost$core$Int p_index);
