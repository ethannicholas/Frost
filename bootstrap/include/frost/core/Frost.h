...
frost$core$String* frost$core$Frost$allocationName$frost$core$Class$R$frost$core$String(frost$core$Class* p_cl);
void frost$core$Frost$countAllocation$frost$core$Class(frost$core$Frost* self, frost$core$Class* p_cl);
void frost$core$Frost$countDeallocation$frost$core$Class(frost$core$Frost* self, frost$core$Class* p_cl);
void frost$core$Frost$dumpReport(frost$core$Frost* self);
