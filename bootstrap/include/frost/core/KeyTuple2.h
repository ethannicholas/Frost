...
void frost$core$KeyTuple2$init$frost$core$KeyTuple2$T0$frost$core$KeyTuple2$T1(frost$core$KeyTuple2* self, frost$collections$HashKey* p_f0, frost$collections$HashKey* p_f1);
