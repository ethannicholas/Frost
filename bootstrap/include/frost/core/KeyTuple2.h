...
frost$core$Object* frost$core$KeyTuple2$$IDX$frost$core$Int64$R$frost$core$Object$Q(frost$core$KeyTuple2* self, frost$core$Int64 p_i);
...
frost$core$Int64 frost$core$KeyTuple2$get_hash$R$frost$core$Int64(frost$core$KeyTuple2* self);
