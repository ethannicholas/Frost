...
frost$core$Int8 frost$core$UInt32$convert$R$frost$core$Int8(frost$core$UInt32 self);
frost$core$Int16 frost$core$UInt32$convert$R$frost$core$Int16(frost$core$UInt32 self);
frost$core$Int32 frost$core$UInt32$convert$R$frost$core$Int32(frost$core$UInt32 self);
frost$core$Int64 frost$core$UInt32$convert$R$frost$core$Int64(frost$core$UInt32 self);
frost$core$UInt8 frost$core$UInt32$convert$R$frost$core$UInt8(frost$core$UInt32 self);
frost$core$UInt16 frost$core$UInt32$convert$R$frost$core$UInt16(frost$core$UInt32 self);
frost$core$UInt64 frost$core$UInt32$convert$R$frost$core$UInt64(frost$core$UInt32 self);
frost$core$Real32 frost$core$UInt32$convert$R$frost$core$Real32(frost$core$UInt32 self);
frost$core$Real64 frost$core$UInt32$convert$R$frost$core$Real64(frost$core$UInt32 self);
frost$core$String* frost$core$UInt32$convert$R$frost$core$String(frost$core$UInt32 self);
