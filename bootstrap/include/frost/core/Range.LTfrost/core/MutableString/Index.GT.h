...
frost$core$String* frost$core$Range$LTfrost$core$MutableString$Index$GT$convert$R$frost$core$String(frost$core$Range$LTfrost$core$MutableString$Index$GT self);
