...
void frost$core$KeyTuple7$init$frost$core$KeyTuple7$T0$frost$core$KeyTuple7$T1$frost$core$KeyTuple7$T2$frost$core$KeyTuple7$T3$frost$core$KeyTuple7$T4$frost$core$KeyTuple7$T5$frost$core$KeyTuple7$T6(frost$core$KeyTuple7* self, frost$collections$HashKey* p_f0, frost$collections$HashKey* p_f1, frost$collections$HashKey* p_f2, frost$collections$HashKey* p_f3, frost$collections$HashKey* p_f4, frost$collections$HashKey* p_f5, frost$collections$HashKey* p_f6);
frost$core$Object* frost$core$KeyTuple7$$IDX$frost$core$Int$R$frost$core$Object$Q(frost$core$KeyTuple7* self, frost$core$Int p_i);
...
frost$core$Int frost$core$KeyTuple7$get_hash$R$frost$core$Int(frost$core$KeyTuple7* self);
