...
void frost$core$RegularExpression$init$frost$core$String$frost$core$Int64(frost$core$RegularExpression* self, frost$core$String* p_regex, frost$core$Int64 p_flags);
...
void frost$core$RegularExpression$compile$frost$core$String$frost$core$Int64(frost$core$RegularExpression* self, frost$core$String* p_regex, frost$core$Int64 p_flags);
