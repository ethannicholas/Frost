...
void frost$core$String$init$frost$unsafe$Pointer$LTfrost$core$Char8$GT$frost$core$Int(frost$core$String* self, frost$core$Char8* p_data, frost$core$Int p_length);
void frost$core$String$init$frost$unsafe$Pointer$LTfrost$core$Char8$GT$frost$core$Int$frost$core$String(frost$core$String* self, frost$core$Char8* p_data, frost$core$Int p_length, frost$core$String* p_owner);
...
frost$core$Int frost$core$String$get_length$R$frost$core$Int(frost$core$String* self);
frost$core$Int frost$core$String$get_byteLength$R$frost$core$Int(frost$core$String* self);
...
frost$core$String* frost$core$String$$MUL$frost$core$Int$R$frost$core$String(frost$core$String* self, frost$core$Int p_count);
...
frost$core$Char32 frost$core$String$$IDX$frost$core$Int$R$frost$core$Char32(frost$core$String* self, frost$core$Int p_index);
...
frost$core$String* frost$core$String$$IDX$frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int$GT$R$frost$core$String(frost$core$String* self, frost$core$SteppedRange$LTfrost$core$String$Index$Q$Cfrost$core$Int$GT p_r);
frost$core$String* frost$core$String$$IDX$frost$core$Range$LTfrost$core$Int$Q$GT$R$frost$core$String(frost$core$String* self, frost$core$Range$LTfrost$core$Int$Q$GT p_r);
frost$core$String* frost$core$String$$IDX$frost$core$SteppedRange$LTfrost$core$Int$Q$Cfrost$core$Int$GT$R$frost$core$String(frost$core$String* self, frost$core$SteppedRange$LTfrost$core$Int$Q$Cfrost$core$Int$GT p_r);
...
frost$core$String$Index frost$core$String$offset$frost$core$String$Index$frost$core$Int$R$frost$core$String$Index(frost$core$String* self, frost$core$String$Index p_index, frost$core$Int p_offset);
frost$core$String* frost$core$String$leftAlign$frost$core$Int$R$frost$core$String(frost$core$String* self, frost$core$Int p_width);
frost$core$String* frost$core$String$leftAlign$frost$core$Int$frost$core$Char32$R$frost$core$String(frost$core$String* self, frost$core$Int p_width, frost$core$Char32 p_fill);
frost$core$String* frost$core$String$rightAlign$frost$core$Int$R$frost$core$String(frost$core$String* self, frost$core$Int p_width);
frost$core$String* frost$core$String$rightAlign$frost$core$Int$frost$core$Char32$R$frost$core$String(frost$core$String* self, frost$core$Int p_width, frost$core$Char32 p_fill);
frost$core$String* frost$core$String$centerAlign$frost$core$Int$R$frost$core$String(frost$core$String* self, frost$core$Int p_width);
frost$core$String* frost$core$String$centerAlign$frost$core$Int$frost$core$Char32$R$frost$core$String(frost$core$String* self, frost$core$Int p_width, frost$core$Char32 p_fill);
...
frost$collections$Array* frost$core$String$split$frost$core$String$frost$core$Int$R$frost$collections$Array$LTfrost$core$String$GT(frost$core$String* self, frost$core$String* p_delimiter, frost$core$Int p_maxResults);
frost$collections$Array* frost$core$String$split$frost$core$RegularExpression$frost$core$Int$R$frost$collections$Array$LTfrost$core$String$GT(frost$core$String* self, frost$core$RegularExpression* p_delimiter, frost$core$Int p_maxResults);
...
frost$core$Int$nullable frost$core$String$get_asInt$R$frost$core$Int$Q(frost$core$String* self);
...
frost$core$Int frost$core$String$get_hash$R$frost$core$Int(frost$core$String* self);
