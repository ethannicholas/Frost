...
void frost$core$String$MatchIterator$init$frost$core$String$frost$core$String$frost$core$Bit(void* rawSelf, frost$core$String* p_haystack, frost$core$String* p_needle, frost$core$Bit p_allowOveraps);
