...
frost$core$Char8 frost$core$String$UTF8List$$IDX$frost$core$Int64$R$frost$core$Char8(frost$core$String$UTF8List* self, frost$core$Int64 p_index);
frost$core$Int64 frost$core$String$UTF8List$get_count$R$frost$core$Int64(frost$core$String$UTF8List* self);
