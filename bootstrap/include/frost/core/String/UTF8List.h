...
void frost$core$String$UTF8List$init$frost$core$String(void* rawSelf, frost$core$String* p_str);
frost$core$Char8 frost$core$String$UTF8List$$IDX$frost$core$Int$R$frost$core$Char8(void* rawSelf, frost$core$Int p_index);
