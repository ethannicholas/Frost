...
frost$core$String$Index frost$core$String$Index$init$frost$core$Int64(frost$core$Int64 p_value);
...
frost$core$Int64 frost$core$String$Index$get_hash$R$frost$core$Int64(frost$core$String$Index self);
