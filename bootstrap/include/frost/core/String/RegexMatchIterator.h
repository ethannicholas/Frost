...
void frost$core$String$RegexMatchIterator$init$frost$core$String$frost$core$RegularExpression$frost$core$Bit(frost$core$String$RegexMatchIterator* self, frost$core$String* p_haystack, frost$core$RegularExpression* p_needle, frost$core$Bit p_allowOverlaps);
