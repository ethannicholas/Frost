...
frost$core$Object* frost$core$KeyTuple8$$IDX$frost$core$Int64$R$frost$core$Object$Q(frost$core$KeyTuple8* self, frost$core$Int64 p_i);
...
frost$core$Int64 frost$core$KeyTuple8$get_hash$R$frost$core$Int64(frost$core$KeyTuple8* self);
