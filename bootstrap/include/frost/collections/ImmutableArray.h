...
void frost$collections$ImmutableArray$init$frost$unsafe$Pointer$LTfrost$collections$ImmutableArray$T$GT$frost$core$Int(void* rawSelf, frost$unsafe$Pointer p_data, frost$core$Int p_count);
