...
void frost$collections$MapWriter$filterInPlace$$LPfrost$collections$MapWriter$K$Cfrost$collections$MapWriter$V$RP$EQ$GT$LPfrost$core$Bit$RP(frost$collections$MapWriter* self, frost$core$MutableMethod* p_test);
