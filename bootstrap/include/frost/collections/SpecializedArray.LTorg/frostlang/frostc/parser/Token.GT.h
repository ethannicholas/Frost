...
frost$collections$Iterator* frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT$get_iterator$R$frost$collections$Iterator$LTorg$frostlang$frostc$parser$Token$GT(frost$collections$SpecializedArray$LTorg$frostlang$frostc$parser$Token$GT* self);
