...
void frost$collections$Stack$insert$frost$core$Int64$frost$collections$Stack$T(frost$collections$Stack* self, frost$core$Int64 p_depth, frost$core$Object* p_value);
frost$core$Object* frost$collections$Stack$removeIndex$frost$core$Int64$R$frost$collections$Stack$T(frost$collections$Stack* self, frost$core$Int64 p_depth);
