...
frost$json$JSON* frost$json$JSONParser$list$R$frost$json$JSON(frost$json$JSONParser* self);
frost$json$JSON* frost$json$JSONParser$map$R$frost$json$JSON(frost$json$JSONParser* self);
