...
panda$core$Int64 org$pandalanguage$panda$Int64List$computeCount$panda$core$SteppedRange$LTpanda$core$Int64$Cpanda$core$Int64$GT$R$panda$core$Int64(panda$core$SteppedRange$LTpanda$core$Int64$Cpanda$core$Int64$GT p_range);
