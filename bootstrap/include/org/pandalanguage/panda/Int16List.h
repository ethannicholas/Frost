...
panda$core$Int64 org$pandalanguage$panda$Int16List$computeCount$panda$core$SteppedRange$LTpanda$core$Int16$Cpanda$core$Int16$GT$R$panda$core$Int64(panda$core$SteppedRange$LTpanda$core$Int16$Cpanda$core$Int16$GT p_range);
