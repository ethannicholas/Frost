...
typedef struct { panda$core$Class* cl; int32_t refCount; panda$core$String* name; panda$core$Class* super; ITable* itable; void* vtable[160]; } org$pandalanguage$pandac$Compiler$class_type;
