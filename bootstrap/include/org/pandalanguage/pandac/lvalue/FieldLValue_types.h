...
typedef struct org$pandalanguage$pandac$lvalue$FieldLValue {
...
} org$pandalanguage$pandac$lvalue$FieldLValue;
#include "panda/core/Class.h"
typedef struct { panda$core$Class* cl; int32_t refCount; panda$core$String* name; panda$core$Class* super; ITable* itable; void* vtable[6]; } org$pandalanguage$pandac$lvalue$FieldLValue$class_type;
extern org$pandalanguage$pandac$lvalue$FieldLValue$class_type org$pandalanguage$pandac$lvalue$FieldLValue$class;
