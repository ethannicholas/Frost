...
void org$pandalanguage$pandac$Compiler$EnclosingContext$init$panda$core$Int64$org$pandalanguage$pandac$IR$Value(org$pandalanguage$pandac$Compiler$EnclosingContext* self, panda$core$Int64 p_rv, org$pandalanguage$pandac$IR$Value* p_f0);
