...
#undef PANDA_TYPESONLY
typedef struct { panda$core$Class* cl; int32_t refCount; panda$core$Class* super; ITable* itable; void* vtable[97]; } org$pandalanguage$pandac$LLVMCodeGenerator$class_type;
