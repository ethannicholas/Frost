#include "org/pandalanguage/pandac/IR.h" // writeImport org.pandalanguage.pandac.IR
...
#include "panda/collections/Array.h" // writeImport panda.collections.Array
...
#include "org/pandalanguage/pandac/IR/Block.h" // writeImport org.pandalanguage.pandac.IR.Block
#include "panda/collections/Iterable.h" // writeImport panda.collections.Iterable
#include "panda/collections/Iterator.h" // writeImport panda.collections.Iterator
...
#include "panda/core/UInt64.h" // writeImport panda.core.UInt64
...
block2:;
panda$core$Int64 $tmp25 = (panda$core$Int64) {392};
...
block10:;
panda$core$Int64 $tmp146 = (panda$core$Int64) {420};
