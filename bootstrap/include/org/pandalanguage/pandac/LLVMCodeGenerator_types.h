...
typedef struct { panda$core$Class* cl; int32_t refCount; panda$core$String* name; panda$core$Class* super; ITable* itable; void* vtable[117]; } org$pandalanguage$pandac$LLVMCodeGenerator$class_type;
