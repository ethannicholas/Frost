...
void org$frostlang$plex$runtime$DFA$init$frost$core$Int$frost$unsafe$Pointer$LTfrost$unsafe$Pointer$LTfrost$core$Int$GT$GT$frost$unsafe$Pointer$LTfrost$core$Int$GT(void* rawSelf, frost$core$Int p_stateCount, frost$core$Int** p_transitions, frost$core$Int* p_accepts);
