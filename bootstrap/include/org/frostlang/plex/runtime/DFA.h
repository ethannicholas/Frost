...
void org$frostlang$plex$runtime$DFA$init$frost$core$Int$frost$unsafe$Pointer$LTfrost$unsafe$Pointer$LTfrost$core$Int$GT$GT$frost$unsafe$Pointer$LTfrost$core$Int$GT(void* rawSelf, frost$core$Int p_stateCount, frost$unsafe$Pointer p_transitions, frost$unsafe$Pointer p_accepts);
void org$frostlang$plex$runtime$DFA$init$frost$core$String$frost$core$Int$frost$unsafe$Pointer$LTfrost$unsafe$Pointer$LTfrost$core$Int$GT$GT$frost$unsafe$Pointer$LTfrost$core$Int$GT(void* rawSelf, frost$core$String* p_source, frost$core$Int p_stateCount, frost$unsafe$Pointer p_transitions, frost$unsafe$Pointer p_accepts);
