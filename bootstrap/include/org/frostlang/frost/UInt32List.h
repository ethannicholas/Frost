...
void org$frostlang$frost$UInt32List$init$frost$core$SteppedRange$LTfrost$core$UInt32$Cfrost$core$UInt32$GT(void* rawSelf, frost$core$SteppedRange$LTfrost$core$UInt32$Cfrost$core$UInt32$GT p_range);
...
frost$core$UInt32 org$frostlang$frost$UInt32List$$IDX$frost$core$Int$R$frost$core$UInt32(void* rawSelf, frost$core$Int p_index);
