...
frost$core$Int org$frostlang$frost$Int16List$get_count$R$frost$core$Int(org$frostlang$frost$Int16List* self);
frost$core$Int16 org$frostlang$frost$Int16List$$IDX$frost$core$Int$R$frost$core$Int16(org$frostlang$frost$Int16List* self, frost$core$Int p_index);
frost$core$String* org$frostlang$frost$Int16List$get_asString$R$frost$core$String(org$frostlang$frost$Int16List* self);
