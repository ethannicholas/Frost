...
void org$frostlang$frostc$CCodeGenerator$EnclosingContext$init$frost$core$Int$frost$core$String$Q$frost$core$String$frost$core$String(void* rawSelf, frost$core$Int p_rv, frost$core$String* p_f0, frost$core$String* p_f1, frost$core$String* p_f2);
