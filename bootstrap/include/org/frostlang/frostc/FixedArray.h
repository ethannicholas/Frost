...
void org$frostlang$frostc$FixedArray$init$frost$unsafe$Pointer$LTorg$frostlang$frostc$FixedArray$T$GT$frost$core$Int(org$frostlang$frostc$FixedArray* self, frost$core$Object** p_data, frost$core$Int p_count);
...
frost$core$Object* org$frostlang$frostc$FixedArray$$IDX$frost$core$Int$R$org$frostlang$frostc$FixedArray$T(org$frostlang$frostc$FixedArray* self, frost$core$Int p_index);
frost$core$Int org$frostlang$frostc$FixedArray$get_count$R$frost$core$Int(org$frostlang$frostc$FixedArray* self);
