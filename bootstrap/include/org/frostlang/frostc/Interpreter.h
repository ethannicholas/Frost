...
frost$core$Int64 org$frostlang$frostc$Interpreter$$anonymous18$org$frostlang$frostc$Interpreter$Context$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$IR$Value$GT$R$frost$core$Int64(org$frostlang$frostc$Interpreter$Context* p_context, org$frostlang$frostc$FixedArray* p_args);
frost$core$Int64 org$frostlang$frostc$Interpreter$$anonymous19$org$frostlang$frostc$Interpreter$Context$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$IR$Value$GT$R$frost$core$Int64(org$frostlang$frostc$Interpreter$Context* p_context, org$frostlang$frostc$FixedArray* p_args);
frost$core$Int64 org$frostlang$frostc$Interpreter$$anonymous24$org$frostlang$frostc$Interpreter$Context$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$IR$Value$GT$R$frost$core$Int64(org$frostlang$frostc$Interpreter$Context* p_context, org$frostlang$frostc$FixedArray* p_args);
frost$core$Int64 org$frostlang$frostc$Interpreter$$anonymous25$org$frostlang$frostc$Interpreter$Context$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$IR$Value$GT$R$frost$core$Int64(org$frostlang$frostc$Interpreter$Context* p_context, org$frostlang$frostc$FixedArray* p_args);
frost$core$Int64 org$frostlang$frostc$Interpreter$$anonymous26$org$frostlang$frostc$Interpreter$Context$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$IR$Value$GT$R$frost$core$Int64(org$frostlang$frostc$Interpreter$Context* p_context, org$frostlang$frostc$FixedArray* p_args);
frost$core$Int64 org$frostlang$frostc$Interpreter$$anonymous27$org$frostlang$frostc$Interpreter$Context$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$IR$Value$GT$R$frost$core$Int64(org$frostlang$frostc$Interpreter$Context* p_context, org$frostlang$frostc$FixedArray* p_args);
...
frost$core$Int64 org$frostlang$frostc$Interpreter$call$org$frostlang$frostc$MethodDecl$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$IR$Value$GT$frost$core$Int64$Q$R$frost$core$Int64(void* rawSelf, org$frostlang$frostc$MethodDecl* p_m, org$frostlang$frostc$FixedArray* p_args, frost$core$Int64$nullable p_selfOverride);
