...
frost$unsafe$NewPointer org$frostlang$frostc$Interpreter$align$frost$unsafe$NewPointer$LTfrost$core$UInt8$GT$frost$core$Int$R$frost$unsafe$NewPointer$LTfrost$core$UInt8$GT(void* rawSelf, frost$unsafe$NewPointer p_p, frost$core$Int p_alignment);
frost$unsafe$NewPointer org$frostlang$frostc$Interpreter$alloca$org$frostlang$frostc$Type$R$frost$unsafe$NewPointer$LTfrost$core$UInt8$GT(void* rawSelf, org$frostlang$frostc$Type* p_t);
frost$core$Bit org$frostlang$frostc$Interpreter$needsStructNewPointer$org$frostlang$frostc$Type$R$frost$core$Bit(void* rawSelf, org$frostlang$frostc$Type* p_t);
void org$frostlang$frostc$Interpreter$destroyObject$frost$unsafe$NewPointer$LTfrost$core$UInt8$GT(void* rawSelf, frost$unsafe$NewPointer p_o);
void org$frostlang$frostc$Interpreter$ref$frost$unsafe$NewPointer$LTfrost$core$UInt8$GT(void* rawSelf, frost$unsafe$NewPointer p_o);
void org$frostlang$frostc$Interpreter$unref$frost$unsafe$NewPointer$LTfrost$core$UInt8$GT(void* rawSelf, frost$unsafe$NewPointer p_o);
...
void org$frostlang$frostc$Interpreter$getFieldNewPointer$org$frostlang$frostc$Interpreter$Context$org$frostlang$frostc$IR$Statement$ID$org$frostlang$frostc$IR$Value$org$frostlang$frostc$FieldDecl(void* rawSelf, org$frostlang$frostc$Interpreter$Context* p_context, org$frostlang$frostc$IR$Statement$ID p_id, org$frostlang$frostc$IR$Value* p_value, org$frostlang$frostc$FieldDecl* p_field);
