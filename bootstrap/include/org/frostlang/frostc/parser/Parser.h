...
void org$frostlang$frostc$parser$Parser$init$frost$threads$MessageQueue$LTorg$frostlang$frostc$Compiler$Message$GT(void* rawSelf, frost$threads$MessageQueue* p_errors);
void org$frostlang$frostc$parser$Parser$start$frost$io$File$frost$core$Int$frost$core$String(void* rawSelf, frost$io$File* p_path, frost$core$Int p_pathIndex, frost$core$String* p_source);
...
void org$frostlang$frostc$parser$Parser$pushback$org$frostlang$frostc$parser$Token(void* rawSelf, org$frostlang$frostc$parser$Token p_token);
...
org$frostlang$frostc$parser$Token$nullable org$frostlang$frostc$parser$Parser$checkNext$org$frostlang$frostc$parser$Token$Kind$R$org$frostlang$frostc$parser$Token$Q(void* rawSelf, org$frostlang$frostc$parser$Token$Kind p_kind);
org$frostlang$frostc$parser$Token$nullable org$frostlang$frostc$parser$Parser$expect$org$frostlang$frostc$parser$Token$Kind$frost$core$String$R$org$frostlang$frostc$parser$Token$Q(void* rawSelf, org$frostlang$frostc$parser$Token$Kind p_kind, frost$core$String* p_expected);
void org$frostlang$frostc$parser$Parser$error$org$frostlang$frostc$parser$Token$frost$core$String(void* rawSelf, org$frostlang$frostc$parser$Token p_token, frost$core$String* p_msg);
void org$frostlang$frostc$parser$Parser$open$org$frostlang$frostc$parser$SyntaxHighlighter$Kind(void* rawSelf, org$frostlang$frostc$parser$SyntaxHighlighter$Kind p_kind);
void org$frostlang$frostc$parser$Parser$close$org$frostlang$frostc$parser$SyntaxHighlighter$Kind(void* rawSelf, org$frostlang$frostc$parser$SyntaxHighlighter$Kind p_kind);
...
frost$core$String* org$frostlang$frostc$parser$Parser$text$org$frostlang$frostc$parser$Token$R$frost$core$String(void* rawSelf, org$frostlang$frostc$parser$Token p_token);
org$frostlang$frostc$ASTNode* org$frostlang$frostc$parser$Parser$addStringChunk$org$frostlang$frostc$ASTNode$Q$org$frostlang$frostc$ASTNode$R$org$frostlang$frostc$ASTNode(void* rawSelf, org$frostlang$frostc$ASTNode* p_string, org$frostlang$frostc$ASTNode* p_chunk);
frost$core$String* org$frostlang$frostc$parser$Parser$formatString$org$frostlang$frostc$parser$Token$R$frost$core$String$Q(void* rawSelf, org$frostlang$frostc$parser$Token p_start);
frost$core$String* org$frostlang$frostc$parser$Parser$alignmentString$org$frostlang$frostc$parser$Token$R$frost$core$String$Q(void* rawSelf, org$frostlang$frostc$parser$Token p_start);
org$frostlang$frostc$ASTNode* org$frostlang$frostc$parser$Parser$convertToString$org$frostlang$frostc$ASTNode$R$org$frostlang$frostc$ASTNode(void* rawSelf, org$frostlang$frostc$ASTNode* p_expr);
...
org$frostlang$frostc$ASTNode* org$frostlang$frostc$parser$Parser$type$frost$core$Bit$R$org$frostlang$frostc$ASTNode$Q(void* rawSelf, frost$core$Bit p_needSpeculativeParse);
...
org$frostlang$frostc$ASTNode* org$frostlang$frostc$parser$Parser$forLoop$frost$core$String$Q$R$org$frostlang$frostc$ASTNode$Q(void* rawSelf, frost$core$String* p_label);
org$frostlang$frostc$ASTNode* org$frostlang$frostc$parser$Parser$whileLoop$frost$core$String$Q$R$org$frostlang$frostc$ASTNode$Q(void* rawSelf, frost$core$String* p_label);
org$frostlang$frostc$ASTNode* org$frostlang$frostc$parser$Parser$doLoop$frost$core$String$Q$R$org$frostlang$frostc$ASTNode$Q(void* rawSelf, frost$core$String* p_label);
org$frostlang$frostc$ASTNode* org$frostlang$frostc$parser$Parser$loopLoop$frost$core$String$Q$R$org$frostlang$frostc$ASTNode$Q(void* rawSelf, frost$core$String* p_label);
...
org$frostlang$frostc$ASTNode* org$frostlang$frostc$parser$Parser$anyLoop$frost$core$String$Q$R$org$frostlang$frostc$ASTNode$Q(void* rawSelf, frost$core$String* p_label);
...
org$frostlang$frostc$ASTNode* org$frostlang$frostc$parser$Parser$methodDeclaration$org$frostlang$frostc$ASTNode$Q$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$ASTNode$GT$R$org$frostlang$frostc$ASTNode$Q(void* rawSelf, org$frostlang$frostc$ASTNode* p_doccomment, org$frostlang$frostc$FixedArray* p_annotations);
...
org$frostlang$frostc$ASTNode* org$frostlang$frostc$parser$Parser$initDeclaration$org$frostlang$frostc$ASTNode$Q$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$ASTNode$GT$R$org$frostlang$frostc$ASTNode$Q(void* rawSelf, org$frostlang$frostc$ASTNode* p_doccomment, org$frostlang$frostc$FixedArray* p_annotations);
org$frostlang$frostc$ASTNode* org$frostlang$frostc$parser$Parser$fieldDeclaration$org$frostlang$frostc$ASTNode$Q$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$ASTNode$GT$R$org$frostlang$frostc$ASTNode$Q(void* rawSelf, org$frostlang$frostc$ASTNode* p_doccomment, org$frostlang$frostc$FixedArray* p_annotations);
org$frostlang$frostc$ASTNode* org$frostlang$frostc$parser$Parser$choiceCase$org$frostlang$frostc$ASTNode$Q$R$org$frostlang$frostc$ASTNode$Q(void* rawSelf, org$frostlang$frostc$ASTNode* p_doccomment);
org$frostlang$frostc$ASTNode* org$frostlang$frostc$parser$Parser$choiceDeclaration$org$frostlang$frostc$ASTNode$Q$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$ASTNode$GT$R$org$frostlang$frostc$ASTNode$Q(void* rawSelf, org$frostlang$frostc$ASTNode* p_choiceDoccomment, org$frostlang$frostc$FixedArray* p_choiceAnnotations);
...
org$frostlang$frostc$ASTNode* org$frostlang$frostc$parser$Parser$classDeclaration$org$frostlang$frostc$ASTNode$Q$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$ASTNode$GT$R$org$frostlang$frostc$ASTNode$Q(void* rawSelf, org$frostlang$frostc$ASTNode* p_doccomment, org$frostlang$frostc$FixedArray* p_annotations);
org$frostlang$frostc$ASTNode* org$frostlang$frostc$parser$Parser$interfaceDeclaration$org$frostlang$frostc$ASTNode$Q$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$ASTNode$GT$R$org$frostlang$frostc$ASTNode$Q(void* rawSelf, org$frostlang$frostc$ASTNode* p_doccomment, org$frostlang$frostc$FixedArray* p_annotations);
