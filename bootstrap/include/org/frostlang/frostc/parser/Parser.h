...
void org$frostlang$frostc$parser$Parser$init$frost$threads$MessageQueue$LTorg$frostlang$frostc$Compiler$Error$GT(org$frostlang$frostc$parser$Parser* self, frost$threads$MessageQueue* p_errors);
...
org$frostlang$frostc$ASTNode* org$frostlang$frostc$parser$Parser$callExpression$R$org$frostlang$frostc$ASTNode$Q(org$frostlang$frostc$parser$Parser* self);
