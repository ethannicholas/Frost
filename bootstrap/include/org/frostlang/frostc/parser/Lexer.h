...
frost$unsafe$Pointer org$frostlang$frostc$parser$Lexer$alloc$frost$core$Int$frost$core$Int$R$frost$unsafe$Pointer$LTfrost$core$Int$GT(frost$core$Int p_count, frost$core$Int p_fill);
frost$unsafe$Pointer org$frostlang$frostc$parser$Lexer$getTransitions$R$frost$unsafe$Pointer$LTfrost$unsafe$Pointer$LTfrost$core$Int$GT$GT();
frost$unsafe$Pointer org$frostlang$frostc$parser$Lexer$getAccepts$R$frost$unsafe$Pointer$LTfrost$core$Int$GT();
