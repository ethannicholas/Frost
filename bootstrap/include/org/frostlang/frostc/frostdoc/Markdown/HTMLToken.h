...
frost$core$Int org$frostlang$frostc$frostdoc$Markdown$HTMLToken$get_hash$R$frost$core$Int(org$frostlang$frostc$frostdoc$Markdown$HTMLToken* self);
frost$core$String* org$frostlang$frostc$frostdoc$Markdown$HTMLToken$get_asString$R$frost$core$String(org$frostlang$frostc$frostdoc$Markdown$HTMLToken* self);
