...
void org$frostlang$frostc$frostdoc$Markdown$HTMLToken$init$frost$core$Int64$frost$core$String(org$frostlang$frostc$frostdoc$Markdown$HTMLToken* self, frost$core$Int64 p_rv, frost$core$String* p_f0);
