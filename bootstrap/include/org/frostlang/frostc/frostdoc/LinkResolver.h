...
void org$frostlang$frostc$frostdoc$LinkResolver$init$org$frostlang$frostc$Compiler$frost$io$File$frost$core$String(org$frostlang$frostc$frostdoc$LinkResolver* self, org$frostlang$frostc$Compiler* p_compiler, frost$io$File* p_docPath, frost$core$String* p_apiRelativePath);
void org$frostlang$frostc$frostdoc$LinkResolver$init$org$frostlang$frostc$Compiler$frost$io$File$frost$core$String$org$frostlang$frostc$ClassDecl$Q(org$frostlang$frostc$frostdoc$LinkResolver* self, org$frostlang$frostc$Compiler* p_compiler, frost$io$File* p_docPath, frost$core$String* p_apiRelativePath, org$frostlang$frostc$ClassDecl* p_context);
