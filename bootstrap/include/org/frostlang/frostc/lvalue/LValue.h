...
org$frostlang$frostc$Type* org$frostlang$frostc$lvalue$LValue$type$R$org$frostlang$frostc$Type(void* rawSelf);
org$frostlang$frostc$IR$Value* org$frostlang$frostc$lvalue$LValue$compileLoad$R$org$frostlang$frostc$IR$Value$Q(void* rawSelf);
void org$frostlang$frostc$lvalue$LValue$compileStore$org$frostlang$frostc$IR$Value(void* rawSelf, org$frostlang$frostc$IR$Value* p_value);
