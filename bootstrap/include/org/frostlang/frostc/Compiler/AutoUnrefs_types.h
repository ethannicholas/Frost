...
typedef struct org$frostlang$frostc$Compiler$AutoUnrefs {
    ...
    frost$core$Int depth;
} org$frostlang$frostc$Compiler$AutoUnrefs;
#include "frost/core/Class.h"
typedef struct { frost$core$Class* cl; int32_t refCount; uint8_t flags;frost$core$String* name; frost$core$Class* super; ITable* itable; void* vtable[2]; } org$frostlang$frostc$Compiler$AutoUnrefs$class_type;
