...
void org$frostlang$frostc$Compiler$Message$init$frost$core$Int64$frost$core$String$frost$core$Int64$frost$core$Int64$frost$core$String(org$frostlang$frostc$Compiler$Message* self, frost$core$Int64 p_rv, frost$core$String* p_f0, frost$core$Int64 p_f1, frost$core$Int64 p_f2, frost$core$String* p_f3);
