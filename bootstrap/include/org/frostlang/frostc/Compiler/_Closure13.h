...
void org$frostlang$frostc$Compiler$_Closure13$init$org$frostlang$frostc$SymbolTable(org$frostlang$frostc$Compiler$_Closure13* self, org$frostlang$frostc$SymbolTable* p_$dummy486);
