...
void org$frostlang$frostc$Compiler$AutoContext$init$org$frostlang$frostc$Compiler$org$frostlang$frostc$Compiler$EnclosingContext(void* rawSelf, org$frostlang$frostc$Compiler* p_compiler, org$frostlang$frostc$Compiler$EnclosingContext* p_context);
