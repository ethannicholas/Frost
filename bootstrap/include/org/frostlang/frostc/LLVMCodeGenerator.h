...
void org$frostlang$frostc$LLVMCodeGenerator$writePointerAlloc$org$frostlang$frostc$MethodPosition$org$frostlang$frostc$IR$Statement$ID$org$frostlang$frostc$IR$Value$org$frostlang$frostc$Type(void* rawSelf, org$frostlang$frostc$MethodPosition p_position, org$frostlang$frostc$IR$Statement$ID p_id, org$frostlang$frostc$IR$Value* p_count, org$frostlang$frostc$Type* p_type);
void org$frostlang$frostc$LLVMCodeGenerator$writePointerDestroy$org$frostlang$frostc$MethodPosition$org$frostlang$frostc$IR$Value(void* rawSelf, org$frostlang$frostc$MethodPosition p_position, org$frostlang$frostc$IR$Value* p_ptr);
...
void org$frostlang$frostc$LLVMCodeGenerator$writePointerRealloc$org$frostlang$frostc$MethodPosition$org$frostlang$frostc$IR$Statement$ID$org$frostlang$frostc$IR$Value$org$frostlang$frostc$IR$Value$org$frostlang$frostc$IR$Value(void* rawSelf, org$frostlang$frostc$MethodPosition p_position, org$frostlang$frostc$IR$Statement$ID p_id, org$frostlang$frostc$IR$Value* p_ptr, org$frostlang$frostc$IR$Value* p_oldCount, org$frostlang$frostc$IR$Value* p_newCount);
