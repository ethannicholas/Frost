...
void org$frostlang$frostc$SymbolTable$init$org$frostlang$frostc$Compiler(org$frostlang$frostc$SymbolTable* self, org$frostlang$frostc$Compiler* p_compiler);
void org$frostlang$frostc$SymbolTable$init$org$frostlang$frostc$SymbolTable(org$frostlang$frostc$SymbolTable* self, org$frostlang$frostc$SymbolTable* p_parent);
void org$frostlang$frostc$SymbolTable$add$org$frostlang$frostc$Symbol(org$frostlang$frostc$SymbolTable* self, org$frostlang$frostc$Symbol* p_s);
void org$frostlang$frostc$SymbolTable$add$org$frostlang$frostc$Symbol$frost$core$String(org$frostlang$frostc$SymbolTable* self, org$frostlang$frostc$Symbol* p_s, frost$core$String* p_name);
