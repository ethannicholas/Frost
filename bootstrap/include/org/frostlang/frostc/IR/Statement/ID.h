...
org$frostlang$frostc$IR$Statement$ID org$frostlang$frostc$IR$Statement$ID$init$frost$core$Int(frost$core$Int p_value);
frost$core$Int org$frostlang$frostc$IR$Statement$ID$get_hash$R$frost$core$Int(org$frostlang$frostc$IR$Statement$ID self);
