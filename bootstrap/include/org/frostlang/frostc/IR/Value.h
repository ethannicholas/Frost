...
void org$frostlang$frostc$IR$Value$init$frost$core$Int64$frost$core$String$org$frostlang$frostc$Type(org$frostlang$frostc$IR$Value* self, frost$core$Int64 p_rv, frost$core$String* p_f0, org$frostlang$frostc$Type* p_f1);
void org$frostlang$frostc$IR$Value$init$frost$core$Int64$org$frostlang$frostc$IR$Value$Q$org$frostlang$frostc$MethodDecl$org$frostlang$frostc$Type(org$frostlang$frostc$IR$Value* self, frost$core$Int64 p_rv, org$frostlang$frostc$IR$Value* p_f0, org$frostlang$frostc$MethodDecl* p_f1, org$frostlang$frostc$Type* p_f2);
void org$frostlang$frostc$IR$Value$init$frost$core$Int64$org$frostlang$frostc$IR$Value$Q$org$frostlang$frostc$FixedArray$LTorg$frostlang$frostc$MethodDecl$GT$org$frostlang$frostc$Type(org$frostlang$frostc$IR$Value* self, frost$core$Int64 p_rv, org$frostlang$frostc$IR$Value* p_f0, org$frostlang$frostc$FixedArray* p_f1, org$frostlang$frostc$Type* p_f2);
...
void org$frostlang$frostc$IR$Value$init$frost$core$Int64$org$frostlang$frostc$Type$org$frostlang$frostc$Type(org$frostlang$frostc$IR$Value* self, frost$core$Int64 p_rv, org$frostlang$frostc$Type* p_f0, org$frostlang$frostc$Type* p_f1);
