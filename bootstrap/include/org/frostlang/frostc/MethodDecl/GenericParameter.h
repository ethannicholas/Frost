...
frost$core$String* org$frostlang$frostc$MethodDecl$GenericParameter$get_asString$R$frost$core$String(org$frostlang$frostc$MethodDecl$GenericParameter* self);
