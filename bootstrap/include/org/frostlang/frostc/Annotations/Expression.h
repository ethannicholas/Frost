...
void org$frostlang$frostc$Annotations$Expression$init$frost$core$Int$frost$core$String$org$frostlang$frostc$ASTNode(void* rawSelf, frost$core$Int p_rv, frost$core$String* p_f0, org$frostlang$frostc$ASTNode* p_f1);
