...
void org$frostlang$frostc$Variable$Storage$init$frost$core$Int64$frost$core$Int64(org$frostlang$frostc$Variable$Storage* self, frost$core$Int64 p_rv, frost$core$Int64 p_f0);
