...
void org$frostlang$frostc$Variable$init$org$frostlang$frostc$Position$org$frostlang$frostc$Variable$Kind$frost$core$String$org$frostlang$frostc$Type$org$frostlang$frostc$Variable$Storage(void* rawSelf, org$frostlang$frostc$Position p_position, org$frostlang$frostc$Variable$Kind p_kind, frost$core$String* p_name, org$frostlang$frostc$Type* p_type, org$frostlang$frostc$Variable$Storage* p_storage);
