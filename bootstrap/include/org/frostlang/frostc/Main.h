...
frost$io$File* org$frostlang$frostc$Main$toExecutable$frost$collections$Array$LTfrost$io$File$GT$frost$collections$Array$LTfrost$core$String$GT$frost$io$File$frost$io$File$frost$core$Bit$R$frost$io$File(org$frostlang$frostc$Main* self, frost$collections$Array* p_libraryPaths, frost$collections$Array* p_libraries, frost$io$File* p_llvm, frost$io$File* p_dest, frost$core$Bit p_preserveTemporaries);
