...
frost$io$File* org$frostlang$frostc$Main$toObject$frost$io$File$frost$io$File$frost$core$Bit$org$frostlang$frostc$Compiler$Settings$R$frost$io$File(void* rawSelf, frost$io$File* p_llvm, frost$io$File* p_dest, frost$core$Bit p_preserveTemporaries, org$frostlang$frostc$Compiler$Settings* p_settings);
frost$core$String* org$frostlang$frostc$Main$$anonymous5$frost$io$File$R$frost$core$String(frost$io$File* p_p);
frost$core$String* org$frostlang$frostc$Main$$anonymous6$frost$core$String$R$frost$core$String(frost$core$String* p_l);
frost$io$File* org$frostlang$frostc$Main$toExecutable$frost$collections$Array$LTfrost$io$File$GT$frost$collections$Array$LTfrost$core$String$GT$frost$io$File$frost$io$File$frost$core$Bit$org$frostlang$frostc$Compiler$Settings$R$frost$io$File(void* rawSelf, frost$collections$Array* p_libraryPaths, frost$collections$Array* p_libraries, frost$io$File* p_llvm, frost$io$File* p_dest, frost$core$Bit p_preserveTemporaries, org$frostlang$frostc$Compiler$Settings* p_settings);
