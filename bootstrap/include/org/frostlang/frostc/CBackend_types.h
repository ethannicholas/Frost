...
typedef struct org$frostlang$frostc$CBackend {
    ...
    frost$core$Weak* hBackend;
    org$frostlang$frostc$HBackend* hBackendRetain;
...
} org$frostlang$frostc$CBackend;
#include "frost/core/Class.h"
typedef struct { frost$core$Class* cl; int32_t refCount; uint8_t flags;frost$core$String* name; frost$core$Class* super; ITable* itable; void* vtable[77]; } org$frostlang$frostc$CBackend$class_type;
extern org$frostlang$frostc$CBackend$class_type org$frostlang$frostc$CBackend$class;
