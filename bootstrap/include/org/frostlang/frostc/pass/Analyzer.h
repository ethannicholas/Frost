...
void org$frostlang$frostc$pass$Analyzer$updateStateForExitIndex$org$frostlang$frostc$IR$Block$frost$core$Int64$org$frostlang$frostc$pass$Analyzer$State(org$frostlang$frostc$pass$Analyzer* self, org$frostlang$frostc$IR$Block* p_b, frost$core$Int64 p_exit, org$frostlang$frostc$pass$Analyzer$State* p_state);
...
void org$frostlang$frostc$pass$Analyzer$removeBlock$frost$core$Int64(org$frostlang$frostc$pass$Analyzer* self, frost$core$Int64 p_index);
