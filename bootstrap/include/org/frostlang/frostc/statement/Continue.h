...
void org$frostlang$frostc$statement$Continue$init(org$frostlang$frostc$statement$Continue* self);
void org$frostlang$frostc$statement$Continue$cleanup(org$frostlang$frostc$statement$Continue* self);
