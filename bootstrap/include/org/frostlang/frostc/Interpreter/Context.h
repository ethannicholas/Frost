...
void org$frostlang$frostc$Interpreter$Context$init$org$frostlang$frostc$Interpreter$org$frostlang$frostc$Interpreter$MethodCode(void* rawSelf, org$frostlang$frostc$Interpreter* p_interpreter, org$frostlang$frostc$Interpreter$MethodCode* p_code);
