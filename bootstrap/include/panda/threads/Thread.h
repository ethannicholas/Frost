...
void panda$threads$Thread$run$$LP$RP$EQ$AM$GT$LP$RP$builtin_bit(panda$threads$Thread* self, void(*p_m)(), bool p_preventsExit);
panda$threads$Thread* panda$threads$Thread$start$$LP$RP$EQ$AM$GT$LP$RP$R$panda$threads$Thread(void(*p_run)());
panda$threads$Thread* panda$threads$Thread$start$$LP$RP$EQ$AM$GT$LP$RP$panda$core$Bit$R$panda$threads$Thread(void(*p_run)(), panda$core$Bit p_preventsExit);
