...
void panda$io$FileOutputStream$close(panda$io$FileOutputStream* self);
void panda$io$FileOutputStream$write$panda$core$UInt8(panda$io$FileOutputStream* self, panda$core$UInt8 p_value);
void panda$io$FileOutputStream$write$panda$unsafe$Pointer$LTpanda$core$UInt8$GT$panda$core$Int64(panda$io$FileOutputStream* self, panda$core$UInt8* p_ptr, panda$core$Int64 p_size);
