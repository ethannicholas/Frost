#include "panda/core/Range.LTpanda/core/Int64.GT.h" // writeImport panda.core.Range<panda.core.Int64>
...
__attribute__((weak)) panda$core$String* panda$core$Range$LTpanda$core$Int64$GT$convert$R$panda$core$String$shim(panda$core$Object* p0) {
    panda$core$String* result = panda$core$Range$LTpanda$core$Int64$GT$convert$R$panda$core$String(((panda$core$Range$LTpanda$core$Int64$GT$wrapper*) p0)->value);

    return result;
}
__attribute__((weak)) void panda$core$Range$LTpanda$core$Int64$GT$cleanup$shim(panda$core$Object* p0) {
    panda$core$Range$LTpanda$core$Int64$GT$cleanup(((panda$core$Range$LTpanda$core$Int64$GT$wrapper*) p0)->value);

}

static panda$core$String $s1;
panda$core$Range$LTpanda$core$Int64$GT$class_type panda$core$Range$LTpanda$core$Int64$GT$class = { (panda$core$Class*) &panda$core$Class$class, -999, &$s1, (panda$core$Class*) &panda$core$Value$class, NULL, { panda$core$Range$LTpanda$core$Int64$GT$convert$R$panda$core$String$shim, panda$core$Range$LTpanda$core$Int64$GT$cleanup$shim} };
...
panda$core$Range$LTpanda$core$Int64$GT panda$core$Range$LTpanda$core$Int64$GT$init$panda$core$Int64$panda$core$Int64$panda$core$Bit(panda$core$Int64 param0, panda$core$Int64 param1, panda$core$Bit param2) {

panda$core$Range$LTpanda$core$Int64$GT local0;
// line 30
panda$core$Int64* $tmp3 = &(&local0)->min;
*$tmp3 = param0;
// line 31
panda$core$Int64* $tmp4 = &(&local0)->max;
*$tmp4 = param1;
// line 32
panda$core$Bit* $tmp5 = &(&local0)->inclusive;
*$tmp5 = param2;
panda$core$Range$LTpanda$core$Int64$GT $tmp6 = *(&local0);
return $tmp6;

}
panda$core$String* panda$core$Range$LTpanda$core$Int64$GT$convert$R$panda$core$String(panda$core$Range$LTpanda$core$Int64$GT param0) {
...
// line 38
panda$core$Int64 $tmp9 = param0.min;
...
panda$core$Int64 $tmp13 = param0.min;
panda$core$Int64$wrapper* $tmp14;
$tmp14 = (panda$core$Int64$wrapper*) pandaObjectAlloc(24, (panda$core$Class*) &panda$core$Int64$wrapperclass);
$tmp14->value = $tmp13;
...
block4:;
// line 47
panda$core$Int64 $tmp21 = param0.max;
...
panda$core$Int64 $tmp25 = param0.max;
panda$core$Int64$wrapper* $tmp26;
$tmp26 = (panda$core$Int64$wrapper*) pandaObjectAlloc(24, (panda$core$Class*) &panda$core$Int64$wrapperclass);
$tmp26->value = $tmp25;
...
void panda$core$Range$LTpanda$core$Int64$GT$cleanup(panda$core$Range$LTpanda$core$Int64$GT param0) {
