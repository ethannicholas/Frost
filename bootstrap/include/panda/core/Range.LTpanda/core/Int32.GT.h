...
panda$core$Range$LTpanda$core$Int32$GT panda$core$Range$LTpanda$core$Int32$GT$init$panda$core$Int32$panda$core$Int32$panda$core$Bit(panda$core$Int32 p_min, panda$core$Int32 p_max, panda$core$Bit p_inclusive);
