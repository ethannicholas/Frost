...
panda$core$Range$LTpanda$core$Int8$GT panda$core$Range$LTpanda$core$Int8$GT$init$panda$core$Int8$panda$core$Int8$panda$core$Bit(panda$core$Int8 p_min, panda$core$Int8 p_max, panda$core$Bit p_inclusive);
