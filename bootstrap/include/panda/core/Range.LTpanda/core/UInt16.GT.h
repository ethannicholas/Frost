...
panda$core$Range$LTpanda$core$UInt16$GT panda$core$Range$LTpanda$core$UInt16$GT$init$panda$core$UInt16$panda$core$UInt16$panda$core$Bit(panda$core$UInt16 p_min, panda$core$UInt16 p_max, panda$core$Bit p_inclusive);
