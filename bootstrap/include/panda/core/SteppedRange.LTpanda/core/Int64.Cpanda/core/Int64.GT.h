...
panda$core$SteppedRange$LTpanda$core$Int64$Cpanda$core$Int64$GT panda$core$SteppedRange$LTpanda$core$Int64$Cpanda$core$Int64$GT$init$panda$core$Int64$panda$core$Int64$panda$core$Int64$panda$core$Bit(panda$core$Int64 p_start, panda$core$Int64 p_end, panda$core$Int64 p_step, panda$core$Bit p_inclusive);
