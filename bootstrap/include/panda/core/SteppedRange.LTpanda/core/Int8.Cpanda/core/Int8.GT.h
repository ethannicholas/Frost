...
panda$core$SteppedRange$LTpanda$core$Int8$Cpanda$core$Int8$GT panda$core$SteppedRange$LTpanda$core$Int8$Cpanda$core$Int8$GT$init$panda$core$Int8$panda$core$Int8$panda$core$Int8$panda$core$Bit(panda$core$Int8 p_start, panda$core$Int8 p_end, panda$core$Int8 p_step, panda$core$Bit p_inclusive);
