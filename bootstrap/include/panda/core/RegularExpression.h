...
void panda$core$RegularExpression$compile$panda$core$String$panda$core$Int64(panda$core$RegularExpression* self, panda$core$String* p_regex, panda$core$Int64 p_flags);
