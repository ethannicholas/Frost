...
panda$core$MutableString$Index panda$core$MutableString$Index$init$panda$core$Int64(panda$core$Int64 p_value);
...
panda$core$Int64 panda$core$MutableString$Index$get_hash$R$panda$core$Int64(panda$core$MutableString$Index self);
