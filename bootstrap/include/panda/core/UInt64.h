...
panda$core$UInt64 panda$core$UInt64$init$builtin_uint64(uint64_t p_value);
panda$core$UInt64 panda$core$UInt64$init$panda$core$UInt8(panda$core$UInt8 p_value);
panda$core$UInt64 panda$core$UInt64$init$panda$core$UInt16(panda$core$UInt16 p_value);
panda$core$UInt64 panda$core$UInt64$init$panda$core$UInt32(panda$core$UInt32 p_value);
...
panda$core$Real64 panda$core$UInt64$$DIV$panda$core$Real32$R$panda$core$Real64(panda$core$UInt64 self, panda$core$Real32 p_other);
panda$core$Real64 panda$core$UInt64$$DIV$panda$core$Real64$R$panda$core$Real64(panda$core$UInt64 self, panda$core$Real64 p_other);
