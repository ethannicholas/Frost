...
panda$core$Bit panda$collections$ListView$inRange$panda$core$SteppedRange$LTpanda$core$Int64$Q$Cpanda$core$Int64$GT$panda$core$Int64$R$panda$core$Bit(panda$core$SteppedRange$LTpanda$core$Int64$Q$Cpanda$core$Int64$GT p_r, panda$core$Int64 p_count);
...
panda$collections$Iterator* panda$collections$ListView$get_iterator$R$panda$collections$Iterator$LTpanda$collections$ListView$T$GT(panda$collections$ListView* self);
panda$collections$ListView* panda$collections$ListView$sort$$LPpanda$collections$ListView$T$Cpanda$collections$ListView$T$RP$EQ$GT$LPpanda$core$Bit$RP$R$panda$collections$ListView$LTpanda$collections$ListView$T$GT(panda$collections$ListView* self, panda$core$MutableMethod* p_greater);
