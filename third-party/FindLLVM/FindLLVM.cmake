...
if(NOT LLVM_CONFIG)
    if(NOT LLVM_FIND_QUIETLY)
        message(WARNING "Could not find llvm-config (LLVM >= ${LLVM_FIND_VERSION}) in your PATH.\nTry adding the LLVM bin directory to your PATH or manually setting LLVM_CONFIG to the path of the llvm-config executable.")
    endif()
else()
